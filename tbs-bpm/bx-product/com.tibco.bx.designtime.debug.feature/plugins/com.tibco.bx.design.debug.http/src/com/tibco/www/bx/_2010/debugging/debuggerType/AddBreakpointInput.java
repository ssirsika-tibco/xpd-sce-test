 ...
 *         &lt;element name="condExpression" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlType(name = "", propOrder = { "processId", "location", "when", "condExpression", "language" })
@XmlRootElement(name = "addBreakpointInput")
public class AddBreakpointInput {
	...
	protected String condExpression;
	@XmlElement(required = true, nillable = true)
	...
	/**
	 * Gets the value of the condExpression property.
	 * 
	 * @return possible object is {@link String }
	 * 
	 */
	...
	/**
	 * Sets the value of the condExpression property.
	 * 
	 * @param value
	 *            allowed object is {@link String }
	 * 
	 */
	public void setCondExpression(String value) {
		this.condExpression = value;
	}
