...
public class DeleteIntermediateInputAction implements IActionDelegate{
	...
	public void run(IAction action) {
		...
		EList<IntermediateInput> list = null;
		...
		list = processNode.getIntermediateInputs();
		
		if(processNode != null){
			EditingDomain editingDomain = WorkingCopyUtil.getEditingDomain(processNode);
			IUndoableOperation operation = EmulationCommandHelper.getDeleteOperation(editingDomain, list);
	        try {
