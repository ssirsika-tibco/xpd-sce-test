...
/**
 * This is the item provider adapter for a {@link com.tibco.bx.emulation.model.Assertion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssertionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Assertion_accessible_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Assertion_accessible_feature", "_UI_Assertion_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 EmulationPackage.Literals.ASSERTION__ACCESSIBLE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		return getString("_UI_Assertion_type") + " " + ((Assertion)object).getName();
	}
