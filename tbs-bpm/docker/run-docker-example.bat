...
docker run --rm --name studio -e DISPLAY=10.100.83.72:0.0 -v//c/eclipse/oxygen/workspaces/runtime-SCE:/workspace -v //c/scratch/temp/eclipse/export:/exports tibco/sce-studio:5.0.0
