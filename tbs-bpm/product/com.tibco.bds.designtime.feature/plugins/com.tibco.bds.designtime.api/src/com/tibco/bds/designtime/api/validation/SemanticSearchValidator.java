...
public class SemanticSearchValidator {
    ...
    //
    // private static final String RX_TAG_SUFFIX = "\\$[A-Za-z_][A-Za-z0-9_]*";
    // //$NON-NLS-1$
    //
    // private static final String RX_FUNCTION_CALL = "(.*?)\\((.*)\\)";
    // //$NON-NLS-1$
    //
    // private static final String RX_FUNCTION_NAMES = "(?i)(lower|upper)";
    // //$NON-NLS-1$
    //
    ...
    //
    // /**
    // * Gets the literal value of the EnumerationLiteral (i.e. the literal
    // value
