...
public class SemanticSearchValidator {
	/*
	 * Sid ACE-7314 Reintroduce DQL Query string validation - BUT THIS IS STILL NOT REQUIRED AS runtime DQLParser now
	 * does most of the validation
	 */
	...
	// /*
	// * Sid ACE-7314 TYPE OF is no longer supported in 5.x (as we do not support generalisation any more)
	// */
	// addError(String
	// .format(Messages.SemanticSearchValidator_Typeof_no_longer_supported,
	// asc.getAttrPath()));
	//
	...
	// PrimitivesUtil.getBasePrimitiveType(type);
	...
	//
	// /*
	// * Sid ACE-7314 We don't have BOMs generated from XSD anymore so removed code thaty deals with them (besides,
	// * these have plugin dependencies that we can no longer include).
	// */
	//
	...
	// Class aClass = clazz;
	// String fragments[] = sortAttribute.getPath().split("\\."); //$NON-NLS-1$
	...
	// fragment));
	// }
	// else if (SuffixType.ALL.equals(st))
	// {
	// addError(String.format(Messages.SemanticSearchValidator_ALL_tag_no_longer_supported,
	// fragment));
	// }
