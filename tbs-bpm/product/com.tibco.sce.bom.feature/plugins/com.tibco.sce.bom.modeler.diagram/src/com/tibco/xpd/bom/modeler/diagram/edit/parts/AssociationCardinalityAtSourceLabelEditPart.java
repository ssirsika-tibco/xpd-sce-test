...
import com.tibco.xpd.bom.modeler.diagram.edit.policies.custom.CardinalityLabelDirectEditPolicy;
 ...
 * @generated
 */
public class AssociationCardinalityAtSourceLabelEditPart extends LabelEditPart
    ...
    static {
        registerSnapBackPosition(UMLVisualIDRegistry
                .getType(com.tibco.xpd.bom.modeler.diagram.edit.parts.AssociationCardinalityAtSourceLabelEditPart.VISUAL_ID),
                new Point(0, -15));
    }
     ...
     * @generated
     */
    public AssociationCardinalityAtSourceLabelEditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
                new CardinalityLabelDirectEditPolicy());
    }
    ...
    public EObject resolveSemanticElement() {
        EObject element = super.resolveSemanticElement();

        /*
         * This label edit part is editing the source association property
         */
        if (element instanceof Association) {
            EList<Property> ends = ((Association) element).getMemberEnds();
            if (ends.size() > 0) {
                element = ends.get(0);
            }
        }
    ...
    protected IFigure createFigurePrim() {
        return new CardinalityAtSourceLabelFigure();
    }

    /**
     * @generated
     */
    public class CardinalityAtSourceLabelFigure extends WrappingLabel {

        /**
         * @generated NOT
         */
        public CardinalityAtSourceLabelFigure() {
