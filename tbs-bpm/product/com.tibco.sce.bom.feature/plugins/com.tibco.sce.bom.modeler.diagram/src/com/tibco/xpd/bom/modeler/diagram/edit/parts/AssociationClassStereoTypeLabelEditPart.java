...
public class AssociationClassStereoTypeLabelEditPart extends
     ...
     * @generated
     */
    public AssociationClassStereoTypeLabelEditPart(View view) {
        super(view);
    }
    ...
    public void setLabel(WrappingLabel figure) {
        ...
        AssociationClass assocCl = (AssociationClass) resolveSemanticElement();
        if (!assocCl.getAppliedStereotypes().isEmpty()
                && !FirstClassProfileManager.getInstance()
                        .isFirstClassProfileApplied(assocCl.getModel())) {
            AssociationClassEditPart ep =
                    (AssociationClassEditPart) getParent();
            ep.getCustFigure().rebuildFigureWithStereo(true);
        }
        ...
        if (parser == null) {
            ...
            IAdaptable hintAdapter =
                    new UMLParserProvider.HintAdapter(
                            UMLElementTypes.AssociationClass_1005,
