 ...
 * @generated
 */
public class AssociationSourceLabelEditPart extends BOMStereoAwareLabelEditPart
        implements ITextAwareEditPart {

    private Association element = (Association) resolveSemanticElement();
    ...
    private LabelResourceListener labelNotif;

    /**
     * @generated
     */
    static {
        registerSnapBackPosition(UMLVisualIDRegistry.getType(com.tibco.xpd.bom.modeler.diagram.edit.parts.AssociationSourceLabelEditPart.VISUAL_ID),
                new Point(0, 15));
    }
     ...
     * @generated
     */
    public AssociationSourceLabelEditPart(View view) {
        super(view);
    }
    ...
    public void refresh() {
        ...
        // Check navigability since we may need to hide the label
        Property sourceEnd = null, targetEnd = null;
        List<Property> memberEnds = element.getMemberEnds();
        sourceEnd = memberEnds.get(0);
        targetEnd = memberEnds.get(1);

        // Is new owned end source or target?
        List<Property> lstOwnedEnds = element.getOwnedEnds();

        // Should only be one in the list
        if (lstOwnedEnds.size() > 0) {
            Property ownedEnd = lstOwnedEnds.get(0);
            if (ownedEnd == sourceEnd) {
    ...
    protected void handleNotificationEvent(Notification event) {
        ...
        // Check for a navigability change
        if (UMLPackage.Literals.PROPERTY__OWNING_ASSOCIATION.equals(feature)) {
    ...
    protected IFigure createFigurePrim() {
        return new AssociationSourceLabelFigure();
    }

    /**
     * @generated
     */
    public class AssociationSourceLabelFigure extends WrappingLabel {
        ...
        public AssociationSourceLabelFigure() {
            ...
            this.setLayoutManager(BOMCustomFigureUtils
    ...
    public void activate() {
        ...
        labelNotif = new LabelResourceListener();
        XpdResourcesPlugin.getDefault().getEditingDomain()
                .addResourceSetListener(labelNotif);
    }
    ...
    public void deactivate() {
        if (labelNotif != null) {
            XpdResourcesPlugin.getDefault().getEditingDomain()
                    .removeResourceSetListener(labelNotif);
            labelNotif = null;
        }
        super.deactivate();
    }
