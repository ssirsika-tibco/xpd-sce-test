...
public class ClassStereoTypeLabelEditPart extends
     ...
     * @generated NOT
     */
    public ClassStereoTypeLabelEditPart(View view) {
        super(view);
    ...
    public void setLabel(WrappingLabel figure) {
        ...
        Class cl = (Class) resolveSemanticElement();

        if (!cl.getAppliedStereotypes().isEmpty()
                && !FirstClassProfileManager.getInstance()
                        .isFirstClassProfileApplied(cl.getModel())) {

            if (BOMEditPartUtils.shouldRebuildFigureToShowStereotype(cl)) {
                ClassEditPart cep = (ClassEditPart) getParent();
                cep.getCustFigure().rebuildFigureWithStereo(true);
            }
