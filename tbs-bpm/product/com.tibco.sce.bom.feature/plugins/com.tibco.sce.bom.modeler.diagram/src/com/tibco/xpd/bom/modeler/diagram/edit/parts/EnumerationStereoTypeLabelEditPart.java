...
public class EnumerationStereoTypeLabelEditPart extends
     ...
     * @generated NOT
     */
    public EnumerationStereoTypeLabelEditPart(View view) {
        super(view);
        element = (Enumeration) resolveSemanticElement();
    }
    ...
    public void setLabel(WrappingLabel figure) {
        ...
        Enumeration en = (Enumeration) resolveSemanticElement();
        if (!en.getAppliedStereotypes().isEmpty()
                && !FirstClassProfileManager.getInstance()
                        .isFirstClassProfileApplied(en.getModel())) {

            if (BOMEditPartUtils.shouldRebuildFigureToShowStereotype(en)) {
