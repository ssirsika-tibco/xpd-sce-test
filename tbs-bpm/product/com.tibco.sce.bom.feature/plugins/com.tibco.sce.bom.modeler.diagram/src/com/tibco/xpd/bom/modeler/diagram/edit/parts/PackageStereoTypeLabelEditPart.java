...
public class PackageStereoTypeLabelEditPart extends
     ...
     * @generated
     */
    public PackageStereoTypeLabelEditPart(View view) {
        super(view);
    }
    ...
    public void setLabel(WrappingLabel figure) {
        ...
        Package pkg = (Package) resolveSemanticElement();
        if (!pkg.getAppliedStereotypes().isEmpty()
                && !FirstClassProfileManager.getInstance()
                        .isFirstClassProfileApplied(pkg.getModel())) {

            if (BOMEditPartUtils.shouldRebuildFigureToShowStereotype(pkg)) {
                PackageEditPart pep = (PackageEditPart) getParent();
        ...
        if (parser == null) {
            ...
            IAdaptable hintAdapter =
                    new UMLParserProvider.HintAdapter(
                            UMLElementTypes.Package_1001, getParserElement(),
                            parserHint);
