...
public class EnumerationCustomFigure extends NodeFigure implements
        IGradientFigure {
    /**
     * 
     */
    private WrappingLabel classNameLabel;
     ...
     * 
     */
    public EnumerationCustomFigure() {
    ...
    private void createContents() {
        ...
        // layoutPrimitiveTypeContentFigure0.marginWidth = 2;
        ...
        // Name label
        classNameLabel = new WrappingLabel();
        classNameLabel.setLayoutManager(BOMCustomFigureUtils
                .createBOMWrapLabelLayout());
        classNameLabel.setText("Enumeration");
        ...
        gradFigure.add(classNameLabel, gDataClassNameLabel);
     ...
     * 
     */
    public WrappingLabel getClassNameLabel() {
