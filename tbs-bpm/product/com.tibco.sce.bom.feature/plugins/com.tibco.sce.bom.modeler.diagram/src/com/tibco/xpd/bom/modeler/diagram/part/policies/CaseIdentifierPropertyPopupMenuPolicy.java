 ...
 * Case Identifier entry
 * 
 */
public class CaseIdentifierPropertyPopupMenuPolicy implements
        ...
        if (selection instanceof StructuredSelection) {
            ...
            for (Object object : elements.toList()) {
                if ((object != null) && (object instanceof PropertyEditPart)) {
                    ...
                    // Case Identifiers are only supported on Case Classes
                    Class clazz = toMutateProperty.getClass_();
                    if (clazz != null) {
                    ...
                    // Check to see if this property is a case state, if it is
                    // then we do not want to show the option to change it to a
                    // case identifier
                    if (GlobalDataProfileManager.getInstance()
                    ...
                    // Check to see if this property is a case identifier, if it
                    // is then we do not want to show the option to change it to
                    // a case identifier
                    if (GlobalDataProfileManager.getInstance()
