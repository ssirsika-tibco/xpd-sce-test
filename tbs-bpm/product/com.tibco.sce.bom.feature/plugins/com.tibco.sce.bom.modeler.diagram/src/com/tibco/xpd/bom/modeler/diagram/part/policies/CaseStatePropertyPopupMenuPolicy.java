 ...
 * 
 */
public class CaseStatePropertyPopupMenuPolicy implements
        ...
        if (selection instanceof StructuredSelection) {
            ...
            for (Object object : elements.toList()) {
                if ((object != null) && (object instanceof PropertyEditPart)) {
                    ...
                    // Case States are only supported on Case Classes
                    ...
                    // At the moment we do not support changing from case
                    // identifier
                    if (GlobalDataProfileManager.getInstance()
                    ...
                    // then we do not want to show the option to change it to
                    // case state
                    if (GlobalDataProfileManager.getInstance()
