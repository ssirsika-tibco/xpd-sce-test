 ...
 * @generated
 */
public class AssociationEndViewFactory extends ConnectionViewFactory {
    ...
    protected void decorateView(View containerView, View view,
        ...
        if (semanticHint == null) {
            semanticHint = UMLVisualIDRegistry
                    .getType(AssociationEndEditPart.VISUAL_ID);
        ...
        getViewService()
                .createNode(
                        ...
                        view,
                        UMLVisualIDRegistry
                                .getType(AssociationEndTargetNameLabelEditPart.VISUAL_ID),
        ...
        getViewService()
                .createNode(
                        ...
                        view,
                        UMLVisualIDRegistry
                                .getType(AssociationEndTargetMultiplicityLabelEditPart.VISUAL_ID),
                        ViewUtil.APPEND, true, getPreferencesHint());
    }
}
