...
public class DiagramBackgroundSection extends AbstractAppearanceSection {
    ...
    protected void initializeControls(Composite parent) {
        ...
        bgColorButton
                .setToolTipText(Messages.DiagramBackgroundSection_bgColor_action_tooltip);
        bgColorButton.setImage(BOMDiagramUIPropertiesImages
        ...
        bgColorButton.getAccessible()
                .addAccessibleListener(new AccessibleAdapter() {
                    public void getName(AccessibleEvent e) {
                        e.result =
                                Messages.DiagramBackgroundSection_bgColor_accessible_label;
                    }
                });
