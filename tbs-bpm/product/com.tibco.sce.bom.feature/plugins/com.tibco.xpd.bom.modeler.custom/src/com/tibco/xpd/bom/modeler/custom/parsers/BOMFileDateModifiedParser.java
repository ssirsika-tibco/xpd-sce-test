...
public class BOMFileDateModifiedParser implements ISemanticParser {
    ...
    public String getPrintString(IAdaptable element, int flags) {
        String text = Messages.BOMFileDateModifiedParser_UnknownDate_label;
        EObject obj = getElement(element);
        ...
        if (file != null) {
            ...
            /*
             * This may be a file that has been opened from a revision history
             * so check if the resource URI has a time stamp.
             */
