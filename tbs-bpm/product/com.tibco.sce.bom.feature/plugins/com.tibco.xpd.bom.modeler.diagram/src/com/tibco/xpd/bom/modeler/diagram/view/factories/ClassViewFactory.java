...
public class ClassViewFactory extends AbstractShapeViewFactory {
    ...
    protected void decorateView(View containerView, View view,
        ...
        getViewService().createNode(eObjectAdapter,
                view,
                UMLVisualIDRegistry
                        .getType(SuperClassNameLabelEditPart.VISUAL_ID),
                ViewUtil.APPEND,
                true,
                getPreferencesHint());
        getViewService().createNode(eObjectAdapter,
                view,
                UMLVisualIDRegistry
                        .getType(ClassStereoTypeLabelEditPart.VISUAL_ID),
                ViewUtil.APPEND,
                true,
                getPreferencesHint());
        getViewService()
     ...
     * #initializeFromPreferences(org.eclipse.gmf.runtime.notation.View)
     */
    @Override
