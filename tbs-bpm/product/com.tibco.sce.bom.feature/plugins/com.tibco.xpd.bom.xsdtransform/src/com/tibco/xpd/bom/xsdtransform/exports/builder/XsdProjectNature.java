...
/**
 * XSD project nature. This nature manages builders for creating modules for
 * XSD.
 * <p>
 ...
 * 
 */
public class XsdProjectNature implements IProjectNature {

    /** Id of this nature. */
    public static final String NATURE_ID = Activator.PLUGIN_ID + ".xsdNature"; //$NON-NLS-1$
    ...
    public void configure() throws CoreException {
        ProjectUtil.addBuilderToProject(project, Bom2XsdBuilder.BUILDER_ID);
    }
    ...
    public void deconfigure() throws CoreException {
        ProjectUtil
                .removeBuilderFromProject(project, Bom2XsdBuilder.BUILDER_ID);
    }
