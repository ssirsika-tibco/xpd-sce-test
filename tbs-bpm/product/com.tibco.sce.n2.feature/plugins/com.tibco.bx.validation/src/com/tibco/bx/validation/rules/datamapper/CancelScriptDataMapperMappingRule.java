 ...
 * @since 21 Apr 2015
 */
public class CancelScriptDataMapperMappingRule
    ...
    protected IScriptDataMapperProvider getScriptDataMapperProvider() {
        return new AuditEventScriptDataMapperProvider(
                AuditEventType.CANCELLED_LITERAL, getDataMapperContext());
    }
    ...
    protected String getMappingTypeDescription(EObject objectToValidate) {
        return Messages.CancelScriptDataMapperMappingRule_ScriptDescription;
    }
}
