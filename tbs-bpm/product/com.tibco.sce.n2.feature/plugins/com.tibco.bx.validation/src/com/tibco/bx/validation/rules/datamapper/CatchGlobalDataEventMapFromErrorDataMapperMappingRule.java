...
import com.tibco.xpd.globaldataservice.datamapper.GlobalDataErrorDataMapperMapFromErrorSectionFilter;
...
/**
 * Rules for Catch Global Data Error Event in case of 'Map from error' section.
 * 
 * @author ssirsika
 * @since 07-Mar-2016
 */
public class CatchGlobalDataEventMapFromErrorDataMapperMappingRule extends
    ...
    protected boolean objectIsApplicable(EObject eo) {
        ...
        if (eo instanceof Activity) {
            if (eo instanceof Activity) {
                ...
                GlobalDataErrorDataMapperMapFromErrorSectionFilter filter =
                        new GlobalDataErrorDataMapperMapFromErrorSectionFilter();
