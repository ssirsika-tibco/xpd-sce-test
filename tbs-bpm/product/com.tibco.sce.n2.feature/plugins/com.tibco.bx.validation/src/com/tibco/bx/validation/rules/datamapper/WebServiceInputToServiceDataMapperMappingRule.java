...
import com.tibco.xpd.webservice.datamapper.section.filter.WebServiceDataMapperInputToServiceSectionFilter;
import com.tibco.xpd.xpdl2.Activity;

/**
 * DataMapper validation rule for WebService InputToService
 * 
 * @author ssirsika
 * @since 01-Feb-2016
 */
public class WebServiceInputToServiceDataMapperMappingRule extends
    ...
    protected boolean objectIsApplicable(EObject eo) {
        ...
        if (eo instanceof Activity) {
            ...
            WebServiceDataMapperInputToServiceSectionFilter filter =
                    new WebServiceDataMapperInputToServiceSectionFilter();
    ...
    protected String getMappingTypeDescription(EObject objectToValidate) {
        return Messages.WebServiceInputToServiceDataMapperMappingRule_MappingTypeDescription;
    }
