...
import com.tibco.xpd.webservice.datamapper.section.filter.WebServiceDataMapperOutputFromProcessSectionFilter;
import com.tibco.xpd.xpdl2.Activity;

/**
 * DataMapper validation rule for WebService OutputFromProcess
 * 
 * @author ssirsika
 * @since 01-Feb-2016
 */
public class WebServiceOutputFromProcessDataMapperMappingRule extends
    ...
    protected boolean objectIsApplicable(EObject eo) {
        ...
        if (eo instanceof Activity) {
            ...
            WebServiceDataMapperOutputFromProcessSectionFilter filter =
                    new WebServiceDataMapperOutputFromProcessSectionFilter();
    ...
    protected String getMappingTypeDescription(EObject objectToValidate) {
        return Messages.WebServiceOutputFromProcessDataMapperMappingRule_MappingTypeDescription;
    }
