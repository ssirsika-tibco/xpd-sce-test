...
/**
 * SetSharedResourceTypeDatabaseResolution
 * 
 * 
 * @author bharge
 * @since 3.3 (28 Jan 2010)
 */
public class SetSharedResourceTypeDatabaseResolution extends
        ...
        if (target instanceof Participant) {
            ...
            return new RecordingCommand(
                ...
                protected void doExecute() {
                    ...
                    if (sharedResource != null) {
                        final JdbcResource jr =
                                XpdExtensionFactory.eINSTANCE
                                        .createJdbcResource();

                        jr.setInstanceName(""); //$NON-NLS-1$
                        sharedResource.setSharedResource(jr);
                    }
                }
            };
