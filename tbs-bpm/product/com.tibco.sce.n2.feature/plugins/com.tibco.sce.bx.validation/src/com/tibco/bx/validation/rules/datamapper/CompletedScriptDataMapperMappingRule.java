 ...
 * @since 21 Apr 2015
 */
public class CompletedScriptDataMapperMappingRule
    ...
    protected IScriptDataMapperProvider getScriptDataMapperProvider() {
        return new AuditEventScriptDataMapperProvider(
                AuditEventType.COMPLETED_LITERAL, getDataMapperContext());
    }
    ...
    protected String getMappingTypeDescription(EObject objectToValidate) {
        return Messages.CompletedScriptDataMapperMappingRule_ScriptDescription;
    }
}
