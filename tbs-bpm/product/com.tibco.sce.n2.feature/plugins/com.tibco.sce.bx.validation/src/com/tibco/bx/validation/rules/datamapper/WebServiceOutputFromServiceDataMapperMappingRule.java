...
import com.tibco.xpd.webservice.datamapper.section.filter.WebServiceDataMapperOutputFromServiceSectionFilter;
import com.tibco.xpd.xpdl2.Activity;

/**
 * DataMapper validation rule for WebService OutputFromService
 * 
 * @author ssirsika
 * @since 01-Feb-2016
 */
public class WebServiceOutputFromServiceDataMapperMappingRule extends
    ...
    protected boolean objectIsApplicable(EObject eo) {
        ...
        if (eo instanceof Activity) {
            ...
            WebServiceDataMapperOutputFromServiceSectionFilter filter =
                    new WebServiceDataMapperOutputFromServiceSectionFilter();
    ...
    protected String getMappingTypeDescription(EObject objectToValidate) {
        return Messages.WebServiceOutputFromServiceDataMapperMappingRule_MappingTypeDescription;
    }
    ...
    protected boolean isPartialMappingCompletionSupported(
        ...
        // partial mapping is allowed because process instance might be already
        // present
        return true;
    }
