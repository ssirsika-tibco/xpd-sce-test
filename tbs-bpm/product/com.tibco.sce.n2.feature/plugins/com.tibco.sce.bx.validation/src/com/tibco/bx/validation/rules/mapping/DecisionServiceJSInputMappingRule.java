 ...
 * @since 1 Aug 2011
 */
public class DecisionServiceJSInputMappingRule extends
    ...
    /**
     * @see com.tibco.xpd.validation.bpmn.rules.baserules.AbstractProcess2ProcessJSInputMappingRule#doCreateMappingTargetItemProvider()
     * 
     * @return
     */
    @Override
    ...
    protected String getMappingTypeDescription(EObject objectToValidate) {
        return Messages.DecisionServiceJSInputMappingRule_DecisionServiceMapping_label;
    }
