 ...
 *
 */
public class ActivityCancelledScriptBOMReferenceChange extends ScriptBOMReferenceChange {

    private Activity activity = null;
    
    public ActivityCancelledScriptBOMReferenceChange(String oldScript, RenameArguments args,
     ...
     */
    public ActivityCancelledScriptBOMReferenceChange(String oldScript,
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetCancelledScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptName() {
        return Messages.ActivityCancelledScriptBOMReferenceChange_Cancelled;
    }    
