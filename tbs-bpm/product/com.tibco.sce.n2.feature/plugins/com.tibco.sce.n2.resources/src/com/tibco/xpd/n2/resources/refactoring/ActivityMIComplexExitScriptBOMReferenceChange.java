 ...
 *
 */
public class ActivityMIComplexExitScriptBOMReferenceChange extends ScriptBOMReferenceChange {

    private Activity activity = null;
    
    public ActivityMIComplexExitScriptBOMReferenceChange(String oldScript, RenameArguments args,
     ...
     */
    public ActivityMIComplexExitScriptBOMReferenceChange(String oldScript,
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetMIComplexExitExprScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptName() {
        return Messages.ActivityMIComplexExitScriptBOMReferenceChange_MIComplecExit;
    } 
