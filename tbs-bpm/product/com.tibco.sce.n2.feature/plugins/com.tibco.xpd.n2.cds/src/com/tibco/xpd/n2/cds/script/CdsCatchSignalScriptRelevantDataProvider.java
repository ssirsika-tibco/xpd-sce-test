...
/**
 * BDS Class factory aware version of the script relevant data provider for
 * catch signal event mappings
 * 
 * @author aallway
 * @since 3 May 2012
 */
public class CdsCatchSignalScriptRelevantDataProvider extends
        CatchSignalScriptRelevantDataProvider {
