...
/**
 * Opens openspace in a browser.
 * 
 * @author Jan Arciuchiewicz
 */
public class OpenOpenspaceInBrowserHandler extends OpenInBrowserHandler {
    ...
    private static final int OPENSPACE_PORT = 8080;
    ...
    protected URL getURL(Object element) {
        if (element instanceof Server
            ...
            try {
                ...
                int port = OPENSPACE_PORT;
                if ("localDevServer".equals(server.getId())) { //$NON-NLS-1$
                    port = OPENSPACE_LOCAL_PORT;
                }
                return new URL(protocol, host, port, OPENSPACE_WEB_PATH);
