...
/**
 * Copy the resources, ie. stylesheet and images, for the exported GSD
 * documentation
 * 
 * 
...
public class ResourceCopier implements ExportSubTask {
    ...
    public static final String GLOBAL_SIGNAL_ICON = "GlobalSignalFileIcon.gif"; //$NON-NLS-1$
    ...
    private static class ResourceCopyFile {
                ...
                if (!folder.exists()) {
                    ...
                    if (!folder.mkdirs()) {
                        throw generateCoreException(String
                                .format(Messages.ResourceCopier_FolderCreationFailed_msg,
                                        folder.toString()));
                    }
                    ...
                    // exception
                    throw generateCoreException(String
                            .format(Messages.ResourceCopier_UnableToCreateFolder_msg,
                                    folder.toString()));
                }
            }
        ...
        private CoreException generateCoreException(Throwable throwable) {
            return new CoreException(new Status(IStatus.ERROR,
                    GsdResourcePlugin.PLUGIN_ID, IStatus.OK,
        ...
        private CoreException generateCoreException(String errMsg) {
            return new CoreException(new Status(IStatus.ERROR,
                    GsdResourcePlugin.PLUGIN_ID, IStatus.OK, errMsg, null));
        }
    ...
    private static final ResourceCopyFile copyFiles[] =
            {
                    new ResourceCopyFile(
                            "/style/gsddoc.css", "style/gsddoc.css", false), //$NON-NLS-1$ //$NON-NLS-2$
                    new ResourceCopyFile(
                            "/style/printgsddoc.css", "style/printgsddoc.css", false), //$NON-NLS-1$ //$NON-NLS-2$
                    new ResourceCopyFile(
                            "/icons/tick.gif", IMAGES_FOLDER + "/tick.gif", true), //$NON-NLS-1$ //$NON-NLS-2$
                    new ResourceCopyFile(
                            "/icons/" + GLOBAL_SIGNAL_ICON, IMAGES_FOLDER + "/" + GLOBAL_SIGNAL_ICON, true), //$NON-NLS-1$ //$NON-NLS-2$
            };
        ...
        if (outputFile != null) {
            ...
            if (monitor != null) {
                ...
                monitor.subTask(inputFile.getName() + ": " //$NON-NLS-1$
                        + Messages.ResourceCopier_CreatingStylesheet_msg);
            }
