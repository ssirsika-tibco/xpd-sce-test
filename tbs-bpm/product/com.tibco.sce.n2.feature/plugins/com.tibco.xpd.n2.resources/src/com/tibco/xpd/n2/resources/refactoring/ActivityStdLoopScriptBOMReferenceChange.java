 ...
 *
 */
public class ActivityStdLoopScriptBOMReferenceChange extends ScriptBOMReferenceChange {

    private Activity activity = null;
    
    public ActivityStdLoopScriptBOMReferenceChange(String oldScript, RenameArguments args,
     ...
     */
    public ActivityStdLoopScriptBOMReferenceChange(String oldScript,
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetStdLoopExpressionScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptName() {
        return Messages.ActivityStdLoopScriptBOMReferenceChange_StdLoop;
    } 
}
