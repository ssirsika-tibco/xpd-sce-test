...
/**
 * BOM content refactor handler for timer event reschedule scripts.
 * 
 * @author aallway
 * @since 18 Mar 2013
 */
public class RescheduleTimerEventScriptBOMReferenceChange extends
        ScriptBOMReferenceChange {

    private Activity activity = null;

    public RescheduleTimerEventScriptBOMReferenceChange(String oldScript,
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetRescheduleTimerEventScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptName() {
        return Messages.RescheduleTimerEventScriptBOMReferenceChange_RescheduleTimerEvent_label;
    }
}
