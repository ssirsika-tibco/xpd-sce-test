 ...
 * 
 */
public class TimerEventScriptBOMReferenceChange extends
        ScriptBOMReferenceChange {

    private Activity activity = null;

    public TimerEventScriptBOMReferenceChange(String oldScript,
            RenameArguments args, EObject element,
            Activity activity, EditingDomain editingDomain) {
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetTimerEventScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptName() {
        return Messages.TimerEventScriptBOMReferenceChange_TimerEvent;
    }
}
