 ...
 *
 */
public class UserTaskOpenScriptBOMReferenceChange extends ScriptBOMReferenceChange {

    private Activity activity = null;
    
    public UserTaskOpenScriptBOMReferenceChange(String oldScript, RenameArguments args,
     ...
     */
    public UserTaskOpenScriptBOMReferenceChange(String oldScript,
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetUserTaskOpenScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptName() {
        return Messages.UserTaskOpenScriptBOMReferenceChange_OpenScript;
    }
}
