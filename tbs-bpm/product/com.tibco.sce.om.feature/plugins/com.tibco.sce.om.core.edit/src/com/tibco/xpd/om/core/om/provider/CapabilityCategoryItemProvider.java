 ...
 * {@link com.tibco.xpd.om.core.om.CapabilityCategory} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class CapabilityCategoryItemProvider extends NamedElementItemProvider
    ...
    public Collection<?> getChildren(Object object) {
        CapabilityCategory category = (CapabilityCategory) object;
    ...
    public boolean hasChildren(Object object) {
        return super.hasChildren(object)
                || !((CapabilityCategory) object).getMembers().isEmpty();
    }
    ...
    protected void addMembersPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                        ...
                        getResourceLocator(),
                        getString("_UI_CapabilityCategory_members_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_CapabilityCategory_members_feature", "_UI_CapabilityCategory_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        OMPackage.Literals.CAPABILITY_CATEGORY__MEMBERS,
                        true,
                        false,
                        true,
                        null,
        ...
        itemPropertyDescriptors
                .add(new ItemPropertyDescriptor(
                        ((ComposeableAdapterFactory) adapterFactory)
                                .getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_CapabilityCategory_capabilities_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_CapabilityCategory_members_feature", "_UI_CapabilityCategory_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        OMPackage.Literals.CAPABILITY_CATEGORY__MEMBERS, true,
                    ...
                    public Collection<?> getChoiceOfValues(Object object) {
                        ...
                        EObject container =
                                getEParent(((CapabilityCategory) object),
                                        OrgModel.class);
                        for (TreeIterator<Object> allContents =
                            ...
                            (new OMSwitch<Object>() {
                                 ...
                                 * caseCapability
                                 * (com.tibco.xpd.om.core.om.Capability)
                                 */
                                @Override
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures
                    .add(OMPackage.Literals.CAPABILITY_CATEGORY__SUB_CATEGORIES);
        }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator()
                .getImage("full/obj16/CapabilityCategory")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_CapabilityCategory_type") : //$NON-NLS-1$
                label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(CapabilityCategory.class)) {
                ...
                .setDisplayName(OMUtil
                        .getDefaultName(getString("_UI_DefaultName_CapabilityCategory_label"), //$NON-NLS-1$
                                getDisplayNamesArray(model != null ? getAllCategories(model)
                                        : getChildren(object))));
        newChildDescriptors
                .add(createChildParameter(OMPackage.Literals.CAPABILITY_CATEGORY__SUB_CATEGORIES,
                        capabilityCategory));
        ...
        capability
                .setDisplayName(OMUtil
                        .getDefaultName(getString("_UI_DefaultName_Capability_label"), //$NON-NLS-1$
                                getDisplayNamesArray(model != null ? getAllCapabilities(model)
                                        : getChildren(object))));
        newChildDescriptors
    ...
    protected Command createCreateChildCommand(EditingDomain domain,
        ...
        if (feature == OMPackage.Literals.ORG_MODEL__CAPABILITIES) {
            ...
            Command setParentCommand =
                    new SetCommand(domain, (EObject) value,
                            OMPackage.Literals.CAPABILITY__CATEGORY, owner) {
                        /*
                         * This command will assume that it will always be possible to
                         * add capability to (non-Javadoc)
                         * 
            ...
            cmd.setLabel(getString("_UI_Capability_type")); //$NON-NLS-1$
        ...
        for (Object object : collection) {
            if (object instanceof Capability) {
                ...
                ECrossReferenceAdapter crossReferenceAdapter =
                        ECrossReferenceAdapter.getCrossReferenceAdapter(c);
                Collection<Setting> inverseReferences =
                        crossReferenceAdapter.getInverseReferences(c, true);
                for (Setting ref : inverseReferences) {
                    if (ref.getEObject() instanceof CapabilityAssociation
                        ...
                        CapabilityAssociation capAssoc =
                                ((CapabilityAssociation) ref.getEObject());
     ...
     * @return
     */
    private Collection<Capability> getAllCapabilities(OrgModel model) {
        if (model != null) {
     ...
     * @return
     */
    private Collection<CapabilityCategory> getAllCategories(EObject obj) {
        List<CapabilityCategory> categories =
                new BasicEList<CapabilityCategory>();
