 ...
 * {@link com.tibco.xpd.om.core.om.OrgUnitRelationship} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class OrgUnitRelationshipItemProvider extends NamedElementItemProvider
     ...
     * @generated
     */
    public OrgUnitRelationshipItemProvider(AdapterFactory adapterFactory) {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            // addIsHierarchicalPropertyDescriptor(object);
        }
    ...
    protected void addFromPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_OrgUnitRelationship_from_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_OrgUnitRelationship_from_feature", "_UI_OrgUnitRelationship_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        OMPackage.Literals.ORG_UNIT_RELATIONSHIP__FROM,
                        false,
                        false,
                        true,
                        null,
                        getString("_UI_PropertyDescriptor_EndsPropertyCategory"), //$NON-NLS-1$
                        null));
    }
    ...
    protected void addToPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_OrgUnitRelationship_to_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_OrgUnitRelationship_to_feature", "_UI_OrgUnitRelationship_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addRelationshipTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_OrgUnitRelationship_relationshipType_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_OrgUnitRelationship_relationshipType_feature", "_UI_OrgUnitRelationship_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        OMPackage.Literals.ORG_UNIT_RELATIONSHIP__RELATIONSHIP_TYPE,
                        true,
                        false,
                        true,
                        null,
    ...
    /**
     * This adds a property descriptor for the Is Hierarchical feature. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    protected void addIsHierarchicalPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_OrgUnitRelationship_isHierarchical_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_OrgUnitRelationship_isHierarchical_feature", "_UI_OrgUnitRelationship_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        OMPackage.Literals.ORG_UNIT_RELATIONSHIP__IS_HIERARCHICAL,
                        true,
                        false,
                        false,
    ...
    /**
     * This returns OrgUnitRelationship.gif.
     * <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator()
                .getImage("full/obj16/OrgUnitRelationship")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_OrgUnitRelationship_type") : //$NON-NLS-1$
                label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(OrgUnitRelationship.class)) {
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors
                .add(createChildParameter(OMPackage.Literals.ORG_TYPED_ELEMENT__ATTRIBUTE_VALUES,
