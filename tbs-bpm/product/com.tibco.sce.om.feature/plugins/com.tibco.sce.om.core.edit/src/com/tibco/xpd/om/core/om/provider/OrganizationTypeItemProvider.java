...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.om.core.om.OrganizationType} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class OrganizationTypeItemProvider extends OrgElementTypeItemProvider
        ...
        if (parent instanceof OrgMetaModel) {
            ...
            return patentItemProvider != null ? patentItemProvider
                    .getTransientParent(parent,
                            OMPackage.Literals.ORG_META_MODEL__ORGANIZATION_TYPES)
                    : null;
        }
        return parent;
    }
     ...
     * @generated
     */
    public OrganizationTypeItemProvider(AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures
                    .add(OMPackage.Literals.ORGANIZATION_TYPE__ORG_UNIT_FEATURES);
        }
    ...
    /**
     * This returns OrganizationType.gif.
     * <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator()
                .getImage("full/obj16/OrganizationType")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_OrganisationType_type") : //$NON-NLS-1$
                label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(OrganizationType.class)) {
    ...
    protected void collectNewChildDescriptors(
        ...
        OrgUnitFeature feature = OMFactory.eINSTANCE.createOrgUnitFeature();
        feature
        ...
        newChildDescriptors
                .add(createChildParameter(OMPackage.Literals.ORGANIZATION_TYPE__ORG_UNIT_FEATURES,
                        feature));
    }
