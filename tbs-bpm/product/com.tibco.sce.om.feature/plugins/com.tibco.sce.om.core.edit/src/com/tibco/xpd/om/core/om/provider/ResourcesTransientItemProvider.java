...
/**
 * Transient group object grouping OM's resource elements.
 * 
 * <p>
 ...
 */
public class ResourcesTransientItemProvider extends TransientItemProvider {
     ...
     */
    public ResourcesTransientItemProvider(AdapterFactory adapterFactory,
            EObject object) {
    ...
    protected Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(OMPackage.Literals.ORG_MODEL__RESOURCES);
        }
    ...
    public String getText(Object object) {
        return getString("_UI_ResourcesGroup_type"); //$NON-NLS-1$
    }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator()
                .getImage("full/obj16/ResourcesGroup")); //$NON-NLS-1$ 
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        if (target instanceof OrgModel) {
            ...
            EList<ResourceType> resourceTypes =
                    orgModel.getEmbeddedMetamodel().getResourceTypes();
            for (ResourceType resourceType : resourceTypes) {
                Resource res = OMFactory.eINSTANCE.createResource();
                res
                        .setDisplayName(OMUtil
                                .getDefaultName(getString("_UI_DefaultName_Resource_label"), //$NON-NLS-1$
                                        getDisplayNamesArray(getChildren(object))));
                res.setType(resourceType);
                newChildDescriptors
                        .add(createChildParameter(OMPackage.Literals.ORG_MODEL__RESOURCES,
                                res));
            }
