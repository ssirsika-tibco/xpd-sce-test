 ...
 * @generated
 */
public class OrgUnitDisplayNameEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public OrgUnitDisplayNameEditPart(View view) {
        super(view);
    }
    ...
    public void setLabel(WrappingLabel figure) {
        ...
        if (eo instanceof OrgUnit) {
            ...
            if (element.getFeature() != null) {
                parentEP.getPrimaryShape().rebuildFigureWithFeatureLabel(true);

            } else {
                parentEP.getPrimaryShape().rebuildFigureWithFeatureLabel(false);
            }
