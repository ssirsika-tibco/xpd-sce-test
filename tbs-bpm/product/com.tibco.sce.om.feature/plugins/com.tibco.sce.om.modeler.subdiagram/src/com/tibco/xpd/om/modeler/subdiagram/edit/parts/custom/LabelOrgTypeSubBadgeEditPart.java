 ...
 * @generated
 */
public class LabelOrgTypeSubBadgeEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {

    public static final String VISUAL_ID = "LabelOrgTypeSubBadge"; //$NON-NLS-1$
     ...
     * @generated
     */
    public LabelOrgTypeSubBadgeEditPart(View view) {
        super(view);
    }
