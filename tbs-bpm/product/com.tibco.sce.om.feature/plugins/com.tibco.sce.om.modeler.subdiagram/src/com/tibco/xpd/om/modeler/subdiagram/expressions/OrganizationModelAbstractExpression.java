 ...
 * @generated
 */
public abstract class OrganizationModelAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = OrganizationModelSubDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected OrganizationModelAbstractExpression(String body,
			EClassifier context) {
		myBody = body;
		myContext = context;
	}
