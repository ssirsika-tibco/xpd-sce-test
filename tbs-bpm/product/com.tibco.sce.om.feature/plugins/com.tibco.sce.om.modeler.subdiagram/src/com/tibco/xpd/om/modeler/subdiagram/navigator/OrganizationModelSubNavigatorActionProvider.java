 ...
 * @generated
 */
public class OrganizationModelSubNavigatorActionProvider extends
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof OrganizationModelSubNavigatorItem) {
					selectedElement = ((OrganizationModelSubNavigatorItem) selectedElement)
							.getView();
