 ...
 * @generated
 */
public class OrgUnitSubViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = OrganizationModelVisualIDRegistry
					.getType(OrgUnitSubEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				view,
				OrganizationModelVisualIDRegistry
						.getType(OrgUnitSubFeatureNameEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService()
				.createNode(
						eObjectAdapter,
