...
/**
 * Transient group object grouping OM's org. unit relationship types elements.
 * 
 * <p>
 ...
 */
public class OrgUnitRelationshipTypesTransientItemProvider extends
     ...
     */
    public OrgUnitRelationshipTypesTransientItemProvider(
            AdapterFactory adapterFactory, EObject object) {
    ...
    protected Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures
                    .add(OMPackage.Literals.ORG_META_MODEL__ORG_UNIT_RELATIONSHIP_TYPES);
        }
    ...
    public String getText(Object object) {
        return getString("_UI_OrgUnitRelationshipTypesGroup_type"); //$NON-NLS-1$
    }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage(
                "full/obj16/OrgUnitRelationshipTypesGroup")); //$NON-NLS-1$ 
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        OrgUnitRelationshipType orgUnitRelType = OMFactory.eINSTANCE
                .createOrgUnitRelationshipType();
        orgUnitRelType.setDisplayName(OMUtil.getDefaultName(
                getString("_UI_DefaultName_OrgUnitRelationshipType_label"), //$NON-NLS-1$
                getDisplayNamesArray(getChildren(object))));
        newChildDescriptors.add(createChildParameter(
                OMPackage.Literals.ORG_META_MODEL__ORG_UNIT_RELATIONSHIP_TYPES,
                orgUnitRelType));
    }
