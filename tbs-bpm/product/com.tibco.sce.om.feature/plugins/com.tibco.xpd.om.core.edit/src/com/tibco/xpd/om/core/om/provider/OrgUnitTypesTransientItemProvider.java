...
/**
 * Transient group object grouping OM's organization unit types elements.
 * 
 * <p>
 ...
 */
public class OrgUnitTypesTransientItemProvider extends TransientItemProvider {
     ...
     */
    public OrgUnitTypesTransientItemProvider(AdapterFactory adapterFactory,
            EObject object) {
    ...
    protected Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures
                    .add(OMPackage.Literals.ORG_META_MODEL__ORG_UNIT_TYPES);
        }
    ...
    public String getText(Object object) {
        return getString("_UI_OrgUnitTypesGroup_type"); //$NON-NLS-1$
    }
    ...
    public Object getImage(Object object) {
        ...
        return overlayImage(object, getResourceLocator().getImage(
                "full/obj16/OrgUnitTypesGroup")); //$NON-NLS-1$ 
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        orgUnitType.setDisplayName(OMUtil.getDefaultName(
                getString("_UI_DefaultName_OrgUnitType_label"), //$NON-NLS-1$
