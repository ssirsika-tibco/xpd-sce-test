...
/**
 * Transient group object grouping OM's organization types elements.
 * 
 * <p>
 ...
 */
public class OrganizationTypesTransientItemProvider extends
     ...
     */
    public OrganizationTypesTransientItemProvider(
    ...
    public String getText(Object object) {
        return getString("_UI_OrganizationTypesGroup_type"); //$NON-NLS-1$
    }
    ...
    public Object getImage(Object object) {
        ...
        return overlayImage(object, getResourceLocator().getImage(
                "full/obj16/OrganizationTypesGroup")); //$NON-NLS-1$ 
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        OrganizationType organisationType = OMFactory.eINSTANCE
                .createOrganizationType();
        organisationType.setDisplayName(OMUtil.getDefaultName(
                getString("_UI_DefaultName_OrganisationType_label"), //$NON-NLS-1$
