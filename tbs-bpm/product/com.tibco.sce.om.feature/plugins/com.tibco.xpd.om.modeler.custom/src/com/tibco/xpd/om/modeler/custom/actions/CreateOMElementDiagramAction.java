...
public class CreateOMElementDiagramAction extends DiagramAction {
    ...
    public CreateOMElementDiagramAction(IWorkbenchPage workbenchPage,
        ...
        if (actionId.equals(OMActionIds.ACTION_ADD_ORGUNIT)) {
            ...
            setText(Messages.CreateOMElementDiagramAction_AddOrganizationLabel);
        }
    ...
    public CreateOMElementDiagramAction(IWorkbenchPage workbenchPage,
        ...
        setToolTipText("Add " + getText()); //$NON-NLS-1$
        setOrgType(orgType);
    }
    ...
    protected Command getCommand(Request request) {
        if (request instanceof CreateViewAndElementRequest) {
            ...
            // (Organization).
            if (request.getExtendedData().containsKey(
                    IOrganizationModelDiagramConstants.OMCreationToolIsSubUnit)) {

                Object object = request
                        .getExtendedData()
                        .get(
                                IOrganizationModelDiagramConstants.OMCreationToolParentOrgUnit);
                ...
                if (object instanceof OrgUnit) {
                    ...
                    if (diagramEditPart != null) {
                        Command curCommand = diagramEditPart
                                .getCommand(request);
    ...
    protected Request createTargetRequest() {
        ...
        if (getId() == OMActionIds.ACTION_ADD_ORGUNIT) {
            desc = new ViewAndElementDescriptor(
    ...
    protected void updateTargetRequest() {
        ...
        if (req.getExtendedData().containsKey(
                IOrganizationModelDiagramConstants.OMCreationToolParentOrgUnit)) {
