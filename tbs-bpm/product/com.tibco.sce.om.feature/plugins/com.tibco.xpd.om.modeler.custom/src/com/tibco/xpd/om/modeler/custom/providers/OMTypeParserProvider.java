...
public class OMTypeParserProvider extends AbstractProvider implements
        IParserProvider {

    private IParser typeParser;
    ...
    private IParser createTypeParser() {
    ...
    private IParser getParser(int visualID) {
        if (visualID == OrganizationTypeNameEditPart.VISUAL_ID) {
