 ...
 * @generated
 */
public class OrgModelDateCreatedBadgeEditPart extends CompartmentEditPart
        implements ITextAwareEditPart {

    public static final String VISUAL_ID = "OrgModelDateCreatedBadgeEditPart"; //$NON-NLS-1$
     ...
     * @generated
     */
    public OrgModelDateCreatedBadgeEditPart(View view) {
        super(view);
    }
        ...
        public void resourceSetChanged(ResourceSetChangeEvent event) {
            ...
            if (notifications != null) {
                for (Object next : notifications) {
                    ...
                    // && ((Element) notifier).getModel() == root
                    // .getModel()) {
                    // refresh();
                    // break;
                    // } else if (notifier instanceof FillStyle) {
