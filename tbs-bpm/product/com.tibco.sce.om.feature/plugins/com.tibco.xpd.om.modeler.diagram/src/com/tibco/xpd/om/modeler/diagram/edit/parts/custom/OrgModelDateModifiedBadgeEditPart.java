 ...
 * @generated
 */
public class OrgModelDateModifiedBadgeEditPart extends CompartmentEditPart
        implements ITextAwareEditPart {

    public static final String VISUAL_ID = "OrgModelDateModifiedBadgeEditPart"; //$NON-NLS-1$

    private ResourceListener ResList;
     ...
     * @generated
     */
    public OrgModelDateModifiedBadgeEditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        /*
         * Disable this editpolicy so that the label cannot be selected
         */
    ...
    public IParser getParser() {
        if (parser == null) {
            ...
            IAdaptable hintAdapter = new OrganizationModelParserProvider.HintAdapter(
                    OrganizationModelElementTypes.OrgModel_79,
    ...
    public void activate() {
        ...
        ResList = new ResourceListener();
        // XpdResourcesPlugin.getDefault().getEditingDomain()
        // .addResourceSetListener(ResList);
        getEditingDomain().addResourceSetListener(ResList);
    ...
    public void deactivate() {
        ...
        if (ResList != null) {
            // XpdResourcesPlugin.getDefault().getEditingDomain()
            // .removeResourceSetListener(ResList);
            getEditingDomain().removeResourceSetListener(ResList);
            ResList = null;
        }
     ...
     * changes.
     */
    class ResourceListener extends ResourceSetListenerImpl {
        @Override
        ...
        public void resourceSetChanged(ResourceSetChangeEvent event) {
            ...
            if (notifications != null) {
                for (Object next : notifications) {
                    ...
                    // Check that the notification relates to this Resource
                    if (notifier instanceof Resource
                            && notifier.equals(element.eResource())) {
                        // If the Respurce is NOT dirty then we can assume that
                        // is has been saved
                        if (!((Resource) notifier).isModified()) {
                            refresh();
                        }
                        return;
                    }
