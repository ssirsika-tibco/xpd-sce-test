 ...
 * @generated
 */
public class OrgModelNameBadgeEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {

    public static final String VISUAL_ID = "OrgModelNameBadge"; //$NON-NLS-1$
     ...
     * @generated
     */
    public OrgModelNameBadgeEditPart(View view) {
        super(view);
    }
