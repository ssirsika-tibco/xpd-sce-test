 ...
 * @generated
 */
public class OrgModelVersionBadgeEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {

    public static final String VISUAL_ID = "OrgModelVersionBadgeEditPart"; //$NON-NLS-1$
     ...
     * @generated
     */
    public OrgModelVersionBadgeEditPart(View view) {
        super(view);
    }
