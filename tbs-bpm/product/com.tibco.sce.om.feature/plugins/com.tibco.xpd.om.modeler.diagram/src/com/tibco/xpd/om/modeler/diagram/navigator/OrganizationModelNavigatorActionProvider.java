 ...
 * @generated
 */
public class OrganizationModelNavigatorActionProvider extends
    ...
    private class OpenDiagramAction extends Action {
        ...
        public final void selectionChanged(IStructuredSelection selection) {
            ...
            if (selection.size() == 1) {
                ...
                if (selectedElement instanceof OrganizationModelNavigatorItem) {
                    selectedElement = ((OrganizationModelNavigatorItem) selectedElement)
                            .getView();
        ...
        public void run() {
            ...
            try {
                page.openEditor(editorInput, OrganizationModelDiagramEditor.ID);
