package com.tibco.xpd.om.modeler.diagram.sheet;
...
import com.tibco.xpd.om.modeler.diagram.navigator.OrganizationModelNavigatorGroup;
 ...
 * @generated
 */
public class OrganizationModelSheetLabelProvider extends
        DecoratingLabelProvider {

    private Image noteAttachment;

    private static final String NOTE_LABEL =
            Messages.OrganizationModelSheetLabelProvider_note_label;

    private static final String TEXT_LABEL =
            Messages.OrganizationModelSheetLabelProvider_text_label;

    private static final String NOTE_ATTACHMENT_LABEL =
            Messages.OrganizationModelSheetLabelProvider_noteAttachment_label;
     ...
     * @generated
     */
    public OrganizationModelSheetLabelProvider() {
    ...
    public String getText(Object element) {
        ...
        if (element instanceof EObject) {
            ...
            if (wc != null && wc.isReadOnly()) {
                text = String.format(Messages.OrganizationModelSheetLabelProvider_readOnlyTagged_label, text);
            }
        }
    ...
    private String _getText(Object element) {
        ...
        if (selected instanceof OrganizationModelNavigatorGroup) {
            return ((OrganizationModelNavigatorGroup) selected).getGroupName();
