 ...
 * @generated
 */
public class OrganizationNameSubBadgeEditPart extends CompartmentEditPart
        implements ITextAwareEditPart {

    
    
    public static final String VISUAL_ID = "OrganizationNameSubBadge"; //$NON-NLS-1$
     ...
     * @generated
     */
    public OrganizationNameSubBadgeEditPart(View view) {
        super(view);
    }
