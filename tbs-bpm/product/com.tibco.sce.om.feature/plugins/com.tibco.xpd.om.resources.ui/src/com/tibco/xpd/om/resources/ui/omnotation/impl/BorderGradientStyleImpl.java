...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Border Gradient Style</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.xpd.om.resources.ui.omnotation.impl.BorderGradientStyleImpl#getGradStartColor <em>Grad Start Color</em>}</li>
 *   <li>{@link com.tibco.xpd.om.resources.ui.omnotation.impl.BorderGradientStyleImpl#getGradEndColor <em>Grad End Color</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BorderGradientStyleImpl extends EObjectImpl implements BorderGradientStyle {
    /**
     ...
     * @generated
     */
    protected BorderGradientStyleImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return OmNotationPackage.Literals.BORDER_GRADIENT_STYLE;
    }
    ...
    public void setGradStartColor(int newGradStartColor) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OmNotationPackage.BORDER_GRADIENT_STYLE__GRAD_START_COLOR, oldGradStartColor, gradStartColor));
    }
    ...
    public void setGradEndColor(int newGradEndColor) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OmNotationPackage.BORDER_GRADIENT_STYLE__GRAD_END_COLOR, oldGradEndColor, gradEndColor));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case OmNotationPackage.BORDER_GRADIENT_STYLE__GRAD_START_COLOR:
                return new Integer(getGradStartColor());
            case OmNotationPackage.BORDER_GRADIENT_STYLE__GRAD_END_COLOR:
