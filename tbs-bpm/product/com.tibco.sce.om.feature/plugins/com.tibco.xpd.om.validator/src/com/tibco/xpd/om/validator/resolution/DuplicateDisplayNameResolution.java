...
/**
 * Resolution for duplicate Display Names.
 * 
 * @author rgreen
 * 
 */
public class DuplicateDisplayNameResolution extends
    ...
    protected Command getResolutionCommand(final EditingDomain editingDomain,
        ...
        if (target.eContainer() != null && target instanceof NamedElement) {
            String newDisplayName = getUniqueName(target);
    ...
    private String getUniqueName(final EObject target) {
        ...
        while (!isUnique) {
            uniqueName = element.getDisplayName() + i;
    ...
    private boolean isUniqueName(NamedElement element, EObject container,
        ...
        while (iter.hasNext()) {
            ...
            if (childElem instanceof NamedElement && childElem != element
                ...
                if (childNamedElem.getDisplayName().equals(name)) {
                    return false;
                }
            }
        }
