...
/**
 * Message utility (for access of Internationalisation message bundle
 * com.tibco.xpd.nimbus.xsltutil/messages.properties)
 * 
 * 
 * @author aallway
 * @since 16 Oct 2012
 */
public class ImportNimbusProcessMapXsltMessages {

    public static ImportNimbusProcessMapXsltMessages INSTANCE =
            new ImportNimbusProcessMapXsltMessages();
    ...
    private String errorMessage(String key) {
        ...
        System.out.println("ProcDocMsgs: Invalid msg requested: " + key); //$NON-NLS-1$
        return err;
    }
