...
import com.tibco.xpd.process.analyst.branding.wp.samples.postinstall.PostInstallAction;
...
class SampleProjects {
	...
	class Project {
		...
		private Collection<PostInstallStep> revealPostInstallSteps(IConfigurationElement element) {
