...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.simulation.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentRootItemProvider extends ItemProviderAdapter implements
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures
                    .add(SimulationPackage.Literals.DOCUMENT_ROOT__MIXED);
        }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator()
                .getImage("full/obj16/DocumentRoot")); //$NON-NLS-1$
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors
                .add(createChildParameter(SimulationPackage.Literals.DOCUMENT_ROOT__MIXED,
                        FeatureMapUtil
        ...
        newChildDescriptors
                .add(createChildParameter(SimulationPackage.Literals.DOCUMENT_ROOT__MIXED,
                        FeatureMapUtil
                                .createEntry(SimulationPackage.Literals.DOCUMENT_ROOT__ACTIVITY_SIMULATION_DATA,
        ...
        newChildDescriptors
                .add(createChildParameter(SimulationPackage.Literals.DOCUMENT_ROOT__MIXED,
                        FeatureMapUtil
                                .createEntry(SimulationPackage.Literals.DOCUMENT_ROOT__PARTICIPANT_SIMULATION_DATA,
                                        SimulationFactory.eINSTANCE
        ...
        newChildDescriptors
                .add(createChildParameter(SimulationPackage.Literals.DOCUMENT_ROOT__MIXED,
                        FeatureMapUtil
                                .createEntry(SimulationPackage.Literals.DOCUMENT_ROOT__SPLIT_SIMULATION_DATA,
                                        SimulationFactory.eINSTANCE
        ...
        newChildDescriptors
                .add(createChildParameter(SimulationPackage.Literals.DOCUMENT_ROOT__MIXED,
                        FeatureMapUtil
                                .createEntry(SimulationPackage.Literals.DOCUMENT_ROOT__START_SIMULATION_DATA,
                                        SimulationFactory.eINSTANCE
        ...
        newChildDescriptors
                .add(createChildParameter(SimulationPackage.Literals.DOCUMENT_ROOT__MIXED,
                        FeatureMapUtil
                                .createEntry(SimulationPackage.Literals.DOCUMENT_ROOT__TRANSITION_SIMULATION_DATA,
                                        SimulationFactory.eINSTANCE
        ...
        newChildDescriptors
                .add(createChildParameter(SimulationPackage.Literals.DOCUMENT_ROOT__MIXED,
                        FeatureMapUtil
                                .createEntry(SimulationPackage.Literals.DOCUMENT_ROOT__WORKFLOW_PROCESS_SIMULATION_DATA,
                                        SimulationFactory.eINSTANCE
