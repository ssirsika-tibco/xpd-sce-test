 ...
 * <ul>
 *   <li>{@link com.tibco.xpd.simulation.impl.ParameterDistributionImpl#getEnumerationValue <em>Enumeration Value</em>}</li>
 *   <li>{@link com.tibco.xpd.simulation.impl.ParameterDistributionImpl#getParameterId <em>Parameter Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ParameterDistributionImpl extends EObjectImpl implements
    ...
    protected EClass eStaticClass() {
        return SimulationPackage.Literals.PARAMETER_DISTRIBUTION;
    }
    ...
    public EList<EnumerationValueType> getEnumerationValue() {
        if (enumerationValue == null) {
            enumerationValue =
                    new EObjectContainmentEList<EnumerationValueType>(
                            EnumerationValueType.class,
                            this,
                            SimulationPackage.PARAMETER_DISTRIBUTION__ENUMERATION_VALUE);
        }
    ...
    public void setParameterId(String newParameterId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SimulationPackage.PARAMETER_DISTRIBUTION__PARAMETER_ID,
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case SimulationPackage.PARAMETER_DISTRIBUTION__ENUMERATION_VALUE:
            ...
            getEnumerationValue()
                    .addAll((Collection<? extends EnumerationValueType>) newValue);
            return;
        case SimulationPackage.PARAMETER_DISTRIBUTION__PARAMETER_ID:
