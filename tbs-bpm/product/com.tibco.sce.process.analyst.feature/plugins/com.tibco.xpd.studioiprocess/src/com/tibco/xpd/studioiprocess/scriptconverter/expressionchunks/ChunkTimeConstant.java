...
/**
 * Chunk that is a constant time (in iProcess this is "#hh:mm#".
 * <p>
 ...
 * @since 19 May 2011
 */
public class ChunkTimeConstant extends IProcessExpressionChunk {

    /**
     * @param line
     * @param startOfChunkIdx
     */
    public ChunkTimeConstant(String line, int startOfChunkIdx) {
