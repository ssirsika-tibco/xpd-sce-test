 ...
 * @author nwilson
 */
public class JavaScriptJavaToProcessMappingFactory extends
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
            String target) {
        return new JavaScriptJavaToProcessMapping(activity, target);
    }
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
        ...
        return new JavaScriptJavaToProcessMapping(activity, target, script);
    }
