...
/**
 * User task schedule script field resolver (looks for data references in user
 ...
 * @since 19 Jun 2012
 */
public class UserTaskScheduleScriptFieldResolver extends
    ...
    protected String getActivityScript(Activity activity) {
        String userTaskOpenScript =
                ProcessScriptUtil.getUserTaskScheduleScript(activity);
    ...
    protected boolean isInterestingActivity(Activity activity) {
        return ProcessScriptUtil.isUserTaskWithScheduleScriptType(activity,
                getJavaScriptGrammar());
    }
