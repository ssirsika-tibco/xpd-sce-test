...
/**
 * Action to generate case service that updates case data.
 * 
 * 
 * @author Ali
 * @since 30 Jul 2014
 */
public class GenerateCaseActionToUpdateCaseData extends
        AbstractCaseDataProcessGeneratorAction {

    private final String UPDATE_CASE_DATA_CASE_SERVICE_FRAGMENT_ID =
            "_update_case_data_caseservice_fragment_id"; //$NON-NLS-1$
    ...
    protected List<Process> generateNewProcesses(Package newOrExistingXpdlPkg,
        ...
        if (null != newOrExistingXpdlPkg) {
            ...
            cmdToCreateProcess
                    .setLabel(Messages.Generate_UpdateCaseService_Command_label);
            xpdl2WorkingCopy =
            ...
            for (Class caseClass : caseClassList) {
                ...
                CaseActionProcessCreator caseClassProcCreator =
                        new CaseActionProcessCreator(
                                ...
                                UPDATE_CASE_DATA_CASE_SERVICE_FRAGMENT_ID,
    ...
    protected String getWizardPageTitle() {
        ...
        return Messages.GenerateCaseService_updateData_wizardPage_title;
    }
