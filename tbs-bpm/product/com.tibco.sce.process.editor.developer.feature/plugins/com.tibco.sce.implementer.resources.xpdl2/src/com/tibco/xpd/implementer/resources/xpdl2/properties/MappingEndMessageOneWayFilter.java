...
public class MappingEndMessageOneWayFilter implements IFilter,
        IPluginContribution {

    private IFilter filter;

    public MappingEndMessageOneWayFilter() {
        /*
         * Filter will accept: - end message event implemented by request-only
         * webservice (no output)
         */
