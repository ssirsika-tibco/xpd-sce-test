...
/**
 * Filter for "Map From Service". "Map to Service" - data fields in right hand
 * column.
 * 
 * @author scrossle, mmaciuki
 */
public class ServiceTaskMappingFromServiceFilter implements IFilter,
        IPluginContribution {

    private IFilter filter;

    public ServiceTaskMappingFromServiceFilter() {
        /*
         * "Map from service" filter will accept: - service task implemented by
         * webservice
         */
    ...
    public String getLocalId() {
        return "developer.activityMessageMapperFrom"; //$NON-NLS-1$
    }
