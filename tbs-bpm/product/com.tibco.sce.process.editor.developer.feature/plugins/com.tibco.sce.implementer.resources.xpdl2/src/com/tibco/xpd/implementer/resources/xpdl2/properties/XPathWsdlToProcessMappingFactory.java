 ...
 * @author nwilson
 */
public class XPathWsdlToProcessMappingFactory extends
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
            String target) {
        return new XPathWsdlToProcessMapping(activity, target);
    }
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
        ...
        return new XPathWsdlToProcessMapping(activity, target, script);
    }
