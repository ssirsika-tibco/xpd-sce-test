 ...
 * 
 */
public class ImplementedEndEventFilter implements IFilter {
    ...
    public boolean select(Object toTest) {
        ...
        if (eo instanceof Activity
            ...
            if (ProcessInterfaceUtil.getImplementedMethod((Activity) eo) != null) {

                InterfaceMethod startMethod =
                        ProcessInterfaceUtil
                                .getImplementedMethod((Activity) eo);
