...
import com.tibco.xpd.js.validation.tools.InitiatedScriptTaskScriptTool;
...
/**
 * Initiated script validation rule.
 * 
 * 
 * @author agondal
 * @since 25 Sep 2013
 */
public abstract class AbstractInitiatedScriptTaskScriptRule extends
    ...
    protected ScriptTool createScriptToolIfInterested(Expression expression) {
        /*
         * If this is initiated script, then create and return appropriate
         * script tool
         */

        if (expression.eContainer() instanceof AuditEvent) {
            AuditEvent auditEvent = (AuditEvent) expression.eContainer();
            if (AuditEventType.INITIATED_LITERAL.equals(auditEvent.getType())) {
                Activity activity =
                ...
                if (activity != null) {
                    ...
                    return getScope()
                            .getTool(InitiatedScriptTaskScriptTool.class,
                                    activity);
                }
            }
        }
