...
import com.tibco.xpd.js.validation.tools.JavaServiceUnmappedScriptInputTool;
...
/**
 * Java service unmapped input script validation rule.
 * 
 * 
 * @author agondal
 * @since 17 Sep 2013
 */
public abstract class AbstractJavaServiceUnmappedScriptInputRule extends
    ...
    protected ScriptTool getScriptTool(ScriptInformation scriptInformation) {
        ...
        if (!MappingRuleUtil
            ...
            if (scriptInformation != null
                    && DirectionType.IN_LITERAL.equals(scriptInformation
                            .getDirection())) {
                ...
                if (activity != null
                    ...
                    if (service != null) {
                        ...
                        if (TaskImplementationTypeDefinitions.JAVA_SERVICE
                                .equals(type)) {
                            return getScope()
                                    .getTool(JavaServiceUnmappedScriptInputTool.class,
                                            scriptInformation);
                        }
                    }
                }
