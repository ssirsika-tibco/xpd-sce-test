...
import com.tibco.xpd.js.validation.tools.MILoopExprTool;
...
/**
 * Multi-instance loop condition script validation rule.
 * 
 * 
 * @author agondal
 * @since 25 Sep 2013
 */
public abstract class AbstractMILoopExprRule extends AbstractExpressionRule {
    ...
    protected ScriptTool createScriptToolIfInterested(Expression expression) {
        ...
        if (Xpdl2Package.eINSTANCE.getLoopMultiInstance_MICondition()
            ...
            if (activity != null) {
                ...
                return getScope().getTool(MILoopExprTool.class, activity);
            }
        }
        return null;
    }
    ...
    protected String getScriptContext() {
        return ProcessJsConsts.MI_LOOP_EXPR;
    }
