 ...
 *
 */
public class JsScriptPerformerRule extends AbstractPerformerFieldScriptRule {
    /** The issue id. */
    private static final String ERROR_ID = "js.validatePerformerScript"; //$NON-NLS-1$

    private static final String WARNING_ID = "js.warning.validatePerformerScript"; //$NON-NLS-1$
