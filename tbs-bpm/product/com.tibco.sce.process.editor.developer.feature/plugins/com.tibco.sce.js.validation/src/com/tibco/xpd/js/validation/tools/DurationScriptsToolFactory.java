 ...
 * 
 */
public class DurationScriptsToolFactory extends JavaScriptToolFactory {
	...
	public IPreProcessor createPreProcessor(IValidationScope scope, Object input) {
        ...
        if (input instanceof Activity) {
            ...
            boolean b =
                    ProcessScriptUtil
                            .isActivityWithDurationCalculationScripts(activity);
            if (b) {
                processor = new DurationScriptsTool(activity);
            }
        }
        return processor;
    }
	...
	public Class<? extends IPreProcessor> getToolClass() {
        return DurationScriptsTool.class;
    }
