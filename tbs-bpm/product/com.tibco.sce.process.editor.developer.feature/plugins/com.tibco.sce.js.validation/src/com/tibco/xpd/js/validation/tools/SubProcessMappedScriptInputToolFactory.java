 ...
 * 
 */
public class SubProcessMappedScriptInputToolFactory extends JavaScriptToolFactory {
        ...
        if (input instanceof DataMapping) {
            ...
            boolean b =
                    ProcessScriptUtil.isDataMappingWithScriptType(dataMapping,
                            getScriptGrammar());
            if (b) {
                processor = new SubProcessMappedScriptInputTool(dataMapping);
            }
        }
        return processor;
    }
	...
	public Class<? extends IPreProcessor> getToolClass() {
		return SubProcessMappedScriptInputTool.class;
	}
