 ...
 * 
 */
public class WebServiceMappedJScriptInputToolFactory extends JavaScriptToolFactory {
        ...
        if (input instanceof DataMapping) {
            ...
            boolean b =
                    ProcessScriptUtil.isDataMappingWithScriptType(dataMapping,
                            getScriptGrammar());
            if (b) {
                processor = new WebServiceMappedJScriptInputTool(dataMapping);
            }
        }
        return processor;
    }
	...
	public Class<? extends IPreProcessor> getToolClass() {
		return WebServiceMappedJScriptInputTool.class;
	}
