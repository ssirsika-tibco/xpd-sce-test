...
/**
 * Javascript expression validation rule for Script Task Process Data Mapper
 * scripts.
 * 
 * @author nwilson
 * @since 28 Apr 2015
 */
public class ScriptTaskDataMapperExpressionRule extends
    ...
    protected boolean isRelevant(Expression sdmExpression) {
        ...
        if (parent instanceof TaskScript) {
            relevant = true;
        }
        return relevant;
    }
