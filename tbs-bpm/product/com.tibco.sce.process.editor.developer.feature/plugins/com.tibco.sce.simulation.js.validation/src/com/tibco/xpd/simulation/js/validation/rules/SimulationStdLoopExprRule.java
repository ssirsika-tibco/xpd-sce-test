 ...
 * @since 17 Sep 2013
 */
public class SimulationStdLoopExprRule extends AbstractStdLoopExprRule {
    /** The issue id. */
    private static final String ERROR_ID = "simulation.stdLoopExprScript"; //$NON-NLS-1$                                  

    private static final String WARNING_ID =
            "simulation.warning.stdLoopExprScript"; //$NON-NLS-1$
