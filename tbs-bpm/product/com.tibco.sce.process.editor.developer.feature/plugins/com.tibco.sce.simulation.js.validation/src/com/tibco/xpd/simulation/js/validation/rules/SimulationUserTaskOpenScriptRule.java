 ...
 * validation is abstracted out in super class, which enables reusing the rule
 ...
 * @since 17 Sep 2013
 */
public class SimulationUserTaskOpenScriptRule extends
        AbstractUserTaskOpenScriptRule {

    /** The issue id. */
    private static final String ERROR_ID =
            "simulation.error.userTaskOpenScript"; //$NON-NLS-1$

    private static final String WARNING_ID =
            "simulation.warning.userTaskOpenScript"; //$NON-NLS-1$
