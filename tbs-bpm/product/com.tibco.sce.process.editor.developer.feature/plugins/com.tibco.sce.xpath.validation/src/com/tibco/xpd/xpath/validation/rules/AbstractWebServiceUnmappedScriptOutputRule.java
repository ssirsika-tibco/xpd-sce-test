...
import com.tibco.xpd.xpath.validation.tools.WebServiceUnmappedScriptOutputTool;
 ...
 * 
 */
public abstract class AbstractWebServiceUnmappedScriptOutputRule extends AbstractXpathScriptRule {
	...
	public void validate(FlowContainer flowContainer) {
		...
		for (ScriptInformation scriptInformation : scriptInformationList) {
		    XPathScriptTool tool = validationScope.getTool(WebServiceUnmappedScriptOutputTool.class,
			        scriptInformation);
                    ...
                    List<ScriptInformation> tempScriptInformationList =
                            ProcessScriptUtil
                                    .getScriptInformationTasksWithScriptType(activity,
                                            getScriptGrammar(), DirectionType.OUT_LITERAL.getLiteral());
