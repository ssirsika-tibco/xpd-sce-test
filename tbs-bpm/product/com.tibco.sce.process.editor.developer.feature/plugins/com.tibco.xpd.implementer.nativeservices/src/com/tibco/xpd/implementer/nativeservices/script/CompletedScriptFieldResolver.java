 ...
 * 
 */
public class CompletedScriptFieldResolver extends ScriptProcessFieldResolver {
    ...
    protected String getActivityScript(Activity activity) {
        String completedScript = ProcessScriptUtil.getCompletedScript(activity);
    ...
    protected Command getSetActivityScriptCommand(EditingDomain editingDomain,
        ...
        Command cmd =
                ProcessScriptUtil.getSetCompletedScriptCommand(editingDomain,
                        strScript,
                        activity,
    ...
    protected boolean isInterestingActivity(Activity activity) {
        return ProcessScriptUtil.isActivityWithCompletedScriptType(activity,
                getJavaScriptGrammar());
    }
