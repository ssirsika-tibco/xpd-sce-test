 ...
 * 
 */
public class ReceiveTaskXPathScriptFieldResolver extends
    ...
    protected List<ScriptInformation> getActivityScriptInformationList(
            Activity activity) {
        return ProcessScriptUtil.getAllReceiveTaskScriptInformations(activity,
                getGrammarType());
    }

    @Override
    protected boolean isInterestingActivity(Activity activity) {
        return ProcessScriptUtil.isReceiveTaskWithScriptType(activity,
                getGrammarType());
    }
    ...
    protected String getMappingInReferenceContextLabel(Activity activity) {
         ...
         * 
         * Which fair enough is should not be a possibility for receive task
         * anyway.
         */
    ...
    protected String getMappingOutReferenceContextLabel(Activity activity) {
        /*
         * There is only one situation for receive task with OUT direction and
