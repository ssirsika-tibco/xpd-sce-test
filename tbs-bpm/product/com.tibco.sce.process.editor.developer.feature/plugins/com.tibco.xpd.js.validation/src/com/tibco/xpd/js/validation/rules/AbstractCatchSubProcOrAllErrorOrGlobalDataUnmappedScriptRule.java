...
import com.tibco.xpd.js.validation.tools.SubProcessUnmappedScriptOutputTool;
 ...
 * @since 17 Sep 2013
 */
public abstract class AbstractCatchSubProcOrAllErrorOrGlobalDataUnmappedScriptRule extends
            ...
            if (!MappingRuleUtil
                ...
                if (activity != null && activity.getEvent() != null
                    ...
                    if (BpmnCatchableErrorUtil
                        ...
                        return getScope()
                                .getTool(SubProcessUnmappedScriptOutputTool.class,
                                        scriptInformation);
                    }
                }
            }
