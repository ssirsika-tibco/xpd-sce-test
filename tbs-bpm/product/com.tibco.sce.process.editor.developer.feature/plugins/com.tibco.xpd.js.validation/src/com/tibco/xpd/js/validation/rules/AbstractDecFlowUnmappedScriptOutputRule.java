...
import com.tibco.xpd.js.validation.tools.DecFlowUnmappedScriptOutputTool;
...
/**
 * Decision flow unmapped output script validation rule
 * 
 * 
 * @author agondal
 * @since 17 Sep 2013
 */
public abstract class AbstractDecFlowUnmappedScriptOutputRule extends
        ...
        if (!MappingRuleUtil
            ...
            if (scriptInfoDirection != null
                ...
                if (activity != null
                    ...
                    return getScope()
                            .getTool(DecFlowUnmappedScriptOutputTool.class,
                                    scriptInformation);
                }
            }
        }
