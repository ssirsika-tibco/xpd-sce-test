...
import com.tibco.xpd.js.validation.tools.UserTaskCloseScriptTool;
...
/**
 * User task close script validation rule.
 * 
 * 
 * @author agondal
 * @since 17 Sep 2013
 */
public abstract class AbstractUserTaskCloseScriptRule extends
    ...
    protected ScriptTool createScriptToolIfInterested(Expression expression) {
        ...
        if (XpdExtensionPackage.eINSTANCE.getUserTaskScripts_CloseScript()
            ...
            if (activity != null) {
                ...
                if (taskUser != null) {
                    return getScope().getTool(UserTaskCloseScriptTool.class,
                            activity);
                }
            }
        }
