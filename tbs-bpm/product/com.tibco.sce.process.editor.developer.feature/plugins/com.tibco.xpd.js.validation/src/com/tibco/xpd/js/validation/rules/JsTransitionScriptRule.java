 ...
 * 
 */
public class JsTransitionScriptRule extends AbstractTransitionScriptRule {
    /** The issue id. */
    private static final String ERROR_ID =
            "js.validateConditionalTransitionScript"; //$NON-NLS-1$

    private static final String WARNING_ID =
            "js.warning.validateConditionalTransitionScript"; //$NON-NLS-1$
