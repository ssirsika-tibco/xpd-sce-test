...
/**
 * Javascript expression validation rule for User Task Process Data Mapper
 * scripts.
 * 
 * @author nwilson
 * @since 28 Apr 2015
 */
public class UserTaskDataMapperExpressionRule extends
    ...
    protected boolean isRelevant(Expression sdmExpression) {
        ...
        if (parent instanceof UserTaskScripts) {
            relevant = true;
        }
        return relevant;
    }
