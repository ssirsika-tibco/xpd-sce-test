...
public class IpeScriptTranslator extends antlr.TreeParser       implements IpeScriptTranslatorTokenTypes
 {
...
public IpeScriptTranslator() {
	...
	public final void stat(AST _t) throws RecognitionException {
		...
		ASTPair currentAST = new ASTPair();
		AST stat_AST = null;
		AST statExpr_AST = null;
		AST statExpr = null;
		AST forCondExpr_AST = null;
		AST forCondExpr = null;
		AST whileStat = null;
		AST whileStat_AST = null;
		AST whileCondExpr_AST = null;
		AST whileCondExpr = null;
		AST whileBrace_AST = null;
		AST whileBrace = null;
		AST doWhileCondExpr_AST = null;
		AST doWhileCondExpr = null;
		...
		try {      // for error handling
			...
			case EXPR:
			{
				statExpr = _t==ASTNULL ? null : (AST)_t;
				expression(_t);
				_t = _retTree;
				statExpr_AST = (AST)returnAST;
				astFactory.addASTChild(currentAST, returnAST);
				TranslateUtil.handleBooleanExpression(statExpr_AST,this);
				stat_AST = (AST)currentAST.root;
				break;
			}
			case LABELED_STAT:
			...
			case LITERAL_for:
			{
				...
				case EXPR:
				{
					forCondExpr = _t==ASTNULL ? null : (AST)_t;
					expression(_t);
					_t = _retTree;
					forCondExpr_AST = (AST)returnAST;
					astFactory.addASTChild(currentAST, returnAST);
					TranslateUtil.handleBooleanExpression(forCondExpr_AST,this);
					break;
				}
				case 3:
				{
				...
				_t = __t51;
				_t = _t.getNextSibling();
				TranslateUtil.addDummyBooleanExpression(tmp6_AST,this);
				AST __t53 = _t;
				AST tmp7_AST = null;
			...
			case LITERAL_while:
			{
				...
				_t = _t.getFirstChild();
				whileCondExpr = _t==ASTNULL ? null : (AST)_t;
				expression(_t);
				_t = _retTree;
				whileCondExpr_AST = (AST)returnAST;
				astFactory.addASTChild(currentAST, returnAST);
				TranslateUtil.handleBooleanExpression(whileCondExpr_AST,this);
			...
			case LITERAL_do:
			{
				...
				match(_t,LITERAL_do);
				_t = _t.getFirstChild();
				doWhileCondExpr = _t==ASTNULL ? null : (AST)_t;
				expression(_t);
				_t = _retTree;
				doWhileCondExpr_AST = (AST)returnAST;
				astFactory.addASTChild(currentAST, returnAST);
				TranslateUtil.handleBooleanExpression(doWhileCondExpr_AST,this);
				stat(_t);
				_t = _retTree;
				astFactory.addASTChild(currentAST, returnAST);
	...
	public final void variableDef(AST _t) throws RecognitionException {
		...
		try {      // for error handling
			...
			TranslateUtil.massageVariableDefinition(variableDef_AST);
			variableDef_AST = (AST)currentAST.root;
		}
		catch (RecognitionException ex) {
			reportError(ex);
	...
	public final void ifElseStat(AST _t) throws RecognitionException {
		...
		try {      // for error handling
			...
			match(_t,LITERAL_if);
			_t = _t.getFirstChild();
			ifCondExpr = _t==ASTNULL ? null : (AST)_t;
			expression(_t);
			_t = _retTree;
			ifCondExpr_AST = (AST)returnAST;
			astFactory.addASTChild(currentAST, returnAST);
			TranslateUtil.handleBooleanExpression(ifCondExpr_AST,this);
			slist(_t);
			_t = _retTree;
			astFactory.addASTChild(currentAST, returnAST);
			{
	...
	public final void returnStatement(AST _t) throws RecognitionException {
		...
		AST returnStatement_AST_in = (_t == ASTNULL) ? null : (AST)_t;
		returnAST = null;
		ASTPair currentAST = new ASTPair();
		...
		try {      // for error handling
			...
			TranslateUtil.translateReturnStatement(returnStatement_AST,scriptType);
			returnStatement_AST = (AST)currentAST.root;
		}
		catch (RecognitionException ex) {
			reportError(ex);
	...
	public final void expr(AST _t) throws RecognitionException {
		...
		AST expr_AST = null;
		AST pAssign = null;
		AST pAssign_AST = null;
		AST mAssign = null;
		AST mAssign_AST = null;
		AST sAssign = null;
		AST sAssign_AST = null;
		AST dAssign = null;
		AST dAssign_AST = null;
		AST bandAssign = null;
		AST bandAssign_AST = null;
		AST bxorAssign = null;
		AST bxorAssign_AST = null;
		AST borAssign = null;
		AST borAssign_AST = null;
		...
		try {      // for error handling
			...
			{
				AST __t90 = _t;
				pAssign = _t==ASTNULL ? null :(AST)_t;
				AST pAssign_AST_in = null;
				pAssign_AST = astFactory.create(pAssign);
				astFactory.addASTChild(currentAST, pAssign_AST);
				...
				_t = __t90;
				_t = _t.getNextSibling();
				TranslateUtil.translateCompoundOperatorAssignment(pAssign_AST);
				expr_AST = (AST)currentAST.root;
				break;
			}
			case MINUS_ASSIGN:
			{
				AST __t91 = _t;
				mAssign = _t==ASTNULL ? null :(AST)_t;
				AST mAssign_AST_in = null;
				mAssign_AST = astFactory.create(mAssign);
				astFactory.addASTChild(currentAST, mAssign_AST);
				...
				_t = __t91;
				_t = _t.getNextSibling();
				TranslateUtil.translateCompoundOperatorAssignment(mAssign_AST);
				expr_AST = (AST)currentAST.root;
				break;
			}
			case STAR_ASSIGN:
			{
				AST __t92 = _t;
				sAssign = _t==ASTNULL ? null :(AST)_t;
				AST sAssign_AST_in = null;
				sAssign_AST = astFactory.create(sAssign);
				astFactory.addASTChild(currentAST, sAssign_AST);
				...
				_t = __t92;
				_t = _t.getNextSibling();
				TranslateUtil.translateCompoundOperatorAssignment(sAssign_AST);
				expr_AST = (AST)currentAST.root;
				break;
			}
			case DIV_ASSIGN:
			{
				AST __t93 = _t;
				dAssign = _t==ASTNULL ? null :(AST)_t;
				AST dAssign_AST_in = null;
				dAssign_AST = astFactory.create(dAssign);
				astFactory.addASTChild(currentAST, dAssign_AST);
				...
				_t = __t93;
				_t = _t.getNextSibling();
				TranslateUtil.translateCompoundOperatorAssignment(dAssign_AST);
				expr_AST = (AST)currentAST.root;
				break;
			}
			case MOD_ASSIGN:
			...
			{
				AST __t98 = _t;
				bandAssign = _t==ASTNULL ? null :(AST)_t;
				AST bandAssign_AST_in = null;
				bandAssign_AST = astFactory.create(bandAssign);
				astFactory.addASTChild(currentAST, bandAssign_AST);
				...
				_t = __t98;
				_t = _t.getNextSibling();
				TranslateUtil.translateCompoundOperatorAssignment(bandAssign_AST);
				expr_AST = (AST)currentAST.root;
				break;
			}
			case BXOR_ASSIGN:
			{
				AST __t99 = _t;
				bxorAssign = _t==ASTNULL ? null :(AST)_t;
				AST bxorAssign_AST_in = null;
				bxorAssign_AST = astFactory.create(bxorAssign);
				astFactory.addASTChild(currentAST, bxorAssign_AST);
				...
				_t = __t99;
				_t = _t.getNextSibling();
				TranslateUtil.translateCompoundOperatorAssignment(bxorAssign_AST);
				expr_AST = (AST)currentAST.root;
				break;
			}
			case BOR_ASSIGN:
			{
				AST __t100 = _t;
				borAssign = _t==ASTNULL ? null :(AST)_t;
				AST borAssign_AST_in = null;
				borAssign_AST = astFactory.create(borAssign);
				astFactory.addASTChild(currentAST, borAssign_AST);
				...
				_t = __t100;
				_t = _t.getNextSibling();
				TranslateUtil.translateCompoundOperatorAssignment(borAssign_AST);
				expr_AST = (AST)currentAST.root;
				break;
			}
			case LOR:
	...
	public final void primaryExpression(AST _t) throws RecognitionException {
		...
		try {      // for error handling
			...
			case METHOD_CALL:
			{
				...
				_t = __t136;
				_t = _t.getNextSibling();
				TranslateUtil.handleMethodParams(this,methodAST_AST);TranslateUtil.translateAttributeMethodCall(this,methodAST_AST);TranslateUtil.translateProcessNameMethodCall(this,methodAST_AST);TranslateUtil.translateTaskNameMethodCall(this,methodAST_AST);
				primaryExpression_AST = (AST)currentAST.root;
				break;
			}
			case TYPECAST:
