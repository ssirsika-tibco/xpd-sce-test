...
import com.tibco.xpd.js.validation.rules.AbstractTaskScriptRule;
 ...
 * @since 17 Sep 2013
 */
public class SimulationScriptTaskRule extends AbstractTaskScriptRule {

    /** The issue id. */
    private static final String ERROR_ID =
            "simulation.error.validateScriptTask"; //$NON-NLS-1$								  

    private static final String WARNING_ID =
            "simulation.warning.validateScriptTask"; //$NON-NLS-1$
