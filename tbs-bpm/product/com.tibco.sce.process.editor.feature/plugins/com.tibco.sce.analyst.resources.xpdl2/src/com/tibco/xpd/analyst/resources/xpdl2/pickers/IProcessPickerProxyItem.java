...
/**
 * This represents an item that will be displayed in the Process Picker. The
 ...
 * 
 */
public interface IProcessPickerProxyItem {
    ...
    /**
     * @return The name of the project containing the item.
     */
