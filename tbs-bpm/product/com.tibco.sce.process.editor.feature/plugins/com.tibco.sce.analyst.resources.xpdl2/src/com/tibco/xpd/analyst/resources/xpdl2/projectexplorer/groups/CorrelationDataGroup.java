 ...
 * 
 */
public class CorrelationDataGroup extends AbstractAssetGroup {

    private static final String TITLE = Messages.CorrelationDataGroup_TITLE;
     ...
     * @param parent
     */
    public CorrelationDataGroup(EObject parent) {
        super(parent, ProcessEditorElementType.correlation_data);
    }
