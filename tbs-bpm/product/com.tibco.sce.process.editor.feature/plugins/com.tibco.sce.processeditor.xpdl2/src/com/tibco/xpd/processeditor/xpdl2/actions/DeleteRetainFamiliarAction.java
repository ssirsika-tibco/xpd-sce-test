 ...
 * 
 */
public class DeleteRetainFamiliarAction extends Action {
     ...
     * 
     */
    public DeleteRetainFamiliarAction(AbstractRetainFamiliarSection section) {
    ...
    public String getText() {
        ...
        if (selection instanceof IStructuredSelection) {
            ...
            if (firstElement instanceof RetainFamiliarActivities) {
    ...
    public void run() {
        CompoundCommand cCmd =
                new CompoundCommand(
                        Messages.RetainFamiliarSection_RemoveRetainFamiliarCommand);
