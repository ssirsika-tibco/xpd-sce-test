...
/**
 * Compare structure create for process package content.
 * 
 * @author aallway
 * @since 30 Sep 2010
 */
public class ProcessCompareStructureCreator extends EMFCompareStructureCreator {
    ...
    protected EMFCompareNodeFactory createEMFCompareNodeFactory() {
         ...
         */
        return new ProcessCompareNodeFactory("xpdlContent"); //$NON-NLS-1$
    }
    ...
    public String getName() {
        return Messages.ProcessStructureCreator_ProcessStructCompare_title;
    }
