 ...
 * @since 20 Jun 2012
 */
public class CatchSignalEventMappingCompositorFactory extends
        ScriptMappingCompositorFactory {

    /**
     * 
     */
    public CatchSignalEventMappingCompositorFactory() {
        // TODO Auto-generated constructor stub
    }

    /**
     * @see com.tibco.xpd.processeditor.xpdl2.properties.script.ScriptMappingCompositorFactory#getCompositor(com.tibco.xpd.xpdl2.Activity,
     *      java.lang.String)
     * 
     * @param activity
     * @param target
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
            String target) {
        return new CatchSignalEventMappingCompositor(activity, target);
    }
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
        ...
        return new CatchSignalEventMappingCompositor(activity, target, script);
    }

    private static class CatchSignalEventMappingCompositor implements
         ...
         *            The target.
         */
        public CatchSignalEventMappingCompositor(Activity activity,
                String target) {
        ...
        public Collection<Object> getSourceItems(boolean isInput) {
            ...
            for (String name : getSourceItemNames()) {
                items.add(ConceptUtil.resolveConceptPath(activity, name));
            }
            return items;
        }
