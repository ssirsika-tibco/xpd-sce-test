 ...
 */
public class InitiatedScriptTaskScriptSection extends
    ...
    public String getCurrentSetScriptGrammarId() {
        ...
        if (act != null) {
            currentScriptGrammarId =
                    TaskObjectUtil
                            .getExistingSetInitiatedAuditScriptGrammarId(act);
        }
    ...
    protected EObject getScriptNotifierObject(Audit audit) {
        return TaskObjectUtil.getAuditEvent(AuditEventType.INITIATED_LITERAL,
                audit);
    }

    protected String getScriptDefinitionLabel() {
        return Messages.AuditScriptSection_InitiatedAuditDefinitionScripts;
    }
