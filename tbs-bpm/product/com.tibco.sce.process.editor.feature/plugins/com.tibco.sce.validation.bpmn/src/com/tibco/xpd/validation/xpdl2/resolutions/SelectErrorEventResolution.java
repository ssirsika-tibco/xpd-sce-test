...
/**
 * Resolution that allows user to select a new error to catch from catch error
 * event.
 * 
 * @author aallway
 * @since 3.2
 */
public class SelectErrorEventResolution extends AbstractWorkingCopyResolution {
        ...
        if (target instanceof Activity) {
            ...
            if (catchErrorEvent.getEvent() instanceof IntermediateEvent
                ...
                if (BpmnCatchableErrorUtil.getAttachedToTask(catchErrorEvent) != null) {
                    ...
                    return BpmnCatchableErrorUtil.selectErrorCode(Display
