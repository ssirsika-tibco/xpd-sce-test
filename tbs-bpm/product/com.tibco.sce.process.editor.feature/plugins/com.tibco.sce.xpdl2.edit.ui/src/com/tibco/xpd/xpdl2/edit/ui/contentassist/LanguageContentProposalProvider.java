...
/**
 * Used to get all proposals for the different language iso's available for each locale.
 * @author glewis
 *
 */
public class LanguageContentProposalProvider implements IContentProposalProvider{
     ...
     * @param proposals
     */
    public LanguageContentProposalProvider(String[] proposals) {
         data = proposals;
    }
