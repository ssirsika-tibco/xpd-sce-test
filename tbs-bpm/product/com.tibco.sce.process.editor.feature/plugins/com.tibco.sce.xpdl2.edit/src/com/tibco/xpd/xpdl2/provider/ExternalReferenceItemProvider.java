...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdl2.ExternalReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExternalReferenceItemProvider extends DataTypeItemProvider
    ...
    public String getText(Object object) {
        String label = ((ExternalReference) object).getNamespace();
        return label == null || label.length() == 0 ? getString("_UI_ExternalReference_type") : //$NON-NLS-1$
                getString("_UI_ExternalReference_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
