...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Basic Type Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.tibco.xpd.xpdl2.Xpdl2Package#getBasicTypeType()
 * @model extendedMetaData="name='Type_._2_._type'"
 * @generated
 */
public enum BasicTypeType implements Enumerator {
    /**
     ...
     * @ordered
     */
    DATETIME_LITERAL(6, "DATETIME", "DATETIME"),
    /**
     ...
     * @ordered
     */
    BOOLEAN_LITERAL(7, "BOOLEAN", "BOOLEAN"),
    /**
     ...
     * @ordered
     */
    PERFORMER_LITERAL(8, "PERFORMER", "PERFORMER");
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     ...
     * @ordered
     */
    public static final int PERFORMER = 8;

    /**
     * An array of all the '<em><b>Basic Type Type</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public static BasicTypeType get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            BasicTypeType result = VALUES_ARRAY[i];
     ...
     * @generated
     */
    private BasicTypeType(int value, String name, String literal) {
        this.value = value;
        this.name = name;
