...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Deprecated Xor Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.tibco.xpd.xpdl2.Xpdl2Package#getDeprecatedXorType()
 * @model extendedMetaData="name='XorType_._type'"
 * @generated
 */
public enum DeprecatedXorType implements Enumerator {
    /**
    ...
    /**
     * An array of all the '<em><b>Deprecated Xor Type</b></em>' enumerators.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public static DeprecatedXorType get(String literal) {
        for (int i = 0; i < VALUES_ARRAY.length; ++i) {
            DeprecatedXorType result = VALUES_ARRAY[i];
     ...
     * @generated
     */
    private DeprecatedXorType(int value, String name, String literal) {
        this.value = value;
        this.name = name;
