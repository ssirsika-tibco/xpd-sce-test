 ...
 * This is a virtual model object that ALL elements that have both...
 * - A universally Unique Id attribute  (via UniqueIdElement)
 * - A non-unique Name attribute  
 * 
 * <!-- end-user-doc -->
 * <p>
...
public abstract class NamedElementImpl extends UniqueIdElementImpl implements
    ...
    protected EClass eStaticClass() {
        return Xpdl2Package.Literals.NAMED_ELEMENT;
    }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == OtherAttributesContainer.class) {
            ...
            case Xpdl2Package.OTHER_ATTRIBUTES_CONTAINER__OTHER_ATTRIBUTES:
                return Xpdl2Package.NAMED_ELEMENT__OTHER_ATTRIBUTES;
            default:
                return -1;
            }
        }
