 ...
 * <p>
 * Call <code>{@value #getOverwriteStatus(int)}</code> with the result from
 * <code>{@value #open()}</code> to get the
 * <code>{@value OverwriteStatus}</code> enum value of the selection made in
 * the dialog.
 * 
 * @author njpatel
 */
public class OverwriteFileMessageDialog extends MessageDialog {
     ...
     * The values are:
     * <ul>
     * <li><b>NO</b> - <i>No</i> was selected in the dialog, indicating that
     * the file should not be overwritten</li>
     * <li><b>FILE</b> - <i>Yes</i> was selected in the dialog, indicating
     * that the file should be overwritten</li>
     ...
     * overwritten</li>
     * <li><b>CANCEL</b> - <i>Cancel</i> was selected in the dialog,
     * indicating that the process should be stopped</li>
     * </ul>
     * </p>
     */
    ...
    private static final String buttonsList[] = new String[] {
    ...
    /**
     * Get the <code>OverwriteStatus</code> code for the return value from
     * this dialog
     * 
     * @param retValue
     *            The return code from <code>Open()</code>
     * @return <code>OverwriteStatus</code> enum value of the choice made in
     *         the dialog
     */
