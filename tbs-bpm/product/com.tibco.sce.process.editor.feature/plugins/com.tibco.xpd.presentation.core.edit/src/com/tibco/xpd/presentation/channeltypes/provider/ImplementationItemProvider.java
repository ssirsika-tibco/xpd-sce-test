 ...
 * {@link com.tibco.xpd.presentation.channeltypes.Implementation} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ImplementationItemProvider extends NamedElementItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Implementation_bindings_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Implementation_bindings_feature", "_UI_Implementation_type"),
                 ChannelTypesPackage.Literals.IMPLEMENTATION__BINDINGS,
                 true,
                 false,
                 true,
                 null,
