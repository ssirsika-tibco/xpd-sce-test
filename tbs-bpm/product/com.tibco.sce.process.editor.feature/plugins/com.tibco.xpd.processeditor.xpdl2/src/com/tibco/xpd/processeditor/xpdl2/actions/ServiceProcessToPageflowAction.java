...
/**
 * Action to convert service process to pageflow process.
 * 
 * @author bharge
 * @since 16 Feb 2015
 */
public class ServiceProcessToPageflowAction extends BaseSelectionListenerAction {
     ...
     * @param text
     */
    public ServiceProcessToPageflowAction() {

        super(Messages.ServiceProcessToPageflowAction_ConvertToPageflow_menu);
    ...
    public void run() {
        ...
        if (selectedProcess != null
            ...
            /*
             * Create command to convert service process to pageflow process.
             */
            CompoundCommand cmd =
            ...
            /*
             * Remove Service Process Configuration
             */
            ...
            for (Activity activity : allActivitiesInProc) {
                ...
                cmd.append(new ResetDefaultActivityColourCommand(editingDomain,
                        activity, serviceProcessColours, pageflowColours));
            }
