 ...
 * (non-cancelling) for Studio in business analyst mode (section without
 * scripting)
 * <p>
 ...
 * @since 25 Apr 2012
 */
public class CatchSignalMapperAnalystSection extends
    ...
    public CatchSignalMapperAnalystSection() {
    ...
    protected ITreeContentProvider createSourceContentProvider() {
        sourceContentProvider =
                new CatchSignalMapperSourceContentProvider(false);
    ...
    protected String getTitle() {
        return Messages.CatchSignalMapperAnalystSection_MapFromSignal_title1;
    }
    ...
    public static class Filter implements IFilter, IPluginContribution {
        ...
        public String getLocalId() {
            return "analyst.catchBpmnSignalMapperOut"; //$NON-NLS-1$
        }
