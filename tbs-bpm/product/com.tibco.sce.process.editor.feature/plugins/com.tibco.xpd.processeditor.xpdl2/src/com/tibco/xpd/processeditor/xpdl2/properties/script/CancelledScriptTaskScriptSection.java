 ...
 */
public class CancelledScriptTaskScriptSection extends
    ...
    public String getCurrentSetScriptGrammarId() {
        ...
        if (act != null) {
            currentScriptGrammarId =
                    TaskObjectUtil
                            .getExistingSetCancelledAuditScriptGrammarId(act);
        }
    ...
    protected EObject getScriptNotifierObject(Audit audit) {
        return TaskObjectUtil.getAuditEvent(AuditEventType.CANCELLED_LITERAL,
                audit);
    }

    protected String getScriptDefinitionLabel() {
        return Messages.AuditScriptSection_CancelledAuditDefinitionScripts;
    }
