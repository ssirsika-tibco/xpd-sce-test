...
public class SubmitUserTaskScriptSection extends BaseUserTaskScriptSection {
    ...
    public String getCurrentSetScriptGrammarId() {
        ...
        if (act != null) {
            currentScriptGrammarId =
                    TaskObjectUtil
                            .getExistingSetSubmitUserTaskScriptGrammarId(act);
        }
    ...
    protected EObject getScriptNotifierObject(UserTaskScripts userTaskScripts) {
        return userTaskScripts.getSubmitScript();
    }

    protected String getScriptDefinitionLabel() {
        return Messages.UserTaskScriptSection_SubmitUserTaskDefinitionScripts;
    }
