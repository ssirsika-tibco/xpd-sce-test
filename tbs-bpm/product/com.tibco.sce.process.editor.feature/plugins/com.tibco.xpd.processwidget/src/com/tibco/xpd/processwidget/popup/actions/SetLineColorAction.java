 ...
 * 
 */
public class SetLineColorAction extends ActionDelegate {
        ...
        if (cmd_ok && selectionList.size() > 0) {
            ...
            if (ep != null) {
                ...
                if (adp != null) {
                    ...
                    // selection list)
                    String colorIDForType = ep.getLineColorIDForPartType();

                    ProcessWidgetColors colors = ProcessWidgetColors.getInstance(ep);
                    WidgetRGB wRGB =
                    ...
                    colorDlg.setText(Messages.SetLineColorAction_menu);
                        ...
                        for (Iterator iter = selectionList.iterator(); iter
                            ...
                            if (ep != null) {
                                ...
                                if (adp != null) {
                                    cmd
                                            .append(adp
                                                    .getSetLineColorCommand(editingDomain,
                                                            newColorStr));
                                }
                            }
                        }
