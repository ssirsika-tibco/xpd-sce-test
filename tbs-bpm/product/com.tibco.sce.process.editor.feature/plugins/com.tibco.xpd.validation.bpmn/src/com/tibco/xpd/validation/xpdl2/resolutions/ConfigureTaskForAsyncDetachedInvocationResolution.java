 ...
 * 'Asynchronous Detached', set start strategy to 'Schedule Start' and unset
 * 'Suspend/Resume with parent sub-proc'.
 * 
 * @author sajain
 * @since Jan 15, 2015
 */
public class ConfigureTaskForAsyncDetachedInvocationResolution extends
    ...
    protected Command getResolutionCommand(EditingDomain editingDomain,
        ...
        if (target instanceof Activity) {
            ...
            if (activity.getImplementation() instanceof SubFlow) {
                ...
                return getConfigureTaskForAsyncDetachedInvocationCommand(editingDomain,
                        subFlow);
            }
        }
    ...
    /**
     * Return command to set Call Sub-process activity's invocation mode to
     * 'Asynchronous Detached', set start strategy to 'Schedule Start' and unset
     * 'Suspend/Resume with parent sub-proc'.
     * 
     * @param editingDomain
     ...
     * 
     * @return Command to set Call Sub-process activity's invocation mode to
     *         'Asynchronous Detached', set start strategy to 'Schedule Start'
     *         and unset 'Suspend/Resume with parent sub-proc'.
     */
    private Command getConfigureTaskForAsyncDetachedInvocationCommand(
            EditingDomain editingDomain, SubFlow subFlow) {
