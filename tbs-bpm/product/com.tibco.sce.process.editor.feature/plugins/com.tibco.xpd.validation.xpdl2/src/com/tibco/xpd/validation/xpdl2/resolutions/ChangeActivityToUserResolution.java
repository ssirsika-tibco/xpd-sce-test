 ...
 * @author nwilson
 */
public class ChangeActivityToUserResolution implements IResolution {

    /** Command id. */
    private static final String COMMAND = "changeActivityToUserCommand"; //$NON-NLS-1$
            ...
            if (resource != null) {
                ...
                if (target instanceof Activity) {
                    ...
                    if (user == null) {
                        ...
                        user = Xpdl2Factory.eINSTANCE.createTaskUser();
                        EStructuralFeature feature =
                            Xpdl2Package.eINSTANCE
                                    .getTask_TaskUser();
