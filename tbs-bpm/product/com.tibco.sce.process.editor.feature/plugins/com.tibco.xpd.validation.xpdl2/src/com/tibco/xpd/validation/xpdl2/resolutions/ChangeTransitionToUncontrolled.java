 ...
 * @author nwilson
 */
public class ChangeTransitionToUncontrolled extends AbstractWorkingCopyResolution {
    /** Remove activity command name. */
    private static final String COMMAND = "changeTransitionToUncontrolledCommand"; //$NON-NLS-1$
    ...
    protected Command getResolutionCommand(EditingDomain ed, EObject target, IMarker marker)
        ...
        if (target instanceof Transition) {
            ...
            command.append(SetCommand.create(ed, transition,
