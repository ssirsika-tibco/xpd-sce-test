 ...
 * @generated
 */
public class FormImplementationItemProvider extends ItemProviderAdapter
    ...
    protected void addFormTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getResourceLocator(),
                getString("_UI_FormImplementation_formType_feature"), //$NON-NLS-1$
                getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                        "_UI_FormImplementation_formType_feature", //$NON-NLS-1$
                        "_UI_FormImplementation_type"), //$NON-NLS-1$
                XpdExtensionPackage.Literals.FORM_IMPLEMENTATION__FORM_TYPE,
                true,
                false,
                false,
    ...
    protected void addFormURIPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(),
                getResourceLocator(),
                getString("_UI_FormImplementation_formURI_feature"), //$NON-NLS-1$
                getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                        "_UI_FormImplementation_formURI_feature", //$NON-NLS-1$
                        "_UI_FormImplementation_type"), //$NON-NLS-1$
                XpdExtensionPackage.Literals.FORM_IMPLEMENTATION__FORM_URI,
                true,
                false,
                false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Object getImage(Object object) {
        return overlayImage(object,
                getResourceLocator().getImage("full/obj16/FormImplementation")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        FormImplementationType labelValue =
                ((FormImplementation) object).getFormType();
        String label = labelValue == null ? null : labelValue.toString();
        return label == null || label.length() == 0
                ? getString("_UI_FormImplementation_type") //$NON-NLS-1$
