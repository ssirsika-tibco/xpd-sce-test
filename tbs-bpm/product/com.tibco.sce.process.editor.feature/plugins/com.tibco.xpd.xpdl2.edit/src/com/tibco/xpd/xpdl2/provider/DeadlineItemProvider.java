...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdl2.Deadline} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeadlineItemProvider extends ItemProviderAdapter implements
    ...
    public String getText(Object object) {
        ExecutionType labelValue = ((Deadline) object).getExecution();
        String label = labelValue == null ? null : labelValue.toString();
        return label == null || label.length() == 0 ? getString("_UI_Deadline_type") : //$NON-NLS-1$
                getString("_UI_Deadline_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
