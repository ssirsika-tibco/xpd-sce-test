 ...
 * @generated
 */
public class TriggerConditionalImpl extends EObjectImpl implements
        TriggerConditional {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    public void setConditionName(String newConditionName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Xpdl2Package.TRIGGER_CONDITIONAL__CONDITION_NAME,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification =
                    new ENotificationImpl(this, Notification.SET,
                            Xpdl2Package.TRIGGER_CONDITIONAL__EXPRESSION,
