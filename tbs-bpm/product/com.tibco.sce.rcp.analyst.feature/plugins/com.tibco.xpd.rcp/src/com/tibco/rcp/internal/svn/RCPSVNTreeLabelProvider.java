...
/**
 * 
 * copy of org.eclipse.ui.model.WorkbenchLabelProvider as I needed to override
 * getImage(Object) method
 * 
 * @author kupadhya
 * @since 12 Dec 2012
 */
public class RCPSVNTreeLabelProvider extends LabelProvider implements
    ...
    public static ILabelProvider getDecoratingWorkbenchLabelProvider() {
        return new DecoratingLabelProvider(new RCPSVNTreeLabelProvider(),
     ...
     */
    public RCPSVNTreeLabelProvider() {
        PlatformUI.getWorkbench().getEditorRegistry()
                .addPropertyListener(editorRegistryListener);
    ...
    protected final IWorkbenchAdapter2 getAdapter2(Object o) {
        return (IWorkbenchAdapter2) Adapters.adapt(o, IWorkbenchAdapter2.class);
    }
    ...
    public final Image getImage(Object element) {
        ...
        // this slows down the response time in the tree
        // if (element instanceof ISVNRemoteFolder) {
        // boolean isProject =
        // SVNUtils.isXPDProjectPresent((ISVNRemoteFolder) element);
        // if (isProject) {
        // descriptor =
        // XpdResourcesPlugin
        // .getImageDescriptor("/icons/xpdProject.png");
        // }
        // }
        if (descriptor == null) {
    ...
    public Font getFont(Object element) {
        ...
        return (Font) resourceManager
                .get(FontDescriptor.createFrom(descriptor));
    }
