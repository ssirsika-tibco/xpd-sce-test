package com.tibco.xpd.rcp.splashHandlers;
...
public class ExtensibleSplashHandler extends AbstractSplashHandler {
    ...
    private final static String F_SPLASH_EXTENSION_ID =
            "com.tibco.xpd.rcp.splashExtension"; //$NON-NLS-1$
    ...
    private void configureUICompositeIconPanelBounds() {
        ...
        Point panelSize =
                fIconPanel.computeSize(SWT.DEFAULT, SWT.DEFAULT, true);

        int x_coord =
                getSplash().getSize().x - F_SPLASH_SCREEN_BEVEL - panelSize.x;
        int y_coord =
                getSplash().getSize().y - F_SPLASH_SCREEN_BEVEL - panelSize.y;
    ...
    private void loadSplashExtensions() {
        ...
        IExtension[] extensions =
                Platform.getExtensionRegistry()
                        .getExtensionPoint(F_SPLASH_EXTENSION_ID)
                        .getExtensions();
    ...
    private void processSplashElementIcon(
        ...
        String iconImageFilePath =
                configurationElement.getAttribute(F_ELEMENT_ICON);
