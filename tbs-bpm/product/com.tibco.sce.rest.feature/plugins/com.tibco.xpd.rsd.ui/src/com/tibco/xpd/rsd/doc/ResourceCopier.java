...
/**
 * Copy the resources, ie. stylesheet and images, for the exported REST
 * documentation
 * 
 * 
...
public class ResourceCopier implements ExportSubTask {
    ...
    public static final String REST_SERVICE_ICON = "Service.png"; //$NON-NLS-1$

    public static final String RSD_FILE_ICON = "RsdFile.png"; //$NON-NLS-1$
    ...
    private static class ResourceCopyFile {
        ...
        private CoreException generateCoreException(Throwable throwable) {
            return new CoreException(new Status(IStatus.ERROR,
                    RsdUIPlugin.PLUGIN_ID, IStatus.OK,
        ...
        private CoreException generateCoreException(String errMsg) {
            return new CoreException(new Status(IStatus.ERROR,
                    RsdUIPlugin.PLUGIN_ID, IStatus.OK, errMsg, null));
        }
    ...
    private static final ResourceCopyFile copyFiles[] =
            {
                    new ResourceCopyFile(
                            "/style/restdoc.css", "style/restdoc.css", false), //$NON-NLS-1$ //$NON-NLS-2$
                    new ResourceCopyFile(
                            "/style/printrestdoc.css", "style/printrestdoc.css", false), //$NON-NLS-1$ //$NON-NLS-2$
                    new ResourceCopyFile(
                            "/icons/full/obj16/" + REST_SERVICE_ICON, IMAGES_FOLDER + "/" + REST_SERVICE_ICON, true), //$NON-NLS-1$ //$NON-NLS-2$
                    new ResourceCopyFile(
                            "/icons/tick.gif", IMAGES_FOLDER + "/tick.gif", true), //$NON-NLS-1$ //$NON-NLS-2$
                    new ResourceCopyFile(
                            "/icons/" + RSD_FILE_ICON, IMAGES_FOLDER + "/" + RSD_FILE_ICON, true), //$NON-NLS-1$ //$NON-NLS-2$
            };
