 ...
 * @since 29 Oct 2013
 */
public class CaseRefLinkMethod extends AbstractJsMethod {
    ...
    public CaseRefLinkMethod(Class caseClass, Property property,
            String caseRefName) {
        ...
        this.comment =
                getLinkJavaDoc(caseClass, property, caseRefName, methodName);
    ...
    private String getLinkJavaDoc(Class caseClass, Property property,
        ...
        String comment =
                Messages.ScriptContentAssist_javadoc_comment_definition_and_usage
                        + Messages.GlobalDataGenerator_comment_ref_link_attribute_description
                        + "\n\n"
                        + Messages.ScriptContentAssist_javadoc_comment_syntax
                        + Messages.GlobalDataGenerator_comment_ref_link_attribute_syntax
                        + "\n\n"
                        + Messages.ScriptContentAssist_javadoc_comment_param
                        + Messages.GlobalDataGenerator_comment_ref_link_attribute_param
                        + "\n\n"
                        + Messages.ScriptContentAssist_javadoc_comment_return
                        + Messages.GlobalDataGenerator_comment_ref_link_attribute_return;
        comment =
