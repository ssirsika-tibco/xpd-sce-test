 ...
 * that takes DQL String criteria as an argument. This method returns list of
 ...
 * @since 7 Feb 2014
 */
public class CaseRefMultiValuedNavigateByCriteriaStringMethod extends
        AbstractJsMethod {
    ...
    public CaseRefMultiValuedNavigateByCriteriaStringMethod(Class caseClass,
        ...
        this.returnType =
                new CaseJsMethodParam(propUmlCaseRefJsClass.getType(), null,
                        propUmlCaseRefJsClass.getType(), true, true, 0, -1,
                        scriptRelevantData);
    }
    ...
    private String getJavaDoc(Property property, String caseRefName,
        ...
        String comment =
                Messages.ScriptContentAssist_javadoc_comment_definition_and_usage
                        + Messages.GlobalDataGenerator_comment_ref_multivalued_navigate_by_criteria_string_description
                        + "\n\n" //$NON-NLS-1$
                        ...
                        + Messages.GlobalDataGenerator_comment_ref_multivalued_navigate_by_criteria_string_return;
        comment =
