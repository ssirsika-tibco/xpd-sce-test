...
public class JavaScriptColorPreferences {
    ...
    private static final JavaScriptColorPreferences global =
            new JavaScriptColorPreferences();
    ...
    protected void loadColors() {
        ...
        TextAttribute ta =
                createTextAttribute(IStyleConstantsJavaScript.DEFAULT);
        if (ta != null)
            taDefault = ta;
    ...
    protected void handlePropertyChange(PropertyChangeEvent event) {
        if (event != null) {
            ...
            if (IStyleConstantsJavaScript.DEFAULT.equals(prefKey)) {
                ...
                taKeyword =
                        createTextAttribute(IStyleConstantsJavaScript.KEYWORD);
            } else if (IStyleConstantsJavaScript.LITERAL.equals(prefKey)) {
                taStringLit =
                        createTextAttribute(IStyleConstantsJavaScript.LITERAL);
            } else if (IStyleConstantsJavaScript.COMMENT.equals(prefKey)) {
                taComment =
                        createTextAttribute(IStyleConstantsJavaScript.COMMENT);
            } else if (IStyleConstantsJavaScript.UNFINISHED_COMMENT
                    .equals(prefKey)) {
                taUnfComment =
                        createTextAttribute(IStyleConstantsJavaScript.UNFINISHED_COMMENT);
            }
        }
    }
