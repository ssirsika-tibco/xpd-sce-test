...
public class JavaScriptSourcePreferencePage extends AbstractPreferencePage
    ...
    protected Control createContents(Composite parent) {
        ...
        PlatformUI.getWorkbench().getHelpSystem().setHelp(composite,
                IHelpContextIds.JS_PREFWEBX_SOURCE_HELPID);
    ...
    protected void performDefaultsForContentAssistGroup() {
        ...
        fAutoPropose.setSelection(getPreferenceStore()
                .getDefaultBoolean(JSCommonUIPreferenceNames.AUTO_PROPOSE));
        fAutoProposeText.setText(getPreferenceStore()
                .getDefaultString(JSCommonUIPreferenceNames.AUTO_PROPOSE_CODE));
    }
    ...
    protected void initializeValuesForContentAssistGroup() {
        // Content Assist
        fAutoPropose.setSelection(getPreferenceStore()
                .getBoolean(JSCommonUIPreferenceNames.AUTO_PROPOSE));
        fAutoProposeText.setText(getPreferenceStore()
                .getString(JSCommonUIPreferenceNames.AUTO_PROPOSE_CODE));
    }
    ...
    protected void storeValuesForContentAssistGroup() {
        // Content Assist
        getPreferenceStore().setValue(JSCommonUIPreferenceNames.AUTO_PROPOSE,
                fAutoPropose.getSelection());
        getPreferenceStore()
                .setValue(JSCommonUIPreferenceNames.AUTO_PROPOSE_CODE,
    ...
    protected void performDefaultsForFormattingGroup() {
        if (JSCommonUIPreferenceNames.TAB.equals(getPreferenceStore()
                .getDefaultString(JSCommonUIPreferenceNames.INDENTATION_CHAR))) {
        ...
        fIndentationSize.setSelection(getPreferenceStore()
                .getDefaultInt(JSCommonUIPreferenceNames.INDENTATION_SIZE));
    }

    protected void initializeValuesForFormattingGroup() {
        if (JSCommonUIPreferenceNames.TAB.equals(getPreferenceStore()
                .getString(JSCommonUIPreferenceNames.INDENTATION_CHAR))) {
            fIndentUsingTabs.setSelection(true);
            fIndentUsingSpaces.setSelection(false);
        } else {
            fIndentUsingSpaces.setSelection(true);
        ...
        fIndentationSize.setSelection(getPreferenceStore()
                .getInt(JSCommonUIPreferenceNames.INDENTATION_SIZE));
    }

    protected void storeValuesForFormattingGroup() {
        if (fIndentUsingTabs.getSelection()) {
            getPreferenceStore()
                    .setValue(JSCommonUIPreferenceNames.INDENTATION_CHAR,
                            JSCommonUIPreferenceNames.TAB);
        } else {
            getPreferenceStore()
                    .setValue(JSCommonUIPreferenceNames.INDENTATION_CHAR,
                            JSCommonUIPreferenceNames.SPACE);
        }
        getPreferenceStore()
                .setValue(JSCommonUIPreferenceNames.INDENTATION_SIZE,
