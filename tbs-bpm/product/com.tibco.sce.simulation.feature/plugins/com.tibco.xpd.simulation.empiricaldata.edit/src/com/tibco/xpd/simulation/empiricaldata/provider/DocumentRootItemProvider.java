...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.simulation.empiricaldata.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentRootItemProvider extends ItemProviderAdapter implements
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(EmpiricalDataPackage.Literals.DOCUMENT_ROOT__MIXED);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors,
		...
		newChildDescriptors
				.add(createChildParameter(
						EmpiricalDataPackage.Literals.DOCUMENT_ROOT__MIXED,
						FeatureMapUtil
								.createEntry(
				...
				.add(createChildParameter(
						...
						FeatureMapUtil
								.createEntry(
										...
										EmpiricalDataFactory.eINSTANCE
												.createEmpiricalData())));
	}
