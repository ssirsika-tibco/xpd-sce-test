...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.simulation.empiricaldata.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Parameter_name_feature", "_UI_Parameter_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						EmpiricalDataPackage.Literals.PARAMETER__NAME, true,
						false, false,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(EmpiricalDataPackage.Literals.PARAMETER__ENUMERATION);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors,
		...
		newChildDescriptors.add(createChildParameter(
				EmpiricalDataPackage.Literals.PARAMETER__ENUMERATION,
				EmpiricalDataFactory.eINSTANCE.createEnumeration()));
	}
