...
public class SelectImportTypePage extends AbstractXpdWizardPage implements ISelectionChangedListener {
    ...
    private EmpiricalDataWizard wizard;
    

    protected SelectImportTypePage(EmpiricalDataWizard wizard, String pageName) {
        super(pageName);
        this.wizard = wizard;
    }
    ...
    public void createControl(Composite parent) {
        ...
        importersLabel.setText(Messages.SelectImportTypePage_Importers);
