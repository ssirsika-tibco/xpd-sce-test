/* 
 ** 
 **  MODULE:             $RCSfile: IntEngRouteSimulationTest.java $ 
 **                      $Revision: 1.0 $ 
 **                      $Date: 2005-09-01 $ 
 ** 
 **  DESCRIPTION:           
...
public class IntEngRouteSimulationTest extends XpdlBaseTestCase {
    ...
    private static final String TEST_XPDL_FILE = "RootingActivityOnly.xpdl"; //$NON-NLS-1$
    private static final String OUT_FILE = "RootingActivityOnlyOut.xpdl"; //$NON-NLS-1$
    ...
    /*public void testIntEng() throws MalformedURLException {
        ...
        // repository.installDefaultApplications();
        try {
