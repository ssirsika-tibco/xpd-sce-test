...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add Current Resource To View Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.n2.brm.api.impl.AddCurrentResourceToViewTypeImpl#getWorkListViewID <em>Work List View ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AddCurrentResourceToViewTypeImpl extends EObjectImpl implements AddCurrentResourceToViewType {
    /**
     ...
     * @generated
     */
    protected AddCurrentResourceToViewTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return N2BRMPackage.Literals.ADD_CURRENT_RESOURCE_TO_VIEW_TYPE;
    }
    ...
    public void setWorkListViewID(long newWorkListViewID) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.ADD_CURRENT_RESOURCE_TO_VIEW_TYPE__WORK_LIST_VIEW_ID, oldWorkListViewID, workListViewID, !oldWorkListViewIDESet));
    }
    ...
    public void unsetWorkListViewID() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.ADD_CURRENT_RESOURCE_TO_VIEW_TYPE__WORK_LIST_VIEW_ID, oldWorkListViewID, WORK_LIST_VIEW_ID_EDEFAULT, oldWorkListViewIDESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case N2BRMPackage.ADD_CURRENT_RESOURCE_TO_VIEW_TYPE__WORK_LIST_VIEW_ID:
...
} //AddCurrentResourceToViewTypeImpl
