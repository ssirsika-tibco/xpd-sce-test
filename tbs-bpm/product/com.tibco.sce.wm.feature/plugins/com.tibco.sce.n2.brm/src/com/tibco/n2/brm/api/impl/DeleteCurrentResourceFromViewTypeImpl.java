...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Delete Current Resource From View Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.n2.brm.api.impl.DeleteCurrentResourceFromViewTypeImpl#getWorkListViewID <em>Work List View ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DeleteCurrentResourceFromViewTypeImpl extends EObjectImpl implements DeleteCurrentResourceFromViewType {
    /**
     ...
     * @generated
     */
    protected DeleteCurrentResourceFromViewTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return N2BRMPackage.Literals.DELETE_CURRENT_RESOURCE_FROM_VIEW_TYPE;
    }
    ...
    public void setWorkListViewID(long newWorkListViewID) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.DELETE_CURRENT_RESOURCE_FROM_VIEW_TYPE__WORK_LIST_VIEW_ID, oldWorkListViewID, workListViewID, !oldWorkListViewIDESet));
    }
    ...
    public void unsetWorkListViewID() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.DELETE_CURRENT_RESOURCE_FROM_VIEW_TYPE__WORK_LIST_VIEW_ID, oldWorkListViewID, WORK_LIST_VIEW_ID_EDEFAULT, oldWorkListViewIDESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case N2BRMPackage.DELETE_CURRENT_RESOURCE_FROM_VIEW_TYPE__WORK_LIST_VIEW_ID:
...
} //DeleteCurrentResourceFromViewTypeImpl
