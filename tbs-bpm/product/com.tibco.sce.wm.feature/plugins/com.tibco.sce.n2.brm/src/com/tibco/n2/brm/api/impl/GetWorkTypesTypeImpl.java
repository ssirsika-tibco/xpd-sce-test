...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Work Types Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkTypesTypeImpl#getStartPosition <em>Start Position</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkTypesTypeImpl#getNumberOfItems <em>Number Of Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GetWorkTypesTypeImpl extends EObjectImpl implements GetWorkTypesType {
    /**
     ...
     * @generated
     */
    protected GetWorkTypesTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return N2BRMPackage.Literals.GET_WORK_TYPES_TYPE;
    }
    ...
    public void setStartPosition(long newStartPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_TYPES_TYPE__START_POSITION, oldStartPosition, startPosition, !oldStartPositionESet));
    }
    ...
    public void unsetStartPosition() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_WORK_TYPES_TYPE__START_POSITION, oldStartPosition, START_POSITION_EDEFAULT, oldStartPositionESet));
    }
    ...
    public void setNumberOfItems(long newNumberOfItems) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_TYPES_TYPE__NUMBER_OF_ITEMS, oldNumberOfItems, numberOfItems, !oldNumberOfItemsESet));
    }
    ...
    public void unsetNumberOfItems() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_WORK_TYPES_TYPE__NUMBER_OF_ITEMS, oldNumberOfItems, NUMBER_OF_ITEMS_EDEFAULT, oldNumberOfItemsESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case N2BRMPackage.GET_WORK_TYPES_TYPE__START_POSITION:
                return getStartPosition();
            case N2BRMPackage.GET_WORK_TYPES_TYPE__NUMBER_OF_ITEMS:
