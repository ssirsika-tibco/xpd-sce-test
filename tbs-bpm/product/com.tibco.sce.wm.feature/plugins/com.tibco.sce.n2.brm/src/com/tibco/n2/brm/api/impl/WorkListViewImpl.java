...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Work List View</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.n2.brm.api.impl.WorkListViewImpl#getCreationDate <em>Creation Date</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.WorkListViewImpl#getLocker <em>Locker</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.WorkListViewImpl#getModificationDate <em>Modification Date</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.WorkListViewImpl#getWorkViewID <em>Work View ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WorkListViewImpl extends WorkListViewEditImpl implements WorkListView {
    /**
    ...
    /**
     * The default value of the '{@link #getLocker() <em>Locker</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getLocker()
     * @generated
     * @ordered
     */
    protected static final String LOCKER_EDEFAULT = null;

    /**
     * The cached value of the '{@link #getLocker() <em>Locker</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #getLocker()
     * @generated
     * @ordered
     */
    protected String locker = LOCKER_EDEFAULT;
    ...
    protected EClass eStaticClass() {
        return N2BRMPackage.Literals.WORK_LIST_VIEW;
    }
    ...
    public void setCreationDate(XMLGregorianCalendar newCreationDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.WORK_LIST_VIEW__CREATION_DATE, oldCreationDate, creationDate));
    }
     ...
     * @generated
     */
    public void setLocker(String newLocker) {
        String oldLocker = locker;
        locker = newLocker;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.WORK_LIST_VIEW__LOCKER, oldLocker, locker));
    }
    ...
    public void setModificationDate(XMLGregorianCalendar newModificationDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.WORK_LIST_VIEW__MODIFICATION_DATE, oldModificationDate, modificationDate));
    }
    ...
    public void setWorkViewID(long newWorkViewID) {
        ...
        workViewIDESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.WORK_LIST_VIEW__WORK_VIEW_ID, oldWorkViewID, workViewID, !oldWorkViewIDESet));
    }
    ...
    public void unsetWorkViewID() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.WORK_LIST_VIEW__WORK_VIEW_ID, oldWorkViewID, WORK_VIEW_ID_EDEFAULT, oldWorkViewIDESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case N2BRMPackage.WORK_LIST_VIEW__CREATION_DATE:
                return getCreationDate();
            case N2BRMPackage.WORK_LIST_VIEW__LOCKER:
                return getLocker();
            case N2BRMPackage.WORK_LIST_VIEW__MODIFICATION_DATE:
                return getModificationDate();
            case N2BRMPackage.WORK_LIST_VIEW__WORK_VIEW_ID:
    ...
    public boolean eIsSet(int featureID) {
        switch (featureID) {
            ...
            case N2BRMPackage.WORK_LIST_VIEW__LOCKER:
                return LOCKER_EDEFAULT == null ? locker != null : !LOCKER_EDEFAULT.equals(locker);
            case N2BRMPackage.WORK_LIST_VIEW__MODIFICATION_DATE:
