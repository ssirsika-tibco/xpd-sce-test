...
/**
 * Resolution to select case class type for the case service
 * 
 * @author Ali
 * @since 13 Aug 2014
 */
public class SelectCaseClassTypeResolution extends
    ...
    protected Command getResolutionCommand(EditingDomain editingDomain,
        ...
        if (target instanceof Process) {
            ...
            if (process != null) {
                ...
                if (caseService == null) {
                    /*
                     * create new case service if it doesn't exist and to the
                     * process
                     */
                ...
                ExternalReference externalRef =
                        getCaseClassCaseRef(WorkingCopyUtil
                                .getProjectFor(process));

                if (externalRef != null) {

                    EObject eo =
                            ProcessUIUtil.getReferencedClassifier(externalRef,
                    ...
                    /*
                     * If no param exist then create one for the case service of
                     * type case class ref
                     */
                    if (process.getFormalParameters().isEmpty()
                        ...
                        member.setExternalReference(EcoreUtil.copy(externalRef));
                        caseRefType.getMember().add(member);
                        param.setDataType(caseRefType);

                        cmpCmd.append(AddCommand
    ...
    /**
     * Returns the selected case class case external ref.
     * 
     * @param project
     * @return caseRefType
     */
    private ExternalReference getCaseClassCaseRef(IProject project) {
