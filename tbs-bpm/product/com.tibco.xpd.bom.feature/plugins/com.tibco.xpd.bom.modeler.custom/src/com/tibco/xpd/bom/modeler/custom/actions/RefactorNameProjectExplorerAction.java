 ...
 * 
 */
public class RefactorNameProjectExplorerAction implements IObjectActionDelegate {

    private Shell shell;

    private EObject element;

    public RefactorNameProjectExplorerAction() {
    }
    ...
    public void selectionChanged(IAction action, ISelection selection) {
        ...
        if (selection instanceof IStructuredSelection) {
            ...
            if (sSel.size() == 1 && sSel.getFirstElement() instanceof EObject) {
                element = (EObject) sSel.getFirstElement();
                enabled = true;
            }
        }
