 ...
 */
package com.tibco.xpd.bom.modeler.custom.navigator;
...
/**
 * Link helper to link the BOM (sub)Package editor with the project explorer.
 * 
 * @author njpatel
 * 
 */
public class SubPackageEditorLinkHelper extends
    ...
    protected boolean isChild(Object selObject, Object mainSelection) {
        if (selObject != mainSelection) {
            if (selObject instanceof Model && mainSelection instanceof IFile) {
                return true;
            }

            if (selObject instanceof EObject
                    && mainSelection instanceof EObject) {
                if (mainSelection == ((EObject) selObject).eContainer()) {
                    return true;
                }
    ...
    public void activateEditor(IWorkbenchPage page,
        ...
        if (element instanceof NamedElement) {
            ...
            while (eo != null && !(eo instanceof Package)) {
                eo = eo.eContainer();
            }
            element = eo;
        }
