 ...
 * @generated
 */
public class AssociationClassConnectorReorientCommand extends
        EditElementCommand {
     ...
     * @generated
     */
    public AssociationClassConnectorReorientCommand(
    ...
    protected boolean canReorientSource() {
        ...
        CollaborationUse target = (CollaborationUse) getLink()
                .getCollaborationUses().get(0);
        ...
        return UMLBaseItemSemanticEditPolicy.LinkConstraints
                .canExistAssociationClass_3004(container, getNewSource(),
                        target);
    }
    ...
    protected boolean canReorientTarget() {
        ...
        CollaborationUse source = (CollaborationUse) getLink()
                .getCollaborationUses().get(0);
        if (!(getLink().eContainer() instanceof Package)) {
            return false;
        }
        Package container = (Package) getLink().eContainer();
        return UMLBaseItemSemanticEditPolicy.LinkConstraints
                .canExistAssociationClass_3004(container, source,
                        getNewTarget());
    }
