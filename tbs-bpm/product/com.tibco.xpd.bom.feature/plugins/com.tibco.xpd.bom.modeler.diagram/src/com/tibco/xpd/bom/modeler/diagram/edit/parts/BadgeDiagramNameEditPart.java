...
/**
 * 
 * EditPart for the Diagram name label on the sub-diagram badge.
 * 
 ...
 * 
 */
public class BadgeDiagramNameEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {

    /**
     * @generated
     */
    public static final int VISUAL_ID = 9500;
     ...
     * @generated
     */
    public BadgeDiagramNameEditPart(View view) {
        super(view);
    }
    ...
    protected Image getLabelIcon() {
        ...
        if (parserElement == null || parserElement instanceof Model) {
            return null;
        }
        // Don't display an icon for now
        return null;
    ...
    protected void refreshFont() {
        ...
        // Make sure we get the style from the labels view NOT the container
        View notationView = getNotationView();

        FontStyle style =
                (FontStyle) notationView.getStyle(NotationPackage.eINSTANCE
                        .getFontStyle());
