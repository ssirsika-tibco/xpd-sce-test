...
import com.tibco.xpd.bom.modeler.diagram.edit.policies.EnumerationLiteralItemSemanticEditPolicy;
...
public class EnumerationLiteralEditPart extends
        BOMStereoAwareCompartmentEditPart implements ITextAwareEditPart,
        BOMReferenceAware {
    ...
    protected IFigure createFigurePrim() {
        return new EnumerationLiteralLabelFigure();
    }

    /**
     * @generated
     */
    public class EnumerationLiteralLabelFigure extends WrappingLabel {

        /**
         * @generated
         */
        private WrappingLabel fFigureEnumerationLiteralLabel;

        /**
         * @generated
         */
        public EnumerationLiteralLabelFigure() {
            this.setText("<enum literal>");
        }

        /**
         * @generated
         */
        public WrappingLabel getFigureEnumerationLiteralLabel() {
            return fFigureEnumerationLiteralLabel;
        }
     ...
     * and then if we drag-drop an Enumeration literal from the Palette to a
     * class in that model, we get an illegal argument exception stating: "An
     * EditPart has to be selectable (isSelectable() == true) in order to get
     * selected". That's why we are overriding isSelectable() in order to avoid
     * that exception.
     * 
     */
    @Override
    ...
    public EditPart getTargetEditPart(Request request) {
        ...
        // marquee select and if they are we do not want to select literals
        // within the enum, this is because if we have literals and enums
