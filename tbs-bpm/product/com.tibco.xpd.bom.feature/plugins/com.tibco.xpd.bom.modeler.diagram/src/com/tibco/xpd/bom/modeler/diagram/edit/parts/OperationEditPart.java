...
import com.tibco.xpd.bom.modeler.diagram.edit.policies.OperationItemSemanticEditPolicy;
...
public class OperationEditPart extends BOMStereoAwareCompartmentEditPart
        ...
        if (parser == null) {
            ...
            IAdaptable hintAdapter =
                    new UMLParserProvider.HintAdapter(
                            UMLElementTypes.Operation_2002, getParserElement(),
                            parserHint);
    ...
    protected IFigure createFigurePrim() {
        return new OperationLabelFigure();
    }

    /**
     * @generated
     */
    public class OperationLabelFigure extends WrappingLabel {

        /**
         * @generated
         */
        private WrappingLabel fFigureOperationLabel;

        /**
         * @generated NOT
         */
        public OperationLabelFigure() {
            this.setText(Messages.OperationEditPart_operation_figure_label);
        }

        /**
         * @generated
         */
        public WrappingLabel getFigureOperationLabel() {
            return fFigureOperationLabel;
        }
     ...
     * and then if we drag-drop an Operation from the Palette to a class in that
