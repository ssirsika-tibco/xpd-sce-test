 ...
 */
package com.tibco.xpd.bom.modeler.diagram.expressions;
...
public abstract class UMLAbstractExpression {
    ...
    private static final boolean DISABLED_NO_IMPL_EXCEPTION_LOG = Boolean
            .valueOf(
                    Platform.getDebugOption(BOMDiagramEditorPlugin
                            .getInstance().getBundle().getSymbolicName()
                            + "/debug/disableNoExprImplExceptionLog")) //$NON-NLS-1$
            .booleanValue();
    /**
     * @generated
     */
    ...
    protected void setStatus(int severity, String message, Throwable throwable) {
        String pluginID = BOMDiagramEditorPlugin.ID;
