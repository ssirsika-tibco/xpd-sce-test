 ...
 * @generated
 */
public class BOMDiagramEditorPlugin extends AbstractUIPlugin {
     ...
     * @generated
     */
    public static final String ID = "com.tibco.xpd.bom.modeler.diagram"; //$NON-NLS-1$
     ...
     * @generated
     */
    private static BOMDiagramEditorPlugin instance;
     ...
     * @generated
     */
    public static BOMDiagramEditorPlugin getInstance() {
        return instance;
    }
    ...
    protected ComposedAdapterFactory createAdapterFactory() {
        // TODO WZ: this is temporary solution, it should be moved to the
        // template
        AdapterFactoryEditingDomain ed =
                (AdapterFactoryEditingDomain) TransactionalEditingDomain.Registry.INSTANCE
                        .getEditingDomain(XpdConsts.EDITING_DOMAIN_ID);
        return (ComposedAdapterFactory) ed.getAdapterFactory();
    }
    ...
    public void logError(String error, Throwable throwable) {
        ...
        getLog().log(new Status(IStatus.ERROR, BOMDiagramEditorPlugin.ID,
    ...
    public void logInfo(String message, Throwable throwable) {
        ...
        getLog().log(new Status(IStatus.INFO, BOMDiagramEditorPlugin.ID,
