...
/**
 * Resolution to re-enable process flow analyzer validation for an individual
 * process once it has been supressed.
 * 
 * @author aallway
 * @since 25 May 2013
 */
public class EnableProcessFlowValidationResolution extends
