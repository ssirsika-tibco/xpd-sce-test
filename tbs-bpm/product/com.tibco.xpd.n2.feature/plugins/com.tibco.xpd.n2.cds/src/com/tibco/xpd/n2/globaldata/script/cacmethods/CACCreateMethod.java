...
/**
 * class that creates 'create' method that takes case class as argument and
 * returns case ref. also provides java doc for this method in the content
 * assist
 * 
 * @author bharge
 * @since 29 Oct 2013
 */
public class CACCreateMethod extends AbstractJsMethod {
     ...
     * @param cacName
     */
    public CACCreateMethod(CaseRefJsClass caseRefJsClass, String cacName) {
        ...
        this.comment =
                getCreateJavaDocComment(caseRefJsClass, cacName, caseClass);
        this.returnType =
     ...
     * @return String
     */
    private String getCreateJavaDocComment(CaseRefJsClass caseRefJsClass,
        ...
        String createJavaDocComment =
                Messages.ScriptContentAssist_javadoc_comment_definition_and_usage
                        + Messages.GlobalDataGenerator_comment_cac_create_description
                        + "\n\n"
                        + Messages.ScriptContentAssist_javadoc_comment_syntax
                        + Messages.GlobalDataGenerator_comment_cac_create_syntax
                        + "\n\n"
                        + Messages.ScriptContentAssist_javadoc_comment_param
                        + Messages.GlobalDataGenerator_comment_cac_create_param
                        + "\n\n"
                        + Messages.ScriptContentAssist_javadoc_comment_return
                        + Messages.GlobalDataGenerator_comment_cac_create_return;
        createJavaDocComment =
                String.format(createJavaDocComment, cacName + "." + CREATE, //$NON-NLS-1$
                        caseClass.getName(),
