...
/**
 * The class that creates 'findByCriteria' method that takes a Criteria and
 * returns PaginatedList of Case Refs. This class also provides java doc for
 * this method in the content assist
 * 
 * @author aprasad
 * @since 31 Oct 2013
 */
public class CACFindByCriteriaMethod extends AbstractJsMethod {
     ...
     * @param cacName
     */
    public CACFindByCriteriaMethod(CaseRefJsClass caseRefJsClass, String cacName) {
     ...
     * @return
     */
    protected List<JsMethodParam> getInputParam(Class caseClass) {

        List<JsMethodParam> inParam = new ArrayList<JsMethodParam>();
        CaseClassCriteriaJsMethodParam baseJsMethodParam =
                new CaseClassCriteriaJsMethodParam(JsConsts.CRITERIA, null,
                        JsConsts.CRITERIA, false, false, 1, 1, caseClass);
     ...
     */
    protected String getFindByCriteriaJavaDoc(CaseRefJsClass caseRefJsClass,
        ...
        comment =
                Messages.ScriptContentAssist_javadoc_comment_definition_and_usage
                        ...
                        + Messages.GlobalDataGenerator_comment_cac_find_by_criteria_param
                        + "\n\n"
