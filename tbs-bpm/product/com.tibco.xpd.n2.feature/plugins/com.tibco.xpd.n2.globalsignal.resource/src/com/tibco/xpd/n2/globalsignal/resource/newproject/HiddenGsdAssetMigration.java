...
/**
 * Asset migration for the hidden global signal asset (which marks a project as being for case data etc).
 * 
 ...
 * @since 17 Jul 2020
 */
public class HiddenGsdAssetMigration implements IProjectAssetMigration, IProjectAssetVersionProvider {

    /**
     * 
     */
    public HiddenGsdAssetMigration() {
