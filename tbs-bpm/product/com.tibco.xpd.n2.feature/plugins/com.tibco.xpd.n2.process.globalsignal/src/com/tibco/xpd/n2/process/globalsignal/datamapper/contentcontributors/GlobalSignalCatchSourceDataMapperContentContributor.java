...
/**
 * Source Content Contributor for Global Signal Catch.
 * 
 * @author sajain
 * @since Apr 27, 2016
 */
public class GlobalSignalCatchSourceDataMapperContentContributor extends
        AbstractProcessDataMapperContentContributor {

    /**
     * @param direction
     */
    public GlobalSignalCatchSourceDataMapperContentContributor() {
    }
    ...
    protected ITreeContentProvider createItemProvider() {
        return new PayloadDataMapperContentProvider(false, MappingDirection.OUT);
    }
