...
/**
 * Script Tool Factory for Catch Global Signal Mapped Events.
 * 
 * @author ssirsika
 * @since 02-May-2016
 */
public class CatchGlobalSignalMappedScriptToolFactory extends
        ...
        if (mapping != null) {
            if (ProcessScriptUtil
                    .isScriptInformationWithScriptType(ProcessScriptUtil
                            ...
                            getScriptGrammar())) {
                return new CatchGlobalSignalMappedScriptTool(mapping);
            }
        }
        return null;
    }
    ...
    public Class<? extends IPreProcessor> getToolClass() {
        return CatchGlobalSignalMappedScriptTool.class;
    }
