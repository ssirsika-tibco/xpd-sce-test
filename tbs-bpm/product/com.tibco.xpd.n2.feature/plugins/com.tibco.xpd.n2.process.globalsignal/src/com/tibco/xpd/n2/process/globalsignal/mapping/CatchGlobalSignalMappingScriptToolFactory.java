...
/**
 * Script Tool Factor for Catch Global Signal Events.
 * 
 * @author kthombar
 * @since Feb 12, 2015
 */
public class CatchGlobalSignalMappingScriptToolFactory extends
        ...
        if (scriptInformation != null) {
            if (ProcessScriptUtil
                    .isScriptInformationWithScriptType(scriptInformation,
                            getScriptGrammar())) {
                return new CatchGlobalSignalMappingScriptTool(scriptInformation);
            }
        }
        return null;
    }
    ...
    public Class<? extends IPreProcessor> getToolClass() {
        return CatchGlobalSignalMappingScriptTool.class;
    }
