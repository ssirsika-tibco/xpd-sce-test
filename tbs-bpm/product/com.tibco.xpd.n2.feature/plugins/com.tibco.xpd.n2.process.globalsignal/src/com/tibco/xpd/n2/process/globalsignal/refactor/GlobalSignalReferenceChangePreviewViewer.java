...
/**
 * Viewer to show Activity to Global Signal references.
 * 
 * @author sajain
 * @since May 21, 2015
 */
public class GlobalSignalReferenceChangePreviewViewer extends
    ...
    public void setInput(ChangePreviewViewerInput input) {
        ...
        if (input != null && getViewer() != null
            ...
            if (change instanceof GlobalSignalReferenceChange) {

                GlobalSignalReferenceChange refactorChange =
                        (GlobalSignalReferenceChange) change;
