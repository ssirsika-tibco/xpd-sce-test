...
/**
 * Viewer to show GSD reference changes in scripts.
 * 
 * @author sajain
 * @since May 14, 2015
 */
public class ScriptGSDReferenceChangePreviewViewer extends
    ...
    public void setInput(ChangePreviewViewerInput input) {
        ...
        if (input != null && getViewer() != null
            ...
            if (change instanceof AbstractScriptGSDReferenceChange) {

                AbstractScriptGSDReferenceChange refactorChange =
                        (AbstractScriptGSDReferenceChange) change;
