...
public class RESTServiceFactory {
    /*
     * Sid ACE-194: Currently we do not support 'Publish as REST service' for
     * individual activities. Something rather than deleting as we may want to
     * introduce something similar later.
     */
    //
    ...
    // * @param activity
    // *
    // * @return restService or <code>null</code> if the REST service couldn't
    // be
    // * generated.
    // */
    ...
    // * {@link RESTServiceParamsData} and returns the '__PROCESS_ID__' which
    // will
    ...
    // * @return the created subProcActivity or <code>null</code> if the
    // activity
    ...
    // * @param activity
    // *
    // * @return list of parameters or <code>null</code> if parameters couldn't
    // be
    // * created
    // */
    ...
    // *
    // * @return serviceTaskActivity or <code>null</code> if the activity
    // couldn't
    // * be generated
    // */
    ...
    // * @param participantId
    // *
    // * @return sendTaskActivity or <code>null</code> if the activity couldn't
    // be
    // * generated
    // *
    // */
