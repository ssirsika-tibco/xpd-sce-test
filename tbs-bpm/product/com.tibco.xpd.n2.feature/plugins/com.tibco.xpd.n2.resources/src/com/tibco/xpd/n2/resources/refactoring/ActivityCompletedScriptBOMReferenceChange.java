 ...
 *
 */
public class ActivityCompletedScriptBOMReferenceChange extends ScriptBOMReferenceChange {

    private Activity activity = null;
    
    public ActivityCompletedScriptBOMReferenceChange(String oldScript, RenameArguments args,
     ...
     */
    public ActivityCompletedScriptBOMReferenceChange(String oldScript,
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetCompletedScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptName() {
        return Messages.ActivityCompletedScriptBOMReferenceChange_Completed;
    } 
}
