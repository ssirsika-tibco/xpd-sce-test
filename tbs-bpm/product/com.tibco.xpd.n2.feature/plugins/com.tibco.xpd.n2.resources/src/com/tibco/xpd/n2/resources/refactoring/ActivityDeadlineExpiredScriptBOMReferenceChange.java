 ...
 *
 */
public class ActivityDeadlineExpiredScriptBOMReferenceChange extends ScriptBOMReferenceChange {

    private Activity activity = null;
    
    public ActivityDeadlineExpiredScriptBOMReferenceChange(String oldScript, RenameArguments args,
     ...
     */
    public ActivityDeadlineExpiredScriptBOMReferenceChange(String oldScript,
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetDeadlineExpiredScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptName() {
        return Messages.ActivityDeadlineExpiredScriptBOMReferenceChange_DeadlineExpired;
    } 
