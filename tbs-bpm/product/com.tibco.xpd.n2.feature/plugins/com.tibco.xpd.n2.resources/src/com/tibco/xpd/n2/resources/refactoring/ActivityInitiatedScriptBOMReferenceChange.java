 ...
 *
 */
public class ActivityInitiatedScriptBOMReferenceChange extends ScriptBOMReferenceChange {

    private Activity activity = null;
    
    public ActivityInitiatedScriptBOMReferenceChange(String oldScript, RenameArguments args,
     ...
     */
    public ActivityInitiatedScriptBOMReferenceChange(String oldScript,
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetInitiatedScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptName() {
        return Messages.ActivityInitiatedScriptBOMReferenceChange_Initiated;
    } 
