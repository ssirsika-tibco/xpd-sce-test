 ...
 *
 */
public class ActivityMIAdditionalLoopScriptBOMReferenceChange extends ScriptBOMReferenceChange {

    private Activity activity = null;
    
    public ActivityMIAdditionalLoopScriptBOMReferenceChange(String oldScript, RenameArguments args,
     ...
     */
    public ActivityMIAdditionalLoopScriptBOMReferenceChange(String oldScript,
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetMIAdditionalInstancesExprScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptType() {
        return ProcessScriptContextConstants.MI_ADDITIONAL_INSTANCES_LOOP_EXPR;
    }
    
    @Override
    protected String getScriptName() {
        return Messages.ActivityMIAdditionalLoopScriptBOMReferenceChange_MIAdditionalloop;
    } 
