 ...
 *
 */
public class ActivityMILoopScriptBOMReferenceChange extends ScriptBOMReferenceChange {

    private Activity activity = null;
    
    public ActivityMILoopScriptBOMReferenceChange(String oldScript, RenameArguments args,
     ...
     */
    public ActivityMILoopScriptBOMReferenceChange(String oldScript,
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetMILoopExprScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptType() {
        return ProcessScriptContextConstants.MI_LOOP_EXPR;
    }
    
    @Override
    protected String getScriptName() {
        return Messages.ActivityMILoopScriptBOMReferenceChange_MILoopScrit;
    } 
}
