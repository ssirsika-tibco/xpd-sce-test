 ...
 * 
 */
public class ScriptBOMReferenceChangePreviewViewer extends AbstractReferenceChangePreviewViewer {
    ...
    public void setInput(ChangePreviewViewerInput input) {
        if (input != null && getViewer() != null
            ...
            if (change instanceof ScriptBOMReferenceChange) {
                ScriptBOMReferenceChange refactorChange = (ScriptBOMReferenceChange) change;
