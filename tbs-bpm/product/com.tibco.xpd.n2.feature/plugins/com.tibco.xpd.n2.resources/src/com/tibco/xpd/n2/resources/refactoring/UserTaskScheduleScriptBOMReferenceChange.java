 ...
 *
 */
public class UserTaskScheduleScriptBOMReferenceChange extends ScriptBOMReferenceChange {

    private Activity activity = null;
    
    public UserTaskScheduleScriptBOMReferenceChange(String oldScript, RenameArguments args,
     ...
     */
    public UserTaskScheduleScriptBOMReferenceChange(String oldScript,
    ...
    protected Command getRefactorCommand() {
        return ProcessScriptUtil
                .getSetUserTaskScheduleScriptCommand(getEditingDomain(),
                        getNewScript(),
                        activity,
                        getScriptGrammar());
    }
    ...
    protected String getScriptName() {
        return Messages.UserTaskScheduleScriptBOMReferenceChange_ScheduleScript;
    }
}
