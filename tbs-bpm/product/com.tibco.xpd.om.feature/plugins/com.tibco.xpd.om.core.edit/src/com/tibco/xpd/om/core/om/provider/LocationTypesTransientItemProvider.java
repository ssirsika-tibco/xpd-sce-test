...
/**
 * Transient group object grouping OM's location types elements.
 * 
 * <p>
 ...
 */
public class LocationTypesTransientItemProvider extends TransientItemProvider {
     ...
     */
    public LocationTypesTransientItemProvider(AdapterFactory adapterFactory,
            EObject object) {
    ...
    protected Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures
                    .add(OMPackage.Literals.ORG_META_MODEL__LOCATION_TYPES);
        }
    ...
    public String getText(Object object) {
        return getString("_UI_LocationTypesGroup_type"); //$NON-NLS-1$
    }
    ...
    public Object getImage(Object object) {
        ...
        return overlayImage(object, getResourceLocator().getImage(
                "full/obj16/LocationTypesGroup")); //$NON-NLS-1$ 
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        locationType.setDisplayName(OMUtil.getDefaultName(
                getString("_UI_DefaultName_LocationType_label"), //$NON-NLS-1$
