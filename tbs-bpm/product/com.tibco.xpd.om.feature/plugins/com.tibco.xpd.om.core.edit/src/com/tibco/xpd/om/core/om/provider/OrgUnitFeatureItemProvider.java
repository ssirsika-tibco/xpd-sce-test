...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.om.core.om.OrgUnitFeature} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class OrgUnitFeatureItemProvider extends NamedElementItemProvider
     ...
     * @generated
     */
    public OrgUnitFeatureItemProvider(AdapterFactory adapterFactory) {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            // addContextRelationshipTypePropertyDescriptor(object);
        }
    ...
    protected void addFeatureTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_OrgUnitFeature_featureType_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_OrgUnitFeature_featureType_feature", "_UI_OrgUnitFeature_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        OMPackage.Literals.ORG_UNIT_FEATURE__FEATURE_TYPE,
                        true,
                        false,
                        true,
                        null,
    ...
    /**
     * This adds a property descriptor for the Context Relationship Type feature.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * @generated
     */
    protected void addContextRelationshipTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_OrgUnitFeature_contextRelationshipType_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_OrgUnitFeature_contextRelationshipType_feature", "_UI_OrgUnitFeature_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        OMPackage.Literals.ORG_UNIT_FEATURE__CONTEXT_RELATIONSHIP_TYPE,
                        true,
                        false,
                        true,
                        null,
    ...
    /**
     * This returns OrgUnitFeature.gif.
     * <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * @generated
     */
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator()
                .getImage("full/obj16/OrgUnitFeature")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_OrgUnitFeature_type") : //$NON-NLS-1$
                label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(OrgUnitFeature.class)) {
