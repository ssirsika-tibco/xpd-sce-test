...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.om.core.om.Privilege} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PrivilegeItemProvider extends QualifiedOrgElementItemProvider
    ...
    public Object getParent(Object object) {
        ...
        if (privilege.getCategory() != null) {
            return privilege.getCategory();
        }
    ...
    protected void addCategoryPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(new ItemPropertyDescriptor(
                        ...
                        getResourceLocator(),
                        getString("_UI_AbstractPrivilege_category_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_AbstractPrivilege_category_feature", "_UI_AbstractPrivilege_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        OMPackage.Literals.PRIVILEGE__CATEGORY, true, false,
                        true, null, null, null) {
                    /*
                     * (non-Javadoc)
                     * 
                    ...
                    public Collection<?> getChoiceOfValues(Object object) {
                        ...
                        for (TreeIterator<Object> allContents =
                                EcoreUtil.getAllContents(Collections
                                        .singletonList(((Privilege) object)
                                                .eContainer())); allContents
                                .hasNext();) {
                            (new OMSwitch<EObject>() {
                                @Override
                                public EObject casePrivilegeCategory(
                                        com.tibco.xpd.om.core.om.PrivilegeCategory object) {
                                    list.add(object);
                                    return object;
                                };
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            // childrenFeatures
            // .add(OMPackage.Literals.ABSTRACT_CAPABILITY__PARAMETER_FEATURE);
        }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator()
                .getImage("full/obj16/Privilege")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_Privilege_type") : //$NON-NLS-1$
                label;
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        // OMPackage.Literals.ABSTRACT_CAPABILITY__PARAMETER_FEATURE,
        // OMFactory.eINSTANCE.createParameterFeature()));
    }
