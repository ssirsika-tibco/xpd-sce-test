...
/**
 * Transient group object grouping OM's resource types elements.
 * 
 * <p>
 ...
 */
public class ResourceTypesTransientItemProvider extends TransientItemProvider {
     ...
     */
    public ResourceTypesTransientItemProvider(AdapterFactory adapterFactory,
            EObject object) {
    ...
    protected Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures
                    .add(OMPackage.Literals.ORG_META_MODEL__RESOURCE_TYPES);
        }
    ...
    public String getText(Object object) {
        return getString("_UI_ResourceTypesGroup_type"); //$NON-NLS-1$
    }
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage(
                "full/obj16/ResourceTypesGroup")); //$NON-NLS-1$ 
    }
    ...
    protected void collectNewChildDescriptors(
        ...
        resourceType.setDisplayName(OMUtil.getDefaultName(
                getString("_UI_DefaultName_ResourceType_label"), //$NON-NLS-1$
    ...
    protected Command createRemoveCommand(EditingDomain domain, EObject owner,
        ...
        // Cannot delete human resource type
        if (collection != null && !collection.isEmpty()) {
            for (Object obj : collection) {
                if (obj instanceof ResourceType
                        && ((ResourceType) obj).isHumanResourceType()) {
