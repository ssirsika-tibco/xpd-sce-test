...
public class OrgModelVersionParser implements ISemanticParser {
    ...
    public ICommand getParseCommand(IAdaptable element, String newString,
        ...
        if (obj instanceof OrgModel) {
            ...
            Command cmd = SetCommand.create(ed, om, OMPackage.eINSTANCE
                    .getBaseOrgModel_Version(), newString);
            CompositeCommand result = new CompositeCommand(
                    "Change version name"); //$NON-NLS-1$
    ...
    public String getPrintString(IAdaptable element, int flags) {
        String text = com.tibco.xpd.om.modeler.custom.internal.Messages.OrgModelVersionParser_VersionNotSet_label;
    ...
    public boolean isAffectingEvent(Object event, int flags) {
        if (event instanceof Notification) {
            ...
            if (n.getFeature() instanceof EAttribute) {
                ...
                return ea == OMPackage.Literals.BASE_ORG_MODEL__VERSION;
            }
        }
        return false;
    }
