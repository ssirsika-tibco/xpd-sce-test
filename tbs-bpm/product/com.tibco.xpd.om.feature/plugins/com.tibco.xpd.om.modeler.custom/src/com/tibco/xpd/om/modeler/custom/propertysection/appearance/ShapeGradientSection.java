 ...
 * 
 */
public class ShapeGradientSection extends AbstractAppearanceSection implements
        IFilter {
    ...
    protected Group createGradientGroup(Composite parent) {
        gradientGroup =
                getWidgetFactory().createGroup(parent,
                        Messages.ShapeGradientSection_Gradient_label);
    ...
    protected Composite createGradientControls(Composite parent) {
        ...
        gradStartColorButton.setImage(OMDiagramUIPropertiesImages
        ...
        gradEndColorButton.setImage(OMDiagramUIPropertiesImages
                .get(OMDiagramUIPropertiesImages.IMG_FILL_COLOR));
    ...
    public boolean select(Object toTest) {
        if (toTest instanceof OrgUnitCustomEditPart)
            return true;
