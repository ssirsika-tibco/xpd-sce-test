...
import com.tibco.xpd.om.modeler.diagram.edit.parts.OrganizationEditPart.OrganizationFigure;
 ...
 * @generated
 */
public class OrganizationTypeNameEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
     ...
     * @generated
     */
    public OrganizationTypeNameEditPart(View view) {
        super(view);
    }
            ...
            if (getParser() instanceof ISemanticParser) {
                ...
                if (modelParser.areSemanticElementsAffected(
                    ...
                    if (event.getFeature() == OMPackage.Literals.ORGANIZATION__ORGANIZATION_TYPE) {
                        ...
                        OrganizationFigure primaryShape = parentEP
                                .getPrimaryShape();
                        ...
                        if (primaryShape != null) {
                            ...
                            if (event.getEventType() == Notification.ADD) {
                                // rebuild with label
                                primaryShape.rebuildFigureWithTypeLabel(true);
                            } else if (event.getEventType() == Notification.SET) {
                                // rebuild without label
                                if (event.getNewValue() == null) {
                                    primaryShape
                                            .rebuildFigureWithTypeLabel(false);
                                } else {
                                    primaryShape
                                            .rebuildFigureWithTypeLabel(true);
                                }
                            } else if (event.getEventType() == Notification.REMOVE) {
                                // rebuild without label
                                primaryShape.rebuildFigureWithTypeLabel(false);
                            }
