 ...
 * @generated
 */
public class LabelAuthorBadgeEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {

    public static final String VISUAL_ID = "LabelAuthorBadgeEditPart"; //$NON-NLS-1$
     ...
     * @generated
     */
    public LabelAuthorBadgeEditPart(View view) {
        super(view);
    }
