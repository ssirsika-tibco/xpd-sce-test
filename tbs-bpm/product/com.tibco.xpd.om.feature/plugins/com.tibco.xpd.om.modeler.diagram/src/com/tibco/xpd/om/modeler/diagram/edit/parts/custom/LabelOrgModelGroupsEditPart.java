...
/**
 * 
 * Edit part for the display name label of the Groups figure.</br></br>
 * 
 * Note that the majority of this code is copied from a label editpart generated
 * from the original GMF code generation.
 * 
 * 
 * @author rgreen
 * 
 */
public class LabelOrgModelGroupsEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {

    public static final int VISUAL_ID = 4100; //$NON-NLS-1$
    ...
    public LabelOrgModelGroupsEditPart(View view) {
        super(view);
    }
