 ...
 * @generated
 */
public class LabelVersionBadgeEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {

    public static final String VISUAL_ID = "LabelVersionBadgeEditPart"; //$NON-NLS-1$
     ...
     * @generated
     */
    public LabelVersionBadgeEditPart(View view) {
        super(view);
    }
