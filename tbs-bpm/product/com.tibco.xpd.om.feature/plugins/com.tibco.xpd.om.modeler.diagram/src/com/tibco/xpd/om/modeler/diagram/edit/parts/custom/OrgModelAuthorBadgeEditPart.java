 ...
 * @generated
 */
public class OrgModelAuthorBadgeEditPart extends CompartmentEditPart
        implements ITextAwareEditPart {

    
    
    public static final String VISUAL_ID = "OrgModelAuthorBadgeEditPart"; //$NON-NLS-1$
     ...
     * @generated
     */
    public OrgModelAuthorBadgeEditPart(View view) {
        super(view);
    }
