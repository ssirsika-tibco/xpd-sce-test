...
public class OrganizationModelPaletteFactory {
    ...
    private ToolEntry createOrganization1CreationTool() {
        ...
        NodeToolEntry entry =
                new NodeToolEntry(Messages.Organization1CreationTool_title,
                        Messages.Organization1CreationTool_desc, types);
        entry.setSmallIcon(OrganizationModelElementTypes
                .getImageDescriptor(OrganizationModelElementTypes.Organization_1001));
    ...
    private ToolEntry createOrganizationUnit2CreationTool() {
        ...
        entry.setSmallIcon(OrganizationModelElementTypes
                .getImageDescriptor(OrganizationModelElementTypes.OrgUnit_2001));
        entry.setLargeIcon(entry.getSmallIcon());
        return entry;
    }
    ...
    private ToolEntry createPosition3CreationTool() {
        ...
        entry.setSmallIcon(OrganizationModelElementTypes
                .getImageDescriptor(OrganizationModelElementTypes.Position_2002));
        entry.setLargeIcon(entry.getSmallIcon());
        return entry;
    }
    ...
    private ToolEntry createDynamicOrganization4CreationTool() {
        ...
        NodeToolEntry entry =
                new NodeToolEntry(
                        Messages.DynamicOrganization4CreationTool_title,
                        Messages.DynamicOrganization4CreationTool_desc, types,
                        Collections.singletonMap(OrganizationEditPart.DYNAMIC,
                                Boolean.TRUE));
        /*
         * Can't use the element types (as done in generated code) to get the
         * dynamic organization icon as the dynamic organization is an
         * organization with a flag set (i.e. it's not a different element
         * type).
         */
        entry.setSmallIcon(ExtendedImageRegistry.INSTANCE.getImageDescriptor(OMModelImages
                .getImageObject(OMModelImages.IMAGE_DYNAMIC_ORGANISATION)));

        entry.setLargeIcon(entry.getSmallIcon());
        entry.setToolProperty(OrganizationEditPart.DYNAMIC, Boolean.TRUE);
    ...
    private ToolEntry createDynamicOrganizationUnit5CreationTool() {
        List/* <IElementType> */types = new ArrayList/* <IElementType> */(1);
        types.add(OrganizationModelElementTypes.DynamicOrgUnit_2003);
        NodeToolEntry entry =
                new NodeToolEntry(
                        ...
                        types);
        entry.setSmallIcon(OrganizationModelElementTypes
                .getImageDescriptor(OrganizationModelElementTypes.DynamicOrgUnit_2003));
        entry.setLargeIcon(entry.getSmallIcon());
        return entry;
    }
    ...
    private ToolEntry createHierarchy1CreationTool() {
        ...
        entry.setSmallIcon(OrganizationModelElementTypes
                .getImageDescriptor(OrganizationModelElementTypes.OrgUnitRelationship_3001));
        entry.setLargeIcon(entry.getSmallIcon());
        return entry;
    }
    ...
    private static class NodeToolEntry extends ToolEntry {
        ...
        private NodeToolEntry(String title, String description,
                List elementTypes) {
            this(title, description, elementTypes, null);
        }
        ...
        public NodeToolEntry(String title, String description,
                List elementTypes, Map<?, ?> extendedAttrs) {
            ...
            if (extendedAttrs != null) {
                tool = new UnspecifiedTypeCreationTool(elementTypes) {
                    ...
                    protected Request createTargetRequest() {
                        ...
                        request.setExtendedData(extendedAttrs);
                        return request;
                    }
                };
            } else {
