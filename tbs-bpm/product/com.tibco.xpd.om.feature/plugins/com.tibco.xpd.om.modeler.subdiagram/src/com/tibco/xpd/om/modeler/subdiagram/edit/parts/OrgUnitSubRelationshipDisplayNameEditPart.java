 ...
 * @generated
 */
public class OrgUnitSubRelationshipDisplayNameEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				OrganizationModelVisualIDRegistry
						.getType(com.tibco.xpd.om.modeler.subdiagram.edit.parts.OrgUnitSubRelationshipDisplayNameEditPart.VISUAL_ID),
				new Point(0, 15));
	}
	 ...
	 * @generated
	 */
	public OrgUnitSubRelationshipDisplayNameEditPart(View view) {
		super(view);
	}
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (event.getFeature() == OMPackage.Literals.ORG_UNIT_RELATIONSHIP__RELATIONSHIP_TYPE) {
				...
				if (event.getEventType() == Notification.SET) {
					...
					if (notationView != null) {
						if (event.getNewValue() != null) {
							...
							// Hide label as we have unset the type
							notationView.setVisible(false);
						}
					}
				}
	...
	protected IFigure createFigurePrim() {
		return new OrgUnitRelNameLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OrgUnitRelNameLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureOrgUnitRelNameLabel;

		/**
		 * @generated
		 */
		public OrgUnitRelNameLabelFigure() {
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureOrgUnitRelNameLabel() {
			return fFigureOrgUnitRelNameLabel;
		}
