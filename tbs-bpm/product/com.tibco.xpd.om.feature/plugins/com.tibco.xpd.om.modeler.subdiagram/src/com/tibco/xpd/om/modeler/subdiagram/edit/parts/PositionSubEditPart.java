...
import com.tibco.xpd.om.modeler.subdiagram.edit.policies.OrganizationModelTextNonResizableEditPolicy;
import com.tibco.xpd.om.modeler.subdiagram.edit.policies.OrganizationModelTextSelectionEditPolicy;
import com.tibco.xpd.om.modeler.subdiagram.edit.policies.PositionSubItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PositionSubEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PositionSubEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PositionSubItemSemanticEditPolicy());
	...
	protected IFigure createFigurePrim() {
		return new PositionNameLabelFigure();
	}

	/**
	 * @generated
	 */
	public class PositionNameLabelFigure extends WrappingLabel {
		 ...
		 * @generated NOT
		 */
		public PositionNameLabelFigure() {
			this.setText(Messages.PositionSubEditPart_label);
		}
	 ...
	 * AbstractEditPart to add an assertion, whenever we have the focus on an
	 * Organisation model and then if we drag-drop a Position from the Palette
	 * to an organisation unit in that model, we get an illegal argument
	 * exception stating: "An EditPart has to be selectable (isSelectable() ==
	 * true) in order to get selected". That's why we are overriding
	 * isSelectable() in order to avoid that exception.
	 * 
	 * 
	 */
	@Override
