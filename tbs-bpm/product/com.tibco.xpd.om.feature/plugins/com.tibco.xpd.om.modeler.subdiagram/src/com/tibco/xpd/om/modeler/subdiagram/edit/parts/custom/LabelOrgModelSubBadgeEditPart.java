 ...
 * @generated
 */
public class LabelOrgModelSubBadgeEditPart extends CompartmentEditPart
        implements ITextAwareEditPart {

    public static final String VISUAL_ID = "LabelOrganizationNameSubBadge"; //$NON-NLS-1$
     ...
     * @generated
     */
    public LabelOrgModelSubBadgeEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            ...
            IAdaptable hintAdapter = new OrganizationModelParserProvider.HintAdapter(
                    OrganizationModelElementTypes.Organization_79,
