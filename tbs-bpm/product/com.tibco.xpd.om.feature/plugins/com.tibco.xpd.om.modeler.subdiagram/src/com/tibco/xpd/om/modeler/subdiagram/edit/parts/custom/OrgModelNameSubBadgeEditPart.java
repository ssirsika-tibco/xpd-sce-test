 ...
 * @generated
 */
public class OrgModelNameSubBadgeEditPart extends CompartmentEditPart
        implements ITextAwareEditPart {

    
    
    public static final String VISUAL_ID = "OrgModelNameSubBadge"; //$NON-NLS-1$
     ...
     * @generated
     */
    public OrgModelNameSubBadgeEditPart(View view) {
        super(view);
    }
