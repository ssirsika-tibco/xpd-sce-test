 ...
 * @generated
 */
public class OrgTypeSubBadgeEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {

    public static final String VISUAL_ID = "OrgTypeSubBadge"; //$NON-NLS-1$
     ...
     * @generated
     */
    public OrgTypeSubBadgeEditPart(View view) {
        super(view);
    }
