...
import com.tibco.xpd.om.modeler.subdiagram.edit.parts.OrganizationModelEditPartFactory;
...
public class OrgUnitFeatureNameCustomEditPart extends CompartmentEditPart
     ...
     * @generated
     */
    public OrgUnitFeatureNameCustomEditPart(View view) {
        super(view);
    }
    ...
    protected Image getLabelIcon() {
        ...
        // return
        // OrganizationModelElementTypes.getImage(parserElement.eClass());
    ...
    private View getFontStyleOwnerView() {
        // The owner of this style is the label NOT the parent OrgUnit view
        Object mod = getModel();

        if (mod instanceof View) {
            View labelView = (View) mod;
            return labelView;
        } else {
            ...
            if (getParser() instanceof ISemanticParser) {
                ...
                if (modelParser.areSemanticElementsAffected(
                    ...
                    if (event.getFeature() == OMPackage.Literals.ORG_UNIT__FEATURE) {
                        ...
                        OrgUnitCustomEditPart parentEP = (OrgUnitCustomEditPart) getParent();
                        OrgUnitCustomFigure custFig = parentEP
                                .getPrimaryShape();
                        ...
                        if (custFig != null) {
                            ...
                            if (event.getEventType() == Notification.ADD) {
                                // rebuild with label
                                custFig.rebuildFigureWithFeatureLabel(true);
                            } else if (event.getEventType() == Notification.SET) {
                                // rebuild without label
                                if (event.getNewValue() == null) {
                                    custFig
                                            .rebuildFigureWithFeatureLabel(false);
                                } else {
                                    custFig.rebuildFigureWithFeatureLabel(true);
                                }
                            } else if (event.getEventType() == Notification.REMOVE) {
                                // rebuild without label
                                custFig.rebuildFigureWithFeatureLabel(false);
                            }
