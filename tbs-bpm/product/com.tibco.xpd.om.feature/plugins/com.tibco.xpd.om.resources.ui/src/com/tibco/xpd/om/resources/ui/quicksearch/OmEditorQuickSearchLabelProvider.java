 ...
 * @since 25 Jun 2012
 */
public class OmEditorQuickSearchLabelProvider extends
        AbstractQuickSearchLabelProvider {

    /**
     * @param partRef
     */
    public OmEditorQuickSearchLabelProvider(IWorkbenchPartReference partRef) {
        super(partRef);
    }
    ...
    public String getElementTypeName(Object element) {
        ...
        if (element instanceof OrgUnit) {
            ...
            return Messages.OmEditorQuickSearchLabelProvider_TypeName_Organisation_label;
        }
