...
public class XorGatewayRule extends ProcessValidationRule {
    ...
    public static final String ID = "sim.xorGatewayError"; //$NON-NLS-1$
     ...
     */
    private void checkTransitions(Process process, Activity activity) {
        ...
        for (Object next : activities) {
            ...
            if (route != null) {
                if (JoinSplitType.EXCLUSIVE_LITERAL.equals(Xpdl2ModelUtil
                    ...
                    checkTransitions(activity.getProcess(), activity);
                }
            }
        }
    }
