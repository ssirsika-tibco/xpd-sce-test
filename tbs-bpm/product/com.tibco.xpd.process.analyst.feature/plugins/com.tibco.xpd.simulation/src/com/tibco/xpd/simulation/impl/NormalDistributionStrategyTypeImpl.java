...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Normal Distribution Strategy Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.xpd.simulation.impl.NormalDistributionStrategyTypeImpl#getMean <em>Mean</em>}</li>
 *   <li>{@link com.tibco.xpd.simulation.impl.NormalDistributionStrategyTypeImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NormalDistributionStrategyTypeImpl extends
        LoopControlTransitionTypeImpl implements NormalDistributionStrategyType {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     ...
     * @generated
     */
    protected NormalDistributionStrategyTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return SimulationPackage.Literals.NORMAL_DISTRIBUTION_STRATEGY_TYPE;
    }
    ...
    public void setMean(double newMean) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    SimulationPackage.NORMAL_DISTRIBUTION_STRATEGY_TYPE__MEAN,
    ...
    public void setStandardDeviation(double newStandardDeviation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                    this,
                    Notification.SET,
                    SimulationPackage.NORMAL_DISTRIBUTION_STRATEGY_TYPE__STANDARD_DEVIATION,
                    oldStandardDeviation, standardDeviation,
                    !oldStandardDeviationESet));
    }
    ...
    public void unsetStandardDeviation() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(
                    ...
                    Notification.UNSET,
                    SimulationPackage.NORMAL_DISTRIBUTION_STRATEGY_TYPE__STANDARD_DEVIATION,
                    oldStandardDeviation, STANDARD_DEVIATION_EDEFAULT,
                    oldStandardDeviationESet));
    }
...
} //NormalDistributionStrategyTypeImpl