 ...
 * * @author nwilson
 */
public class JavaScriptDecFlowToProcessMappingFactory extends
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
            String target) {
        return new JavaScriptDecFlowToProcessMapping(activity, target);
    }
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
        ...
        return new JavaScriptDecFlowToProcessMapping(activity, target, script);
    }
