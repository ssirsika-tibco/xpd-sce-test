...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.implementer.nativeservices.databaseservice.database.ParameterType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterTypeItemProvider extends ItemProviderAdapter implements
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                        ...
                        getResourceLocator(),
                        getString("_UI_ParameterType_name_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_ParameterType_name_feature", "_UI_ParameterType_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        DatabasePackage.Literals.PARAMETER_TYPE__NAME,
                        true,
                        false,
                        false,
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator()
                .getImage("full/obj16/ParameterType")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_ParameterType_type") : //$NON-NLS-1$
    ...
    public void notifyChanged(Notification notification) {
        ...
        case DatabasePackage.PARAMETER_TYPE__NAME:
