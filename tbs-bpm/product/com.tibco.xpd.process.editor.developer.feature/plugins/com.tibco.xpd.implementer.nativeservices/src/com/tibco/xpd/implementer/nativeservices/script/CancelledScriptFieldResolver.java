 ...
 * 
 */
public class CancelledScriptFieldResolver extends ScriptProcessFieldResolver {
    ...
    protected String getActivityScript(Activity activity) {
        String cancelledScript = ProcessScriptUtil.getCancelledScript(activity);
    ...
    protected Command getSetActivityScriptCommand(EditingDomain editingDomain,
        ...
        Command cmd =
                ProcessScriptUtil.getSetCancelledScriptCommand(editingDomain,
                        strScript,
                        activity,
    ...
    protected boolean isInterestingActivity(Activity activity) {
        return ProcessScriptUtil.isActivityWithCancelledScriptType(activity,
                getJavaScriptGrammar());
    }
