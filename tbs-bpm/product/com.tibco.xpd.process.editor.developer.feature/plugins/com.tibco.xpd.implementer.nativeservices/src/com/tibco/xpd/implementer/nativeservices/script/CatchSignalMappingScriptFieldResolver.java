 ...
 * @since 20 Jun 2012
 */
public class CatchSignalMappingScriptFieldResolver
    ...
    public Command getSwapActivityDataNameReferencesCommand(
        ...
        CompoundCommand setActivityScriptCommand =
                (CompoundCommand) super.getSwapActivityDataNameReferencesCommand(
                        editingDomain,
                        activity,
                        nameMap);
        ...
        if (scriptInformations != null) {
            for (ScriptInformation scriptInformation : scriptInformations) {
                 ...
                 */
                String translatedScript = getTranslatedScript(process,
                        script,
                 ...
                 * set the new script.
                 */
                setActivityScriptCommand.append(
                        getSetScriptInformationScriptCommand(editingDomain,
                                translatedScript,
                                scriptInformation));
            }
        }
        ...
        for (DataMapping dataMapping : dataMappingList) {
            ...
            if (formalField != null) {
                 ...
                 */
                String translatedRef = getTranslatedParameterRef(activity,
                        formalField,
                        nameMap);
                ...
                if (translatedRef != null && !translatedRef.equals("")) { //$NON-NLS-1$
                    ...
                    setActivityScriptCommand
                            .append(SetCommand.create(editingDomain,
                                    dataMapping,
