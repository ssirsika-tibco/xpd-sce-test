 ...
 * 
 */
public class InitiateScriptFieldResolver extends ScriptProcessFieldResolver {
    ...
    protected String getActivityScript(Activity activity) {
        String initiatedScript = ProcessScriptUtil.getInitiatedScript(activity);
        return initiatedScript;
    }
    ...
    protected Command getSetActivityScriptCommand(EditingDomain editingDomain,
        ...
        Command cmd =
                ProcessScriptUtil.getSetInitiatedScriptCommand(editingDomain,
                        strScript,
                        activity,
    ...
    protected boolean isInterestingActivity(Activity activity) {
        return ProcessScriptUtil.isActivityWithInitiatedScriptType(activity,
                getJavaScriptGrammar());
    }
