...
/**
 * Script field resolver for reschedule timer scripts
 * 
 * 
 * @author aallway
 * @since 19 Mar 2013
 */
public class RescheduleTimerEventScriptFieldResolver extends
    ...
    protected DataReferenceContext getDataReferenceContext(
        ...
        return DataReferenceContext.CONTEXT_RESCHEDULE_TIMER_EVENT_SCRIPT;
    }

    @Override
    protected String getActivityScript(Activity activity) {
        String timerEventScript =
                ProcessScriptUtil.getRescheduleTimerEventScript(activity);
    ...
    protected boolean isInterestingActivity(Activity activity) {
        return ProcessScriptUtil.isRescheduleTimerEventWithScriptType(activity,
                getJavaScriptGrammar());
    }
