 ...
 * 
 * <p>
 * <i>Created: 29 Jul 2007</i>
 * </p>
 * 
 * @author Kamlesh Upadhyaya
 * 
 */
public class UserTaskOpenScriptFieldResolver extends ScriptProcessFieldResolver {
    /**
    ...
    protected boolean isInterestingActivity(Activity activity) {
        return ProcessScriptUtil.isUserTaskWithOpenScriptType(activity,
                getJavaScriptGrammar());
    }
