...
/**
 * Implementation class that does the additional stuff required for delete case
 ...
 * fragment process
 * <p>
 * 5. deletes the case data for global data operation
 * 
 * @author bharge
 * @since 27 Jan 2014
 */
public class DeleteCaseDataProcessCreator extends AbstractCaseProcessCreator {
     ...
     * @param processType
     */
    public DeleteCaseDataProcessCreator(String rootCategoryId,
    ...
    private class PostProcessCommand extends AbstractLateExecuteCommand {
        ...
        protected Command createCommand(EditingDomain editingDomain,
            ...
            if (null != process) {
                ...
                /*
                 * Basic types for case identifiers in the case class are need.
                 * Create them here
                 */
                ...
                AddFragmentActivityAssociatedParamsCommand assocParamsCmd =
                        new AddFragmentActivityAssociatedParamsCommand(
                                editingDomain, process);
                if (null != assocParamsCmd) {

                    cmd.append(assocParamsCmd);
                }
                ...
                /* update global data task for deleting case ref */
                DeleteCaseDataCommand deleteCaseDataCmd =
                        new DeleteCaseDataCommand(editingDomain, process);
                if (null != deleteCaseDataCmd) {

                    cmd.append(deleteCaseDataCmd);
                }
     ...
     * @since 28 Jan 2014
     */
    private class DeleteCaseDataCommand extends AbstractLateExecuteCommand {
         ...
         * @param contextObject
         */
        public DeleteCaseDataCommand(EditingDomain editingDomain,
                Object contextObject) {
        ...
        protected Command createCommand(EditingDomain editingDomain,
            ...
            if (null != process) {
                ...
                if (null != globalDataOp) {
                    ...
                    String caseRefField = getCaseClass().getName() + "Ref"; //$NON-NLS-1$
