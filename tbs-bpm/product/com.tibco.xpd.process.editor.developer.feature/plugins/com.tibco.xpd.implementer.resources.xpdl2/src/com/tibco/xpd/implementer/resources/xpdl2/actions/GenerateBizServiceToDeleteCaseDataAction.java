...
/**
 * Action to generate business service that deletes case data.
 * 
 * @author bharge
 * @since 27 Jan 2014
 */
public class GenerateBizServiceToDeleteCaseDataAction extends
        AbstractCaseDataProcessGeneratorAction {

    private final String GENERATE_DELETE_CASE_DATA_PAGEFLOW_FRAGMENT_ID =
            "_delete_case_data_bizservice_fragment_id"; //$NON-NLS-1$
    ...
    protected List<Process> generateNewProcesses(Package newOrExistingXpdlPkg,
        ...
        if (null != newOrExistingXpdlPkg) {
            ...
            cmdToCreateProcess
                    .setLabel(Messages.Generate_DeleteCaseBizService_Command_label);
            xpdl2WorkingCopy =
            ...
            for (Class caseClass : caseClassList) {
                ...
                DeleteCaseDataProcessCreator caseClassProcCreator =
                        new DeleteCaseDataProcessCreator(
                                BUSINESS_SERVICE_FRAGMENT_ROOT_CATEGORY_ID,
                                GENERATE_DELETE_CASE_DATA_PAGEFLOW_FRAGMENT_ID,
                ...
                String defaultProcNameSuffix =
                        Messages.Generate_DeleteCaseBizService_Default_Process_Name;
    ...
    protected String getWizardPageTitle() {
        ...
        return Messages.GeneratePageflow_deleteData_wizardPage_title;
    }
