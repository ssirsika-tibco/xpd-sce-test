...
/**
 * Dependency provider for XPDL2 files to RSD files.
 * 
 * @author nwilson
 * @since 19 May 2015
 */
public class XpdlToRsdWorkingCopyDependencyProvider implements
        IWorkingCopyDependencyProvider {

    private RestServiceTaskAdapter rsta;

    public XpdlToRsdWorkingCopyDependencyProvider() {
     ...
     * @param wc
     *            The working copy.
     * @return A list of RSD resources that this XPDL2 resource depends on.
     */
    @Override
    ...
    /**
     * Searches the flow container for REST invocation activities and adds
     * referenced RSD resources.
     * 
     * @param container
     *            The flow container.
     * @param resources
