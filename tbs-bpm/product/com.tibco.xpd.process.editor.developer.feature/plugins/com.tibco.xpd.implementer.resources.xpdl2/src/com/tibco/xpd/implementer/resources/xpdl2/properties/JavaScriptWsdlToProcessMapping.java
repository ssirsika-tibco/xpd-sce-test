 ...
 * @author nwilson
 */
public class JavaScriptWsdlToProcessMapping implements SingleMappingCompositor {
     ...
     *            The target.
     */
    public JavaScriptWsdlToProcessMapping(Activity activity, String target) {
    ...
    public Collection<Object> getSourceItems(boolean isInput) {
        ...
        if (script.contains("wso:")) { //$NON-NLS-1$
