...
public class MappingEndMessageFilter implements IFilter, IPluginContribution {

    private IFilter filter;

    public MappingEndMessageFilter() {
        /*
         * Filter will accept: - end message event implemented by
         * request-response webservice (has input and output)
         */

        ViewerFilterBuilder viewerFilterBuilder = ViewerFilterBuilder.INSTANCE;

        // Start/Intermediate message event
        ...
        IFilter eventTypeFilter = eventViewerFilter.hasType(EventType.END);
        IFilter triggerResultMessageFilter =
                eventViewerFilter.hasTriggerResultMessage();
        IFilter f = new IFilter() {
        ...
        IFilter eventFilter =
                viewerFilterBuilder.getComposite(grammerCheckFilter,
