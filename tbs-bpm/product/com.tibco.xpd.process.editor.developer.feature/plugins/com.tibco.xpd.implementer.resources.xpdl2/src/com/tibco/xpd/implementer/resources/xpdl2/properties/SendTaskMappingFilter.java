...
/**
 * Filter for Send Tasks.
 * 
 * @author scrossle, mmaciuki, nwilson
 */
public class SendTaskMappingFilter implements IFilter, IPluginContribution {

    private IFilter filter;

    public SendTaskMappingFilter() {
        ...
        IFilter typeFilter = taskFilterBuilder.hasType(TaskType.SEND_LITERAL);
        IFilter responseFilter = new IFilter() {
    ...
    protected IFilter createGrammarFilter(TaskViewerFilter taskFilterBuilder) {
        IFilter grammerCheckFilter =
                taskFilterBuilder.hasScriptGrammar(DirectionType.IN_LITERAL,
