 ...
 * @author scrossle
 */
public class ServiceTaskMappingFromServiceSection extends
     ...
     * 
     */
    public ServiceTaskMappingFromServiceSection() {
    ...
    public boolean isValidTransfer(Object source, Object target) {
        ...
        if (source instanceof Collection) {
            ...
            if ((target instanceof ProcessRelevantData || target instanceof ConceptPath)
