...
/**
 * Script provider for Sub-Process Task mappings <b>AND</b> Catch error event
 * when error caught is Catch All / Catch By Name / Catch Specific Error thrown
 * by End Error Event.
 * 
 * @author nwilson
 */
public class SubProcAndCatchBpmnErrorEventScriptProvider extends
     ...
     */
    public SubProcAndCatchBpmnErrorEventScriptProvider(String grammar,
    ...
    public String getDecriptionLabel() {
        ...
        if (MappingDirection.IN.equals(direction)) {
            description =
                    Messages.SubProcScriptProvider_DescribeInputScriptLabel;
        } else {
            description =
                    Messages.SubProcScriptProvider_DescribeOutputScriptLabel;
        }
        return description;
    }
