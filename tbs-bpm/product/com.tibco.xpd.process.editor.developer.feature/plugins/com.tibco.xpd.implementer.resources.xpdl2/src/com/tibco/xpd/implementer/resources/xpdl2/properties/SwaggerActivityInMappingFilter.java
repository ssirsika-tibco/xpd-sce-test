...
/**
 * Selects only REST Service activities that can have applied in mappings and have an associated Rest Service Operation
 * of type 'Swagger'
 *
 * @author nkelkar
 * @since Aug 30, 2024
 */
public class SwaggerActivityInMappingFilter implements IFilter
{

	private RestServiceTaskAdapter rsta;

	public SwaggerActivityInMappingFilter()
	{
	...
	public boolean select(Object toTest)
	{
		...
		if (eo instanceof Activity)
		{
					...
					&& (rsta.getServiceRefKey(activity) != null))
			{
				...
				return messageAdapter != null && messageAdapter.hasMappingIn((Activity) eo);
			}
		}
		return false;
	}
