 ...
 * 
 */
public class ImplementedStartEventFilter implements IFilter {
    ...
    public boolean select(Object toTest) {
        ...
        if (eo instanceof Activity) {
            ...
            if (ProcessInterfaceUtil.isEventImplemented(act)
                    && (EventObjectUtil.getFlowType(act) == EventFlowType.FLOW_START_LITERAL)) {

                StartMethod implementedStartMethod =
                        ProcessInterfaceUtil.getImplementedStartMethod(act);
                if (implementedStartMethod != null) {
                    if (TriggerType.MESSAGE_LITERAL == implementedStartMethod
                            .getTrigger()
                    /*
