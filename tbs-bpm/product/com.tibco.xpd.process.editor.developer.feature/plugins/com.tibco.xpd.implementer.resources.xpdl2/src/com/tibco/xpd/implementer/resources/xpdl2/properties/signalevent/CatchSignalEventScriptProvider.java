...
/**
 * Script provider for catch signal event mapping script properties section.
 * 
 * @author aallway
 * @since 30 Apr 2012
 */
public class CatchSignalEventScriptProvider extends
     ...
     */
    public CatchSignalEventScriptProvider(String grammar,
    ...
    public String getDecriptionLabel() {
        return Messages.CatchSignalEventScriptProvider_DefineMappingScript_message;
    }
    ...
    public Command getSetScriptCommand(EditingDomain ed, EObject input,
        ...
        CompoundCommand cmd =
                new CompoundCommand(
                        Messages.CatchSignalEventScriptProvider_EditMappingScript_menu);
