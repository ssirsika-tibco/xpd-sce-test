...
import com.tibco.xpd.js.validation.tools.CompletedScriptTaskScriptTool;
...
/**
 * Completed script task validation rule
 * 
 * 
 * @author agondal
 * @since 17 Sep 2013
 */
public abstract class AbstractCompletedScriptTaskScriptRule extends
    ...
    protected ScriptTool createScriptToolIfInterested(Expression expression) {
        ...
        if (expression.eContainer() instanceof AuditEvent) {
            ...
            if (AuditEventType.COMPLETED_LITERAL.equals(auditEvent.getType())) {
                ...
                if (activity != null) {
                    ...
                    return getScope()
                            .getTool(CompletedScriptTaskScriptTool.class,
                                    activity);
                }
            }
        }
