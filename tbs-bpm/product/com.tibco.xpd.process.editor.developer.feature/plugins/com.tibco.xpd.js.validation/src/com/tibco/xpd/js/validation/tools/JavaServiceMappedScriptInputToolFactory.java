 ...
 * 
 */
public class JavaServiceMappedScriptInputToolFactory extends JavaScriptToolFactory {
        ...
        if (input instanceof DataMapping) {
            ...
            boolean b =
                    ProcessScriptUtil.isDataMappingWithScriptType(dataMapping,
                            getScriptGrammar());
            if (b) {
                processor = new JavaServiceMappedScriptInputTool(dataMapping);
            }
        }
        return processor;
    }
	...
	public Class<? extends IPreProcessor> getToolClass() {
		return JavaServiceMappedScriptInputTool.class;
	}
