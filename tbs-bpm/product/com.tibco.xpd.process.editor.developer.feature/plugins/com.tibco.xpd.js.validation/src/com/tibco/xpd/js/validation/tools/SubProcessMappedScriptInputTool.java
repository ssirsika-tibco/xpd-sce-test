 ...
 * 
 */
public class SubProcessMappedScriptInputTool extends ScriptTool {

    private DataMapping dataMapping = null;

    public SubProcessMappedScriptInputTool(DataMapping dataMapping) {
    ...
    protected String getScriptSubContext() {
        return ProcessJsConsts.INPUT_TO_SERVICE;
    }
