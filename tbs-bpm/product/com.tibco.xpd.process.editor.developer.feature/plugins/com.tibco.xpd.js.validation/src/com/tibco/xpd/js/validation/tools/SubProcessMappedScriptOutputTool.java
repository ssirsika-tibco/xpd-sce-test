 ...
 * 
 */
public class SubProcessMappedScriptOutputTool extends ScriptTool {

    private DataMapping dataMapping = null;

    public SubProcessMappedScriptOutputTool(DataMapping dataMapping) {
    ...
    protected Activity getActivity() {
        if (dataMapping != null) {
            return Xpdl2ModelUtil.getParentActivity(dataMapping);
        }
        return null;
    }
