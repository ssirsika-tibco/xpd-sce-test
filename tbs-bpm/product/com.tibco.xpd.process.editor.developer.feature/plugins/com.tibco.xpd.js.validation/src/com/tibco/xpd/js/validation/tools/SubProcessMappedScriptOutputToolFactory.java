 ...
 * 
 */
public class SubProcessMappedScriptOutputToolFactory extends
    ...
    public IPreProcessor createPreProcessor(IValidationScope scope, Object input) {
        ...
        if (input instanceof DataMapping) {
            ...
            if (b) {
                processor = new SubProcessMappedScriptOutputTool(mapping);
            }
        }
        return processor;
    }
    ...
    public Class<? extends IPreProcessor> getToolClass() {
        return SubProcessMappedScriptOutputTool.class;
    }
