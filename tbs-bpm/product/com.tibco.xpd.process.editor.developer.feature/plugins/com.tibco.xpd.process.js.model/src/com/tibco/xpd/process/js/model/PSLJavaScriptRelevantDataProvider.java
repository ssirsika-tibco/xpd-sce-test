...
/**
 * Script relevant data provider (used for content assist / validation etc) for JavaScript mappings for a process script
 * library function
 *
 * @author nkelkar
 * @since Jan 30, 2024
 */
public class PSLJavaScriptRelevantDataProvider extends DefaultJavaScriptRelevantDataProvider
{
