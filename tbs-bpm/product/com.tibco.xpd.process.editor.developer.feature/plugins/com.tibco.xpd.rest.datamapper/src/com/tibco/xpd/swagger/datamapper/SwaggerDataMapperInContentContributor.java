 ...
 * @since Sep 2, 2024
 */
public class SwaggerDataMapperInContentContributor extends AbstractSwaggerDataMapperContentContributor
{

	/**
	 * @param direction
	 */
	public SwaggerDataMapperInContentContributor()
	{
	...
	{
		return "ProcessToSwagger.DataMapperContent"; //$NON-NLS-1$
	}
