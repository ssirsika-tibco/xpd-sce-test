 ...
 * @author mtorres
 */
public class ScriptMapping implements
     ...
     *            The target.
     */
    public ScriptMapping(Activity activity, String target) {
     ...
     *            The current script.
     */
    public ScriptMapping(Activity activity,
    ...
    public void addMapping(Object source, Object target) {
        ...
        script += TransformUtil.getMappingName(source);
    }
    ...
    public void removeMapping(Object source, Object target) {
        String parameter = TransformUtil.getMappingName(source);
