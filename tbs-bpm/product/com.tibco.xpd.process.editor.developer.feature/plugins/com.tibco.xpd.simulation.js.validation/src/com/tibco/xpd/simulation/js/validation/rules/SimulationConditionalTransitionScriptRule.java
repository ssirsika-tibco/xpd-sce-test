 ...
 * @since 17 Sep 2013
 */
public class SimulationConditionalTransitionScriptRule extends
        AbstractUserTaskSubmitScriptRule {

    /** The issue id. */
    private static final String ERROR_ID =
            "simulation.error.validateConditionalTransitionScript"; //$NON-NLS-1$

    private static final String WARNING_ID =
            "simulation.warning.validateConditionalTransitionScript"; //$NON-NLS-1$
