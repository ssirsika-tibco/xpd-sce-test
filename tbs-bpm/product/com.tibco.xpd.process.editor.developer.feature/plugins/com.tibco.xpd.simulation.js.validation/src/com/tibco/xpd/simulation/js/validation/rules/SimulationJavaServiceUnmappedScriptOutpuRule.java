...
import com.tibco.xpd.js.validation.rules.AbstractJavaServiceUnmappedScriptOutputRule;
 ...
 * @since 17 Sep 2013
 */
public class SimulationJavaServiceUnmappedScriptOutpuRule extends
        AbstractJavaServiceUnmappedScriptOutputRule {

    /** The issue id. */
    private static final String ERROR_ID = "simulation.javaServiceTaskScript"; //$NON-NLS-1$

    private static final String WARNING_ID =
            "simulation.warning.javaServiceTaskScript"; //$NON-NLS-1$
