 ...
 * @since 17 Sep 2013
 */
public class SimulationMIAdditionalInstancesExprRule extends
        AbstractMIAdditionalInstancesExprRule {
    /** The issue id. */
    private static final String ERROR_ID =
            "simulation.miAdditionalInstancesExprScript"; //$NON-NLS-1$                                  

    private static final String WARNING_ID =
            "simulation.warning.miAdditionalInstancesExprScript"; //$NON-NLS-1$
