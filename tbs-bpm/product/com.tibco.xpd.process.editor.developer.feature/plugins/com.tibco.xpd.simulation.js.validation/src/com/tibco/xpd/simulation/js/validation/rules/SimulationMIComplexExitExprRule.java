...
public class SimulationMIComplexExitExprRule extends
        AbstractMIComplexExitExprRule {
    /** The issue id. */
    private static final String ERROR_ID = "simulation.miComplexExitExprScript"; //$NON-NLS-1$                                  

    private static final String WARNING_ID =
            "simulation.warning.miComplexExitExprScript"; //$NON-NLS-1$
