 ...
 * @since 17 Sep 2013
 */
public class SimulationTimerEventScriptRule extends AbstractTimerEventRule {

    /** The issue id. */
    private static final String ERROR_ID =
            "simulation.error.validateTimerEventScript"; //$NON-NLS-1$								  

    private static final String WARNING_ID =
            "simulation.warning.validateTimerEventScript"; //$NON-NLS-1$
