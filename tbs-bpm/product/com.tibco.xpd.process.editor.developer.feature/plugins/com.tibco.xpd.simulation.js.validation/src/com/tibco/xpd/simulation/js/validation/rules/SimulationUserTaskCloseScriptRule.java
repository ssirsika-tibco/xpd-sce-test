 ...
 * @since 17 Sep 2013
 */
public class SimulationUserTaskCloseScriptRule extends
        AbstractUserTaskCloseScriptRule {

    /** The issue id. */
    private static final String ERROR_ID =
            "simulation.error.userTaskCloseScript"; //$NON-NLS-1$

    private static final String WARNING_ID =
            "simulation.warning.userTaskCloseScript"; //$NON-NLS-1$
