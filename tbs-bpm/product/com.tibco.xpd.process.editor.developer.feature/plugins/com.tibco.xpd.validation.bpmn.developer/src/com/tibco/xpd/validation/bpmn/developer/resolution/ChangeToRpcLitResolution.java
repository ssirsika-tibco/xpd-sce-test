 ...
 * @since 10 Feb 2011
 */
public class ChangeToRpcLitResolution extends AbstractWorkingCopyResolution {

    /**
     * 
     */
    public ChangeToRpcLitResolution() {
    }
                        ...
                        if (participantSharedResObj instanceof ParticipantSharedResource) {
                            ...
                            if (sharedResource instanceof WsResource) {
                                ...
                                if (inbound != null) {
                                    ...
                                    /*
                                     * Check for SOAPOverJms bindings as well as
                                     * SOAPOverHttp bindings.
                                     */
                                    List<WsSoapJmsInboundBinding> soapJmsBinding =
