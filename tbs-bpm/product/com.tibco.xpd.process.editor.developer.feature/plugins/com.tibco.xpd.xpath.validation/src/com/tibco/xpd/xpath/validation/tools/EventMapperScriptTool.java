 ...
 * 
 */
public class EventMapperScriptTool extends XPathScriptTool {

    private ScriptInformation scriptInformation = null;

    public EventMapperScriptTool(ScriptInformation scriptInformation) {
    ...
    protected Part getWsdlPart() {
        ...
        if (!(getEvent() instanceof EndEvent)) {
            ...
            if (messageAdapter != null) {
                ...
                if (wso != null) {
                    Message message =
                            Xpdl2WsdlUtil.getMessageInput(getActivity());
                    if (message != null) {
                ...
                if (target != null) {
                    ...
                    if (conceptPath != null) {
                        if (conceptPath.getItem() instanceof ProcessRelevantData) {
                            type =
                                    ProcessUtil
                                            .convertToScriptRelevantData((ProcessRelevantData) conceptPath
                                                    .getItem(),
                                                    WorkingCopyUtil
