 ...
 * 
 */
public class WebServiceMappedScriptInputTool extends XPathScriptTool {

    private DataMapping dataMapping = null;

    public WebServiceMappedScriptInputTool(DataMapping dataMapping) {
    ...
    IScriptRelevantData getMappingType() {
        ...
        IWsdlPath wsdlPath =
                WsdlUtil.resolveParameter(getActivity(), dataMapping
                        .getFormal(), true);
        if (wsdlPath != null) {
