 ...
 * 
 */
public class WebServiceMappedScriptInputToolFactory extends XPathScriptToolFactory {
        ...
        if (input instanceof DataMapping) {
            ...
            boolean b =
                    ProcessScriptUtil.isDataMappingWithScriptType(dataMapping,
                            getScriptGrammar());
            if (b) {
                processor = new WebServiceMappedScriptInputTool(dataMapping);
            }
        }
        return processor;
    }
	...
	public Class<? extends IPreProcessor> getToolClass() {
		return WebServiceMappedScriptInputTool.class;
	}
