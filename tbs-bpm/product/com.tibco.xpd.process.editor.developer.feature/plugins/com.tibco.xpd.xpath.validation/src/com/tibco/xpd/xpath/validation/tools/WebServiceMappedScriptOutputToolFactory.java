 ...
 * 
 */
public class WebServiceMappedScriptOutputToolFactory extends
        XPathScriptToolFactory {
    ...
    public IPreProcessor createPreProcessor(IValidationScope scope, Object input) {
        ...
        if (input instanceof DataMapping) {
            ...
            boolean b = ProcessScriptUtil.isDataMappingWithScriptType(mapping,
                    getScriptGrammar());
            if (b) {
                processor = new WebServiceMappedScriptOutputTool(mapping);
            }
        }
        return processor;
    }
    ...
    public Class<? extends IPreProcessor> getToolClass() {
        return WebServiceMappedScriptOutputTool.class;
    }
