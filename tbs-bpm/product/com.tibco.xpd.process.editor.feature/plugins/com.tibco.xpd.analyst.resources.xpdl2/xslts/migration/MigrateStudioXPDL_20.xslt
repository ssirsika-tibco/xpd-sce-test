...
<!--
	===================================================================================================================
	XSLT:       MigrateStudioXPDL_20.xslt
	
	DESCRIPTION:

  	    This xslt will updgrade a xpdl of format version 20 (4.2.0 V03) to format version 21 (4.3.0 V01).

		- Swap BOM data references namespace to "http://www.eclipse.org/uml2/5.0.0/UML"
...
<xsl:stylesheet version="1.0"
	...
	===============================================================================
    -->
	<xsl:template match="xpdl2:DataType//xpdl2:ExternalReference[@namespace = 'http://www.eclipse.org/uml2/3.0.0/UML']">
