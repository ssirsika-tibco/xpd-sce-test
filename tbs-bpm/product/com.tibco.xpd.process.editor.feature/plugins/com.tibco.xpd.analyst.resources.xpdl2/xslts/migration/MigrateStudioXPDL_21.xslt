...
<!--
	...
	DESCRIPTION:
  	    ...
  	    This xslt will updgrade a xpdl of format version 21 (4.3.0 V01) to format version 22 (4.3.0 V09).

		- Swap ALL BOM data references namespace to "http://www.eclipse.org/uml2/5.0.0/UML" 
		  (MigrateStudioXPL_20 missed references from case actions processes / global case data tasks
...
<xsl:stylesheet version="1.0"
	...
	<!--
	===============================================================================
	Update ALL UML namespace to latest for ExternalReference.
	===============================================================================
    -->
	<xsl:template match="@namespace[. = 'http://www.eclipse.org/uml2/3.0.0/UML']">
		<!-- Overwrite namespace attribute -->
		<xsl:attribute name="namespace">http://www.eclipse.org/uml2/5.0.0/UML</xsl:attribute>
	</xsl:template>
