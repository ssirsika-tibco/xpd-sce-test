 ...
 * {@link com.tibco.xpd.presentation.channeltypes.Presentation} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PresentationItemProvider extends NamedElementItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Presentation_bindings_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Presentation_bindings_feature", "_UI_Presentation_type"),
                 ChannelTypesPackage.Literals.PRESENTATION__BINDINGS,
                 true,
                 false,
                 true,
                 null,
    ...
    /**
     * This returns Presentation.gif. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = ((Presentation) object).getName();
