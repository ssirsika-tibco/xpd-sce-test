 ...
 * 
 */
public class ExtendedAttributeValueColumn extends AbstractColumn {
     ...
     *            column width
     */
    public ExtendedAttributeValueColumn(EditingDomain editingDomain,
    ...
    protected Command getSetCommand(Object element, Object value) {
        ...
        if (input instanceof TypeAssociation
            ...
            String extAttrValue = extAttr.getValue();
