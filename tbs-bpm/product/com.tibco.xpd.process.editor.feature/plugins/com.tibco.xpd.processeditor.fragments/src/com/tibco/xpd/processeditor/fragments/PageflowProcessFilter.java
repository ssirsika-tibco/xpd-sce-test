 ...
 * 
 */
public class PageflowProcessFilter implements IFilter {
    ...
    public boolean select(Object toTest) {
        ...
        if (toTest instanceof AbstractProcessDiagramEditor) {
            ...
            if (input instanceof ProcessEditorInput) {
                ...
                select =
                        Xpdl2ModelUtil.isPageflow(processInput.getProcess())
                                && !Xpdl2ModelUtil
                                        .isPageflowBusinessService(processInput
                                                .getProcess());
            }
        } else if (toTest instanceof String) {

            return toTest.equals(PAGE_FLOW_TEMPLATE_PROVIDER);
        }
        return select;
    }
}
