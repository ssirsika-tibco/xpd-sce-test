 ...
 * 
 */
public class PageflowProcessFragmentContributor extends
        BaseXpdlTemplatesContributor {
	 ...
	 * 
	 */
    private static final String PAGEFLOW_FRAGMENTS_CONTRIBUTOR_ID =
    ...
    public PageflowProcessFragmentContributor() {
    }
    ...
    public ImageData getLocalizedImageData(IFragment fragment, String NL) {
        ...
        if (processDiagramImage != null) {
            ImageData imageData = processDiagramImage.getImageData();

            return imageData;
        } else {
            System.err.println(this.getClass().getSimpleName()
                    + "Failed to create fragment image."); //$NON-NLS-1$
        }
        return null;
    }
    ...
    protected String getContributorId() {
        return PAGEFLOW_FRAGMENTS_CONTRIBUTOR_ID;
    }
