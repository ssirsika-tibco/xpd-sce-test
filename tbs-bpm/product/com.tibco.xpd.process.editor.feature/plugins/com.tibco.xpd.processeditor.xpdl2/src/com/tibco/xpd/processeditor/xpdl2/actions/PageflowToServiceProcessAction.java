...
/**
 * Action to convert pageflow to service process.
 * 
 * @author bharge
 * @since 16 Feb 2015
 */
public class PageflowToServiceProcessAction extends BaseSelectionListenerAction {
     ...
     * @param text
     */
    public PageflowToServiceProcessAction() {

        super(
                Messages.PageflowToServiceProcessAction_ConvertToServiceProcess_menu);
        setImageDescriptor(Xpdl2ProcessEditorPlugin
                .getImageDescriptor(ProcessEditorConstants.ICON_PAGEFLOW_TO_SERVICE_PROCESS));
    }
    ...
    protected boolean updateSelection(IStructuredSelection selection) {
        ...
        if (selection.size() == 1
            ...
            if (Xpdl2ModelUtil.isPageflowProcess((Process) selection
                    .getFirstElement())) {
    ...
    public void run() {
        ...
        if (selectedProcess != null
                && Xpdl2ModelUtil.isPageflowProcess(selectedProcess)) {

            /*
             * Create command to convert pageflow to service process.
             */
            CompoundCommand cmd =
            ...
            serviceProcessConfiguration.setDeployToProcessRuntime(false);
            ...
            /*
             * Convert any activity that has default colour for pageflow to use
             * default colour for service process.
             */
