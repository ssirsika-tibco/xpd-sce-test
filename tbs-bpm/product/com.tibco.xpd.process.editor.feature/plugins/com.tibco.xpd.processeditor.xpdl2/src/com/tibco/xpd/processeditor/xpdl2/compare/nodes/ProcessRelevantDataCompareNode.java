...
/**
 * Process relevant data (data field, formal parameter, correlation data field).
 * 
 * @author aallway
 * @since 29 Nov 2010
 */
public class ProcessRelevantDataCompareNode extends
     ...
     */
    public ProcessRelevantDataCompareNode(ProcessRelevantData data,
            int listIndex, EStructuralFeature feature,
            Object parentCompareNode, EMFCompareNodeFactory compareNodeFactory) {
        super(data, listIndex, feature, parentCompareNode, compareNodeFactory);
