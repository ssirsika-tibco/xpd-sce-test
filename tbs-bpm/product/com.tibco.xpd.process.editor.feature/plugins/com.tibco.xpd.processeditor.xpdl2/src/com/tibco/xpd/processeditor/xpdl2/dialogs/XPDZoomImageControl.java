 ...
 * 
 */
public abstract class XPDZoomImageControl extends Composite implements
		SelectionListener {
	 ...
	 */
	public XPDZoomImageControl(Composite parent, int style,
		...
		ImageRegistry ir = Xpdl2ProcessEditorPlugin.getDefault()
				.getImageRegistry();
		...
		zoomIn.setImage(ir.get(ProcessEditorConstants.IMG_ZOOM_IN));
		zoomIn.addSelectionListener(this);
		zoomIn.setLayoutData(new GridData());

		zoomOut = new Button(this, SWT.PUSH);
		zoomOut.setImage(ir.get(ProcessEditorConstants.IMG_ZOOM_OUT));
