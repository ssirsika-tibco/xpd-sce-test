...
/**
 * Mapping compositor for any grammar mappings from process to sub-process
 ...
 */
public abstract class AbstractProcToSubProcMappingCompositor implements
     ...
     *            The target.
     */
    public AbstractProcToSubProcMappingCompositor(Activity activity,
            String target) {
