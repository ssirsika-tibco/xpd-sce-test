 ...
 * @author nwilson
 */
public class PageflowToProcessCompositorFactory extends
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
            String target) {
        return new PageflowToProcessCompositor(activity, target);
    }
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
        ...
        return new PageflowToProcessCompositor(activity, target, script);
    }
