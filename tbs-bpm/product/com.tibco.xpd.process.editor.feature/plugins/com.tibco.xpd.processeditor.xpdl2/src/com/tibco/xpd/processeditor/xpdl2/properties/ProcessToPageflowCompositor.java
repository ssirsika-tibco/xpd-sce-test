 ...
 * @author nwilson
 */
public class ProcessToPageflowCompositor implements
     ...
     *            The target.
     */
    public ProcessToPageflowCompositor(Activity activity, String target) {
     ...
     *            The current script.
     */
    public ProcessToPageflowCompositor(Activity activity,
