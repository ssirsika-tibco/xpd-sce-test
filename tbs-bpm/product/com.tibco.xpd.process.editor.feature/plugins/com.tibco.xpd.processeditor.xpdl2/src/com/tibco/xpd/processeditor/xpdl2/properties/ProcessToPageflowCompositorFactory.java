 ...
 * @author nwilson
 */
public class ProcessToPageflowCompositorFactory extends
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
            String target) {
        return new ProcessToPageflowCompositor(activity, target);
    }
    ...
    public ScriptMappingCompositor getCompositor(Activity activity,
        ...
        return new ProcessToPageflowCompositor(activity, target, script);
    }
