 ...
 * 
 */
public class RetainFamiliarCommandActions extends
        AbstractResourcePatternsCommandActions {

    private EObject currentContextObject;

    public RetainFamiliarCommandActions() {

    }

    public RetainFamiliarCommandActions(EObject currentContextObject) {
        this.currentContextObject = currentContextObject;
    }

    /**
     * @see com.tibco.xpd.processeditor.xpdl2.util.AbstractResourcePatternsCommandActions#addTasksToGroup(org.eclipse.jface.viewers.ISelection,
    ...
    public CompoundCommand addTasksToGroup(ISelection selection,
        ...
        RetainFamiliarActivities retainFamiliarActivities = null;
//        Activity activity = null;
        ...
        if (selection instanceof StructuredSelection) {
            ...
            for (Object next : structuredSelection.toList()) {
                if (next instanceof RetainFamiliarActivities) {
                    retainFamiliarActivities = (RetainFamiliarActivities) next;
                } else if (next instanceof ActivityRef) {
                    ActivityRef actRef = (ActivityRef) next;
                    EObject container = actRef.eContainer();
                    if (container instanceof RetainFamiliarActivities) {
                        retainFamiliarActivities =
                                (RetainFamiliarActivities) container;
                    }
                }
                /**
                ...
                for (ActivityRef activityRef2 : activityRef) {
                    ...
                    /**
                     * uncomment this block and delete the above line if
                     * you dont want the selected activity to be in the list
                     */
                ...
                if (null != pickedTasks) {
                    ...
                    List<ActivityRef> activityRefsToRemove =
                            removeExistingActivityRefsBeforeAdd(retainFamiliarActivities,
                                    activityList,
                                    pickedTasks);
                    ...
                    if (!activityRefsToRemove.isEmpty()) {
                        ...
                        cCmd.append(new ResourcePatternsCommand(ed,
                                retainFamiliarActivities, activityRefsToRemove,
                                null));
                    }
    ...
    /**
     * @see com.tibco.xpd.processeditor.xpdl2.util.AbstractResourcePatternsCommandActions#deleteTasksOrGroup(org.eclipse.jface.viewers.ISelection,
     *      org.eclipse.emf.common.command.CompoundCommand)
     * 
     * @param selection
     * @param cmd
    ...
    public CompoundCommand deleteTasksOrGroup(ISelection selection,
            CompoundCommand cCmd) {
        List<RetainFamiliarActivities> retainFamiliarActivitiesList =
        ...
        if (selection instanceof StructuredSelection) {
            ...
            for (Object next : structured.toList()) {
                if (next instanceof RetainFamiliarActivities) {
                    retainFamiliarActivities = (RetainFamiliarActivities) next;
                    retainFamiliarActivitiesList.add(retainFamiliarActivities);
                } else if (next instanceof ActivityRef) {
        ...
        for (RetainFamiliarActivities retainFamiliar : retainFamiliarActivitiesList) {
            cCmd.append(RemoveCommand.create(ed, retainFamiliar));
        }
        return cCmd;
        ...
        if (object instanceof RetainFamiliarActivities) {
            ...
            if (!value.equals(oldValue)) {
                CompoundCommand command =
                        new CompoundCommand(
                                Messages.RenameRetainFamiliarAction_EditRFNameCommand);
                EditingDomain ed =
                        WorkingCopyUtil
                                .getEditingDomain(retainFamiliarActivities);
                /**
                ...
                if (ed != null) {
                    if (retainFamiliarActivities.eContainer() != null) {
