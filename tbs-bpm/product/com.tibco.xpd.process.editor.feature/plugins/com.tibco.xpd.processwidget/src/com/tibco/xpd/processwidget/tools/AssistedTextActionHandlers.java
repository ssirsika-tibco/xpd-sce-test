/* 
 ** 
 **  MODULE:             $RCSfile: AssistedTextActionHandlers.java $ 
 **                      $Revision: 1.2 $ 
 **                      $Date: 2005/06/03 11:09:40Z $ 
 ** 
 ** DESCRIPTION    :           
 **                                              
 ** 
 ...
 ** 
 **  COPYRIGHT:    (c) 2005 TIBCO Software, All Rights Reserved. 
 ** 
 **  MODIFICATION HISTORY: 
 ** 
 **    $Log: AssistedTextActionHandlers.java $ 
 **    Revision 1.2  2005/06/03 11:09:40Z  wzurek 
 **    copyrights fixes 
 */
...
/**
 * Code based on org.eclipse.ui.actions.TextActionHandler
 * 
 * The handlers are installed and updated only when text control is activated,
 * and oryginal handlers are restored when control is deactivated.
 * 
 * It allows to have generic cut/copy/paste actions, but use text based copy
 * when editing text in Text widget
 * 
 * 
 * Oryginal Javadoc: * * * * * * * * * * * * * * * * * * *
 * 
 ...
 * </p>
 */
public class AssistedTextActionHandlers {
    ...
    private class DeleteActionHandler extends Action {
        protected DeleteActionHandler() {
            super(Messages.AssistedTextActionHandlers_Delete_menu);  
    ...
    private class CutActionHandler extends Action {
        protected CutActionHandler() {
            super(Messages.AssistedTextActionHandlers_Cut_menu); 
    ...
    private class CopyActionHandler extends Action {
        protected CopyActionHandler() {
            super(Messages.AssistedTextActionHandlers_Copy_menu);  
    ...
    private class PasteActionHandler extends Action {
        protected PasteActionHandler() {
            super(Messages.AssistedTextActionHandlers_Paste_menu);
    ...
    private class SelectAllActionHandler extends Action {
        protected SelectAllActionHandler() {
            super(Messages.AssistedTextActionHandlers_SelectAll_menu);
     ...
     */
    public AssistedTextActionHandlers(IActionBars actionBar) {
        this.actionBar = actionBar;
        this.oldActions = new HashMap();
    }

    /**
     * install handlers on the site, and preserve existing handlers in the
     * oldActions map
     */
    public void install() {

        oldActions.put(ActionFactory.CUT.getId(), actionBar
                .getGlobalActionHandler(ActionFactory.CUT.getId()));
        oldActions.put(ActionFactory.COPY.getId(), actionBar
                .getGlobalActionHandler(ActionFactory.COPY.getId()));
        oldActions.put(ActionFactory.PASTE.getId(), actionBar
                .getGlobalActionHandler(ActionFactory.PASTE.getId()));
        oldActions.put(ActionFactory.SELECT_ALL.getId(), actionBar
                .getGlobalActionHandler(ActionFactory.SELECT_ALL.getId()));
        oldActions.put(ActionFactory.DELETE.getId(), actionBar
    ...
    /**
     * restore oryginal handlers from oldActions map
     */
    public void uninstall() {
        actionBar.setGlobalActionHandler(ActionFactory.CUT.getId(),
                (IAction) oldActions.get(ActionFactory.CUT.getId()));
        actionBar.setGlobalActionHandler(ActionFactory.COPY.getId(),
                (IAction) oldActions.get(ActionFactory.COPY.getId()));
        actionBar.setGlobalActionHandler(ActionFactory.PASTE.getId(),
                (IAction) oldActions.get(ActionFactory.PASTE.getId()));
        actionBar.setGlobalActionHandler(ActionFactory.SELECT_ALL.getId(),
                (IAction) oldActions.get(ActionFactory.SELECT_ALL.getId()));
        actionBar.setGlobalActionHandler(ActionFactory.DELETE.getId(),
                (IAction) oldActions.get(ActionFactory.DELETE.getId()));
        actionBar.updateActionBars();
    }
