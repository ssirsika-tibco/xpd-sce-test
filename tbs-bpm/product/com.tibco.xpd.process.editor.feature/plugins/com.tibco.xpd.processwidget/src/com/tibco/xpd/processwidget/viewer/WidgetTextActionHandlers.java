/* 
 ** 
 **  MODULE:             $RCSfile: WidgetTextActionHandlers.java $ 
 **                      $Revision: 1.2 $ 
 ...
 ** 
 **    $Log: WidgetTextActionHandlers.java $ 
 ...
 * </p>
 */
public class WidgetTextActionHandlers {
    ...
    private class DeleteActionHandler extends Action {
        protected DeleteActionHandler() {
            super(Messages.WidgetTextActionHandlers_Delete_menu);  
    ...
    private class CutActionHandler extends Action {
        protected CutActionHandler() {
            super(Messages.WidgetTextActionHandlers_Cut_menu);
    ...
    private class CopyActionHandler extends Action {
        protected CopyActionHandler() {
            super(Messages.WidgetTextActionHandlers_Copy_menu);
    ...
    private class PasteActionHandler extends Action {
        protected PasteActionHandler() {
            super(Messages.WidgetTextActionHandlers_Paste_menu);
     ...
     */
    public WidgetTextActionHandlers(IActionBars actionBar) {
