...
/**
 * Catch BPMN error event - error-data to Main Process JavaScript output mapping
 * rule.
 * <p>
 ...
 * @since 21 Dec 2010
 */
public abstract class AbstractBpmnCatchErrorJSMappingRule extends
    ...
    protected String getMappingTypeDescription(EObject objectToValidate) {
        return Messages.AbstractSubProcessCatchErrorJSMappingRule_MapFromErrorPrefix_label;
    }
