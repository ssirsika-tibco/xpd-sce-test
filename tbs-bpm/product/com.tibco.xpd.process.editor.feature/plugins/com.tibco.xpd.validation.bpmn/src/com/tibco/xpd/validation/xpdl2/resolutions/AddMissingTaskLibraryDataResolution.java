...
/**
 * Validation problem resolution to add missing data from referenced task
 * library that is required to be duplicated in referencing process.
 * 
 * @author aallway
 * @since 3.2
 */
public class AddMissingTaskLibraryDataResolution extends
            ...
            if (libraryTask != null) {
                ...
                if (missingData != null) {
                    return String.format(propertiesLabel, Xpdl2ModelUtil
                            .getDisplayNameOrName(missingData), Xpdl2ModelUtil
