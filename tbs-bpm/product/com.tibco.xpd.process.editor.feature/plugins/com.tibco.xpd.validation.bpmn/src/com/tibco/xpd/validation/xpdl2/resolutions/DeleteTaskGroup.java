 ...
 * 
 */
public class DeleteTaskGroup extends AbstractWorkingCopyResolution {
    /** Delete Task Group command name. */
    private static final String COMMAND = "deleteTaskGroupCommand"; //$NON-NLS-1$
    ...
    protected Command getResolutionCommand(EditingDomain editingDomain,
        ...
        if (target instanceof SeparationOfDutiesActivities) {
            ...
            if (null != props) {
                /**
                 * getting the value of the retain familiar activities group id
                 */
