 ...
 * parent process' attribute to <code>true</code>.
 * 
 * @author sajain
 * @since Jan 15, 2015
 */
public class SetCallSubProcessSuspendResumeResolution extends
    ...
    protected Command getResolutionCommand(EditingDomain editingDomain,
        ...
        if (target instanceof Activity) {
            ...
            if (activity.getImplementation() instanceof SubFlow) {
                ...
                /*
                 * Check if 'suspend-resume with parent' is false and then only
                 * set it to true.
                 */
