...
/**
 * Resolution to set Call Sub-process activity's start strategy to 'Start
 * Immediate'.
 * 
 * @author sajain
 * @since Jan 15, 2015
 */
public class SetCallSubProcessToStartImmediateResolution extends
        ...
        if (target instanceof Activity) {
            ...
            if (activity.getImplementation() instanceof SubFlow) {
                ...
                if (startStrategyObject instanceof SubProcessStartStrategy) {
                    ...
                    /*
                     * Check if start strategy is set to START_IMMEDIATELY.
                     */
