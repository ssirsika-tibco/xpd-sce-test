 ...
 * @author nwilson
 */
public class ChangeActivityToServiceResolution implements IResolution {

    /** Command id. */
    private static final String COMMAND = "changeActivityToServiceCommand"; //$NON-NLS-1$
            ...
            if (resource != null) {
                ...
                if (target instanceof Activity) {
                    ...
                    if (service == null) {
                        ...
                        ensureRemoved(ed, command, task, task.getTaskManual());
                        service = Xpdl2Factory.eINSTANCE.createTaskService();
                        EStructuralFeature feature =
                            Xpdl2Package.eINSTANCE
                                    .getTask_TaskService();
