 ...
 * @author nwilson
 */
public class ChangeActivityToSubFlowResolution implements IResolution {

    /** Command id. */
    private static final String COMMAND = "changeActivityToSubFlowCommand"; //$NON-NLS-1$
            ...
            if (resource != null) {
                ...
                if (target instanceof Activity) {
                    ...
                    if (!(implementation instanceof SubFlow)) {
                        implementation = Xpdl2Factory.eINSTANCE.createSubFlow();
