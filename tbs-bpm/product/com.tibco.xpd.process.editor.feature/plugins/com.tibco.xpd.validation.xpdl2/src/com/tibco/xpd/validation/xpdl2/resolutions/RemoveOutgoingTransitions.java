 ...
 * @author nwilson
 */
public class RemoveOutgoingTransitions extends AbstractWorkingCopyResolution {

    /** Remove activity command name. */
    private static final String COMMAND = "removeOutgoingTransitionsCommand"; //$NON-NLS-1$
