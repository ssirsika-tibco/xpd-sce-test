...
/**
 * Factory for creating branch analyser tools.
 * 
 * @author nwilson
 */
public class BranchAnalyserFactory implements IPreProcessorFactory {

    /**
     * @param scope The validation scope.
     * @param input The input object.
     * @return A new branch analyser tool.
    ...
    public IPreProcessor createPreProcessor(IValidationScope scope, Object input) {
        ...
        if (input instanceof Process) {
            ...
            LoopGrouper grouper = scope.getTool(LoopGrouper.class, input);
            processor = new BranchAnalyser(tool, grouper);
        }
        return processor;
    }

    /**
     * @return The branch analyser tool class.
     * @see com.tibco.xpd.validation.provider.IPreProcessorFactory#getToolClass()
     */
    public Class<? extends IPreProcessor> getToolClass() {
        return BranchAnalyser.class;
    }
