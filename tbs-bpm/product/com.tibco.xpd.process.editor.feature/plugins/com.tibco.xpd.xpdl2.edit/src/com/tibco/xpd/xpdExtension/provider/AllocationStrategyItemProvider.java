		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addOfferPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AllocationStrategy_offer_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_AllocationStrategy_offer_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_AllocationStrategy_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.ALLOCATION_STRATEGY__OFFER, true, false, false,
	...
	protected void addStrategyPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AllocationStrategy_strategy_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_AllocationStrategy_strategy_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_AllocationStrategy_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.ALLOCATION_STRATEGY__STRATEGY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addReOfferOnClosePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AllocationStrategy_reOfferOnClose_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_AllocationStrategy_reOfferOnClose_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_AllocationStrategy_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.ALLOCATION_STRATEGY__RE_OFFER_ON_CLOSE, true, false, false,
	...
	protected void addReOfferOnCancelPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AllocationStrategy_reOfferOnCancel_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_AllocationStrategy_reOfferOnCancel_feature", "_UI_AllocationStrategy_type"), //$NON-NLS-1$ //$NON-NLS-2$
						XpdExtensionPackage.Literals.ALLOCATION_STRATEGY__RE_OFFER_ON_CANCEL, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addAllocateToOfferSetMemberIdentifierPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						...
						"_UI_AllocationStrategy_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.ALLOCATION_STRATEGY__ALLOCATE_TO_OFFER_SET_MEMBER_IDENTIFIER, true, false,
