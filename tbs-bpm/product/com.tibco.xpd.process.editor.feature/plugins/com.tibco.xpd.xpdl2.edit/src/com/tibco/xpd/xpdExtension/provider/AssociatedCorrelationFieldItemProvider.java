		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AssociatedCorrelationField_name_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_AssociatedCorrelationField_name_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_AssociatedCorrelationField_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.ASSOCIATED_CORRELATION_FIELD__NAME, true, false, false,
	...
	protected void addCorrelationModePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AssociatedCorrelationField_correlationMode_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_AssociatedCorrelationField_correlationMode_feature", //$NON-NLS-1$
								"_UI_AssociatedCorrelationField_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.ASSOCIATED_CORRELATION_FIELD__CORRELATION_MODE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
