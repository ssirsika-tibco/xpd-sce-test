		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addFormalParamPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AssociatedParameter_formalParam_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_AssociatedParameter_formalParam_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_AssociatedParameter_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.ASSOCIATED_PARAMETER__FORMAL_PARAM, true, false, false,
	...
	protected void addModePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AssociatedParameter_mode_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_AssociatedParameter_mode_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_AssociatedParameter_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.ASSOCIATED_PARAMETER__MODE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addMandatoryPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AssociatedParameter_mandatory_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_AssociatedParameter_mandatory_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_AssociatedParameter_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.ASSOCIATED_PARAMETER__MANDATORY, true, false, false,
