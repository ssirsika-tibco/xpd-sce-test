		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addQueryExpressionJoinTypePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				XpdExtensionPackage.Literals.CASE_DOCUMENT_QUERY_EXPRESSION__QUERY_EXPRESSION_JOIN_TYPE, true, false,
	...
	protected void addOpenBracketCountPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_CaseDocumentQueryExpression_openBracketCount_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_CaseDocumentQueryExpression_openBracketCount_feature", //$NON-NLS-1$
								"_UI_CaseDocumentQueryExpression_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.CASE_DOCUMENT_QUERY_EXPRESSION__OPEN_BRACKET_COUNT, true, false,
	...
	protected void addOperatorPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_CaseDocumentQueryExpression_operator_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_CaseDocumentQueryExpression_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.CASE_DOCUMENT_QUERY_EXPRESSION__OPERATOR, true, false, false,
	...
	protected void addCmisPropertyPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_CaseDocumentQueryExpression_cmisProperty_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_CaseDocumentQueryExpression_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.CASE_DOCUMENT_QUERY_EXPRESSION__CMIS_PROPERTY, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addProcessDataFieldPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_CaseDocumentQueryExpression_processDataField_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_CaseDocumentQueryExpression_processDataField_feature", //$NON-NLS-1$
								"_UI_CaseDocumentQueryExpression_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.CASE_DOCUMENT_QUERY_EXPRESSION__PROCESS_DATA_FIELD, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addCloseBracketCountPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_CaseDocumentQueryExpression_closeBracketCount_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_CaseDocumentQueryExpression_closeBracketCount_feature", //$NON-NLS-1$
								"_UI_CaseDocumentQueryExpression_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.CASE_DOCUMENT_QUERY_EXPRESSION__CLOSE_BRACKET_COUNT, true, false,
						false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addCmisDocumentPropertySelectedPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						...
						"_UI_CaseDocumentQueryExpression_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.CASE_DOCUMENT_QUERY_EXPRESSION__CMIS_DOCUMENT_PROPERTY_SELECTED, true,
