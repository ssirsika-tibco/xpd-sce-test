		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addCaseRefFieldPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_CaseReferenceOperationsType_caseRefField_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_CaseReferenceOperationsType_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.CASE_REFERENCE_OPERATIONS_TYPE__CASE_REF_FIELD, true, false, false,
