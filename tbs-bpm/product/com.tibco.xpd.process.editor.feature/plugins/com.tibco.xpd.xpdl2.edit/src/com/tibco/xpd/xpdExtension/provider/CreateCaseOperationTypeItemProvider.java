		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addFromFieldPathPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_CreateCaseOperationType_fromFieldPath_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_CreateCaseOperationType_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.CREATE_CASE_OPERATION_TYPE__FROM_FIELD_PATH, true, false, false,
	...
	protected void addToCaseRefFieldPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_CreateCaseOperationType_toCaseRefField_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_CreateCaseOperationType_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.CREATE_CASE_OPERATION_TYPE__TO_CASE_REF_FIELD, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
