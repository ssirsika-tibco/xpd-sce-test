...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdExtension.Discriminator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
	{
		if (itemPropertyDescriptors == null)
		{
			...
			addStructuredDiscriminatorPropertyDescriptor(object);
		}
	...
	protected void addDiscriminatorTypePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Discriminator_discriminatorType_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Discriminator_discriminatorType_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Discriminator_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.DISCRIMINATOR__DISCRIMINATOR_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Structured Discriminator feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addStructuredDiscriminatorPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Discriminator_structuredDiscriminator_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_Discriminator_structuredDiscriminator_feature", "_UI_Discriminator_type"), //$NON-NLS-1$ //$NON-NLS-2$
						XpdExtensionPackage.Literals.DISCRIMINATOR__STRUCTURED_DISCRIMINATOR, true, false, true, null,
						null, null));
	}
