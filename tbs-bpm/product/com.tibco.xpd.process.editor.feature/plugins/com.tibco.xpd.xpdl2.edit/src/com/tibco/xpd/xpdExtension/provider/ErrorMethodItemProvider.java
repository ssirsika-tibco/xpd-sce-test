	...
	protected void addErrorCodePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ErrorMethod_errorCode_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ErrorMethod_errorCode_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ErrorMethod_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.ERROR_METHOD__ERROR_CODE, true, false, false,
