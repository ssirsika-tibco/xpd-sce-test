		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addFileNameFieldPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_FindByFileNameOperation_fileNameField_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_FindByFileNameOperation_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.FIND_BY_FILE_NAME_OPERATION__FILE_NAME_FIELD, true, false, false,
