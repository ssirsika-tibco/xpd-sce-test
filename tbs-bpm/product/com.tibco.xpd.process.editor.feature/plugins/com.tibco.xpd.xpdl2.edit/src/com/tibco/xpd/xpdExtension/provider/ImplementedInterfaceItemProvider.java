		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addPackageRefPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ImplementedInterface_packageRef_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ImplementedInterface_packageRef_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ImplementedInterface_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.IMPLEMENTED_INTERFACE__PACKAGE_REF, true, false, false,
	...
	protected void addProcessInterfaceIdPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ImplementedInterface_processInterfaceId_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_ImplementedInterface_processInterfaceId_feature", "_UI_ImplementedInterface_type"), //$NON-NLS-1$ //$NON-NLS-2$
						XpdExtensionPackage.Literals.IMPLEMENTED_INTERFACE__PROCESS_INTERFACE_ID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
