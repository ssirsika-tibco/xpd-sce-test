		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addInstanceNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_JdbcResource_instanceName_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_JdbcResource_instanceName_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_JdbcResource_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.JDBC_RESOURCE__INSTANCE_NAME, true, false, false,
	...
	protected void addJdbcProfileNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_JdbcResource_jdbcProfileName_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_JdbcResource_jdbcProfileName_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_JdbcResource_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.JDBC_RESOURCE__JDBC_PROFILE_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
