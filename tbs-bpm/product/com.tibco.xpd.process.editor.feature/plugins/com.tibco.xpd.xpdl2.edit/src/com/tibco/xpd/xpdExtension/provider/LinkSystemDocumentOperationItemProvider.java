		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addDocumentIdPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_LinkSystemDocumentOperation_documentId_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_LinkSystemDocumentOperation_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.LINK_SYSTEM_DOCUMENT_OPERATION__DOCUMENT_ID, true, false, false,
	...
	protected void addReturnCaseDocRefFieldPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						...
						"_UI_LinkSystemDocumentOperation_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.LINK_SYSTEM_DOCUMENT_OPERATION__RETURN_CASE_DOC_REF_FIELD, true, false,
	...
	protected void addCaseRefFieldPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_LinkSystemDocumentOperation_caseRefField_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_LinkSystemDocumentOperation_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.LINK_SYSTEM_DOCUMENT_OPERATION__CASE_REF_FIELD, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
