		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addPrefixPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_NamespaceMapEntry_Prefix_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_NamespaceMapEntry_Prefix_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_NamespaceMapEntry_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.NAMESPACE_MAP_ENTRY__PREFIX, true, false, false,
	...
	protected void addNamespacePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_NamespaceMapEntry_Namespace_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_NamespaceMapEntry_Namespace_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_NamespaceMapEntry_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.NAMESPACE_MAP_ENTRY__NAMESPACE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
