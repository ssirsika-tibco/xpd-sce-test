	...
	protected void addPrefixMappingDisabledPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_NamespacePrefixMap_PrefixMappingDisabled_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_NamespacePrefixMap_PrefixMappingDisabled_feature", "_UI_NamespacePrefixMap_type"), //$NON-NLS-1$ //$NON-NLS-2$
						XpdExtensionPackage.Literals.NAMESPACE_PREFIX_MAP__PREFIX_MAPPING_DISABLED, true, false, false,
