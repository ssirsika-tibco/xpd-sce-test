		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addPortTypeNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PortTypeOperation_portTypeName_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_PortTypeOperation_portTypeName_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_PortTypeOperation_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.PORT_TYPE_OPERATION__PORT_TYPE_NAME, true, false, false,
	...
	protected void addOperationNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PortTypeOperation_operationName_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_PortTypeOperation_operationName_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_PortTypeOperation_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.PORT_TYPE_OPERATION__OPERATION_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTransportPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PortTypeOperation_transport_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_PortTypeOperation_transport_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_PortTypeOperation_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.PORT_TYPE_OPERATION__TRANSPORT, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
