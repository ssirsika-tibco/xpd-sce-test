...
public class RescheduleTimerScriptItemProvider extends ExpressionItemProvider
{
	...
	protected void addDurationRelativeToPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_RescheduleTimerScript_durationRelativeTo_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_RescheduleTimerScript_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.RESCHEDULE_TIMER_SCRIPT__DURATION_RELATIVE_TO, true, false, false,
