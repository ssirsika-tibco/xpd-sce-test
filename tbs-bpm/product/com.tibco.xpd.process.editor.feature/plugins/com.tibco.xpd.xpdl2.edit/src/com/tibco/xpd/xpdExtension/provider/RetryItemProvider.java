		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addMaxPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Retry_max_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Retry_max_feature", "_UI_Retry_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						XpdExtensionPackage.Literals.RETRY__MAX, true, false, false,
	...
	protected void addInitialPeriodPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Retry_initialPeriod_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Retry_initialPeriod_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Retry_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.RETRY__INITIAL_PERIOD, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addPeriodIncrementPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Retry_periodIncrement_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Retry_periodIncrement_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Retry_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.RETRY__PERIOD_INCREMENT, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addMaxRetryActionPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Retry_maxRetryAction_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_Retry_maxRetryAction_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Retry_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.RETRY__MAX_RETRY_ACTION, true, false, false,
