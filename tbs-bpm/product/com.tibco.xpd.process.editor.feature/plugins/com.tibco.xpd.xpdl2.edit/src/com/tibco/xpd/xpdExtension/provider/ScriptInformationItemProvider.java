...
public class ScriptInformationItemProvider extends NamedElementItemProvider
{
	...
	protected void addDirectionPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ScriptInformation_direction_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ScriptInformation_direction_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ScriptInformation_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.SCRIPT_INFORMATION__DIRECTION, true, false, false,
	...
	protected void addActivityPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ScriptInformation_activity_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_ScriptInformation_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.SCRIPT_INFORMATION__ACTIVITY, true, false, true, null, null, null));
	}
	...
	protected void addReferencePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ScriptInformation_reference_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_ScriptInformation_reference_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ScriptInformation_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.SCRIPT_INFORMATION__REFERENCE, true, false, false,
