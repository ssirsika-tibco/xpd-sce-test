		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addDeployToProcessRuntimePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				XpdExtensionPackage.Literals.SERVICE_PROCESS_CONFIGURATION__DEPLOY_TO_PROCESS_RUNTIME, true, false,
	...
	protected void addDeployToPageflowRuntimePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						...
						"_UI_ServiceProcessConfiguration_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.SERVICE_PROCESS_CONFIGURATION__DEPLOY_TO_PAGEFLOW_RUNTIME, true, false,
				false, ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
