...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdExtension.StructuredDiscriminator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	 ...
	 * @generated
	 */
	public StructuredDiscriminatorItemProvider(AdapterFactory adapterFactory)
	{
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
	{
		if (itemPropertyDescriptors == null)
		{
			...
			addWaitForIncomingPathPropertyDescriptor(object);
			addUpStreamParallelSplitPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Wait For Incoming Path feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addWaitForIncomingPathPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						"_UI_StructuredDiscriminator_waitForIncomingPath_feature", "_UI_StructuredDiscriminator_type"), //$NON-NLS-1$ //$NON-NLS-2$
				XpdExtensionPackage.Literals.STRUCTURED_DISCRIMINATOR__WAIT_FOR_INCOMING_PATH, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Up Stream Parallel Split feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addUpStreamParallelSplitPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_StructuredDiscriminator_UpStreamParallelSplit_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_StructuredDiscriminator_UpStreamParallelSplit_feature", //$NON-NLS-1$
								"_UI_StructuredDiscriminator_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.STRUCTURED_DISCRIMINATOR__UP_STREAM_PARALLEL_SPLIT, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns StructuredDiscriminator.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
