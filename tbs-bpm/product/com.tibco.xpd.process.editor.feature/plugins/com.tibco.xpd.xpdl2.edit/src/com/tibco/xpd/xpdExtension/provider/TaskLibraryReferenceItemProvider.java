...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdExtension.TaskLibraryReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	 ...
	 * @generated
	 */
	public TaskLibraryReferenceItemProvider(AdapterFactory adapterFactory)
	{
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object)
	{
		if (itemPropertyDescriptors == null)
		{
			...
			addTaskLibraryIdPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Task Library Id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTaskLibraryIdPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TaskLibraryReference_taskLibraryId_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_TaskLibraryReference_taskLibraryId_feature", "_UI_TaskLibraryReference_type"), //$NON-NLS-1$ //$NON-NLS-2$
						XpdExtensionPackage.Literals.TASK_LIBRARY_REFERENCE__TASK_LIBRARY_ID, true, false, false,
	...
	protected void addPackageRefPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TaskLibraryReference_packageRef_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_TaskLibraryReference_packageRef_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_TaskLibraryReference_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.TASK_LIBRARY_REFERENCE__PACKAGE_REF, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns TaskLibraryReference.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
