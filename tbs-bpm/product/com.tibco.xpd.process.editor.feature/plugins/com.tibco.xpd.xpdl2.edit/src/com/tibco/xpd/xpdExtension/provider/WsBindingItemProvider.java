...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdExtension.WsBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WsBinding_name_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_WsBinding_name_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_WsBinding_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.WS_BINDING__NAME, true, false, false,
	...
	protected void addExtendedPropertiesPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_WsBinding_extendedProperties_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_WsBinding_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.WS_BINDING__EXTENDED_PROPERTIES, true, false, true, null, null, null));
	}
