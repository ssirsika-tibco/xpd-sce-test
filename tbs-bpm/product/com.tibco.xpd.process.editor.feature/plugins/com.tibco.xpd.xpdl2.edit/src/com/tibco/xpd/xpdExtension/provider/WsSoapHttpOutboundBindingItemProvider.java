	...
	protected void addHttpClientInstanceNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WsSoapHttpOutboundBinding_httpClientInstanceName_feature"), //$NON-NLS-1$
						...
						XpdExtensionPackage.Literals.WS_SOAP_HTTP_OUTBOUND_BINDING__HTTP_CLIENT_INSTANCE_NAME, true,
