...
public class WsSoapJmsInboundBindingItemProvider extends WsSoapBindingItemProvider
{
	...
	protected void addOutboundConnectionFactoryPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				XpdExtensionPackage.Literals.WS_SOAP_JMS_INBOUND_BINDING__OUTBOUND_CONNECTION_FACTORY, true, false,
	...
	protected void addInboundDestinationPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						"_UI_WsSoapJmsInboundBinding_inboundDestination_feature", "_UI_WsSoapJmsInboundBinding_type"), //$NON-NLS-1$ //$NON-NLS-2$
				XpdExtensionPackage.Literals.WS_SOAP_JMS_INBOUND_BINDING__INBOUND_DESTINATION, true, false, false,
