...
public class WsSoapJmsOutboundBindingItemProvider extends WsSoapBindingItemProvider
{
	...
	protected void addOutboundConnectionFactoryPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				XpdExtensionPackage.Literals.WS_SOAP_JMS_OUTBOUND_BINDING__OUTBOUND_CONNECTION_FACTORY, true, false,
	...
	protected void addInboundDestinationPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						"_UI_WsSoapJmsOutboundBinding_inboundDestination_feature", "_UI_WsSoapJmsOutboundBinding_type"), //$NON-NLS-1$ //$NON-NLS-2$
				XpdExtensionPackage.Literals.WS_SOAP_JMS_OUTBOUND_BINDING__INBOUND_DESTINATION, true, false, false,
	...
	protected void addOutboundDestinationPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WsSoapJmsOutboundBinding_outboundDestination_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_WsSoapJmsOutboundBinding_outboundDestination_feature", //$NON-NLS-1$
								"_UI_WsSoapJmsOutboundBinding_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.WS_SOAP_JMS_OUTBOUND_BINDING__OUTBOUND_DESTINATION, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDeliveryModePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_WsSoapJmsOutboundBinding_deliveryMode_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_WsSoapJmsOutboundBinding_type"), //$NON-NLS-1$
				XpdExtensionPackage.Literals.WS_SOAP_JMS_OUTBOUND_BINDING__DELIVERY_MODE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addPriorityPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_WsSoapJmsOutboundBinding_priority_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_WsSoapJmsOutboundBinding_priority_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_WsSoapJmsOutboundBinding_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.WS_SOAP_JMS_OUTBOUND_BINDING__PRIORITY, true, false, false,
	...
	protected void addMessageExpirationPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						"_UI_WsSoapJmsOutboundBinding_messageExpiration_feature", "_UI_WsSoapJmsOutboundBinding_type"), //$NON-NLS-1$ //$NON-NLS-2$
				XpdExtensionPackage.Literals.WS_SOAP_JMS_OUTBOUND_BINDING__MESSAGE_EXPIRATION, true, false, false,
				ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addInvocationTimeoutPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
						"_UI_WsSoapJmsOutboundBinding_invocationTimeout_feature", "_UI_WsSoapJmsOutboundBinding_type"), //$NON-NLS-1$ //$NON-NLS-2$
				XpdExtensionPackage.Literals.WS_SOAP_JMS_OUTBOUND_BINDING__INVOCATION_TIMEOUT, true, false, false,
				ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
