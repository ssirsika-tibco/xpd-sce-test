		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	...
	protected void addNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_XpdExtAttribute_name_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_XpdExtAttribute_name_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_XpdExtAttribute_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.XPD_EXT_ATTRIBUTE__NAME, true, false, false,
	...
	protected void addValuePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_XpdExtAttribute_value_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_XpdExtAttribute_value_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_XpdExtAttribute_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.XPD_EXT_ATTRIBUTE__VALUE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add(
				createChildParameter(XpdExtensionPackage.Literals.XPD_EXT_ATTRIBUTE__MIXED, FeatureMapUtil.createEntry(
						Xpdl2Package.Literals.DOCUMENT_ROOT__PACKAGE, Xpdl2Factory.eINSTANCE.createPackage())));
	}
