...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdExtension.XpdExtProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
	 ...
	 * @generated
	 */
	public XpdExtPropertyItemProvider(AdapterFactory adapterFactory)
	{
	...
	protected void addNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_XpdExtProperty_Name_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_XpdExtProperty_Name_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_XpdExtProperty_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.XPD_EXT_PROPERTY__NAME, true, false, false,
	...
	protected void addValuePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_XpdExtProperty_value_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", "_UI_XpdExtProperty_value_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_XpdExtProperty_type"), //$NON-NLS-1$
						XpdExtensionPackage.Literals.XPD_EXT_PROPERTY__VALUE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns XpdExtProperty.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
