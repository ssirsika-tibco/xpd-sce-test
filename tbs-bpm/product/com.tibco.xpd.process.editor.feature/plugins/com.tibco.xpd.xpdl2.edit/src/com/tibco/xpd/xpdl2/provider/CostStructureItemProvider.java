...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdl2.CostStructure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CostStructureItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    public String getText(Object object) {
        BigInteger labelValue = ((CostStructure) object).getFixedCost();
        String label = labelValue == null ? null : labelValue.toString();
        return label == null || label.length() == 0 ? getString("_UI_CostStructure_type") : //$NON-NLS-1$
                getString("_UI_CostStructure_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
