...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdl2.DataMapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataMappingItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    public String getText(Object object) {
        DirectionType labelValue = ((DataMapping) object).getDirection();
        String label = labelValue == null ? null : labelValue.toString();
        return label == null || label.length() == 0 ? getString("_UI_DataMapping_type") : //$NON-NLS-1$
                getString("_UI_DataMapping_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
