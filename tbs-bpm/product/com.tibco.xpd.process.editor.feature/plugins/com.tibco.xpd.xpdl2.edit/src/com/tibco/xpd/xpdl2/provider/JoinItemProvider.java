...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdl2.Join} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JoinItemProvider extends ItemProviderAdapter implements
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addIncomingCondtionPropertyDescriptor(object);
    ...
    /**
     * This adds a property descriptor for the Incoming Condtion feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    protected void addTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                        ...
                        Xpdl2Package.Literals.JOIN__TYPE,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public String getText(Object object) {
        String label = ((Join) object).getIncomingCondtion();
        return label == null || label.length() == 0 ? getString("_UI_Join_type") : //$NON-NLS-1$
                getString("_UI_Join_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
