...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdl2.Loop} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoopItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addLoopTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        Xpdl2Package.Literals.LOOP__LOOP_TYPE,
                        true,
                        false,
                        false,
    ...
    public String getText(Object object) {
        LoopType labelValue = ((Loop) object).getLoopType();
        String label = labelValue == null ? null : labelValue.toString();
        return label == null || label.length() == 0 ? getString("_UI_Loop_type") : //$NON-NLS-1$
                getString("_UI_Loop_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
