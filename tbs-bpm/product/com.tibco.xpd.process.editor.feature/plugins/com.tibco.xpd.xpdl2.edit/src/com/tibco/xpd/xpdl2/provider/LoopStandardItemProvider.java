...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdl2.LoopStandard} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoopStandardItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
     ...
     * @generated
     */
    public LoopStandardItemProvider(AdapterFactory adapterFactory) {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
        if (itemPropertyDescriptors == null) {
            ...
            addAttributeLoopConditionPropertyDescriptor(object);
    ...
    /**
     * This adds a property descriptor for the Attribute Loop Condition feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public String getText(Object object) {
        BigInteger labelValue = ((LoopStandard) object).getLoopCounter();
        String label = labelValue == null ? null : labelValue.toString();
        return label == null || label.length() == 0 ? getString("_UI_LoopStandard_type") : //$NON-NLS-1$
                getString("_UI_LoopStandard_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(LoopStandard.class)) {
