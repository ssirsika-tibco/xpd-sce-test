...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdl2.MessageFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MessageFlowItemProvider extends NamedElementItemProvider {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
        ...
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                                "_UI_MessageFlow_source_feature", //$NON-NLS-1$
                                "_UI_MessageFlow_type"), //$NON-NLS-1$
                        Xpdl2Package.Literals.MESSAGE_FLOW__SOURCE,
                        true,
                        false,
                        false,
    ...
    protected void addTargetPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        ...
                        getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
                                "_UI_MessageFlow_target_feature", //$NON-NLS-1$
                                "_UI_MessageFlow_type"), //$NON-NLS-1$
                        Xpdl2Package.Literals.MESSAGE_FLOW__TARGET,
                        true,
                        false,
                        false,
                        ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(Xpdl2Package.Literals.MESSAGE_FLOW__MESSAGE);
            childrenFeatures.add(Xpdl2Package.Literals.MESSAGE_FLOW__OBJECT);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(Xpdl2Package.Literals.MESSAGE_FLOW__MESSAGE,
                Xpdl2Factory.eINSTANCE.createMessage()));

        newChildDescriptors.add(createChildParameter(Xpdl2Package.Literals.MESSAGE_FLOW__OBJECT,
