...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.xpdl2.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider extends ItemProviderAdapter implements
    ...
    protected void addValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
                        ...
                        getResourceLocator(),
                        getString("_UI_Method_value_feature"), //$NON-NLS-1$
                        getString("_UI_PropertyDescriptor_description", "_UI_Method_value_feature", "_UI_Method_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        Xpdl2Package.Literals.METHOD__VALUE,
                        true,
                        false,
                        false,
    ...
    public String getText(Object object) {
        String label = ((Method) object).getValue();
    ...
    public void notifyChanged(Notification notification) {
        ...
        case Xpdl2Package.METHOD__VALUE:
