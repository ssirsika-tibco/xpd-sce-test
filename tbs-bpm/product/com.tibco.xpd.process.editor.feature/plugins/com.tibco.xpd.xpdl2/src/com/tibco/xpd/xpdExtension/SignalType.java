 ...
 * <!-- end-model-doc -->
 * @see com.tibco.xpd.xpdExtension.XpdExtensionPackage#getSignalType()
 * @model extendedMetaData="name='SignalType_._type'"
 * @generated
 */
public enum SignalType implements Enumerator
{
	...
	/**
	 * The '<em><b>Case Data</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #CASE_DATA_VALUE
	 * @generated
	 * @ordered
	 */
	CASE_DATA(2, "CaseData", "CaseData"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	/**
	 * The '<em><b>Case Data</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Case Data</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #CASE_DATA
	 ...
	 * @ordered
	 */
	public static final int					CASE_DATA_VALUE	= 2;
	 ...
	 * @generated
	 */
	private static final SignalType[]		VALUES_ARRAY	= new SignalType[]{LOCAL, GLOBAL, CASE_DATA,};
