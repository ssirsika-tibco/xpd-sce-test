...
public class ActivityResourcePatternsImpl extends EObjectImpl implements ActivityResourcePatterns
{
	...
	public void setAllocationStrategy(AllocationStrategy newAllocationStrategy)
	{
		if (newAllocationStrategy != allocationStrategy)
		{
			...
			if (allocationStrategy != null) msgs = ((InternalEObject) allocationStrategy).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.ACTIVITY_RESOURCE_PATTERNS__ALLOCATION_STRATEGY, null,
					msgs);
			if (newAllocationStrategy != null) msgs = ((InternalEObject) newAllocationStrategy).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.ACTIVITY_RESOURCE_PATTERNS__ALLOCATION_STRATEGY, null,
					msgs);
	...
	public void setPiling(PilingInfo newPiling)
	{
		...
		{
			NotificationChain msgs = null;
			if (piling != null) msgs = ((InternalEObject) piling).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.ACTIVITY_RESOURCE_PATTERNS__PILING, null, msgs);
			if (newPiling != null) msgs = ((InternalEObject) newPiling).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.ACTIVITY_RESOURCE_PATTERNS__PILING, null, msgs);
	...
	public void setWorkItemPriority(WorkItemPriority newWorkItemPriority)
	{
		...
		{
			NotificationChain msgs = null;
			if (workItemPriority != null) msgs = ((InternalEObject) workItemPriority).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.ACTIVITY_RESOURCE_PATTERNS__WORK_ITEM_PRIORITY, null,
					msgs);
			if (newWorkItemPriority != null) msgs = ((InternalEObject) newWorkItemPriority).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.ACTIVITY_RESOURCE_PATTERNS__WORK_ITEM_PRIORITY, null,
					msgs);
