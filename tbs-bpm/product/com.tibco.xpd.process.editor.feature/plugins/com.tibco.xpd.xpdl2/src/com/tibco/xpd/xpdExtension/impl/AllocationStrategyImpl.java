...
public class AllocationStrategyImpl extends EObjectImpl implements AllocationStrategy
{
	...
	public void setOffer(AllocationType newOffer)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.ALLOCATION_STRATEGY__OFFER, oldOffer, offer, !oldOfferESet));
	}
	...
	public void unsetOffer()
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.UNSET,
				XpdExtensionPackage.ALLOCATION_STRATEGY__OFFER, oldOffer, OFFER_EDEFAULT, oldOfferESet));
	}
	...
	public void setStrategy(AllocationStrategyType newStrategy)
	{
		...
		strategyESet = true;
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.ALLOCATION_STRATEGY__STRATEGY, oldStrategy, strategy, !oldStrategyESet));
	}
	...
	public void unsetStrategy()
	{
		...
		strategyESet = false;
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.UNSET,
				XpdExtensionPackage.ALLOCATION_STRATEGY__STRATEGY, oldStrategy, STRATEGY_EDEFAULT, oldStrategyESet));
	}
	...
	public String toString()
	{
		...
		if (offerESet) result.append(offer);
		else
			result.append("<unset>"); //$NON-NLS-1$
		result.append(", strategy: "); //$NON-NLS-1$
		if (strategyESet) result.append(strategy);
		else
			result.append("<unset>"); //$NON-NLS-1$
		result.append(", reOfferOnClose: "); //$NON-NLS-1$
		if (reOfferOnCloseESet) result.append(reOfferOnClose);
		else
			result.append("<unset>"); //$NON-NLS-1$
		result.append(", reOfferOnCancel: "); //$NON-NLS-1$
		if (reOfferOnCancelESet) result.append(reOfferOnCancel);
		else
			result.append("<unset>"); //$NON-NLS-1$
		result.append(", allocateToOfferSetMemberIdentifier: "); //$NON-NLS-1$
		if (allocateToOfferSetMemberIdentifierESet) result.append(allocateToOfferSetMemberIdentifier);
		else
			result.append("<unset>"); //$NON-NLS-1$
		result.append(')');
