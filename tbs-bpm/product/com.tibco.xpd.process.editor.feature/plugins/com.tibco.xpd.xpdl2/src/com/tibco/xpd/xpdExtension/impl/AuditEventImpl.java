...
public class AuditEventImpl extends EObjectImpl implements AuditEvent
{
	...
	public void setType(AuditEventType newType)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.AUDIT_EVENT__TYPE, oldType, type, !oldTypeESet));
	}
	...
	public void unsetType()
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.UNSET,
				XpdExtensionPackage.AUDIT_EVENT__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
	}
	...
	public void setInformation(Expression newInformation)
	{
		if (newInformation != information)
		{
			...
			if (information != null) msgs = ((InternalEObject) information).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.AUDIT_EVENT__INFORMATION, null, msgs);
			if (newInformation != null) msgs = ((InternalEObject) newInformation).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.AUDIT_EVENT__INFORMATION, null, msgs);
			msgs = basicSetInformation(newInformation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.AUDIT_EVENT__INFORMATION, newInformation, newInformation));
	}
