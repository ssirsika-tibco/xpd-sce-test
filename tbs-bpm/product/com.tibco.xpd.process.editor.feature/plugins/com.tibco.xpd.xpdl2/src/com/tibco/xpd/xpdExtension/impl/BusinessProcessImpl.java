...
public class BusinessProcessImpl extends EObjectImpl implements BusinessProcess
{
	...
	public void setProcessId(String newProcessId)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.BUSINESS_PROCESS__PROCESS_ID, oldProcessId, processId));
	}
	...
	public void setPackageRefId(String newPackageRefId)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.BUSINESS_PROCESS__PACKAGE_REF_ID, oldPackageRefId, packageRefId));
	}
	...
	public void setActivityId(String newActivityId)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.BUSINESS_PROCESS__ACTIVITY_ID, oldActivityId, activityId));
	}
