...
public class CalendarReferenceImpl extends EObjectImpl implements CalendarReference
{
	...
	public void setAlias(String newAlias)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.CALENDAR_REFERENCE__ALIAS, oldAlias, alias, !oldAliasESet));
	}
	...
	public void unsetAlias()
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.UNSET,
				XpdExtensionPackage.CALENDAR_REFERENCE__ALIAS, oldAlias, ALIAS_EDEFAULT, oldAliasESet));
	}
	...
	public void unsetDataFieldId()
	{
		...
		if (eNotificationRequired()) eNotify(
				new ENotificationImpl(this, Notification.UNSET, XpdExtensionPackage.CALENDAR_REFERENCE__DATA_FIELD_ID,
						oldDataFieldId, DATA_FIELD_ID_EDEFAULT, oldDataFieldIdESet));
	}
	...
	public String toString()
	{
		...
		if (aliasESet) result.append(alias);
		else
			result.append("<unset>"); //$NON-NLS-1$
		result.append(", dataFieldId: "); //$NON-NLS-1$
		if (dataFieldIdESet) result.append(dataFieldId);
		else
			result.append("<unset>"); //$NON-NLS-1$
		result.append(')');
