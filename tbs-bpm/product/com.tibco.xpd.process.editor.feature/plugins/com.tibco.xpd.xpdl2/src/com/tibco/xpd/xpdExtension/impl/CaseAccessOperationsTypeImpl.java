...
public class CaseAccessOperationsTypeImpl extends EObjectImpl implements CaseAccessOperationsType
{
	...
	public void setCreate(CreateCaseOperationType newCreate)
	{
		...
		{
			NotificationChain msgs = null;
			if (create != null) msgs = ((InternalEObject) create).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_ACCESS_OPERATIONS_TYPE__CREATE, null, msgs);
			if (newCreate != null) msgs = ((InternalEObject) newCreate).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_ACCESS_OPERATIONS_TYPE__CREATE, null, msgs);
	...
	public void setDeleteByCaseIdentifier(DeleteByCaseIdentifierType newDeleteByCaseIdentifier)
	{
		...
		{
			NotificationChain msgs = null;
			if (deleteByCaseIdentifier != null) msgs = ((InternalEObject) deleteByCaseIdentifier).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_ACCESS_OPERATIONS_TYPE__DELETE_BY_CASE_IDENTIFIER,
					null, msgs);
			...
			if (msgs != null) msgs.dispatch();
				...
				XpdExtensionPackage.CASE_ACCESS_OPERATIONS_TYPE__DELETE_BY_CASE_IDENTIFIER, newDeleteByCaseIdentifier,
				newDeleteByCaseIdentifier));
	}
