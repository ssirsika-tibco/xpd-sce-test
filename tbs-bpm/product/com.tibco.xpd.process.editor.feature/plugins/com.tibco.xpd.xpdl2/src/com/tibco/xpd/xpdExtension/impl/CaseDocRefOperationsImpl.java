...
public class CaseDocRefOperationsImpl extends EObjectImpl implements CaseDocRefOperations
{
	...
	public void setMoveCaseDocOperation(MoveCaseDocOperation newMoveCaseDocOperation)
	{
		if (newMoveCaseDocOperation != moveCaseDocOperation)
		{
			...
			if (moveCaseDocOperation != null) msgs = ((InternalEObject) moveCaseDocOperation).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_DOC_REF_OPERATIONS__MOVE_CASE_DOC_OPERATION, null,
					msgs);
			if (newMoveCaseDocOperation != null) msgs = ((InternalEObject) newMoveCaseDocOperation).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_DOC_REF_OPERATIONS__MOVE_CASE_DOC_OPERATION, null,
					msgs);
	...
	public void setUnlinkCaseDocOperation(UnlinkCaseDocOperation newUnlinkCaseDocOperation)
	{
		...
		{
			NotificationChain msgs = null;
			if (unlinkCaseDocOperation != null) msgs = ((InternalEObject) unlinkCaseDocOperation).eInverseRemove(this,
	...
	public void setLinkCaseDocOperation(LinkCaseDocOperation newLinkCaseDocOperation)
	{
		...
		{
			NotificationChain msgs = null;
			if (linkCaseDocOperation != null) msgs = ((InternalEObject) linkCaseDocOperation).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_DOC_REF_OPERATIONS__LINK_CASE_DOC_OPERATION, null,
					msgs);
			if (newLinkCaseDocOperation != null) msgs = ((InternalEObject) newLinkCaseDocOperation).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_DOC_REF_OPERATIONS__LINK_CASE_DOC_OPERATION, null,
					msgs);
	...
	public void setDeleteCaseDocOperation(DeleteCaseDocOperation newDeleteCaseDocOperation)
	{
		...
		{
			NotificationChain msgs = null;
			if (deleteCaseDocOperation != null) msgs = ((InternalEObject) deleteCaseDocOperation).eInverseRemove(this,
