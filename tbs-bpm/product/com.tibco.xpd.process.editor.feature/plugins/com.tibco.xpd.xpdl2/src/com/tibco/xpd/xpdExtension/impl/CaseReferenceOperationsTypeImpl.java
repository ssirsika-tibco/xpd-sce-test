...
public class CaseReferenceOperationsTypeImpl extends EObjectImpl implements CaseReferenceOperationsType
{
	...
	public void setUpdate(UpdateCaseOperationType newUpdate)
	{
		if (newUpdate != update)
		{
			...
			if (update != null) msgs = ((InternalEObject) update).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_REFERENCE_OPERATIONS_TYPE__UPDATE, null, msgs);
			if (newUpdate != null) msgs = ((InternalEObject) newUpdate).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_REFERENCE_OPERATIONS_TYPE__UPDATE, null, msgs);
	...
	public void setDelete(DeleteCaseReferenceOperationType newDelete)
	{
		...
		{
			NotificationChain msgs = null;
			if (delete != null) msgs = ((InternalEObject) delete).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_REFERENCE_OPERATIONS_TYPE__DELETE, null, msgs);
			if (newDelete != null) msgs = ((InternalEObject) newDelete).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_REFERENCE_OPERATIONS_TYPE__DELETE, null, msgs);
	...
	public void setAddLinkAssociations(AddLinkAssociationsType newAddLinkAssociations)
	{
		...
		{
			NotificationChain msgs = null;
			if (addLinkAssociations != null) msgs = ((InternalEObject) addLinkAssociations).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_REFERENCE_OPERATIONS_TYPE__ADD_LINK_ASSOCIATIONS,
					null, msgs);
			if (newAddLinkAssociations != null) msgs = ((InternalEObject) newAddLinkAssociations).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_REFERENCE_OPERATIONS_TYPE__ADD_LINK_ASSOCIATIONS,
					null, msgs);
	...
	public void setRemoveLinkAssociations(RemoveLinkAssociationsType newRemoveLinkAssociations)
	{
		if (newRemoveLinkAssociations != removeLinkAssociations)
		{
			...
			if (msgs != null) msgs.dispatch();
				...
				XpdExtensionPackage.CASE_REFERENCE_OPERATIONS_TYPE__REMOVE_LINK_ASSOCIATIONS, newRemoveLinkAssociations,
				newRemoveLinkAssociations));
	}
	...
	public void setRemoveAllLinksByName(RemoveAllLinksByNameType newRemoveAllLinksByName)
	{
		if (newRemoveAllLinksByName != removeAllLinksByName)
		{
			...
			if (msgs != null) msgs.dispatch();
				...
				XpdExtensionPackage.CASE_REFERENCE_OPERATIONS_TYPE__REMOVE_ALL_LINKS_BY_NAME, newRemoveAllLinksByName,
				newRemoveAllLinksByName));
	}
