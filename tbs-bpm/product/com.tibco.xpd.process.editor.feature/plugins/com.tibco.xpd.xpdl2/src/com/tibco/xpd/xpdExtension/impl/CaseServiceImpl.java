...
public class CaseServiceImpl extends EObjectImpl implements CaseService
{
	...
	public void setCaseClassType(ExternalReference newCaseClassType)
	{
		if (newCaseClassType != caseClassType)
		{
			...
			if (caseClassType != null) msgs = ((InternalEObject) caseClassType).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_SERVICE__CASE_CLASS_TYPE, null, msgs);
			if (newCaseClassType != null) msgs = ((InternalEObject) newCaseClassType).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_SERVICE__CASE_CLASS_TYPE, null, msgs);
			msgs = basicSetCaseClassType(newCaseClassType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.CASE_SERVICE__CASE_CLASS_TYPE, newCaseClassType, newCaseClassType));
	}
	...
	public void setVisibleForCaseStates(VisibleForCaseStates newVisibleForCaseStates)
	{
		...
		{
			NotificationChain msgs = null;
			if (visibleForCaseStates != null) msgs = ((InternalEObject) visibleForCaseStates).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_SERVICE__VISIBLE_FOR_CASE_STATES, null, msgs);
			if (newVisibleForCaseStates != null) msgs = ((InternalEObject) newVisibleForCaseStates).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CASE_SERVICE__VISIBLE_FOR_CASE_STATES, null, msgs);
			msgs = basicSetVisibleForCaseStates(newVisibleForCaseStates, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(
				new ENotificationImpl(this, Notification.SET, XpdExtensionPackage.CASE_SERVICE__VISIBLE_FOR_CASE_STATES,
