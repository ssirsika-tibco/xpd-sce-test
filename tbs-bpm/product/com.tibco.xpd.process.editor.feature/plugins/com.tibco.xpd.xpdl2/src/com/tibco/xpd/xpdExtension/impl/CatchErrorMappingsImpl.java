...
public class CatchErrorMappingsImpl extends EObjectImpl implements CatchErrorMappings
{
	...
	public void setMessage(Message newMessage)
	{
		if (newMessage != message)
		{
			...
			if (message != null) msgs = ((InternalEObject) message).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CATCH_ERROR_MAPPINGS__MESSAGE, null, msgs);
			...
			if (msgs != null) msgs.dispatch();
				...
				XpdExtensionPackage.CATCH_ERROR_MAPPINGS__MESSAGE, newMessage, newMessage));
	}
