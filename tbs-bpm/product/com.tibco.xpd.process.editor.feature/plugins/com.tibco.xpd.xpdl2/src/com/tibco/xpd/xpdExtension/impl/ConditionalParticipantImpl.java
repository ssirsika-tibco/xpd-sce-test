...
public class ConditionalParticipantImpl extends EObjectImpl implements ConditionalParticipant
{
	...
	public void setPerformerScript(Expression newPerformerScript)
	{
		if (newPerformerScript != performerScript)
		{
			...
			if (performerScript != null) msgs = ((InternalEObject) performerScript).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CONDITIONAL_PARTICIPANT__PERFORMER_SCRIPT, null, msgs);
			if (newPerformerScript != null) msgs = ((InternalEObject) newPerformerScript).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.CONDITIONAL_PARTICIPANT__PERFORMER_SCRIPT, null, msgs);
			msgs = basicSetPerformerScript(newPerformerScript, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.CONDITIONAL_PARTICIPANT__PERFORMER_SCRIPT, newPerformerScript, newPerformerScript));
	}
