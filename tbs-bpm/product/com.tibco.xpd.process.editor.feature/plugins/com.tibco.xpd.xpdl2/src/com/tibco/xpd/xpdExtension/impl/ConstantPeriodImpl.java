...
public class ConstantPeriodImpl extends EObjectImpl implements ConstantPeriod
{
	...
	public void setHours(BigInteger newHours)
	{
		...
		hours = newHours;
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.CONSTANT_PERIOD__HOURS, oldHours, hours));
	}
	...
	public void setMicroSeconds(BigInteger newMicroSeconds)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.CONSTANT_PERIOD__MICRO_SECONDS, oldMicroSeconds, microSeconds));
	}
	...
	public void setMinutes(BigInteger newMinutes)
	{
		...
		minutes = newMinutes;
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.CONSTANT_PERIOD__MINUTES, oldMinutes, minutes));
	}
	...
	public void setMonths(BigInteger newMonths)
	{
		...
		months = newMonths;
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.CONSTANT_PERIOD__MONTHS, oldMonths, months));
	}
	...
	public void setSeconds(BigInteger newSeconds)
	{
		...
		seconds = newSeconds;
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.CONSTANT_PERIOD__SECONDS, oldSeconds, seconds));
	}
	...
	public void setWeeks(BigInteger newWeeks)
	{
		...
		weeks = newWeeks;
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.CONSTANT_PERIOD__WEEKS, oldWeeks, weeks));
	}
	...
	public void setYears(BigInteger newYears)
	{
		...
		years = newYears;
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.CONSTANT_PERIOD__YEARS, oldYears, years));
	}
