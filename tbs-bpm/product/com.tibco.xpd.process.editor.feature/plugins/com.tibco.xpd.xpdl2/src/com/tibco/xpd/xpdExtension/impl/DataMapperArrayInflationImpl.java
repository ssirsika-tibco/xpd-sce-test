...
public class DataMapperArrayInflationImpl extends EObjectImpl implements DataMapperArrayInflation
{
	 ...
	 * @ordered
	 */
	protected static final DataMapperArrayInflationType	MAPPING_TYPE_EDEFAULT	= DataMapperArrayInflationType.APPEND_LIST;
	...
	public void setPath(String newPath)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.DATA_MAPPER_ARRAY_INFLATION__PATH, oldPath, path));
	}
	...
	public void unsetMappingType()
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.UNSET,
				XpdExtensionPackage.DATA_MAPPER_ARRAY_INFLATION__MAPPING_TYPE, oldMappingType, MAPPING_TYPE_EDEFAULT,
				oldMappingTypeESet));
	}
	...
	public String toString()
	{
		...
		if (mappingTypeESet) result.append(mappingType);
		else
