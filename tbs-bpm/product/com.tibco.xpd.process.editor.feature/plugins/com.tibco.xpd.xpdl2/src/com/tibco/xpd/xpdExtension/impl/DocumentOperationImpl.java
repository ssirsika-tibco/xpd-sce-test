...
public class DocumentOperationImpl extends EObjectImpl implements DocumentOperation
{
	...
	public void setCaseDocRefOperation(CaseDocRefOperations newCaseDocRefOperation)
	{
		if (newCaseDocRefOperation != caseDocRefOperation)
		{
			...
			if (caseDocRefOperation != null) msgs = ((InternalEObject) caseDocRefOperation).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DOCUMENT_OPERATION__CASE_DOC_REF_OPERATION, null,
					msgs);
			if (newCaseDocRefOperation != null) msgs = ((InternalEObject) newCaseDocRefOperation).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DOCUMENT_OPERATION__CASE_DOC_REF_OPERATION, null,
					msgs);
	...
	public void setCaseDocFindOperations(CaseDocFindOperations newCaseDocFindOperations)
	{
		...
		{
			NotificationChain msgs = null;
			if (caseDocFindOperations != null) msgs = ((InternalEObject) caseDocFindOperations).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DOCUMENT_OPERATION__CASE_DOC_FIND_OPERATIONS, null,
					msgs);
			if (newCaseDocFindOperations != null) msgs = ((InternalEObject) newCaseDocFindOperations).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DOCUMENT_OPERATION__CASE_DOC_FIND_OPERATIONS, null,
					msgs);
	...
	public void setLinkSystemDocumentOperation(LinkSystemDocumentOperation newLinkSystemDocumentOperation)
	{
		if (newLinkSystemDocumentOperation != linkSystemDocumentOperation)
		{
			...
			if (msgs != null) msgs.dispatch();
				...
				XpdExtensionPackage.DOCUMENT_OPERATION__LINK_SYSTEM_DOCUMENT_OPERATION, newLinkSystemDocumentOperation,
