...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
     ...
     * @ordered
     */
    protected static final EventHandlerFlowStrategy EVENT_HANDLER_FLOW_STRATEGY_EDEFAULT =
     ...
     * @ordered
     */
    protected static final BusinessServicePublishType BUSINESS_SERVICE_PUBLISH_TYPE_EDEFAULT =
    ...
    public String toString() {
        ...
        if (publishAsBusinessServiceESet)
            result.append(publishAsBusinessService);
        else
            result.append("<unset>"); //$NON-NLS-1$
        result.append(", businessServiceCategory: "); //$NON-NLS-1$
        if (businessServiceCategoryESet)
            result.append(businessServiceCategory);
        else
            result.append("<unset>"); //$NON-NLS-1$
        ...
        if (setPerformerInProcessESet)
            result.append(setPerformerInProcess);
        else
            result.append("<unset>"); //$NON-NLS-1$
        result.append(", embSubprocOtherStateHeight: "); //$NON-NLS-1$
        if (embSubprocOtherStateHeightESet)
            result.append(embSubprocOtherStateHeight);
        else
            result.append("<unset>"); //$NON-NLS-1$
        result.append(", embSubprocOtherStateWidth: "); //$NON-NLS-1$
        if (embSubprocOtherStateWidthESet)
            result.append(embSubprocOtherStateWidth);
        else
            result.append("<unset>"); //$NON-NLS-1$
        ...
        if (targetPrimitivePropertyESet)
            result.append(targetPrimitiveProperty);
        else
            result.append("<unset>"); //$NON-NLS-1$
        result.append(", sourcePrimitiveProperty: "); //$NON-NLS-1$
        if (sourcePrimitivePropertyESet)
            result.append(sourcePrimitiveProperty);
        else
            result.append("<unset>"); //$NON-NLS-1$
        result.append(", xpdModelType: "); //$NON-NLS-1$
        if (xpdModelTypeESet)
            result.append(xpdModelType);
        else
            result.append("<unset>"); //$NON-NLS-1$
        ...
        if (isCaseServiceESet)
            result.append(isCaseService);
        else
            result.append("<unset>"); //$NON-NLS-1$
        result.append(", isEventSubProcess: "); //$NON-NLS-1$
        if (isEventSubProcessESet)
            result.append(isEventSubProcess);
        else
            result.append("<unset>"); //$NON-NLS-1$
        result.append(", nonInterruptingEvent: "); //$NON-NLS-1$
        if (nonInterruptingEventESet)
            result.append(nonInterruptingEvent);
        else
            result.append("<unset>"); //$NON-NLS-1$
        result.append(", correlateImmediately: "); //$NON-NLS-1$
        result.append(correlateImmediately);
        result.append(", asyncExecutionMode: "); //$NON-NLS-1$
        if (asyncExecutionModeESet)
            result.append(asyncExecutionMode);
        else
            result.append("<unset>"); //$NON-NLS-1$
        ...
        if (businessServicePublishTypeESet)
            result.append(businessServicePublishType);
        else
            result.append("<unset>"); //$NON-NLS-1$
