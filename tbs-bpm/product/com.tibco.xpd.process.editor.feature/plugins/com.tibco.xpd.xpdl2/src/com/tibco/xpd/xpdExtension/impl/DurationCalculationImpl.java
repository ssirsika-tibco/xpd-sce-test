...
public class DurationCalculationImpl extends EObjectImpl implements DurationCalculation
{
	...
	public void setYears(Expression newYears)
	{
		if (newYears != years)
		{
			...
			if (years != null) msgs = ((InternalEObject) years).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__YEARS, null, msgs);
			if (newYears != null) msgs = ((InternalEObject) newYears).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__YEARS, null, msgs);
			msgs = basicSetYears(newYears, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.DURATION_CALCULATION__YEARS, newYears, newYears));
	}
	...
	public void setMonths(Expression newMonths)
	{
		...
		{
			NotificationChain msgs = null;
			if (months != null) msgs = ((InternalEObject) months).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__MONTHS, null, msgs);
			if (newMonths != null) msgs = ((InternalEObject) newMonths).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__MONTHS, null, msgs);
			msgs = basicSetMonths(newMonths, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.DURATION_CALCULATION__MONTHS, newMonths, newMonths));
	}
	...
	public void setWeeks(Expression newWeeks)
	{
		...
		{
			NotificationChain msgs = null;
			if (weeks != null) msgs = ((InternalEObject) weeks).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__WEEKS, null, msgs);
			if (newWeeks != null) msgs = ((InternalEObject) newWeeks).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__WEEKS, null, msgs);
			msgs = basicSetWeeks(newWeeks, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.DURATION_CALCULATION__WEEKS, newWeeks, newWeeks));
	}
	...
	public void setDays(Expression newDays)
	{
		...
		{
			NotificationChain msgs = null;
			if (days != null) msgs = ((InternalEObject) days).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__DAYS, null, msgs);
			if (newDays != null) msgs = ((InternalEObject) newDays).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__DAYS, null, msgs);
			msgs = basicSetDays(newDays, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.DURATION_CALCULATION__DAYS, newDays, newDays));
	}
	...
	public void setHours(Expression newHours)
	{
		...
		{
			NotificationChain msgs = null;
			if (hours != null) msgs = ((InternalEObject) hours).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__HOURS, null, msgs);
			if (newHours != null) msgs = ((InternalEObject) newHours).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__HOURS, null, msgs);
			msgs = basicSetHours(newHours, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.DURATION_CALCULATION__HOURS, newHours, newHours));
	}
	...
	public void setMinutes(Expression newMinutes)
	{
		...
		{
			NotificationChain msgs = null;
			if (minutes != null) msgs = ((InternalEObject) minutes).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__MINUTES, null, msgs);
			if (newMinutes != null) msgs = ((InternalEObject) newMinutes).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__MINUTES, null, msgs);
			msgs = basicSetMinutes(newMinutes, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.DURATION_CALCULATION__MINUTES, newMinutes, newMinutes));
	}
	...
	public void setSeconds(Expression newSeconds)
	{
		...
		{
			NotificationChain msgs = null;
			if (seconds != null) msgs = ((InternalEObject) seconds).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__SECONDS, null, msgs);
			if (newSeconds != null) msgs = ((InternalEObject) newSeconds).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__SECONDS, null, msgs);
			msgs = basicSetSeconds(newSeconds, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.DURATION_CALCULATION__SECONDS, newSeconds, newSeconds));
	}
	...
	public void setMicroseconds(Expression newMicroseconds)
	{
		...
		{
			NotificationChain msgs = null;
			if (microseconds != null) msgs = ((InternalEObject) microseconds).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__MICROSECONDS, null, msgs);
			if (newMicroseconds != null) msgs = ((InternalEObject) newMicroseconds).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.DURATION_CALCULATION__MICROSECONDS, null, msgs);
