...
public class FormImplementationImpl extends EObjectImpl implements FormImplementation
{
	...
	public void setFormType(FormImplementationType newFormType)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.FORM_IMPLEMENTATION__FORM_TYPE, oldFormType, formType, !oldFormTypeESet));
	}
	...
	public void unsetFormType()
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.UNSET,
				XpdExtensionPackage.FORM_IMPLEMENTATION__FORM_TYPE, oldFormType, FORM_TYPE_EDEFAULT, oldFormTypeESet));
	}
	...
	public void setFormURI(String newFormURI)
	{
		...
		formURI = newFormURI;
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.FORM_IMPLEMENTATION__FORM_URI, oldFormURI, formURI));
	}
	...
	public String toString()
	{
		...
		if (formTypeESet) result.append(formType);
		else
