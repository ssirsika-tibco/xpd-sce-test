...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Intermediate Method</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.tibco.xpd.xpdExtension.impl.IntermediateMethodImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.tibco.xpd.xpdExtension.impl.IntermediateMethodImpl#getAssociatedParameters <em>Associated Parameters</em>}</li>
 *   <li>{@link com.tibco.xpd.xpdExtension.impl.IntermediateMethodImpl#isDisableImplicitAssociation <em>Disable Implicit Association</em>}</li>
 *   <li>{@link com.tibco.xpd.xpdExtension.impl.IntermediateMethodImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link com.tibco.xpd.xpdExtension.impl.IntermediateMethodImpl#getTriggerResultMessage <em>Trigger Result Message</em>}</li>
 *   <li>{@link com.tibco.xpd.xpdExtension.impl.IntermediateMethodImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link com.tibco.xpd.xpdExtension.impl.IntermediateMethodImpl#getErrorMethods <em>Error Methods</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntermediateMethodImpl extends NamedElementImpl implements IntermediateMethod
{
	 ...
	 * @generated
	 */
	protected IntermediateMethodImpl()
	{
		super();
	}
	...
	{
		return XpdExtensionPackage.Literals.INTERMEDIATE_METHOD;
	}
	...
	public void setDescription(Description newDescription)
	{
		if (newDescription != description)
		{
			...
			if (description != null) msgs = ((InternalEObject) description).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.INTERMEDIATE_METHOD__DESCRIPTION, null, msgs);
			...
			if (msgs != null) msgs.dispatch();
				...
				XpdExtensionPackage.INTERMEDIATE_METHOD__DESCRIPTION, newDescription, newDescription));
	}
	...
	public void setDisableImplicitAssociation(boolean newDisableImplicitAssociation)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.INTERMEDIATE_METHOD__DISABLE_IMPLICIT_ASSOCIATION, oldDisableImplicitAssociation,
	...
	public void setTrigger(TriggerType newTrigger)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.INTERMEDIATE_METHOD__TRIGGER, oldTrigger, trigger));
	}
	...
	public void setTriggerResultMessage(TriggerResultMessage newTriggerResultMessage)
	{
		if (newTriggerResultMessage != triggerResultMessage)
		{
			...
			if (triggerResultMessage != null) msgs = ((InternalEObject) triggerResultMessage).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.INTERMEDIATE_METHOD__TRIGGER_RESULT_MESSAGE, null,
					msgs);
	...
	public void setVisibility(Visibility newVisibility)
	{
		...
		visibilityESet = true;
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.INTERMEDIATE_METHOD__VISIBILITY, oldVisibility, visibility, !oldVisibilityESet));
	}
		...
		if (baseClass == DescribedElement.class)
		{
			switch (baseFeatureID)
			{
				case Xpdl2Package.DESCRIBED_ELEMENT__DESCRIPTION:
					return XpdExtensionPackage.INTERMEDIATE_METHOD__DESCRIPTION;
				default:
					return -1;
			}
		}
		if (baseClass == AssociatedParametersContainer.class)
		{
			switch (baseFeatureID)
			{
				case XpdExtensionPackage.ASSOCIATED_PARAMETERS_CONTAINER__ASSOCIATED_PARAMETERS:
					return XpdExtensionPackage.INTERMEDIATE_METHOD__ASSOCIATED_PARAMETERS;
				case XpdExtensionPackage.ASSOCIATED_PARAMETERS_CONTAINER__DISABLE_IMPLICIT_ASSOCIATION:
					return XpdExtensionPackage.INTERMEDIATE_METHOD__DISABLE_IMPLICIT_ASSOCIATION;
				default:
					return -1;
			}
		}
