...
public class MultiInstanceScriptsImpl extends EObjectImpl implements MultiInstanceScripts
{
	...
	public void setAdditionalInstances(Expression newAdditionalInstances)
	{
		if (newAdditionalInstances != additionalInstances)
		{
			...
			if (additionalInstances != null) msgs = ((InternalEObject) additionalInstances).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.MULTI_INSTANCE_SCRIPTS__ADDITIONAL_INSTANCES, null,
					msgs);
			if (newAdditionalInstances != null) msgs = ((InternalEObject) newAdditionalInstances).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.MULTI_INSTANCE_SCRIPTS__ADDITIONAL_INSTANCES, null,
					msgs);
