...
public class ParticipantSharedResourceImpl extends EObjectImpl implements ParticipantSharedResource
{
	...
	public void setEmail(EmailResource newEmail)
	{
		if (newEmail != email)
		{
			...
			if (email != null) msgs = ((InternalEObject) email).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.PARTICIPANT_SHARED_RESOURCE__EMAIL, null, msgs);
			if (newEmail != null) msgs = ((InternalEObject) newEmail).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.PARTICIPANT_SHARED_RESOURCE__EMAIL, null, msgs);
	...
	public void setJdbc(JdbcResource newJdbc)
	{
		...
		{
			NotificationChain msgs = null;
			if (jdbc != null) msgs = ((InternalEObject) jdbc).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.PARTICIPANT_SHARED_RESOURCE__JDBC, null, msgs);
			if (newJdbc != null) msgs = ((InternalEObject) newJdbc).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.PARTICIPANT_SHARED_RESOURCE__JDBC, null, msgs);
			msgs = basicSetJdbc(newJdbc, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.PARTICIPANT_SHARED_RESOURCE__JDBC, newJdbc, newJdbc));
	}
	...
	public void setWebService(WsResource newWebService)
	{
		...
		{
			NotificationChain msgs = null;
			if (webService != null) msgs = ((InternalEObject) webService).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.PARTICIPANT_SHARED_RESOURCE__WEB_SERVICE, null, msgs);
			if (newWebService != null) msgs = ((InternalEObject) newWebService).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.PARTICIPANT_SHARED_RESOURCE__WEB_SERVICE, null, msgs);
	...
	public void setRestService(RestServiceResource newRestService)
	{
		...
		{
			NotificationChain msgs = null;
			if (restService != null) msgs = ((InternalEObject) restService).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.PARTICIPANT_SHARED_RESOURCE__REST_SERVICE, null, msgs);
			if (newRestService != null) msgs = ((InternalEObject) newRestService).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.PARTICIPANT_SHARED_RESOURCE__REST_SERVICE, null, msgs);
