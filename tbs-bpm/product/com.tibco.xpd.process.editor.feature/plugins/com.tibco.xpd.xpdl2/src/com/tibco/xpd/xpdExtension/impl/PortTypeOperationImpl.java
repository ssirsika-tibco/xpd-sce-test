...
public class PortTypeOperationImpl extends EObjectImpl implements PortTypeOperation
{
	...
	public void setExternalReference(ExternalReference newExternalReference)
	{
		if (newExternalReference != externalReference)
		{
			...
			if (externalReference != null) msgs = ((InternalEObject) externalReference).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.PORT_TYPE_OPERATION__EXTERNAL_REFERENCE, null, msgs);
			if (newExternalReference != null) msgs = ((InternalEObject) newExternalReference).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.PORT_TYPE_OPERATION__EXTERNAL_REFERENCE, null, msgs);
	...
	public void setTransport(String newTransport)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.PORT_TYPE_OPERATION__TRANSPORT, oldTransport, transport));
	}
