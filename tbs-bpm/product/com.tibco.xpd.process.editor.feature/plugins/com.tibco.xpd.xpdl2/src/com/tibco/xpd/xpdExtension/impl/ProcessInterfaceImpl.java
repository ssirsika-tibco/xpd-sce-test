...
public class ProcessInterfaceImpl extends NamedElementImpl implements ProcessInterface
{
	...
	public void setXpdInterfaceType(XpdInterfaceType newXpdInterfaceType)
	{
		...
		if (eNotificationRequired()) eNotify(
				new ENotificationImpl(this, Notification.SET, XpdExtensionPackage.PROCESS_INTERFACE__XPD_INTERFACE_TYPE,
						oldXpdInterfaceType, xpdInterfaceType, !oldXpdInterfaceTypeESet));
	}
	...
	public void setServiceProcessConfiguration(ServiceProcessConfiguration newServiceProcessConfiguration)
	{
		if (newServiceProcessConfiguration != serviceProcessConfiguration)
		{
			...
			if (msgs != null) msgs.dispatch();
				...
				XpdExtensionPackage.PROCESS_INTERFACE__SERVICE_PROCESS_CONFIGURATION, newServiceProcessConfiguration,
	...
	public void setDescription(Description newDescription)
	{
		if (newDescription != description)
		{
			...
			if (description != null) msgs = ((InternalEObject) description).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.PROCESS_INTERFACE__DESCRIPTION, null, msgs);
			...
			if (msgs != null) msgs.dispatch();
				...
				XpdExtensionPackage.PROCESS_INTERFACE__DESCRIPTION, newDescription, newDescription));
	}
	...
	public String toString()
	{
		...
		if (xpdInterfaceTypeESet) result.append(xpdInterfaceType);
		else
