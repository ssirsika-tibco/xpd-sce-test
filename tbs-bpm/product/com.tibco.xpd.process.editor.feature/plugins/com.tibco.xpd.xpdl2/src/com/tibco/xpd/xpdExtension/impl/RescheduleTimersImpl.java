...
public class RescheduleTimersImpl extends EObjectImpl implements RescheduleTimers
{
	 ...
	 * @ordered
	 */
	protected static final RescheduleTimerSelectionType	TIMER_SELECTION_TYPE_EDEFAULT	= RescheduleTimerSelectionType.ALL;
	...
	public void setTimerSelectionType(RescheduleTimerSelectionType newTimerSelectionType)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.RESCHEDULE_TIMERS__TIMER_SELECTION_TYPE, oldTimerSelectionType, timerSelectionType,
	...
	public String toString()
	{
		...
		if (timerSelectionTypeESet) result.append(timerSelectionType);
		else
