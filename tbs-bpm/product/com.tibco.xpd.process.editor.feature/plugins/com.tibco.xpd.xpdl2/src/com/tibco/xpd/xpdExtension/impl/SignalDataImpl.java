...
public class SignalDataImpl extends EObjectImpl implements SignalData
{
			...
			NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					XpdExtensionPackage.SIGNAL_DATA__CORRELATION_MAPPINGS, oldCorrelationMappings,
					newCorrelationMappings);
	...
	public void setCorrelationMappings(CorrelationDataMappings newCorrelationMappings)
	{
		if (newCorrelationMappings != correlationMappings)
		{
			...
			if (correlationMappings != null) msgs = ((InternalEObject) correlationMappings).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.SIGNAL_DATA__CORRELATION_MAPPINGS, null, msgs);
			if (newCorrelationMappings != null) msgs = ((InternalEObject) newCorrelationMappings).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.SIGNAL_DATA__CORRELATION_MAPPINGS, null, msgs);
			msgs = basicSetCorrelationMappings(newCorrelationMappings, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.SIGNAL_DATA__CORRELATION_MAPPINGS, newCorrelationMappings, newCorrelationMappings));
	}
	...
	public void setRescheduleTimers(RescheduleTimers newRescheduleTimers)
	{
		...
		{
			NotificationChain msgs = null;
			if (rescheduleTimers != null) msgs = ((InternalEObject) rescheduleTimers).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.SIGNAL_DATA__RESCHEDULE_TIMERS, null, msgs);
			if (newRescheduleTimers != null) msgs = ((InternalEObject) newRescheduleTimers).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.SIGNAL_DATA__RESCHEDULE_TIMERS, null, msgs);
			msgs = basicSetRescheduleTimers(newRescheduleTimers, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.SIGNAL_DATA__RESCHEDULE_TIMERS, newRescheduleTimers, newRescheduleTimers));
	}
	...
	public void setInputScriptDataMapper(ScriptDataMapper newInputScriptDataMapper)
	{
		...
		{
			NotificationChain msgs = null;
			if (inputScriptDataMapper != null) msgs = ((InternalEObject) inputScriptDataMapper).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.SIGNAL_DATA__INPUT_SCRIPT_DATA_MAPPER, null, msgs);
			if (newInputScriptDataMapper != null) msgs = ((InternalEObject) newInputScriptDataMapper).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.SIGNAL_DATA__INPUT_SCRIPT_DATA_MAPPER, null, msgs);
			msgs = basicSetInputScriptDataMapper(newInputScriptDataMapper, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(
				new ENotificationImpl(this, Notification.SET, XpdExtensionPackage.SIGNAL_DATA__INPUT_SCRIPT_DATA_MAPPER,
						newInputScriptDataMapper, newInputScriptDataMapper));
	}
	...
	public void setOutputScriptDataMapper(ScriptDataMapper newOutputScriptDataMapper)
	{
		...
		{
			NotificationChain msgs = null;
			if (outputScriptDataMapper != null) msgs = ((InternalEObject) outputScriptDataMapper).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.SIGNAL_DATA__OUTPUT_SCRIPT_DATA_MAPPER, null, msgs);
			if (newOutputScriptDataMapper != null)
				msgs = ((InternalEObject) newOutputScriptDataMapper).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.SIGNAL_DATA__OUTPUT_SCRIPT_DATA_MAPPER, null,
						msgs);
