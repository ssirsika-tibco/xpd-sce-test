...
public class UserTaskScriptsImpl extends EObjectImpl implements UserTaskScripts
{
	...
	public void setOpenScript(Expression newOpenScript)
	{
		if (newOpenScript != openScript)
		{
			...
			if (openScript != null) msgs = ((InternalEObject) openScript).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.USER_TASK_SCRIPTS__OPEN_SCRIPT, null, msgs);
			if (newOpenScript != null) msgs = ((InternalEObject) newOpenScript).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.USER_TASK_SCRIPTS__OPEN_SCRIPT, null, msgs);
			msgs = basicSetOpenScript(newOpenScript, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.USER_TASK_SCRIPTS__OPEN_SCRIPT, newOpenScript, newOpenScript));
	}
	...
	public void setCloseScript(Expression newCloseScript)
	{
		...
		{
			NotificationChain msgs = null;
			if (closeScript != null) msgs = ((InternalEObject) closeScript).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.USER_TASK_SCRIPTS__CLOSE_SCRIPT, null, msgs);
			if (newCloseScript != null) msgs = ((InternalEObject) newCloseScript).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.USER_TASK_SCRIPTS__CLOSE_SCRIPT, null, msgs);
			msgs = basicSetCloseScript(newCloseScript, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.USER_TASK_SCRIPTS__CLOSE_SCRIPT, newCloseScript, newCloseScript));
	}
	...
	public void setSubmitScript(Expression newSubmitScript)
	{
		...
		{
			NotificationChain msgs = null;
			if (submitScript != null) msgs = ((InternalEObject) submitScript).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.USER_TASK_SCRIPTS__SUBMIT_SCRIPT, null, msgs);
			if (newSubmitScript != null) msgs = ((InternalEObject) newSubmitScript).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.USER_TASK_SCRIPTS__SUBMIT_SCRIPT, null, msgs);
			msgs = basicSetSubmitScript(newSubmitScript, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.USER_TASK_SCRIPTS__SUBMIT_SCRIPT, newSubmitScript, newSubmitScript));
	}
	...
	public void setScheduleScript(Expression newScheduleScript)
	{
		...
		{
			NotificationChain msgs = null;
			if (scheduleScript != null) msgs = ((InternalEObject) scheduleScript).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.USER_TASK_SCRIPTS__SCHEDULE_SCRIPT, null, msgs);
			if (newScheduleScript != null) msgs = ((InternalEObject) newScheduleScript).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.USER_TASK_SCRIPTS__SCHEDULE_SCRIPT, null, msgs);
	...
	public void setRescheduleScript(Expression newRescheduleScript)
	{
		...
		{
			NotificationChain msgs = null;
			if (rescheduleScript != null) msgs = ((InternalEObject) rescheduleScript).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.USER_TASK_SCRIPTS__RESCHEDULE_SCRIPT, null, msgs);
			if (newRescheduleScript != null) msgs = ((InternalEObject) newRescheduleScript).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.USER_TASK_SCRIPTS__RESCHEDULE_SCRIPT, null, msgs);
			msgs = basicSetRescheduleScript(newRescheduleScript, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.USER_TASK_SCRIPTS__RESCHEDULE_SCRIPT, newRescheduleScript, newRescheduleScript));
	}
