...
public class ValidationIssueOverrideImpl extends EObjectImpl implements ValidationIssueOverride
{
	 ...
	 * @ordered
	 */
	protected static final ValidationIssueOverrideType	OVERRIDE_TYPE_EDEFAULT			= ValidationIssueOverrideType.SUPPRESS_UNTIL_NEXT_FLOW_CHANGE;
	...
	public void unsetOverrideType()
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.UNSET,
				XpdExtensionPackage.VALIDATION_ISSUE_OVERRIDE__OVERRIDE_TYPE, oldOverrideType, OVERRIDE_TYPE_EDEFAULT,
				oldOverrideTypeESet));
	}
	...
	public String toString()
	{
		...
		if (overrideTypeESet) result.append(overrideType);
		else
