	...
	public void setVirtualBinding(WsVirtualBinding newVirtualBinding)
	{
		if (newVirtualBinding != virtualBinding)
		{
			...
			if (virtualBinding != null) msgs = ((InternalEObject) virtualBinding).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.WS_INBOUND__VIRTUAL_BINDING, null, msgs);
			...
			if (msgs != null) msgs.dispatch();
				...
				XpdExtensionPackage.WS_INBOUND__VIRTUAL_BINDING, newVirtualBinding, newVirtualBinding));
	}
