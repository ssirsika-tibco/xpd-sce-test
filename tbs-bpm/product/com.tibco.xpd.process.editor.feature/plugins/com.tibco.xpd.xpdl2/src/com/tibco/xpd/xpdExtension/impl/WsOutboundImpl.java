...
public class WsOutboundImpl extends EObjectImpl implements WsOutbound
{
	...
	public void setVirtualBinding(WsVirtualBinding newVirtualBinding)
	{
		if (newVirtualBinding != virtualBinding)
		{
			...
			if (virtualBinding != null) msgs = ((InternalEObject) virtualBinding).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.WS_OUTBOUND__VIRTUAL_BINDING, null, msgs);
			if (newVirtualBinding != null) msgs = ((InternalEObject) newVirtualBinding).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.WS_OUTBOUND__VIRTUAL_BINDING, null, msgs);
			msgs = basicSetVirtualBinding(newVirtualBinding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.WS_OUTBOUND__VIRTUAL_BINDING, newVirtualBinding, newVirtualBinding));
	}
	...
	public void setSoapHttpBinding(WsSoapHttpOutboundBinding newSoapHttpBinding)
	{
		...
		{
			NotificationChain msgs = null;
			if (soapHttpBinding != null) msgs = ((InternalEObject) soapHttpBinding).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.WS_OUTBOUND__SOAP_HTTP_BINDING, null, msgs);
			if (newSoapHttpBinding != null) msgs = ((InternalEObject) newSoapHttpBinding).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.WS_OUTBOUND__SOAP_HTTP_BINDING, null, msgs);
			msgs = basicSetSoapHttpBinding(newSoapHttpBinding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.WS_OUTBOUND__SOAP_HTTP_BINDING, newSoapHttpBinding, newSoapHttpBinding));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSoapJmsBinding(WsSoapJmsOutboundBinding newSoapJmsBinding, NotificationChain msgs)
	{
	...
	public void setSoapJmsBinding(WsSoapJmsOutboundBinding newSoapJmsBinding)
	{
		...
		{
			NotificationChain msgs = null;
			if (soapJmsBinding != null) msgs = ((InternalEObject) soapJmsBinding).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.WS_OUTBOUND__SOAP_JMS_BINDING, null, msgs);
			if (newSoapJmsBinding != null) msgs = ((InternalEObject) newSoapJmsBinding).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.WS_OUTBOUND__SOAP_JMS_BINDING, null, msgs);
			msgs = basicSetSoapJmsBinding(newSoapJmsBinding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.WS_OUTBOUND__SOAP_JMS_BINDING, newSoapJmsBinding, newSoapJmsBinding));
	}
