...
public class WsSoapHttpInboundBindingImpl extends WsSoapBindingImpl implements WsSoapHttpInboundBinding
{
	...
	public void setInboundSecurity(WsSoapSecurity newInboundSecurity)
	{
		if (newInboundSecurity != inboundSecurity)
		{
			...
			if (inboundSecurity != null) msgs = ((InternalEObject) inboundSecurity).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.WS_SOAP_HTTP_INBOUND_BINDING__INBOUND_SECURITY, null,
					msgs);
			if (newInboundSecurity != null) msgs = ((InternalEObject) newInboundSecurity).eInverseAdd(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.WS_SOAP_HTTP_INBOUND_BINDING__INBOUND_SECURITY, null,
					msgs);
