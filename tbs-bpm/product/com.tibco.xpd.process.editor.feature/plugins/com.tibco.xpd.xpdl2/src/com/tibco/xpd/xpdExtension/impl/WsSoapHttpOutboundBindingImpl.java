...
public class WsSoapHttpOutboundBindingImpl extends WsSoapBindingImpl implements WsSoapHttpOutboundBinding
{
	...
	public void setOutboundSecurity(WsSoapSecurity newOutboundSecurity)
	{
		if (newOutboundSecurity != outboundSecurity)
		{
			...
			if (outboundSecurity != null) msgs = ((InternalEObject) outboundSecurity).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - XpdExtensionPackage.WS_SOAP_HTTP_OUTBOUND_BINDING__OUTBOUND_SECURITY, null,
					msgs);
	...
	public void setHttpClientInstanceName(String newHttpClientInstanceName)
	{
		...
		if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET,
				XpdExtensionPackage.WS_SOAP_HTTP_OUTBOUND_BINDING__HTTP_CLIENT_INSTANCE_NAME, oldHttpClientInstanceName,
