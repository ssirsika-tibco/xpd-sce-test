...
public class XpdExtensionFactoryImpl extends EFactoryImpl implements XpdExtensionFactory
{
	...
	public static XpdExtensionFactory init()
	{
		try
		{
			XpdExtensionFactory theXpdExtensionFactory = (XpdExtensionFactory) EPackage.Registry.INSTANCE
	...
	public Object createFromString(EDataType eDataType, String initialValue)
	{
		switch (eDataType.getClassifierID())
		{
			...
			case XpdExtensionPackage.LIBRARY_FUNCTION_USE_IN:
				return createLibraryFunctionUseInFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue)
	{
		switch (eDataType.getClassifierID())
		{
			...
			case XpdExtensionPackage.LIBRARY_FUNCTION_USE_IN:
				return convertLibraryFunctionUseInToString(eDataType, instanceValue);
			case XpdExtensionPackage.AUDIT_EVENT_TYPE_OBJECT:
	...
	{
		DeleteCaseReferenceOperationTypeImpl deleteCaseReferenceOperationType = new DeleteCaseReferenceOperationTypeImpl();
	...
	{
		DeleteByCompositeIdentifiersTypeImpl deleteByCompositeIdentifiersType = new DeleteByCompositeIdentifiersTypeImpl();
	...
	{
		ProcessDataWorkItemAttributeMappingsImpl processDataWorkItemAttributeMappings = new ProcessDataWorkItemAttributeMappingsImpl();
	 ...
	 * @generated
	 */
	public LibraryFunctionUseIn createLibraryFunctionUseInFromString(EDataType eDataType, String initialValue)
	{
		LibraryFunctionUseIn result = LibraryFunctionUseIn.get(initialValue);
		if (result == null) throw new IllegalArgumentException(
				"The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertLibraryFunctionUseInToString(EDataType eDataType, Object instanceValue)
	{
		return instanceValue == null ? null : instanceValue.toString();
	}
