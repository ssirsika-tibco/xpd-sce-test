	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			...
			case XpdExtensionPackage.ASSOCIATED_CORRELATION_FIELD:
			{
				...
				if (result == null) result = caseDescribedElement(associatedCorrelationField);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XpdExtensionPackage.ASSOCIATED_PARAMETER:
			{
				...
				if (result == null) result = caseDescribedElement(associatedParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.ERROR_METHOD:
			{
				...
				if (result == null) result = caseUniqueIdElement(errorMethod);
				if (result == null) result = caseAssociatedParametersContainer(errorMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.EVENT_HANDLER_INITIALISERS:
			{
				...
				if (result == null) result = caseNamedElement(eventHandlerInitialisers);
				if (result == null) result = caseUniqueIdElement(eventHandlerInitialisers);
				if (result == null) result = caseOtherAttributesContainer(eventHandlerInitialisers);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XpdExtensionPackage.FAULT_MESSAGE:
			{
				...
				if (result == null) result = caseMessage(faultMessage);
				if (result == null) result = caseNamedElement(faultMessage);
				if (result == null) result = caseOtherElementsContainer(faultMessage);
				if (result == null) result = caseUniqueIdElement(faultMessage);
				if (result == null) result = caseOtherAttributesContainer(faultMessage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.INTERFACE_METHOD:
			{
				...
				if (result == null) result = caseDescribedElement(interfaceMethod);
				if (result == null) result = caseAssociatedParametersContainer(interfaceMethod);
				if (result == null) result = caseUniqueIdElement(interfaceMethod);
				if (result == null) result = caseOtherAttributesContainer(interfaceMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XpdExtensionPackage.INTERMEDIATE_METHOD:
			{
				...
				if (result == null) result = caseInterfaceMethod(intermediateMethod);
				if (result == null) result = caseNamedElement(intermediateMethod);
				if (result == null) result = caseDescribedElement(intermediateMethod);
				if (result == null) result = caseAssociatedParametersContainer(intermediateMethod);
				if (result == null) result = caseUniqueIdElement(intermediateMethod);
				if (result == null) result = caseOtherAttributesContainer(intermediateMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.PROCESS_INTERFACE:
			{
				...
				if (result == null) result = caseNamedElement(processInterface);
				if (result == null) result = caseDescribedElement(processInterface);
				if (result == null) result = caseExtendedAttributesContainer(processInterface);
				if (result == null) result = caseFormalParametersContainer(processInterface);
				if (result == null) result = caseOtherElementsContainer(processInterface);
				if (result == null) result = caseUniqueIdElement(processInterface);
				if (result == null) result = caseOtherAttributesContainer(processInterface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.RESCHEDULE_TIMER_SCRIPT:
			{
				...
				if (result == null) result = caseExpression(rescheduleTimerScript);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.REST_SERVICE_RESOURCE_SECURITY:
			{
				...
				if (result == null) result = caseExtendedAttributesContainer(restServiceResourceSecurity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XpdExtensionPackage.RETAIN_FAMILIAR_ACTIVITIES:
			{
				...
				if (result == null) result = caseNamedElement(retainFamiliarActivities);
				if (result == null) result = caseUniqueIdElement(retainFamiliarActivities);
				if (result == null) result = caseOtherAttributesContainer(retainFamiliarActivities);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.SCRIPT_INFORMATION:
			{
				...
				if (result == null) result = caseNamedElement(scriptInformation);
				if (result == null) result = caseUniqueIdElement(scriptInformation);
				if (result == null) result = caseOtherAttributesContainer(scriptInformation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XpdExtensionPackage.SEPARATION_OF_DUTIES_ACTIVITIES:
			{
				...
				if (result == null) result = caseNamedElement(separationOfDutiesActivities);
				if (result == null) result = caseUniqueIdElement(separationOfDutiesActivities);
				if (result == null) result = caseOtherAttributesContainer(separationOfDutiesActivities);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.START_METHOD:
			{
				...
				if (result == null) result = caseInterfaceMethod(startMethod);
				if (result == null) result = caseNamedElement(startMethod);
				if (result == null) result = caseDescribedElement(startMethod);
				if (result == null) result = caseAssociatedParametersContainer(startMethod);
				if (result == null) result = caseUniqueIdElement(startMethod);
				if (result == null) result = caseOtherAttributesContainer(startMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.TRANSFORM_SCRIPT:
			{
				...
				if (result == null) result = caseExtendedAttributesContainer(transformScript);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.WS_SECURITY_POLICY:
			{
				...
				if (result == null) result = caseExtendedAttributesContainer(wsSecurityPolicy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XpdExtensionPackage.WS_SOAP_BINDING:
			{
				...
				if (result == null) result = caseWsBinding(wsSoapBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XpdExtensionPackage.WS_SOAP_HTTP_INBOUND_BINDING:
			{
				...
				if (result == null) result = caseWsSoapBinding(wsSoapHttpInboundBinding);
				if (result == null) result = caseWsBinding(wsSoapHttpInboundBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XpdExtensionPackage.WS_SOAP_HTTP_OUTBOUND_BINDING:
			{
				...
				if (result == null) result = caseWsSoapBinding(wsSoapHttpOutboundBinding);
				if (result == null) result = caseWsBinding(wsSoapHttpOutboundBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XpdExtensionPackage.WS_SOAP_JMS_INBOUND_BINDING:
			{
				...
				if (result == null) result = caseWsSoapBinding(wsSoapJmsInboundBinding);
				if (result == null) result = caseWsBinding(wsSoapJmsInboundBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XpdExtensionPackage.WS_SOAP_JMS_OUTBOUND_BINDING:
			{
				...
				if (result == null) result = caseWsSoapBinding(wsSoapJmsOutboundBinding);
				if (result == null) result = caseWsBinding(wsSoapJmsOutboundBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.WS_VIRTUAL_BINDING:
			{
				...
				if (result == null) result = caseWsBinding(wsVirtualBinding);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			{
				DeleteCaseReferenceOperationType deleteCaseReferenceOperationType = (DeleteCaseReferenceOperationType) theEObject;
			...
			{
				DeleteByCompositeIdentifiersType deleteByCompositeIdentifiersType = (DeleteByCompositeIdentifiersType) theEObject;
			...
			{
				ProcessDataWorkItemAttributeMappings processDataWorkItemAttributeMappings = (ProcessDataWorkItemAttributeMappings) theEObject;
			...
			case XpdExtensionPackage.CASE_SERVICE:
			{
				...
				if (result == null) result = caseOtherElementsContainer(caseService);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case XpdExtensionPackage.SCRIPT_DATA_MAPPER:
			{
				...
				if (result == null) result = caseOtherElementsContainer(scriptDataMapper);
				if (result == null) result = caseOtherAttributesContainer(scriptDataMapper);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
