...
public class PartnerRoleImpl extends EObjectImpl implements PartnerRole {
    ...
    public NotificationChain basicSetEndPoint(EndPoint newEndPoint, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    Xpdl2Package.PARTNER_ROLE__END_POINT, oldEndPoint, newEndPoint);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newEndPoint != endPoint) {
            ...
            if (endPoint != null)
                msgs = ((InternalEObject) endPoint).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - Xpdl2Package.PARTNER_ROLE__END_POINT,
                        null,
                        msgs);
            if (newEndPoint != null)
                msgs = ((InternalEObject) newEndPoint)
                        .eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpdl2Package.PARTNER_ROLE__END_POINT, null, msgs);
            msgs = basicSetEndPoint(newEndPoint, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl2Package.PARTNER_ROLE__END_POINT, newEndPoint,
                    newEndPoint));
    }
    ...
    public void setPortName(String newPortName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl2Package.PARTNER_ROLE__PORT_NAME, oldPortName,
                    portName));
    }
    ...
    public void setRoleName(String newRoleName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl2Package.PARTNER_ROLE__ROLE_NAME, oldRoleName,
                    roleName));
    }
    ...
    public void setServiceName(String newServiceName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, Xpdl2Package.PARTNER_ROLE__SERVICE_NAME,
