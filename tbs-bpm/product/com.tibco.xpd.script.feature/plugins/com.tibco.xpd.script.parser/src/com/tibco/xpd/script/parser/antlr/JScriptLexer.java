// $ANTLR 2.7.7 (20060906): "Jscript.g" -> "JScriptLexer.java"$
...
public class JScriptLexer extends antlr.CharScanner implements JScriptTokenTypes, TokenStream
 {
...
public JScriptLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public JScriptLexer(Reader in) {
	this(new CharBuffer(in));
}
public JScriptLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public JScriptLexer(LexerSharedInputState state) {
	super(state);
	...
	literals.put(new ANTLRHashString("for", this), new Integer(69));
	literals.put(new ANTLRHashString("class", this), new Integer(117));
	literals.put(new ANTLRHashString("final", this), new Integer(39));
	literals.put(new ANTLRHashString("false", this), new Integer(119));
	literals.put(new ANTLRHashString("true", this), new Integer(118));
	literals.put(new ANTLRHashString("try", this), new Integer(79));
	literals.put(new ANTLRHashString("finally", this), new Integer(80));
	literals.put(new ANTLRHashString("UndefinedDataType", this), new Integer(48));
	literals.put(new ANTLRHashString("throw", this), new Integer(76));
	literals.put(new ANTLRHashString("continue", this), new Integer(73));
	literals.put(new ANTLRHashString("do", this), new Integer(71));
	literals.put(new ANTLRHashString("null", this), new Integer(120));
	literals.put(new ANTLRHashString("function", this), new Integer(52));
	literals.put(new ANTLRHashString("while", this), new Integer(70));
	literals.put(new ANTLRHashString("abstract", this), new Integer(40));
	literals.put(new ANTLRHashString("break", this), new Integer(72));
	literals.put(new ANTLRHashString("new", this), new Integer(121));
	literals.put(new ANTLRHashString("return", this), new Integer(74));
	literals.put(new ANTLRHashString("VarType", this), new Integer(50));
	...
	literals.put(new ANTLRHashString("catch", this), new Integer(81));
}
