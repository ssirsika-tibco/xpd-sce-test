...
/**
 * 
 * Interface that provides information to the expression refactors
 * 
 * @author mtorres
 */
public interface IRefactoringInfoObject {
    ...
    /**
     * Returns the {@link IExpressionRefactorFactory}
     * @return
     */
    IExpressionRefactorFactory getExpresionRefactorFactory();

    /**
     * Sets the expression refactor factory
     * 
     * @param expressionValidatorFactory
     */
    void setExpresionRefactorFactory(IExpressionRefactorFactory expressionRefactorFactory);
     ...
     */
    void setRefactoringInfo(RefactoringInfo refactoringInfo);
    
    /**
     * Gets the refactoring information
     * @return
     */
    RefactoringInfo getRefactoringInfo();
}
