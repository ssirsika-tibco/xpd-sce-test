 ...
 * 
 */
public class JScriptInfoObject implements IInfoObject {
    ...
    private IExpressionValidatorFactory expresionValidatorFactory;
    ...
    public void setExpresionValidatorFactory(
            IExpressionValidatorFactory expresionValidatorFactory) {
        this.expresionValidatorFactory = expresionValidatorFactory;
    }

    public IExpressionValidatorFactory getExpresionValidatorFactory() {
        return expresionValidatorFactory;
    }
