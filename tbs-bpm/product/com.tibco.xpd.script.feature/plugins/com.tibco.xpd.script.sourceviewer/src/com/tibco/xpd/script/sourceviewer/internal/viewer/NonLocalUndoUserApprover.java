...
public class NonLocalUndoUserApprover implements IOperationApprover {
    ...
    private static final String scriptText = "Script"; //$NON-NLS-1$
     ...
     */
    public NonLocalUndoUserApprover(IUndoContext context, IWorkbenchPartSite partSite,
    ...
    public IStatus proceedRedoing(IUndoableOperation operation,
        ...
        String message = NLS.bind(
                "", operation //$NON-NLS-1$
                        .getLabel(), NonLocalUndoUserApprover.scriptText);
        return proceedWithOperation(operation, message, ""); //$NON-NLS-1$
    }
    ...
    private IStatus proceedWithOperation(IUndoableOperation operation,
        ...
        MessageDialog dialog = new MessageDialog(partSite.getShell(), NonLocalUndoUserApprover.scriptText,
