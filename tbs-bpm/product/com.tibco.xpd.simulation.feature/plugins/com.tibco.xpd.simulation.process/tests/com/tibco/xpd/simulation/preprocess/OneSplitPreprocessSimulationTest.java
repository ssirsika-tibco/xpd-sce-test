 ...
 * @author jarciuch
 */
public class OneSplitPreprocessSimulationTest extends XpdlBaseTestCase {

    private static final String PROCESS_NAME = "1"; //$NON-NLS-1$
    private static final String TEST_XPDL_FILE = "test-files/OneSplit.xpdl"; //$NON-NLS-1$
    private static final String OUT_FILE = "test-files/OneSplitOut.xpdl"; //$NON-NLS-1$
    private static final String OUT_FILE_2 = "test-files/OneSplitOut2.xpdl"; //$NON-NLS-1$
