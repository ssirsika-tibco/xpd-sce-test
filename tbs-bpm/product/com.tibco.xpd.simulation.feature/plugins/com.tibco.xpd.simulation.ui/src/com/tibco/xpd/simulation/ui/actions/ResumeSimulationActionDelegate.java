/* 
 ** 
 **  MODULE:             $RCSfile: ResumeSimulationActionDelegate.java $ 
 **                      $Revision: 1.0 $ 
 **                      $Date: 2005-09-27 $ 
 ** 
 **  DESCRIPTION:           
...
public class ResumeSimulationActionDelegate extends AbstractActionDelegate {

    private Map enabledState;

    public ResumeSimulationActionDelegate() {
        super();
        ...
        enabledState.put(SimulationEventKeys.SIMULATION_STATE_PAUSED,Boolean.TRUE);
        enabledState.put(SimulationEventKeys.SIMULATION_STATE_RUNNING,Boolean.FALSE);
    }
    ...
    protected void doRun() {
        LaunchPlugin.getSimulationControler().resumeSimulation();
    }
