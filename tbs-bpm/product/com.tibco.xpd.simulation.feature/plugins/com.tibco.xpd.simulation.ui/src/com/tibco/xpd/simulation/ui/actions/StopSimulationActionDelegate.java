/* 
** 
**  MODULE:             $RCSfile: StopSimulationActionDelegate.java $ 
**                      $Revision: 1.0 $ 
**                      $Date: 2005-09-27 $ 
** 
**  DESCRIPTION:           
...
public class StopSimulationActionDelegate extends AbstractActionDelegate {
    ...
    protected void doRun() {
        LaunchPlugin.getSimulationControler().stopSimulation();
    }
