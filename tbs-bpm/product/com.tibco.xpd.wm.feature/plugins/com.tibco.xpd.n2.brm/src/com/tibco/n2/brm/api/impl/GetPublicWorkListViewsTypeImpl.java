...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Public Work List Views Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetPublicWorkListViewsTypeImpl#getApiVersion <em>Api Version</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetPublicWorkListViewsTypeImpl#getNumberOfItems <em>Number Of Items</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetPublicWorkListViewsTypeImpl#getStartPosition <em>Start Position</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GetPublicWorkListViewsTypeImpl extends EObjectImpl implements GetPublicWorkListViewsType {
    /**
     ...
     * @generated
     */
    protected GetPublicWorkListViewsTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return N2BRMPackage.Literals.GET_PUBLIC_WORK_LIST_VIEWS_TYPE;
    }
    ...
    public void setApiVersion(int newApiVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_PUBLIC_WORK_LIST_VIEWS_TYPE__API_VERSION, oldApiVersion, apiVersion, !oldApiVersionESet));
    }
    ...
    public void unsetApiVersion() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_PUBLIC_WORK_LIST_VIEWS_TYPE__API_VERSION, oldApiVersion, API_VERSION_EDEFAULT, oldApiVersionESet));
    }
    ...
    public void setNumberOfItems(long newNumberOfItems) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_PUBLIC_WORK_LIST_VIEWS_TYPE__NUMBER_OF_ITEMS, oldNumberOfItems, numberOfItems, !oldNumberOfItemsESet));
    }
    ...
    public void unsetNumberOfItems() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_PUBLIC_WORK_LIST_VIEWS_TYPE__NUMBER_OF_ITEMS, oldNumberOfItems, NUMBER_OF_ITEMS_EDEFAULT, oldNumberOfItemsESet));
    }
    ...
    public void setStartPosition(long newStartPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_PUBLIC_WORK_LIST_VIEWS_TYPE__START_POSITION, oldStartPosition, startPosition, !oldStartPositionESet));
    }
    ...
    public void unsetStartPosition() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_PUBLIC_WORK_LIST_VIEWS_TYPE__START_POSITION, oldStartPosition, START_POSITION_EDEFAULT, oldStartPositionESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case N2BRMPackage.GET_PUBLIC_WORK_LIST_VIEWS_TYPE__API_VERSION:
                return getApiVersion();
            case N2BRMPackage.GET_PUBLIC_WORK_LIST_VIEWS_TYPE__NUMBER_OF_ITEMS:
                return getNumberOfItems();
            case N2BRMPackage.GET_PUBLIC_WORK_LIST_VIEWS_TYPE__START_POSITION:
...
} //GetPublicWorkListViewsTypeImpl
