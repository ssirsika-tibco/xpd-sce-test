...
import com.tibco.n2.brm.api.GetWorkListItemsResponseType;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Work List Items Response Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkListItemsResponseTypeImpl#getStartPosition <em>Start Position</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkListItemsResponseTypeImpl#getEndPosition <em>End Position</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkListItemsResponseTypeImpl#getTotalItems <em>Total Items</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkListItemsResponseTypeImpl#getWorkItems <em>Work Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GetWorkListItemsResponseTypeImpl extends EObjectImpl implements GetWorkListItemsResponseType {
    /**
     ...
     * @generated
     */
    protected GetWorkListItemsResponseTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return N2BRMPackage.Literals.GET_WORK_LIST_ITEMS_RESPONSE_TYPE;
    }
    ...
    public void setStartPosition(long newStartPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_LIST_ITEMS_RESPONSE_TYPE__START_POSITION, oldStartPosition, startPosition, !oldStartPositionESet));
    }
    ...
    public void unsetStartPosition() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_WORK_LIST_ITEMS_RESPONSE_TYPE__START_POSITION, oldStartPosition, START_POSITION_EDEFAULT, oldStartPositionESet));
    }
    ...
    public void setEndPosition(long newEndPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_LIST_ITEMS_RESPONSE_TYPE__END_POSITION, oldEndPosition, endPosition, !oldEndPositionESet));
    }
    ...
    public void unsetEndPosition() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_WORK_LIST_ITEMS_RESPONSE_TYPE__END_POSITION, oldEndPosition, END_POSITION_EDEFAULT, oldEndPositionESet));
    }
    ...
    public void setTotalItems(long newTotalItems) {
        ...
        totalItemsESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_LIST_ITEMS_RESPONSE_TYPE__TOTAL_ITEMS, oldTotalItems, totalItems, !oldTotalItemsESet));
    }
    ...
    public void unsetTotalItems() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_WORK_LIST_ITEMS_RESPONSE_TYPE__TOTAL_ITEMS, oldTotalItems, TOTAL_ITEMS_EDEFAULT, oldTotalItemsESet));
    }
    ...
    public EList<WorkItem> getWorkItems() {
        if (workItems == null) {
            workItems = new EObjectContainmentEList<WorkItem>(WorkItem.class, this, N2BRMPackage.GET_WORK_LIST_ITEMS_RESPONSE_TYPE__WORK_ITEMS);
        }
        return workItems;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case N2BRMPackage.GET_WORK_LIST_ITEMS_RESPONSE_TYPE__WORK_ITEMS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case N2BRMPackage.GET_WORK_LIST_ITEMS_RESPONSE_TYPE__START_POSITION:
                return getStartPosition();
            case N2BRMPackage.GET_WORK_LIST_ITEMS_RESPONSE_TYPE__END_POSITION:
                return getEndPosition();
            case N2BRMPackage.GET_WORK_LIST_ITEMS_RESPONSE_TYPE__TOTAL_ITEMS:
...
} //GetWorkListItemsResponseTypeImpl
