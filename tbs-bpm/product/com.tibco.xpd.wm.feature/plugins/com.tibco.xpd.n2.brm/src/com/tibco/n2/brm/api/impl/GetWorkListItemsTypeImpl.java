...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Work List Items Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkListItemsTypeImpl#getResourcesRequired <em>Resources Required</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkListItemsTypeImpl#getEntityID <em>Entity ID</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkListItemsTypeImpl#getOrderFilterCriteria <em>Order Filter Criteria</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkListItemsTypeImpl#isGetTotalCount <em>Get Total Count</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkListItemsTypeImpl#getNumberOfItems <em>Number Of Items</em>}</li>
 *   <li>{@link com.tibco.n2.brm.api.impl.GetWorkListItemsTypeImpl#getStartPosition <em>Start Position</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GetWorkListItemsTypeImpl extends EObjectImpl implements GetWorkListItemsType {
    /**
     ...
     * @generated
     */
    protected GetWorkListItemsTypeImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return N2BRMPackage.Literals.GET_WORK_LIST_ITEMS_TYPE;
    }
    ...
    public void setResourcesRequired(ResourcesRequiredType newResourcesRequired) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__RESOURCES_REQUIRED, oldResourcesRequired, resourcesRequired, !oldResourcesRequiredESet));
    }
    ...
    public void unsetResourcesRequired() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__RESOURCES_REQUIRED, oldResourcesRequired, RESOURCES_REQUIRED_EDEFAULT, oldResourcesRequiredESet));
    }
    ...
    public NotificationChain basicSetEntityID(XmlModelEntityId newEntityID, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ENTITY_ID, oldEntityID, newEntityID);
    ...
    public void setEntityID(XmlModelEntityId newEntityID) {
        if (newEntityID != entityID) {
            ...
            if (entityID != null)
                msgs = ((InternalEObject)entityID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ENTITY_ID, null, msgs);
            if (newEntityID != null)
                msgs = ((InternalEObject)newEntityID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ENTITY_ID, null, msgs);
            msgs = basicSetEntityID(newEntityID, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ENTITY_ID, newEntityID, newEntityID));
    }
    ...
    public NotificationChain basicSetOrderFilterCriteria(OrderFilterCriteria newOrderFilterCriteria, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ORDER_FILTER_CRITERIA, oldOrderFilterCriteria, newOrderFilterCriteria);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setOrderFilterCriteria(OrderFilterCriteria newOrderFilterCriteria) {
        if (newOrderFilterCriteria != orderFilterCriteria) {
            ...
            if (orderFilterCriteria != null)
                msgs = ((InternalEObject)orderFilterCriteria).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ORDER_FILTER_CRITERIA, null, msgs);
            if (newOrderFilterCriteria != null)
                msgs = ((InternalEObject)newOrderFilterCriteria).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ORDER_FILTER_CRITERIA, null, msgs);
            msgs = basicSetOrderFilterCriteria(newOrderFilterCriteria, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ORDER_FILTER_CRITERIA, newOrderFilterCriteria, newOrderFilterCriteria));
    }
    ...
    public void setGetTotalCount(boolean newGetTotalCount) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__GET_TOTAL_COUNT, oldGetTotalCount, getTotalCount, !oldGetTotalCountESet));
    }
    ...
    public void unsetGetTotalCount() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__GET_TOTAL_COUNT, oldGetTotalCount, GET_TOTAL_COUNT_EDEFAULT, oldGetTotalCountESet));
    }
    ...
    public void setNumberOfItems(long newNumberOfItems) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__NUMBER_OF_ITEMS, oldNumberOfItems, numberOfItems, !oldNumberOfItemsESet));
    }
    ...
    public void unsetNumberOfItems() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__NUMBER_OF_ITEMS, oldNumberOfItems, NUMBER_OF_ITEMS_EDEFAULT, oldNumberOfItemsESet));
    }
    ...
    public void setStartPosition(long newStartPosition) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__START_POSITION, oldStartPosition, startPosition, !oldStartPositionESet));
    }
    ...
    public void unsetStartPosition() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__START_POSITION, oldStartPosition, START_POSITION_EDEFAULT, oldStartPositionESet));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ENTITY_ID:
                return basicSetEntityID(null, msgs);
            case N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ORDER_FILTER_CRITERIA:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__RESOURCES_REQUIRED:
                return getResourcesRequired();
            case N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ENTITY_ID:
                return getEntityID();
            case N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__ORDER_FILTER_CRITERIA:
                return getOrderFilterCriteria();
            case N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__GET_TOTAL_COUNT:
                return isGetTotalCount();
            case N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__NUMBER_OF_ITEMS:
                return getNumberOfItems();
            case N2BRMPackage.GET_WORK_LIST_ITEMS_TYPE__START_POSITION:
