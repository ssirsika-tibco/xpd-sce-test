...
public class BrmModelsRascContributor implements RascContributor {
    ...
    public void process(IProject aProject, IProgressMonitor aProgressMonitor,
        ...
        try {
            ...
            Version version = new Version(projectVersion.getMajor(),
                    projectVersion.getMinor(), projectVersion.getMicro(),
            ...
            System.out.println("** TOOK this ling to generate BRM models: " //$NON-NLS-1$
