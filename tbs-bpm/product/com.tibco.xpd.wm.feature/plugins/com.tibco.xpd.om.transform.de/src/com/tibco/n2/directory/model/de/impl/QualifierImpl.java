 ...
 * <ul>
 *   <li>{@link com.tibco.n2.directory.model.de.impl.QualifierImpl#getEnum <em>Enum</em>}</li>
 *   <li>{@link com.tibco.n2.directory.model.de.impl.QualifierImpl#getDataType <em>Data Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class QualifierImpl extends EObjectImpl implements Qualifier {
    ...
    protected EClass eStaticClass() {
        return DePackage.Literals.QUALIFIER;
    }
    ...
    public EList<String> getEnum() {
        if (enum_ == null) {
            enum_ = new EDataTypeEList<String>(String.class, this, DePackage.QUALIFIER__ENUM);
        }
        return enum_;
    }
    ...
    public void setDataType(DataType newDataType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DePackage.QUALIFIER__DATA_TYPE, oldDataType, dataType, !oldDataTypeESet));
    }
    ...
    public void unsetDataType() {
        ...
        dataTypeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, DePackage.QUALIFIER__DATA_TYPE, oldDataType, DATA_TYPE_EDEFAULT, oldDataTypeESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case DePackage.QUALIFIER__ENUM:
                return getEnum();
            case DePackage.QUALIFIER__DATA_TYPE:
                return getDataType();
        }
