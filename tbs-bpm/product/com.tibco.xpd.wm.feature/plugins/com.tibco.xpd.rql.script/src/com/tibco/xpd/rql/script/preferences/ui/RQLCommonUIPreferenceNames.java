 ...
 */
public class RQLCommonUIPreferenceNames extends AbstractScriptCommonUIPreferenceNames{
	/**
	 ...
	 * </p>
	 */
	public static final String AUTO_PROPOSE = "autoProposeRQL";//$NON-NLS-1$
	 ...
	 * </p>
	 */
	public static final String AUTO_PROPOSE_CODE = "autoProposeCodeRQL";//$NON-NLS-1$
	 ...
	 * </p>
	 */
	public static final String INDENTATION_SIZE = "indentationSizeRQL";//$NON-NLS-1$
	 ...
	 * </p>
	 */
	public static final String INDENTATION_CHAR = "indentationCharRQL";//$NON-NLS-1$
	 ...
	 */
	public static final String TAB = "tabRQL"; //$NON-NLS-1$
	 ...
	 * @see #INDENTATION_CHAR
	 */
	public static final String SPACE = "spaceRQL"; //$NON-NLS-1$
}
