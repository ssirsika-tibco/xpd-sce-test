...
import com.tibco.xpd.analyst.resources.xpdl2.wizards.newparticipant.AbstractNewParticipantWizard;
...
/**
 * New participant wizard for task library participants.
 * <p>
 * Requests to add participant to package are redirected to the task library (the
 * one process in task library package).
 * 
 * @author aallway
 * @since 3.2
 */
public class NewParticipantWizard extends AbstractNewParticipantWizard {

    @Override
    protected EObject getEContainer(AbstractSpecialFolderFileSelectionPage locationPage) {
