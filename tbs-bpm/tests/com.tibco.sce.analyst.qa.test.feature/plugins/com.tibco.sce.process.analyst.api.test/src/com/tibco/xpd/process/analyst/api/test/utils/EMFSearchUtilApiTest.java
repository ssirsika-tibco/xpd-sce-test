...
/**
 * EMFSearchUtilApiTest
 * <p>
 * EMFSearchUtilApiTest - To test ongoing backwards-compatibility of API provided by the class(es):
 * <li>com.tibco.xpd.xpdl2.extension.EMFSearchUtil</li> 
 * </p>
 *
 * <p>
 ...
 * </p>
 */
public class EMFSearchUtilApiTest extends AbstractApiClassTest {

    public void testApiFor_com_tibco_xpd_xpdl2_extension_EMFSearchUtil() throws Exception {

		String clazzBundleId = "com.tibco.xpd.xpdl2"; //$NON-NLS-1$
        ...
        String clazzName = "com.tibco.xpd.xpdl2.extension.EMFSearchUtil"; //$NON-NLS-1$
        ...
        String[] constructorControlSample = new String[] { 
            "public com.tibco.xpd.xpdl2.extension.EMFSearchUtil()", //$NON-NLS-1$
                };
        ...
        String[] methodControlSample = new String[] { 
            "public static org.eclipse.emf.ecore.EObject findInList(java.util.List,org.eclipse.emf.ecore.EStructuralFeature,java.lang.Object)", //$NON-NLS-1$ 
            "public static org.eclipse.emf.common.util.EList findManyInList(java.util.List,org.eclipse.emf.ecore.EStructuralFeature,java.lang.Object)", //$NON-NLS-1$ 
