...
/**
 * ProcessDestinationUtilApiTest
 * <p>
 * ProcessDestinationUtilApiTest - To test ongoing backwards-compatibility of API provided by the class(es):
 * <li>com.tibco.xpd.analyst.resources.xpdl2.utils.ProcessDestinationUtil</li> 
 * </p>
 *
 * <p>
 ...
 * </p>
 */
public class ProcessDestinationUtilApiTest extends AbstractApiClassTest {

    public void testApiFor_com_tibco_xpd_analyst_resources_xpdl2_utils_ProcessDestinationUtil() throws Exception {
        ...
        String clazzName = "com.tibco.xpd.analyst.resources.xpdl2.utils.ProcessDestinationUtil"; //$NON-NLS-1$
        ...
        String[] constructorControlSample = new String[] { 
            "public com.tibco.xpd.analyst.resources.xpdl2.utils.ProcessDestinationUtil()", //$NON-NLS-1$
                };
        checkApiConstructors(clazz, constructorControlSample);

        String[] fieldControlSample = new String[] { 
            "public static final java.lang.String com.tibco.xpd.analyst.resources.xpdl2.utils.ProcessDestinationUtil.XPDL2WSDL_GENERATION_VALIDATION_DESTINATION",  //$NON-NLS-1$ 
                };
        checkApiFields(clazz, fieldControlSample);

        String[] methodControlSample = new String[] { 
            "public static java.lang.Boolean shouldGenerateWSDLForProcessDestinations(com.tibco.xpd.xpdl2.Process)", //$NON-NLS-1$ 
            "public static java.lang.Boolean shouldGenerateWSDLForProcessInterfaceDestinations(com.tibco.xpd.xpdExtension.ProcessInterface)", //$NON-NLS-1$ 
            "public static boolean isWsdlGenerationPreferenceEnabled(org.eclipse.emf.ecore.EObject)", //$NON-NLS-1$ 
