...
/**
 * ProcessDialogUtilApiTest
 * <p>
 * ProcessDialogUtilApiTest - To test ongoing backwards-compatibility of API provided by the class(es):
 * <li>com.tibco.xpd.processeditor.xpdl2.util.ProcessDialogUtil</li> 
 * </p>
 *
 * <p>
 ...
 * </p>
 */
public class ProcessDialogUtilApiTest extends AbstractApiClassTest {

    public void testApiFor_com_tibco_xpd_processeditor_xpdl2_util_ProcessDialogUtil() throws Exception {
        ...
        String clazzName = "com.tibco.xpd.processeditor.xpdl2.util.ProcessDialogUtil"; //$NON-NLS-1$
        ...
        String[] constructorControlSample = new String[] { 
            "public com.tibco.xpd.processeditor.xpdl2.util.ProcessDialogUtil()", //$NON-NLS-1$
                };
        ...
        String[] methodControlSample = new String[] { 
            "public static void enableSolutionDesignCapability(org.eclipse.swt.widgets.Shell,boolean)", //$NON-NLS-1$ 
