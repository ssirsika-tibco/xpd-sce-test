package com.tibco.bds.designtime.generator.test.da;
...
import com.tibco.bds.designtime.generator.da.DAGenerator;
...
public class DAGenerationTest extends RuntimeGenerationTest {

    private String extendionId = "com.tibco.bds.designtime.generator.da"; //$NON-NLS-1$
    ...
    public void testOrderModel() throws CoreException, IOException,
        ...
        performTest(Collections.singletonList("com.example.ordermodel.bom"), //$NON-NLS-1$
                "da/com.example.ordermodel.da.bds-known-good-output.zip", //$NON-NLS-1$
                ".com.example.ordermodel.da.bds", //$NON-NLS-1$
                "1.0.0.1"); //$NON-NLS-1$
    }
    ...
    public void testGDComp() throws CoreException, IOException,
            GenerationException, DifferException, BOMIllegalStateException {
        performTest(Collections.singletonList("com.example.gdcomp.bom"), //$NON-NLS-1$
                "da/com.example.gdcomp.da.bds-known-good-output.zip", //$NON-NLS-1$
                ".com.example.gdcomp.da.bds", //$NON-NLS-1$
                "1.0.0.1"); //$NON-NLS-1$
    }
}
