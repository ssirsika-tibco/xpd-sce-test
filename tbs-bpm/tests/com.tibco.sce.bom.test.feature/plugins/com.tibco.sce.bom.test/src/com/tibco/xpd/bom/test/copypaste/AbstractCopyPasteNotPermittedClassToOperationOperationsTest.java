 ...
 * 
 */
abstract public class AbstractCopyPasteNotPermittedClassToOperationOperationsTest
    ...
    protected void createTargetElements() {
        try {
            c2 = BOMTestUtils.createClasses((Package) targetWorkingCopy
                    .getRootElement(), 1)[0];
            operation1 = UMLFactory.eINSTANCE.createOperation();
            operation1.setName("property1");
