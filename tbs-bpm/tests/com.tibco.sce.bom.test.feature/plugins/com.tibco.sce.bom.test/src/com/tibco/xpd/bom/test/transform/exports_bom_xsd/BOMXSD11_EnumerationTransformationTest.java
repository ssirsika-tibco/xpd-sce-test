...
public class BOMXSD11_EnumerationTransformationTest extends TransformationTest {

    protected static String TEST_FILE_NAME = "myTest.xsd";

    protected String PLATFORM_EXAMPLE_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/bom-xsd";

    protected String MODEL_FILE = "BOMXSD11Enumeration.bom";
