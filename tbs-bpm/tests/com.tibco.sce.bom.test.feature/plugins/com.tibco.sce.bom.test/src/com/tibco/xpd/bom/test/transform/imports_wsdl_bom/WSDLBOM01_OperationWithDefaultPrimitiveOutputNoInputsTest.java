...
public class WSDLBOM01_OperationWithDefaultPrimitiveOutputNoInputsTest extends
        TransformationTest {
    ...
    protected String MODEL_FILE =
            "WSDLBOM01_OperationWithDefaultPrimitiveOutputNoInputs.wsdl";
    ...
    public void testTransformation() throws Exception {
        ...
        // check classes
        org.eclipse.uml2.uml.Class classBcls =
                TransformUtil.assertPackagedElementClass(packagedElements,
                        "ClassB"); //$NON-NLS-1$

        // check attributes
        TransformUtil.assertAttributeSize(classBcls, 1);
        TransformUtil.assertAttributeInClass(classBcls.getAllAttributes(),
                "attribute1", PrimitivesUtil.BOM_PRIMITIVE_TEXT_NAME); //$NON-NLS-1$

        // check operations
        TransformUtil.assertOperationSize(classBcls, 1);
        TransformUtil
                .assertOperationInClass(classBcls.getAllOperations(),
                        "operation1", PrimitivesUtil.getStandardPrimitiveTypeByName(classBcls.eResource().getResourceSet(), PrimitivesUtil.BOM_PRIMITIVE_DATE_NAME)); //$NON-NLS-1$
