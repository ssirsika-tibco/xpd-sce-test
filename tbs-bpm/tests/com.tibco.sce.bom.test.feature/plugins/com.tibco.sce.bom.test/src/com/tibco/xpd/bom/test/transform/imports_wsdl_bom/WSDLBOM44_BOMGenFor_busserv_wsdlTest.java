...
/**
 * Test that takes busserv.wsdl the api wsdl and checks if there are any error
 ...
 * @since 7 Apr 2014
 */
public class WSDLBOM44_BOMGenFor_busserv_wsdlTest extends
        TransformationTestRoundtrip {

    protected String TEST_FILE_NAME = "WSDLBOM44_BOMGenFor_busserv_wsdlTest";

    protected String PLATFORM_EXAMPLE_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/wsdl/WSDLBOM44_BOMGenFor_busserv_wsdl";

    protected String MODEL_FILE = "busserv.wsdl";

    protected String MODEL_XSD_FILE1 = "channeltype.xsd";

    protected String MODEL_XSD_FILE2 = "comexception.xsd";

    protected String MODEL_XSD_FILE3 = "datamodel.xsd";

    protected String MODEL_XSD_FILE4 = "df-payload.xsd";

    protected String MODEL_XSD_FILE5 = "pfe-business-service.xsd";

    protected String MODEL_XSD_FILE6 = "pfe-common.xsd";

    protected String MODEL_XSD_FILE7 = "pfe-exception.xsd";

    protected String MODEL_XSD_FILE8 = "presentationmodel.xsd";

    protected String PLATFORM_WIZARD_GOLD_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/wsdl/WSDLBOM44_BOMGenFor_busserv_wsdl/gold/builder";
