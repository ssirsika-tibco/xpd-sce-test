...
/**
 * Test that takes processManagement.wsdl the api wsdl and checks if there are
 * any error markers on the generated bom. Also checks the count of boms
 * generated and does the gold file comparison for generated xsd(s)
 * 
 ...
 * @since 7 Apr 2014
 */
public class WSDLBOM47_BOMGenFor_ProcessManagement_wsdlTest extends
        TransformationTestRoundtrip {

    protected String TEST_FILE_NAME =
            "WSDLBOM47_BOMGenFor_ProcessManagement_wsdlTest";

    protected String PLATFORM_EXAMPLE_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/wsdl/WSDLBOM47_BOMGenFor_ProcessManagement_wsdl";

    protected String MODEL_FILE = "processManagement.wsdl";

    protected String MODEL_XSD_FILE1 = "processManagement.xsd";

    protected String PLATFORM_WIZARD_GOLD_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/wsdl/WSDLBOM47_BOMGenFor_ProcessManagement_wsdl/gold/builder";
