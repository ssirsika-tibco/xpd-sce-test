...
public class XSDBOM14_NumberLengthTransformationImportTest extends
    ...
    protected String MODEL_FILE = "XSDBOM14_NumberLengthTransformationTest.xsd";
    ...
    public void testTransformation() throws Exception {
        ...
        TransformUtil.assertIntegerLength(tmpPrimAlone, "10");

        TransformUtil.assertIntegerLength(tmpPrim1, "10");

        TransformUtil.assertIntegerLength(tmpPrim2, "10");

        TransformUtil.assertIntegerLength(prop1, "10");

        TransformUtil.assertIntegerLength(prop2, "10");

        TransformUtil.assertIntegerLength(prop3, "10");

        TransformUtil.assertIntegerLength(prop4, "10");

        TransformUtil.assertIntegerLength(prop5, "10");

        // check positive integer parts

        TransformUtil.assertPackagedElementClass(packagedElements,
                "FamilyMountainBikeSizesPosInt");

        TransformUtil.assertPackagedElementClass(packagedElements,
                "testComplexPosInt");

        TransformUtil.assertPackagedElementClass(packagedElements,
                "testMeSimpleContentPosInt");
        ...
        enum1 =
                TransformUtil
                        .assertPackagedElementEnumeration(packagedElements,
                                "mountainbikesizePosInt");

        class2 =
                TransformUtil.getClass(packagedElements,
                        "FamilyMountainBikeSizesPosInt");

        class3 = TransformUtil.getClass(packagedElements, "testComplexPosInt");
        ...
        // check unsigned long parts

        TransformUtil.assertPackagedElementClass(packagedElements,
                "FamilyMountainBikeSizesUnLong");

        TransformUtil.assertPackagedElementClass(packagedElements,
                "testComplexUnLong");

        TransformUtil.assertPackagedElementClass(packagedElements,
                "testMeSimpleContentUnLong");
        ...
        enum1 =
                TransformUtil
                        .assertPackagedElementEnumeration(packagedElements,
                                "mountainbikesizeUnLong");
        class2 =
                TransformUtil.getClass(packagedElements,
                        "FamilyMountainBikeSizesUnLong");

        class3 = TransformUtil.getClass(packagedElements, "testComplexUnLong");
