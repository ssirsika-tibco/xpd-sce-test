...
public class XSDBOM19_ImportedSchemaTransformationTest extends
    ...
    protected String MODEL_FILE =
            "XSDBOM19_ImportedSchemaTransformationTest.xsd";

    protected String IMPORTED_FILE = "XSDBOM19_ImportedSchema.xsd";

    protected String GOLD_IMPORTED_FILE =
            "XSDBOM19_ImportedSchemaTransformationTest.xsd";
    ...
    protected void setUp() throws Exception {
        ...
        modelFileNames.add(IMPORTED_FILE);

        goldFileNames.add(MODEL_FILE);
        // goldFileNames.add(GOLD_IMPORTED_FILE);
    ...
    private void checkBOMElements(Model model) throws Exception {
        ...
        // check packages
        /*
         * org.eclipse.uml2.uml.Package tmpPackage =
         * TransformUtil.findPackagedElementPackage(packagedElements,
         * "businessobjectmodeltns"); //$NON-NLS-1$
         */
        ...
        TransformUtil.assertAttributeInClass(ownedAttributes,
                "customerAttr",
                PrimitivesUtil.BOM_PRIMITIVE_TEXT_NAME); //$NON-NLS-1$
        ...
        TransformUtil
                .assertTargetNamespace(model, "http://businessobjectmodel"); //$NON-NLS-1$
