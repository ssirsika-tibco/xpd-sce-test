...
public class XSDBOM20_DuplicateNamesDifferentComplexTypesTransformationTest
    ...
    protected String MODEL_FILE =
            "XSDBOM20_DuplicateNamesDifferentComplexTypesTransformationTest.xsd";
    ...
    private void checkClazzes(EList<PackageableElement> packagedElements)
        ...
        TransformUtil.assertAttributeInClass(class1.getOwnedAttributes(),
                "flight",
                null);
        ...
        TransformUtil.assertAttributeInClass(class3.getOwnedAttributes(),
                "flight",
                null);
