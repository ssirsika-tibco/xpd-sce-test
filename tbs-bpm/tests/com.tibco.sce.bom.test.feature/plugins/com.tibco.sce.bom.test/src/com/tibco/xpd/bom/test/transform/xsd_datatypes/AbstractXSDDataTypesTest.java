 ...
 */
package com.tibco.xpd.bom.test.transform.xsd_datatypes;
 ...
 * 
 */
public abstract class AbstractXSDDataTypesTest extends
        TransformationTestRoundtrip {

    protected String TEST_FILE_NAME = "myTest.bom";

    protected String PLATFORM_EXAMPLE_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/xsd-datatypes";
    ...
    public AbstractXSDDataTypesTest(String modelFile) {
