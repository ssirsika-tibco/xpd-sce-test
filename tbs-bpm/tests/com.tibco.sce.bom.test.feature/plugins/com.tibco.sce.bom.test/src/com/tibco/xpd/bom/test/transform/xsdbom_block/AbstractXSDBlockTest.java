 ...
 */
package com.tibco.xpd.bom.test.transform.xsdbom_block;
 ...
 * 
 */
public abstract class AbstractXSDBlockTest extends TransformationTestRoundtrip {

    protected String TEST_FILE_NAME = "myTest.bom";

    protected String PLATFORM_EXAMPLE_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/xsd-block";
    ...
    public AbstractXSDBlockTest(String modelFile) {
