 ...
 * 
 */
abstract public class AbstractCopyPasteNestedClassInPackageTest extends
        ...
        try {
            package1 =
                    BOMTestUtils.createPackages((Package) sourceWorkingCopy
                            .getRootElement(), 1)[0];
            class1 = BOMTestUtils.createClasses(package1, 1)[0];
    ...
    protected void validateCopies() {
        ...
        if (copiedEObject instanceof Package) {
            ...
            Class nestedCopiedPackage = (Class) content.get(0);
            BOMTestUtils.validateNamesAndViews(editingDomain,
                    class1,
                    nestedCopiedPackage);
            return;
        ...
        fail("The Package was not copied.");
    }
