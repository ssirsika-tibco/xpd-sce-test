...
public class CheckDifferentTypesTransformationTest_rt extends
    ...
    protected String MODEL_FILE =
            "CheckDifferentTypesTransformationTest_rt.bom";

    protected String GOLD_FILE = "CheckDifferentTypesTransformationTest_rt.xsd";
    ...
    public void testTransformation() throws Exception {
        ...
        List<IStatus> result =
                XSDUtil.transformBOMToXSD(modelFiles.get(0), ResourcesPlugin
                        .getWorkspace().getRoot().getProject(testProjectName)
                        .getFullPath().append(outputSpecialFolder.getFolder()
                                .getName()), false, true);
