...
public class PackageContainerTransformationTest_rt extends
    ...
    protected String MODEL_FILE = "PackageContainer_rt.bom";

    protected String GOLD_FILE = "PackageContainerTransformationTest.xsd";

    protected String GOLD_FILE2 = "com.example.www.stockcheck.innerpackage.xsd";

    protected String GOLD_FILE3 =
            "com.example.www.stockcheck.innerpackage.mypackage1.xsd";

    protected String GOLD_FILE4 =
            "com.example.www.stockcheck.innerpackage.mypackage1.mypackage2.xsd";
    ...
    protected void setUp() throws Exception {
        ...
        goldFileNames.add(GOLD_FILE3);
        goldFileNames.add(GOLD_FILE4);
    ...
    public void testTransformation() throws Exception {
        ...
        XmlDiff xmlDiff =
                initXMLDiff(transformedFiles.get(0), wizardGoldFiles.get(0));
        ...
        xmlDiff = initXMLDiff(transformedFiles.get(0), builderGoldFiles.get(0));
