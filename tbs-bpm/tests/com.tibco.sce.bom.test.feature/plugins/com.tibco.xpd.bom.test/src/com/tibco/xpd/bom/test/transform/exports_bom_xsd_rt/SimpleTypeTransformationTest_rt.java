...
public class SimpleTypeTransformationTest_rt extends
    ...
    protected String MODEL_FILE = "SimpleTypeTransformationTest_rt.bom";

    protected String GOLD_FILE = "SimpleTypeTransformationTest_rt.xsd";
