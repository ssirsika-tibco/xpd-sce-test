...
public class WSDLBOM05_OperationWithSimpleTypeOutputNoInputsTest extends
        TransformationTest {
    ...
    protected String MODEL_FILE =
            "WSDLBOM05_OperationWithSimpleTypeOutputNoInputs.wsdl";
    ...
    public void testTransformation() throws Exception {
        ...
        // check classes
        org.eclipse.uml2.uml.Class classAcls =
                TransformUtil.assertPackagedElementClass(packagedElements,
                        "ClassA"); //$NON-NLS-1$

        // check simple types
        PrimitiveType primType1Type =
                TransformUtil
                        .assertPackagedElementPrimitiveType(packagedElements,
                                "PrimitiveType1"); //$NON-NLS-1$

        // check attributes
        TransformUtil.assertAttributeSize(classAcls, 1);
        TransformUtil.assertAttributeInClass(classAcls.getAllAttributes(),
                "attribute1", PrimitivesUtil.BOM_PRIMITIVE_TEXT_NAME); //$NON-NLS-1$

        // check operations
        TransformUtil.assertOperationSize(classAcls, 1);
        TransformUtil.assertOperationInClass(classAcls.getAllOperations(),
                "operation1", primType1Type); //$NON-NLS-1$
    }
}
