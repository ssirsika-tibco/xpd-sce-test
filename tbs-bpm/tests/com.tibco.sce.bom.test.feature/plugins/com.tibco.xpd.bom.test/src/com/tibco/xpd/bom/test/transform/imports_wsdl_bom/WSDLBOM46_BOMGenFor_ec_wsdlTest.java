...
/**
 * Test that takes ec.wsdl the api wsdl and checks if there are any error
 ...
 * @since 7 Apr 2014
 */
public class WSDLBOM46_BOMGenFor_ec_wsdlTest extends
        TransformationTestRoundtrip {

    protected String TEST_FILE_NAME = "WSDLBOM46_BOMGenFor_ec_wsdlTest";

    protected String PLATFORM_EXAMPLE_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/wsdl/WSDLBOM46_BOMGenFor_ec_wsdl";

    protected String MODEL_FILE = "ec.wsdl";

    protected String MODEL_XSD_FILE1 = "comexception.xsd";

    protected String MODEL_XSD_FILE2 = "ec.xsd";

    protected String MODEL_XSD_FILE3 = "ec-basetypes.xsd";

    protected String MODEL_XSD_FILE4 = "ecexception.xsd";

    protected String PLATFORM_WIZARD_GOLD_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/wsdl/WSDLBOM46_BOMGenFor_ec_wsdl/gold/builder";
