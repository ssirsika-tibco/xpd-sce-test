...
public class XSDBOM05_ComplexTypeTransformationTest extends
    ...
    protected String MODEL_FILE = "XSDBOM05_ComplexTypeTransformationTest.xsd";
    ...
    private void checkBOMElements(Model model) {
        ...
        assertEquals("Name of class", "concept1", elem.getName()); //$NON-NLS-1$
