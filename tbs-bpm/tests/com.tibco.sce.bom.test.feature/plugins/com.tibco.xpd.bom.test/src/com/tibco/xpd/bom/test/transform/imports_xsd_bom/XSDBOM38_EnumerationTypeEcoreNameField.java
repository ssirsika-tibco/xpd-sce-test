...
/**
 * Junit test for protecting XPD-3997. Checks if the Ecore name is supported for
 * generated xsd's.
 * 
 * @author kthombar
 * @since 17-Jul-2013
 */
public class XSDBOM38_EnumerationTypeEcoreNameField extends
        TransformationTestRoundtrip {

    protected String TEST_FILE_NAME = "XSDBOM38_EnumerationTypeEcoreNameField";

    protected String PLATFORM_EXAMPLE_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/xsd";

    // The name of the XML Schema that is being tested
    protected String MODEL_FILE = "XSDBOM38_EnumerationTypeEcoreNameField.xsd";
    ...
    private void checkBOMElements(Model model) throws Exception {
        ...
        for (Class eachClass : allClazzes) {
            if (eachClass.getName().equals("Class1")) {
