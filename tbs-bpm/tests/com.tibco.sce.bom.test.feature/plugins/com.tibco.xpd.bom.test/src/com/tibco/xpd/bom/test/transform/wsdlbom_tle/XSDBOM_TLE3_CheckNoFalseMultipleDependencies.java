 ...
 * 
 */
public class XSDBOM_TLE3_CheckNoFalseMultipleDependencies extends
        AbstractTLETest {

    public XSDBOM_TLE3_CheckNoFalseMultipleDependencies() {
        super(
                new String[] {
                        "XSDBOM_TLE3_CheckNoFalseMultipleDependencies.wsdl", "XSDBOM_TLE3_CheckNoFalseMultipleDependencies.xsd", "XSDBOM_TLE3_CheckNoFalseMultipleDependencies2.xsd", "XSDBOM_TLE3_CheckNoFalseMultipleDependencies3.xsd" }, true); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    }
