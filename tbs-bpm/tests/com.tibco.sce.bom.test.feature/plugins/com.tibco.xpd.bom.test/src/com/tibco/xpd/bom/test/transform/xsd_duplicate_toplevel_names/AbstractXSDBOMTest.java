 ...
 * 
 */
public abstract class AbstractXSDBOMTest extends TransformationTestRoundtrip {

    protected String TEST_FILE_NAME = "myTest.bom";

    protected String PLATFORM_EXAMPLE_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/xsd-duplicate-toplevel-names";
    ...
    public AbstractXSDBOMTest(String modelFile) {
        this.modelFile = modelFile;
    }

    public AbstractXSDBOMTest(String[] modelFiles) {
    ...
    protected String getPlatformExampleFilesBase() {
        return PLATFORM_EXAMPLE_FILES_BASE;
    }

    protected void setPlatformExampleFilesBase(
            String platform_example_files_base) {
        PLATFORM_EXAMPLE_FILES_BASE = platform_example_files_base;
    }
}
