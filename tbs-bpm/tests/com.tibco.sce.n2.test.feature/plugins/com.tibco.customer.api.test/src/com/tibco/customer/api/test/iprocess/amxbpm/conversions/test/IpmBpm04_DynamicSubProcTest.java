 ...
 * @since May 13, 2014
 */
public class IpmBpm04_DynamicSubProcTest extends AbstractIProcessConversionTest {
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm04_DynamicSubProcTest"; //$NON-NLS-1$
    }
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ConversionTests", "IpmBpm04_DynamicSubProcTest/ImportIpmXpdls/mstmain.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
