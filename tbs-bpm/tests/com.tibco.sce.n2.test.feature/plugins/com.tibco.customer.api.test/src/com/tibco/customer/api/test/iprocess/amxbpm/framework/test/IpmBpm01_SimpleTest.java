...
/**
 * Simple test to check the conversion from iProcess to BPM. This test uses one
 * of Siemens xpdl files for test.This test uses gold files Comparision as test,
 * which might need modification quite often to update gold file reflecting
 * latest changes to xpdl file structure .
 * 
 * @author sajain
 * @since Apr 16, 2014
 */
public class IpmBpm01_SimpleTest extends AbstractIProcessConversionComparisonTest {
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/FrameworkTests", "IpmBpm01_SimpleTest/ImportIpmXpdls/dh8clmgt.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/FrameworkTests", "IpmBpm01_SimpleTest/GoldBPMXpdls/DH8CLMGT.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm01_SimpleTest"; //$NON-NLS-1$
    }
}
