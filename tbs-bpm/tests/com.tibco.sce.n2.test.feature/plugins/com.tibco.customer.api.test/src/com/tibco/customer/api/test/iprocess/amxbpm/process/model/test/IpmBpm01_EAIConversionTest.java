...
/**
 * Test to check the conversion of EAI object to Service task using the iProcess
 * to BPM process conversion framework.
 * 
 * @author sajain
 * @since Apr 28, 2014
 */
public class IpmBpm01_EAIConversionTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm01_EAIConversionTest/ImportIpmXpdls/eai.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm01_EAIConversionTest/GoldBPMXpdls/EAI.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm01_EAIConversionTest"; //$NON-NLS-1$
    }
}
