...
/**
 * JUnit to keep an eye on iPM to BPM conversion of dynamic sub procedure call.
 * 
 * @author sajain
 * @since Jul 15, 2014
 */
public class IpmBpm11_DynamicSubProcCalTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] {
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm11_DynamicSubProcCalTest/ImportIpmXpdls/subptemp.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm11_DynamicSubProcCalTest/ImportIpmXpdls/dynsbpr2.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] {
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm11_DynamicSubProcCalTest/GoldBPMXpdls/SUBPTEMP.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm11_DynamicSubProcCalTest/GoldBPMXpdls/DYNSBPR2.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm11_DynamicSubProcCalTest"; //$NON-NLS-1$
    }
}