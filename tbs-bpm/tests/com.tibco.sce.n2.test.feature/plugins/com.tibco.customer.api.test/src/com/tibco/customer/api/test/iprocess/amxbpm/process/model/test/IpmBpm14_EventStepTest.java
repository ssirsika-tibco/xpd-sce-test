...
/**
 * JUnit to keep an eye on iPM to BPM conversion of Event step.
 * 
 * @author sajain
 * @since Jul 15, 2014
 */
public class IpmBpm14_EventStepTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm14_EventStepTest/ImportIpmXpdls/evtstp.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm14_EventStepTest/GoldBPMXpdls/EVTSTP.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm14_EventStepTest"; //$NON-NLS-1$
    }
}