...
/**
 * JUnit to keep an eye on iPM to BPM conversion of Sub procedures, sub
 * procedure templates enclosing various types of parameters and sub procedure
 * call.
 * 
 * @author sajain
 * @since Jul 15, 2014
 */
public class IpmBpm18_SubProcCalTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm18_SubProcCalTest/ImportIpmXpdls/sbprcal1.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] {
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm18_SubProcCalTest/GoldBPMXpdls/SBPRCAL1.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm18_SubProcCalTest/GoldBPMXpdls/SBPRC1.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm18_SubProcCalTest/GoldBPMXpdls/SBPRC2.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm18_SubProcCalTest/GoldBPMXpdls/SUBPTEMP.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm18_SubProcCalTest"; //$NON-NLS-1$
    }
}