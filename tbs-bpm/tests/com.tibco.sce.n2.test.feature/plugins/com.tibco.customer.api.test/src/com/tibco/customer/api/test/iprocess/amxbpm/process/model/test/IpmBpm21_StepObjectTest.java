...
/**
 * JUnit to keep an eye on iPM to BPM conversion of Step object.
 * 
 * @author sajain
 * @since Jul 15, 2014
 */
public class IpmBpm21_StepObjectTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm21_StepObjectTest/ImportIpmXpdls/stpobj1.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm21_StepObjectTest/GoldBPMXpdls/STPOBJ1.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm21_StepObjectTest"; //$NON-NLS-1$
    }
}