 ...
 * @since 30-Apr-2014
 */
public class IpmBpm02_MoveParticipantToPackageLevelComplexTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ConversionTests", "IpmBpm02_MoveParticipantToPackageLevelComplexTest/ImportIpmXpdls/resusabl.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm02_MoveParticipantToPackageLevelComplexTest"; //$NON-NLS-1$
    }
