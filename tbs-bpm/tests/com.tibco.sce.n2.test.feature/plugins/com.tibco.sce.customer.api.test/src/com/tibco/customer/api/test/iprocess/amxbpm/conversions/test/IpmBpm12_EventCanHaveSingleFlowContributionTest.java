 ...
 * @since May 29, 2014
 */
public class IpmBpm12_EventCanHaveSingleFlowContributionTest extends
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm12_EventCanHaveSingleFlowContributionTest"; //$NON-NLS-1$
    }
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ConversionTests", "IpmBpm12_EventCanHaveSingleFlowContributionTest/ImportIpmXpdls/9EDTB.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    protected void doTestConvertedXpdls(Collection<IFile> convertedXpdls) {
        for (IFile file : convertedXpdls) {
            if ("17TIMER.xpdl".equalsIgnoreCase(file.getName())) { //$NON-NLS-1$
                ...
                if (rootElement instanceof Package) {
                    ...
                    for (Process eachProcess : pkg.getProcesses()) {
                        if ("17TIMER".equalsIgnoreCase(eachProcess.getName())) { //$NON-NLS-1$
