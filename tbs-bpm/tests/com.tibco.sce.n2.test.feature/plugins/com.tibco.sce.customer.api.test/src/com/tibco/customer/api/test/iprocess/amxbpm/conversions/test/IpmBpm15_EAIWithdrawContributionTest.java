 ...
 * @since Jun 5, 2014
 */
public class IpmBpm15_EAIWithdrawContributionTest extends
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm15_EAIWithdrawContributionTest"; //$NON-NLS-1$
    }
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ConversionTests", "IpmBpm15_EAIWithdrawContributionTest/ImportIpmXpdls/test6494_1.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
