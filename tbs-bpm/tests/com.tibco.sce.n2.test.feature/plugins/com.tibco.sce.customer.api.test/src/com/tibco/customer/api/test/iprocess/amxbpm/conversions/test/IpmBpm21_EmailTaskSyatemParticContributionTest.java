 ...
 * @since 13-Jun-2014
 */
public class IpmBpm21_EmailTaskSyatemParticContributionTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ConversionTests", "IpmBpm21_EmailTaskSyatemParticContributionTest/ImportIpmXpdls/email.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    protected String getMainImportProjectName() {
        // TODO Auto-generated method stub
        return "IpmBpm21_EmailTaskSyatemParticContributionTest"; //$NON-NLS-1$
    }
