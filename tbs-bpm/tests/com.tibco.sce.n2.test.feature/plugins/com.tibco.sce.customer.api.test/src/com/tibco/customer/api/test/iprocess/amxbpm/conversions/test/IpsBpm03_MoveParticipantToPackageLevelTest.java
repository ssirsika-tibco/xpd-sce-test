 ...
 * @since 11-Jul-2014
 */
public class IpsBpm03_MoveParticipantToPackageLevelTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ConversionTests", "IpsBpm03_MoveParticipantToPackageLevelTest/Process Packages{processes}/particOnProcessLevel.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    protected String getMainImportProjectName() {
        ...
        return "IpsBpm03_MoveParticipantToPackageLevelTest"; //$NON-NLS-1$
    }
