 ...
 * @since 14-Jul-2014
 */
public class IpsBpm06_DbTaskSyatemParticContributionTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        ...
                        "IpsBpm06_DbTaskSyatemParticContributionTest/Process Packages{processes}/test.xpdl"), }; //$NON-NLS-1$
    ...
    protected String getMainImportProjectName() {
        ...
        return "IpsBpm06_DbTaskSyatemParticContributionTest"; //$NON-NLS-1$
    }
