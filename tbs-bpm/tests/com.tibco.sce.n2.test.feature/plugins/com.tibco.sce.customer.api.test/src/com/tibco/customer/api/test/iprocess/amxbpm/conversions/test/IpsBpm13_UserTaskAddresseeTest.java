 ...
 * @since Jul 15, 2014
 */
public class IpsBpm13_UserTaskAddresseeTest extends
    ...
    protected void doTestConvertedXpdls(Collection<IFile> convertedXpdls) {
        ...
        for (IFile file : convertedXpdls) {
            ...
            if ("utaddressee.xpdl".equalsIgnoreCase(file.getName())) { //$NON-NLS-1$
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ConversionTests", "IpsBpm13_UserTaskAddresseeTest/Process Packages{processes}/usertskaddressee.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    protected String getMainImportProjectName() {
        return "IpsBpm13_UserTaskAddresseeTest"; //$NON-NLS-1$
    }
