 ...
 * @since Jul 15, 2014
 */
public class IpsBpm14_SW_andIDX_FieldsTest extends
            ...
            if ("SWIDX.xpdl".equalsIgnoreCase(file.getName())) { //$NON-NLS-1$
                ...
                if (rootElement instanceof Package) {
                    ...
                    for (Process eachProcess : pkg.getProcesses()) {
                        ...
                        /*
                         * Remove SW_ and IDX_ fields which we don't support in
                         * AMX BPM.
                         */
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ConversionTests", "IpsBpm14_SW_andIDX_FieldsTest/Process Packages{processes}/swidx.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    protected String getMainImportProjectName() {
        return "IpsBpm14_SW_andIDX_FieldsTest"; //$NON-NLS-1$
    }
