 ...
 * @since 15-Jul-2014
 */
public class IpsBpm05_ReusableSubProcInterfaceReferencesCheckTest extends
    ...
    protected void doTestConvertedXpdls(Collection<IFile> convertedXpdls) {
        ...
        for (IFile iFile : convertedXpdls) {
            if (iFile.getName().equals("MSTMAIN.xpdl")) { //$NON-NLS-1$
                ...
                assertTrue("We expected the Sub proc to implement the  interface, however no such activity was found", //$NON-NLS-1$
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/FrameworkTests", "IpsBpm05_ReusableSubProcInterfaceReferencesCheckTest/Process Packages{processes}/test.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    protected String getMainImportProjectName() {
        ...
        return "IpsBpm05_ReusableSubProcInterfaceReferencesCheckTest"; //$NON-NLS-1$
    }
