...
/**
 * JUnit to check the conversion of iProcess Annotations and Sub procedure call
 * in iProcess to BPM Annotations and sub procedure call in AMX BPM
 * respectively.
 * 
 * @author sajain
 * @since May 16, 2014
 */
public class IpmBpm07_ActivitiesConversion02 extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm07_ActivitiesConversion02/ImportIpmXpdls/actxpdl4.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] {
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm07_ActivitiesConversion02/GoldBPMXpdls/ACTXPDL4.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                        new TestResourceInfo("resources/ProcessModelTests", //$NON-NLS-1$
                                "IpmBpm07_ActivitiesConversion02/GoldBPMXpdls/SUB3.xpdl"), }; //$NON-NLS-1$
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm07_ActivitiesConversion02"; //$NON-NLS-1$
    }
}
