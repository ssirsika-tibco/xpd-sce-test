...
/**
 * JUnit to keep an eye on iPM to BPM conversion of complex router.
 * 
 * @author sajain
 * @since Jul 15, 2014
 */
public class IpmBpm09_ComplexRouterTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm09_ComplexRouterTest/ImportIpmXpdls/complrou.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm09_ComplexRouterTest/GoldBPMXpdls/COMPLROU.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm09_ComplexRouterTest"; //$NON-NLS-1$
    }
}
