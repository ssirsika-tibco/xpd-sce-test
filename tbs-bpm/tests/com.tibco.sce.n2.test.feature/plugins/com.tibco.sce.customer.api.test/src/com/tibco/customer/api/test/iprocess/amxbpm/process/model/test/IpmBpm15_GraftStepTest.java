...
/**
 * JUnit to keep an eye on iPM to BPM conversion of Graft step.
 * 
 * @author sajain
 * @since Jul 15, 2014
 */
public class IpmBpm15_GraftStepTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] {
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm15_GraftStepTest/ImportIpmXpdls/gftstp.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm15_GraftStepTest/ImportIpmXpdls/subptemp.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] {
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm15_GraftStepTest/GoldBPMXpdls/GFTSTP.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                        new TestResourceInfo(
                                "resources/ProcessModelTests", "IpmBpm15_GraftStepTest/GoldBPMXpdls/SUBPTEMP.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm15_GraftStepTest"; //$NON-NLS-1$
    }
}