...
/**
 * JUnit to keep an eye on iPM to BPM conversion of Line styles and annotations.
 * 
 * @author sajain
 * @since Jul 15, 2014
 */
public class IpmBpm16_LineStylesAndAnnotationsTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm16_LineStylesAndAnnotationsTest/ImportIpmXpdls/lsandann.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm16_LineStylesAndAnnotationsTest/GoldBPMXpdls/LSANDANN.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm16_LineStylesAndAnnotationsTest"; //$NON-NLS-1$
    }
}
