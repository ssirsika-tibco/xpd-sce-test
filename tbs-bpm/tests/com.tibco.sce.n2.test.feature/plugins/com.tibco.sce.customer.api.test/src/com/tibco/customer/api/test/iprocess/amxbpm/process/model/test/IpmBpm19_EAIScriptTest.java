...
/**
 * JUnit to keep an eye on iPM to BPM conversion of EAI Script.
 * 
 * @author sajain
 * @since Jul 15, 2014
 */
public class IpmBpm19_EAIScriptTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm19_EAIScriptTest/ImportIpmXpdls/scriptz.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm19_EAIScriptTest/GoldBPMXpdls/SCRIPTZ.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm19_EAIScriptTest"; //$NON-NLS-1$
    }
}