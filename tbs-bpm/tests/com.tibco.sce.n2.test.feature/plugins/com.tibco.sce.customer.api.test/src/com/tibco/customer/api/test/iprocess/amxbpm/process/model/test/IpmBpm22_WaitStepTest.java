...
/**
 * JUnit to keep an eye on iPM to BPM conversion of Wait step.
 * 
 * @author sajain
 * @since Jul 15, 2014
 */
public class IpmBpm22_WaitStepTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm22_WaitStepTest/ImportIpmXpdls/waitstp.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm22_WaitStepTest/GoldBPMXpdls/WAITSTP.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm22_WaitStepTest"; //$NON-NLS-1$
    }
}