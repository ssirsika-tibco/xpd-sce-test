...
/**
 * GatewayObjectUtilApiTest
 * <p>
 * GatewayObjectUtilApiTest - To test ongoing backwards-compatibility of API provided by the class(es):
 * <li>com.tibco.xpd.processeditor.xpdl2.util.GatewayObjectUtil</li> 
 * </p>
 *
 * <p>
 ...
 * </p>
 */
public class GatewayObjectUtilApiTest extends AbstractApiClassTest {

    public void testApiFor_com_tibco_xpd_processeditor_xpdl2_util_GatewayObjectUtil() throws Exception {
        ...
        String clazzName = "com.tibco.xpd.processeditor.xpdl2.util.GatewayObjectUtil"; //$NON-NLS-1$
        ...
        String[] constructorControlSample = new String[] { 
            "public com.tibco.xpd.processeditor.xpdl2.util.GatewayObjectUtil()", //$NON-NLS-1$
                };
        ...
        String[] methodControlSample = new String[] { 
            "public static com.tibco.xpd.processwidget.adapters.GatewayType getGatewayType(com.tibco.xpd.xpdl2.Activity)", //$NON-NLS-1$ 
            "public static org.eclipse.emf.common.command.Command getSetGatewayTypeCommand(org.eclipse.emf.edit.domain.EditingDomain,com.tibco.xpd.xpdl2.Activity,com.tibco.xpd.processwidget.adapters.GatewayType)", //$NON-NLS-1$ 
