...
/**
 * WebServiceOperationUtilApiTest
 * <p>
 * WebServiceOperationUtilApiTest - To test ongoing backwards-compatibility of API provided by the class(es):
 * <li>com.tibco.xpd.processeditor.xpdl2.util.WebServiceOperationUtil</li> 
 * </p>
 *
 * <p>
 ...
 * </p>
 */
public class WebServiceOperationUtilApiTest extends AbstractApiClassTest {

    public void testApiFor_com_tibco_xpd_processeditor_xpdl2_util_WebServiceOperationUtil() throws Exception {
        ...
        String clazzName = "com.tibco.xpd.processeditor.xpdl2.util.WebServiceOperationUtil"; //$NON-NLS-1$
        ...
        String[] constructorControlSample = new String[] { 
            "public com.tibco.xpd.processeditor.xpdl2.util.WebServiceOperationUtil()", //$NON-NLS-1$
                };
        ...
        String[] methodControlSample = new String[] { 
            ...
            "public static boolean isWebServiceImplementationType(com.tibco.xpd.xpdl2.Activity)", //$NON-NLS-1$ 
