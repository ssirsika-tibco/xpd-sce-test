...
public class WSDLBOM04_OperationWithOutputNoInputsTest extends
        TransformationTest {
    ...
    protected String MODEL_FILE = "WSDLBOM04_OperationWithOutputNoInputs.wsdl";
    ...
    public void testTransformation() throws Exception {
        ...
        // check classes
        org.eclipse.uml2.uml.Class classCls =
        ...
        // check attributes
        TransformUtil.assertAttributeSize(classCls, 1);
        TransformUtil.assertAttributeInClass(classCls.getAllAttributes(),
                "attribute1", PrimitivesUtil.BOM_PRIMITIVE_TEXT_NAME); //$NON-NLS-1$
        TransformUtil.assertAttributeSize(outputClassCls, 1);
        TransformUtil.assertAttributeInClass(outputClassCls.getAllAttributes(),
                "attribute1", PrimitivesUtil.BOM_PRIMITIVE_TEXT_NAME); //$NON-NLS-1$

        // check operations
        TransformUtil.assertOperationSize(classCls, 1);
