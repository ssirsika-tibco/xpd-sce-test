...
/**
 * Test that takes dac.wsdl the api wsdl and checks if there are any error
 ...
 * @since 7 Apr 2014
 */
public class WSDLBOM45_BOMGenFor_dac_wsdlTest extends
        TransformationTestRoundtrip {

    protected String TEST_FILE_NAME = "WSDLBOM45_BOMGenFor_dac_wsdlTest";

    protected String PLATFORM_EXAMPLE_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/wsdl/WSDLBOM45_BOMGenFor_dac_wsdl";

    protected String MODEL_FILE = "dac.wsdl";

    protected String MODEL_XSD_FILE1 = "dac-basic.xsd";

    protected String MODEL_XSD_FILE2 = "dac-calendar-service.xsd";

    protected String MODEL_XSD_FILE3 = "dac-common.xsd";

    protected String MODEL_XSD_FILE4 = "dac-deadline-service.xsd";

    protected String MODEL_XSD_FILE5 = "dac-exception.xsd";

    protected String MODEL_XSD_FILE6 = "dac-notification-service.xsd";

    protected String MODEL_XSD_FILE7 = "dac-workcal-service.xsd";

    protected String MODEL_XSD_FILE8 = "organisation.xsd";

    protected String MODEL_XSD_FILE9 = "comexception.xsd";

    protected String PLATFORM_WIZARD_GOLD_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/wsdl/WSDLBOM45_BOMGenFor_dac_wsdl/gold/builder";
