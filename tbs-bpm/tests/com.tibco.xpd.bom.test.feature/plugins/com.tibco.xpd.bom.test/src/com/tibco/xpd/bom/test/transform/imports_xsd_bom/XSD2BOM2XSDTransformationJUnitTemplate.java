...
public class XSD2BOM2XSDTransformationJUnitTemplate extends
        TransformationTestRoundtrip {

    protected String TEST_FILE_NAME = "XSD2BOM2XSDWorkedExample.bom";

    protected String PLATFORM_EXAMPLE_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/xsd";

    protected String MODEL_FILE = "XMLSchema2Test.xsd";
