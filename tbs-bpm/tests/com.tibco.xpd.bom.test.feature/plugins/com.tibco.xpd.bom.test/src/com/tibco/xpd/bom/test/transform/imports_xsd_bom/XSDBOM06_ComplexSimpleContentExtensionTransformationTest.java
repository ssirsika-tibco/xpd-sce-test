...
public class XSDBOM06_ComplexSimpleContentExtensionTransformationTest extends
    ...
    protected String MODEL_FILE =
            "XSDBOM06_ComplexSimpleContentExtensionTransformationTest.xsd";
    ...
    private void checkBOMElements(Model model) throws Exception {
        // For this test we should have 1 Class "ComplexType" with attribute
        // called "value" and 1 primitive type named "SimpleType"
        ...
        assertEquals("Number of attributes in complexTypeCls Class", 1, ownedAttributes.size()); //$NON-NLS-1$
        Property valueProp =
                TransformUtil.assertAttributeInClass(ownedAttributes,
                        "value",
                        null);
        TransformUtil.assertPropertyMultiplicity(valueProp, 1, 1);

        Property property = ownedAttributes.get(0);

        assertEquals("Check attribute type:", pt, property.getType());
    }
