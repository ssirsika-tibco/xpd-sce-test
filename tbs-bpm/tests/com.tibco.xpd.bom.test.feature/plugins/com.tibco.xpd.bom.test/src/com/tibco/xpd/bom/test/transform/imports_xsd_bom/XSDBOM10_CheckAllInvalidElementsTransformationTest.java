...
public class XSDBOM10_CheckAllInvalidElementsTransformationTest extends
        TransformationTest {
    ...
    protected String MODEL_FILE =
            "XSDBOM10_CheckAllInvalidElementsTransformationTest.xsd";
    ...
    public void testTransformation() throws Exception {
        ...
        /*
         * XPD-5118 - changed to 6 expected errors from 7 because we now
         * supported "mixed"
         */
        assertEquals("Check number of invalid elements contained within this XML Schema", 6, errors.size()); //$NON-NLS-1$                        
    }
}
