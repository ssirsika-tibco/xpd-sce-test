 ...
 * junit-workspace.
 * <p>
 * <i>Created: 01 July 2010</i>
 * </p>
 * 
 * @author glewis
 */
@SuppressWarnings("nls")
public class XSDBOM23_GeneralizationAndCompositionWithAttributesTest extends
    ...
    protected String MODEL_FILE =
            "XSDBOM23_GeneralizationAndCompositionWithAttributes.xsd";
    ...
    public void testTransformation() throws Exception {
        ...
        Property property1 =
                TransformUtil.assertAttributeInClass(cls1.getAllAttributes(),
                        "attribute1",
                        PrimitivesUtil.BOM_PRIMITIVE_TEXT_NAME);

        Property property2 =
                TransformUtil.assertAttributeInClass(cls2.getAllAttributes(),
                        "attribute1111",
                        PrimitivesUtil.BOM_PRIMITIVE_TEXT_NAME);

        Property property3 =
                TransformUtil.assertAttributeInClass(cls3.getAllAttributes(),
                        "attribute1",
                        PrimitivesUtil.BOM_PRIMITIVE_TEXT_NAME);

        Assert.assertEquals(cls1.getGeneralizations().size(), 1);
        TransformUtil.assertGeneralization(cls1.getGeneralizations().get(0),
                cls2);

        TransformUtil.assertCompositionSize(cls1, 1);
        Assert.assertEquals(cls3, cls1.getAssociations().get(0).getMemberEnds()
                .get(0).getType());
