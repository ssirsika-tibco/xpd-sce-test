...
/**
 * Junit test to protect XPD-3647. Checks if the XSD->BOM->XSD is generated
 * properly when the input xsd has groups or choices used under restriction.
 * 
 * @author kthombar
 * @since 16-Jul-2013
 */
public class XSDBOM37_XsdWithGroupAndChoiceTagsTransformationTest extends
        TransformationTestRoundtrip {

    protected String TEST_FILE_NAME =
            "XSDBOM37_XsdWithGroupAndChoiceTagsTransformationTest";
    ...
    protected String MODEL_FILE =
            "XSDBOM37_XsdWithGroupAndChoiceTagsTransformationTest.xsd";
