...
public class BOMXSDRules07_PrimitiveTypeDefaultLostRule extends
        TransformationTest {
    ...
    protected String MODEL_FILE =
            "BOMXSDRules07PrimitiveTypeDefaultLostRule.bom";
    ...
    public void testTransformation() throws Exception {
        ...
        boolean hasWarningMarker =
                TransformUtil.isMarkerSeverityExist(destIds,
                        modelFiles.get(0),
                        IMarker.SEVERITY_WARNING);
        assertEquals("No XSD Warning Marker has been found when it indeed is an invalid BOM for WSDL Destinations", true, hasWarningMarker); //$NON-NLS-1$
    }
}
