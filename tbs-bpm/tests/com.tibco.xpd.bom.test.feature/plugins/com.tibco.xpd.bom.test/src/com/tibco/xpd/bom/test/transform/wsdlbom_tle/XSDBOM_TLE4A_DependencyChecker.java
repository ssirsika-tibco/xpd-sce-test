 ...
 * 
 */
public class XSDBOM_TLE4A_DependencyChecker extends
        AbstractTLETest {

    public XSDBOM_TLE4A_DependencyChecker() {
        super(
                new String[] {
                        "XSDBOM_TLE4A_DependencyChecker.wsdl"}, new String[]{"org.example.NewWSDLFile.xsd", "org.example.NewWSDLFile2.xsd", "org.example.NewWSDLFile3.xsd", "org.example.NewWSDLFile4.xsd" },"org.example.NewWSDLFile.bom", true); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
    }
