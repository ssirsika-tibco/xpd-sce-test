 ...
 */
package com.tibco.xpd.bom.test.transform.xsdbom_any;
 ...
 * 
 */
public abstract class AbstractXSDAnyTest extends TransformationTestRoundtrip {

    protected String TEST_FILE_NAME = "myTest.bom";

    protected String PLATFORM_EXAMPLE_FILES_BASE =
            "platform:/plugin/com.tibco.xpd.bom.test/test-resources/xsd-any";
    ...
    public AbstractXSDAnyTest(String modelFile) {
