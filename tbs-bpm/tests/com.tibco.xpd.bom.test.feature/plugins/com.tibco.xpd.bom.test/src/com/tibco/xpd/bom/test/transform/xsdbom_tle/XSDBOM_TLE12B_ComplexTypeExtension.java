 ...
 * 
 */
public class XSDBOM_TLE12B_ComplexTypeExtension extends AbstractTLETest {

    private static final String CHILDTYPE_CLASS = "ChildType";

    private static final String PERSON_CLASS = "Person";

    public XSDBOM_TLE12B_ComplexTypeExtension() {
        super("XSDBOM_TLE12B_ComplexTypeExtension.xsd");
    }
    ...
    protected void checkBOMElements(Model model) throws Exception {
        ...
        assertEquals("Number of packageable elements", 5, packagedElements
                .size());
