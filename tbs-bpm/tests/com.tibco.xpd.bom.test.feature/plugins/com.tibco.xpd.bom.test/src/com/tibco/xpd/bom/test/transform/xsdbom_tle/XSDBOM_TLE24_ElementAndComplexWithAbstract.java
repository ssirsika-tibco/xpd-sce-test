 ...
 * @author glewis
 */
public class XSDBOM_TLE24_ElementAndComplexWithAbstract extends AbstractTLETest {

    public XSDBOM_TLE24_ElementAndComplexWithAbstract() {
        super("XSDBOM_TLE24_ElementAndComplexWithAbstract.xsd");
    }
