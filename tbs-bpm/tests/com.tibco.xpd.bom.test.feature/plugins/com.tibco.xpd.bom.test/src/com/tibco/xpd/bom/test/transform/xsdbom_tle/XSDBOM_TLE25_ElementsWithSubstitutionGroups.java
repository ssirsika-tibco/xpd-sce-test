 ...
 * @author glewis
 */
public class XSDBOM_TLE25_ElementsWithSubstitutionGroups extends
        AbstractTLETest {

    public XSDBOM_TLE25_ElementsWithSubstitutionGroups() {
        super("XSDBOM_TLE25_ElementsWithSubstitutionGroups.xsd");
    }
