...
/**
 * Comparator for Org Deploy Model, uses {@link OrgDeployModelDiff}.
 * 
 * @author kupadhya
 * 
 */
public class DEFileComparator extends FileComparator {
    @Override
    public IStatus compareContents(InputStream goldFile,
        ...
        try {
            XmlDiff diff = new OrgDeployModelDiff(goldIS, generatedIS);
