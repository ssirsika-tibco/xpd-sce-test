...
public abstract class DAAContentsTest extends TestCase {
    ...
    // } catch (IOException e) {
    // System.err.println("Unable to instantiate Summary Report!!!");
    // //$NON-NLS-1$
    // }
    // }
    //
    ...
    //
    // /**
    // * Iterates the specified projects comparing generated DAAs and 'Gold'
    // ones.
    // *
    ...
    // */
    // private StringBuffer reportStatus(Map<String, List<IStatus>>
    // testStatusMap) {
    ...
    // System.err.println("For Project " + entry.getKey() + ", " //$NON-NLS-1$
    // //$NON-NLS-2$
    // + entry.getValue());
    ...
    // daaCompareResult
    // .append(String
    // .format("The Following %1$s Project/s failed during DAA comparison:",
    // //$NON-NLS-1$
    ...
    // String goldMsg = " No. of entries in gold DAA " + goldDAASize;
    // //$NON-NLS-1$
    // Status status =
    ...
    // errorMsg = projectName + " entry count do not match" + goldMsg
    // //$NON-NLS-1$
    // + generatedMsg;
    // status =
    // new Status(IStatus.ERROR, Activator.PLUGIN_ID, errorMsg);
    ...
    // toReturn.append("ERROR:: " + message + DAAContentsTest.CRLF);
    // //$NON-NLS-1$
    // }
    // }
    // }
    ...
    // String projectName = project.getName();
    // String entryPath = "plugins/" + projectId + "_"; //$NON-NLS-1$
    // //$NON-NLS-2$
    ...
    // }
    //
    // private static final String FILE_PREFIX = "acceptance-test-report";
    // //$NON-NLS-1$
    //
