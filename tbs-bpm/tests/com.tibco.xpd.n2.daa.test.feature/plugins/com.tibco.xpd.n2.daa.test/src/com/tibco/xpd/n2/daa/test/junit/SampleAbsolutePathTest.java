...
public class SampleAbsolutePathTest extends SetUpTest {
    ...
    // System.getProperty("bpm.cleandaastaging", "null"), //$NON-NLS-1$
    // //$NON-NLS-2$
    // newln);
    //
    // /* Read the configuration file from the user's home area */
    // URI userHomeURI = URI.createFileURI(System.getProperty("user.home"));
    // //$NON-NLS-1$
    // /*
    ...
    // * directory
    // */
    // String pluginSpecificConfigFile = getContextPlugInId() + ".xml";
    // //$NON-NLS-1$
    ...
    // // assertTrue(String.format("Copy generated DAA in Exports folder
    // failed"),
    // // isDaaInExportFolder);
    // }
    //
    ...
    // } else {
    // System.out.println("Studio Projects: " + studioProjectLocation);
    // //$NON-NLS-1$
    // }
    //
