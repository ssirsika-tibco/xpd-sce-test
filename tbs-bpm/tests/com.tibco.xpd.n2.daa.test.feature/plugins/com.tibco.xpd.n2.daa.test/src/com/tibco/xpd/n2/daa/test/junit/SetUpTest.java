...
public abstract class SetUpTest extends TestCase {
    ...
    // */
    // protected List<IResource> generateDAA(List<ProjectType>
    // studioProjectTypes) {
    ...
    //
    // assertTrue(String.format("DAA generation failed for project '%s'",
    // //$NON-NLS-1$
    // project.getName()),
    // generateDAA(project));
    ...
    //
    // assertTrue(String.format("Could not find generated DAA for project '%s'",
    // //$NON-NLS-1$
    // project.getName()),
    ...
    // } else {
    //
    // assertTrue(String.format("generate DAA skipped for project '%s'",
    // //$NON-NLS-1$
    // project.getName()),
    // true);
    // }
    ...
    // */
    // System.setProperty("bx_flownames_number_suffixed", "TRUE"); //$NON-NLS-1$
    // //$NON-NLS-2$
    //
