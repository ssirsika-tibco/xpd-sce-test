 ...
 * @since May 14, 2014
 */
public class IpmBpm05_SetUniqueNameContribution extends
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm05_SetUniqueNameContribution"; //$NON-NLS-1$
    }
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ConversionTests", "IpmBpm05_SetUniqueNameContribution/ImportIpmXpdls/actxpdl6.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
