 ...
 * @since Jul 14, 2014
 */
public class IpsBpm10_EAIStepAuditTrailExpressionsTest extends
    ...
    protected String getMainImportProjectName() {
        return "IpsBpm10_EAIStepAuditTrailExpressionsTest"; //$NON-NLS-1$
    }
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ConversionTests", "IpsBpm10_EAIStepAuditTrailExpressionsTest/Process Packages{processes}/eaistep.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        ...
        for (IFile file : convertedXpdls) {
            ...
            if (rootElement instanceof Package) {
                ...
                for (Process eachProcess : pkg.getProcesses()) {
                    if (eachProcess.getName().equalsIgnoreCase("EAISTEP")) { //$NON-NLS-1$
                                    ...
                                    for (int i = 0; i < allAuditEvents.size(); i++) {
                                        ...
                                        if (AuditEventType.INITIATED_LITERAL
                                            ...
                                            if (auditEventInfoText != null
                                                    && !auditEventInfoText
                                                            .isEmpty()) {
                                                assertEquals("Process.auditLog(FIELD2);",//$NON-NLS-1$
                                                        auditEventInfoText);
                                            }
                                        }
                                    }
