...
/**
 * This validation Test, checks that when few processes being imported already
 * exist in workspace, it should not return Error saying Processes already
 ...
 * @since 12-May-2014
 */
public class IpmBpm_5c_SomeProcAlreadyInWorkspaceTest extends
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm_5c_SomeProcAlreadyInWorkspaceTest"; //$NON-NLS-1$
    }
        ...
        TestResourceInfo[] importResources =
                new TestResourceInfo[] {
                        new TestResourceInfo(
                                ...
                                "IpmBpm_5c_SomeProcAlreadyInWorkspaceTest/ImportIpmXpdls/5c_ProcessA.ipmxpdl"), //$NON-NLS-1$
                        new TestResourceInfo(
                                "resources/FrameworkValidationTests", //$NON-NLS-1$
                                "IpmBpm_5c_SomeProcAlreadyInWorkspaceTest/ImportIpmXpdls/5c_ProcessB.ipmxpdl") }; //$NON-NLS-1$
    ...
    public TestResourceInfo[] getOtherResourcesInfo() {
        TestResourceInfo[] importResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/FrameworkValidationTests", //$NON-NLS-1$
                        "SomeProcAlreadyInWorkspace/Process Packages{processes}/5c_ProcessA.xpdl") }; //$NON-NLS-1$
        return importResources;
    }
    ...
    protected void doTestImportValidations(List<ImportValidationError> errors) {
        ...
        Assert.assertFalse("All process Already exits Error should not be raised", //$NON-NLS-1$
                errorPresent);
