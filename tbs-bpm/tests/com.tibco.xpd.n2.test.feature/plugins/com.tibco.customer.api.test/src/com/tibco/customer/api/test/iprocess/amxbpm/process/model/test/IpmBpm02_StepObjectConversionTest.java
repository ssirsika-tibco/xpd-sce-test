...
/**
 * Test to check the conversion of Step Object object to User task using the
 * iProcess to BPM process conversion framework.
 * 
 * @author sajain
 * @since Apr 28, 2014
 */
public class IpmBpm02_StepObjectConversionTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm02_StepObjectConversionTest/ImportIpmXpdls/stepobj.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm02_StepObjectConversionTest/GoldBPMXpdls/STEPOBJ.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm02_StepObjectConversionTest"; //$NON-NLS-1$
    }
}
