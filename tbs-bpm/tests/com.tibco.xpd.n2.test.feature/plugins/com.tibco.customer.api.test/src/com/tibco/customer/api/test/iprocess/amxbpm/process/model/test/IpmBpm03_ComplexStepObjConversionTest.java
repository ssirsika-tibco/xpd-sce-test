...
/**
 * Test to check the conversion of an iProcess xpdl having a complex Step Object
 * scenario using the iProcess to BPM process conversion framework.
 * 
 * @author sajain
 * @since Apr 28, 2014
 */
public class IpmBpm03_ComplexStepObjConversionTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm03_ComplexStepObjConversionTest/ImportIpmXpdls/sample01.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm03_ComplexStepObjConversionTest/GoldBPMXpdls/SAMPLE01.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm03_ComplexStepObjConversionTest"; //$NON-NLS-1$
    }
}
