...
/**
 * JUnit to check the conversion of EAI E-Mail and Event steps in iProcess to
 * E-Mail service task and receive tasks in AMX BPM respectively.
 * 
 * @author sajain
 * @since May 16, 2014
 */
public class IpmBpm06_ActivitiesConversion01 extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm06_ActivitiesConversion01/ImportIpmXpdls/actxpdl2.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm06_ActivitiesConversion01/GoldBPMXpdls/ACTXPDL2.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm06_ActivitiesConversion01"; //$NON-NLS-1$
    }
}
