...
/**
 * JUnit to keep an eye on iPM to BPM conversion of EAI Mail.
 * 
 * @author sajain
 * @since Jul 15, 2014
 */
public class IpmBpm13_EAIMailTest extends
    ...
    public TestResourceInfo[] getImportResourcesInfo() {
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm13_EAIMailTest/ImportIpmXpdls/eaimail.ipmxpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
    ...
    public TestResourceInfo[] getGoldResourcesInfo() {
        ...
        TestResourceInfo[] testResources =
                new TestResourceInfo[] { new TestResourceInfo(
                        "resources/ProcessModelTests", "IpmBpm13_EAIMailTest/GoldBPMXpdls/EAIMAIL.xpdl"), //$NON-NLS-1$ //$NON-NLS-2$
                };
        return testResources;
    }
    ...
    protected String getMainImportProjectName() {
        return "IpmBpm13_EAIMailTest"; //$NON-NLS-1$
    }
}