...
public class AllTestsB {
    ...
    public static Test suite() {
        ...
        suite.addTestSuite(N2_15_XPathChoiceMappingTest.class);
        suite.addTestSuite(N2_16_XPathRequiredElementNotMappedTest.class);
        suite.addTestSuite(N2_17_ChildAttribMappingNotRequiredTest.class);
        suite.addTestSuite(N2_18_XPathAttributeRequiresMappingTest.class);
        ...
        suite.addTestSuite(N2_22_ChoiceInvalidMarkerTest.class);
        suite.addTestSuite(N2_23_XPathBaseTypeElementMappingTest.class);
        suite.addTestSuite(N2_24_ConcatenationMappingUnsupportedTest.class);
        suite.addTestSuite(N2_25_XPathElementMustHaveMappingTest.class);
        ...
        suite.addTestSuite(N2_28_XPathEntireArrayMappedInvalidTest.class);
