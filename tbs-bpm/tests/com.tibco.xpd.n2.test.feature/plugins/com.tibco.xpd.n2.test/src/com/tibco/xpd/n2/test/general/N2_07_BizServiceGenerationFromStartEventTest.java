...
import com.tibco.xpd.implementer.resources.xpdl2.actions.GenerateBizServiceFromStartTypeNoneAction;
...
/**
 * JUnit test to protect business service generation from a start type none
 * event.
 * 
 * @author sajain
 * @since Jan 21, 2015
 */
public class N2_07_BizServiceGenerationFromStartEventTest
    ...
    public void testBizServiceGenerationTest() throws Exception {
         ...
         */
        Set<Activity> startEventsOfTypeNone = new HashSet<Activity>();
            ...
            for (Process process : pckg.getProcesses()) {
                ...
                for (Activity activity : process.getActivities()) {
                    ...
                    if (EventFlowType.FLOW_START_LITERAL
                        ...
                        startEventsOfTypeNone.add(activity);
                    }
                }
            }
        }
        ...
        for (final Activity activity : startEventsOfTypeNone) {
            ...
            final IObjectActionDelegate delegate =
                    new GenerateBizServiceFromStartTypeNoneAction();
    ...
    protected TestResourceInfo[] getTestResources() {
        TestResourceInfo[] testResources = new TestResourceInfo[] {
                new TestResourceInfo(
                        "resources/N2_07_BizServiceGenerationFromStartEventTest", //$NON-NLS-1$
                        "N2_07_BusinessServiceGeneration/Business Objects{bom}/N2_07_BizServiceGenerationFromStartEventTest.bom"), //$NON-NLS-1$
                new TestResourceInfo(
                        "resources/N2_07_BizServiceGenerationFromStartEventTest", //$NON-NLS-1$
                        "N2_07_BusinessServiceGeneration/Process Packages{processes}/BusinessService.xpdl"), //$NON-NLS-1$
                new TestResourceInfo(
                        "resources/N2_07_BizServiceGenerationFromStartEventTest", //$NON-NLS-1$
                        "N2_07_BusinessServiceGeneration/GoldFiles/GoldBusinessService.xpdl"), //$NON-NLS-1$
        };
