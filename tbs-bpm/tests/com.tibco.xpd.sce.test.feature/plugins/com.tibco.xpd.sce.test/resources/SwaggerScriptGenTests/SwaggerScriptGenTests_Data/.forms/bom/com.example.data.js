...
bpm.data.Loader.classDefiner["com.example.data.DataPackage"] = function() {
    /** Constructor. */
    var theClass = function() {
    };
    bpm.data.Loader.currentLoader.registerPackage(theClass, "com.example.data.DataPackage");

};

bpm.scriptUtil._internal.checkVersionCompatibility("com.example.data.js", "11.4.0.048");
bpm.data.Loader.classDefiner["com.example.data.DataPackage"]();
...
bpm.data.Loader.classDefiner["com.example.data.DataFactory"] = function() {
    /** Constructor. */
    ...
    bpm.data.Loader.currentLoader.registerFactory(theClass, "com.example.data.DataFactory");

    theClass.prototype.SUPPORTED_CLASSES = [
        "com.example.data.Tag"
    ];
    ...
    theClass.prototype.createTag = function(jsonData) {
        var instance = this.$loader.newInstance("com.example.data.Tag", this.context);
        if (jsonData != undefined)
...
bpm.data.Loader.classDefiner["com.example.data.DataFactory"]();
/*
 * This provides an implementation of the BOM class com.example.data.Tag. 
 */
bpm.data.Loader.classDefiner["com.example.data.Tag"] = function() {
    /** Constructor. */
    ...
    theClass.LOADER.registerClass(theClass, "com.example.data.Tag");
...
bpm.data.Loader.classDefiner["com.example.data.Tag"]();
