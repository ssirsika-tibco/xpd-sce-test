 ...
 * @since
 */
public class JavascriptNumberValidTest extends AbstractN2BaseValidationTest {
    ...
    protected void setUpBeforeBuild() {
        ...
        BOMUtils.setAsBusinessDataProject(ResourcesPlugin.getWorkspace()
                .getRoot().getProject("JavascriptNumberTest")); //$NON-NLS-1$
    }
    ...
    public void testAceBomMigrationValidationsTest() throws Exception {
         ...
         */
        IFile okFile1 = getTestFile("JavascriptNumberTest.xpdl"); //$NON-NLS-1$
        ...
        assertTrue(
                "JavascriptNumberTest.xpdl: should not have problem markers but has at least one:\n" //$NON-NLS-1$
                        + the1stProblem,
                the1stProblem == null);
    ...
    protected String getTestName() {
        return "JavascriptNumberTest"; //$NON-NLS-1$
    }
    ...
    protected TestResourceInfo[] getTestResources() {
        return new TestResourceInfo[] { new TestResourceInfo(
                "resources/JavascriptNumberTest", //$NON-NLS-1$
                "JavascriptNumberTest/Process Packages{processes}/JavascriptNumberTest.xpdl") //$NON-NLS-1$
        };
    }
