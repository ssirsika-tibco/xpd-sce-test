...
public class WlfModelRascContributorTest extends TestCase {
    ...
    /**
     * Test that the hasContributionsFor and RASC generation contribution for Worklist Facade Model work correctly.
     * 
     * @throws Exception
     */
    public void testProjectWithContributions() throws Exception {
        ...
        try {
            ...
            assertTrue(projectName + " project should have Worklist Facade RASC contributions",
            ...
            assertTrue(projectName + " project should have a contributed workListFacade.wlf artifact",
                    wlfArtifact != null);
    ...
    public void testProjectWithoutContributions1() throws Exception {
        ...
        RascContributor fixture = new WlfModelsRascContributor();
            ...
            assertFalse(projectName + " project should not have WorkList Facade RASC contributions",
                fixture.hasContributionsFor(project));
