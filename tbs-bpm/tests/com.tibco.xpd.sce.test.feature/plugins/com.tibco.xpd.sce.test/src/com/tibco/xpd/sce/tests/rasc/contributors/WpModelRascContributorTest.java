...
public class WpModelRascContributorTest extends TestCase {
    ...
    public void testProjectWithContributions() throws Exception {
        ...
        try {
             ...
             * 
             * The RASC folder for output resources other than the WP model
             ...
             * necessary the version folder can be re-introduced by appending
             * {@link #getProjectGenerationVersion()} as a new element after the
             * base path.
             */
            ...
            for (WriterContent artifact : artifacts) {
                ...
                } else if (artifact.getFullPath()
                        .equals(baseOtherResourcesFolder
            ...
            System.setProperty("tibco.forms.rasc", "");
        }
    }
    ...
    public void testProjectWithoutContributions1() throws Exception {
        ...
        try {
            ...
            assertFalse(
                    projectName
                            + " project should not have WP RASC contributions",
                    fixture.hasContributionsFor(project));
