 ...
 * <p>
 * AceBomMigrationValidationsTest - Test selected validations are correctly raised.
 * </p>
 * <p>
 ...
 * @since
 */
public class AceBomMigrationValidationsTest extends AbstractN2BaseValidationTest {
    ...
    protected ValidationsTestProblemMarkerInfo[] getValidationProblemMarkerInfos() {
        ValidationsTestProblemMarkerInfo[] markerInfos = new ValidationsTestProblemMarkerInfo[] { 
			    ...
			    new ValidationsTestProblemMarkerInfo(
			    		...
			    		"_F36BAGDjEemqb6fRqQJHQg", //$NON-NLS-1$ 
			    		"BPM  : Global classes cannot contain Case Identifiers (Global class  with case attribs (com.example.unsupportedconstructs))", //$NON-NLS-1$ 
			    		""), //$NON-NLS-1$ 
			    ...
			    new ValidationsTestProblemMarkerInfo(
			    		...
			    		"BPM  : Case State can only be contained within a Case Class (caseState1 (com.example.unsupportedconstructs))", //$NON-NLS-1$ 
			    		""), //$NON-NLS-1$ 
			    ...
			    new ValidationsTestProblemMarkerInfo(
			    		...
			    		"BPM  : Case identifier attribute is mandatory and non-array (multiplicity must be 1) (textCaseId (com.example.unsupportedconstructs))", //$NON-NLS-1$ 
			    		""), //$NON-NLS-1$ 
			    ...
			    new ValidationsTestProblemMarkerInfo(
			    		...
			    		"_KF_LAGDjEemqb6fRqQJHQg", //$NON-NLS-1$ 
			    		"BPM  : Local classes cannot contain Case Identifiers (Local class  with case attribs (com.example.unsupportedconstructs))", //$NON-NLS-1$ 
			    		""), //$NON-NLS-1$ 
    ...
    protected TestResourceInfo[] getTestResources() {
        TestResourceInfo[] testResources = new TestResourceInfo[] {
            new TestResourceInfo("resources/AceBomMigrationValidationsTest", "BPMProjectMigration_BOMValidations/Business Objects{bom}/NoSubPkgAllowed_EvenWhenNoCaseClasses.bom"), //$NON-NLS-1$ //$NON-NLS-2$
            new TestResourceInfo("resources/AceBomMigrationValidationsTest", "BPMProjectMigration_BOMValidations/Business Objects{bom}/SupportedAttribTypes.bom"), //$NON-NLS-1$ //$NON-NLS-2$
            new TestResourceInfo("resources/AceBomMigrationValidationsTest", "BPMProjectMigration_BOMValidations/Business Objects{bom}/SupportedConstructs.bom"), //$NON-NLS-1$ //$NON-NLS-2$
            new TestResourceInfo("resources/AceBomMigrationValidationsTest", "BPMProjectMigration_BOMValidations/Business Objects{bom}/UnsupportedAttribTypes.bom"), //$NON-NLS-1$ //$NON-NLS-2$
            new TestResourceInfo("resources/AceBomMigrationValidationsTest", "BPMProjectMigration_BOMValidations/Business Objects{bom}/UnsupportedConstructs.bom"), //$NON-NLS-1$ //$NON-NLS-2$
        };
