    ...
    protected ValidationsTestProblemMarkerInfo[] getValidationProblemMarkerInfos() {
        ValidationsTestProblemMarkerInfo[] markerInfos = new ValidationsTestProblemMarkerInfo[] {
                ...
                new ValidationsTestProblemMarkerInfo("/BPMLocalSignalProj01/Process Packages/BPMLocalSignalProj01.xpdl",
                        ...
                        "//@package/@processes.0/@activities.4/@event/@triggerResultSignal/@otherElements.0/@outputScriptDataMapper/@dataMappings.2",
                        "BPM  : Data Mapper: The data types are incompatible for mapping 'CorrelationField' to 'Process.priority'. (BPMLocalSignalProj01Process:CatchSignal1:Process_priority$)",
                        "Remove mapping"),
                new ValidationsTestProblemMarkerInfo("/BPMLocalSignalProj01/Process Packages/BPMLocalSignalProj01.xpdl",
                        "abstractMappingRule.incompatibleTypes",
