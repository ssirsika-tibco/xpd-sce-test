 ...
 * 
 */
public class IndexResourceCopier {
    ...
    private static class ResourceCopyFile {
                ...
                if (!folder.exists()) {
                    ...
                    if (!folder.mkdirs()) {
                        throw generateCoreException(String
                                .format(Messages.IndexResourceCopier_FailedToCreateFolder,
                                        folder.toString()));
                    }
                    ...
                    // exception
                    throw generateCoreException(String
                            .format(Messages.IndexResourceCopier_UnableToCreateFolder,
                                    folder.toString()));
                }
            }
        ...
        private CoreException generateCoreException(String errMsg) {
            return new CoreException(new Status(IStatus.ERROR,
                    XpdResourcesUIActivator.ID, IStatus.OK, errMsg, null));
        }
    ...
    private static final ResourceCopyFile copyFiles[] =
            {
                    new ResourceCopyFile(
                            "/resources/css/img/bg_caption.png", "images/bg_caption.png", true), //$NON-NLS-1$ //$NON-NLS-2$
                    new ResourceCopyFile(
                            "/resources/css/img/banner.jpg", "images/banner.jpg", true), //$NON-NLS-1$ //$NON-NLS-2$

            };

    private Set<File> alreadyProcessedFolders = new HashSet<File>();

    public IndexResourceCopier() {
        ;
    }
        ...
        if (outputFile != null) {
            ...
            if (monitor != null) {
                ...
                monitor.subTask(inputFile.getName() + ": " //$NON-NLS-1$
                        + Messages.IndexResourceCopier_CopyingNeededFiles);
            }
