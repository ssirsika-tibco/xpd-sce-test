...
/**
 * Base class for new XPD wizards.
 * 
 */
public abstract class BasicNewXpdResourceWizard extends Wizard implements
        INewWizard {
    ...
    /**
     * Check if this wizard is being called from an RCP application.
     * 
     * @return <code>true</code> if being called from RCP application.
     */
    protected final boolean isRCP() {
        return isRCP;
    }
