...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.deploy.ModuleContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleContainerItemProvider extends ItemProviderAdapter implements
     ...
     * @generated
     */
    public ModuleContainerItemProvider(AdapterFactory adapterFactory) {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            // childrenFeatures
            // .add(DeployPackage.Literals.SERVER_ELEMENT__PARAMETERS);
            childrenFeatures
                    .add(DeployPackage.Literals.CONTAINER_ELEMENT__CHILDREN);
        }
    ...
    /**
     * This returns ModuleContainer.gif.
     * <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = ((ModuleContainer) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_ModuleContainer_type")
                : getString("_UI_ModuleContainer_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ModuleContainer.class)) {
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(
                DeployPackage.Literals.CONTAINER_ELEMENT__CHILDREN,
