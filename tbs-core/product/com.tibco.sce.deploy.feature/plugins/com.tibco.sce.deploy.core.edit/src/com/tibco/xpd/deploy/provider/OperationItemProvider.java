...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.deploy.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider extends ItemProviderAdapter implements
    ...
    protected void addToStatePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Operation_toState_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_Operation_toState_feature", "_UI_Operation_type"),
                DeployPackage.Literals.OPERATION__TO_STATE, true, false, true,
                null, null, null));
    }
