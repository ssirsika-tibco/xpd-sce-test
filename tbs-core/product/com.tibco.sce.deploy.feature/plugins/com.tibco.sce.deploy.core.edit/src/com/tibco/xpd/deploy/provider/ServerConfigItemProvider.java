...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.deploy.ServerConfig} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServerConfigItemProvider extends ItemProviderAdapter implements
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures
                    .add(DeployPackage.Literals.SERVER_CONFIG__CONFIG_PARAMETERS);
        }
    ...
    /**
     * This returns ServerConfig.gif. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = ((ServerConfig) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_ServerConfig_type")
                : getString("_UI_ServerConfig_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ServerConfig.class)) {
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(
                DeployPackage.Literals.SERVER_CONFIG__CONFIG_PARAMETERS,
