 ...
 * 
 */
public class SearchItemProvider implements IWorkbenchAdapter {
    ...
    public String getLabel(Object o) {
        if (o instanceof Search) {
            return ((Search) o).getName();
        } else if (o instanceof RegistrySearch) {
            Search search = ((RegistrySearch) o).getSearch();
            if (search != null) {
