...
public abstract class DetailsDialog extends TrayDialog {
    ...
    /**
     * The key for the image to be displayed (one of the image constants on
     * Dialog)
     */
    private String imageKey = null;

    /**
     * Creates a details pane dialog. Note that the dialog will have no visual
    ...
    protected void buttonPressed(int id) {
        if (id == IDialogConstants.DETAILS_ID) { // was the details button
            // pressed?
            toggleDetailsArea();
        } else {
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        ...
        if (includeDetailsButton()) {
            detailsButton = createButton(parent, IDialogConstants.DETAILS_ID,
                    getDetailsButtonLabelShow(), false);
        }
        updateEnablements();
    }
    ...
    final protected Control createDialogArea(Composite parent) {
        ...
        if (includeErrorMessage()) {
            ...
            errorMessageLabel.setForeground(getShell().getDisplay()
                    .getSystemColor(SWT.COLOR_RED));
        }

        Control statusArea = createStatusArea(parent);
    ...
    /**
     * Create an area under the main dialog area and over the buttons. Default
     * implementation returns <code>null</code>. Subclasses can override to
     * add status controls to the dialog.
     * 
     * @param parent
     * @return <code>Control</code> to add, or <code>null</code> if no
    ...
    /**
     * Return the help context id to be used for the dialog. This context Id
     * will be registered by this class. By default, this method returns
     * <code>null</code>.
     * 
    ...
    /**
     * Return whether the main area should grab excess vertical space. The
     * default is <code>true</code> but subclasses can override in cases where
     * the main is more or less fixed but the details needs to grab.
     * 
