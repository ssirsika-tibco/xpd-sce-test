...
public class IndexDocGen extends AbstractBIRTDocGen {
    ...
    protected void generateExtraResources(IFile inputFile, IPath outputFilePath,
        ...
        try {
            resourceCopier.perform(
                    new SubProgressMonitor(new NullProgressMonitor(), 30),
                    inputFile,
    ...
    // /**
    // * @see
    // org.eclipse.birt.report.model.api.DefaultResourceLocator#findResource(org.eclipse.birt.report.model.api.ModuleHandle,
