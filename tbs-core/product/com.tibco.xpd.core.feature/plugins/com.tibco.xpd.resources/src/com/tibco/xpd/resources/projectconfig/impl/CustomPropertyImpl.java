 ...
 * </p>
 * <ul>
 *   <li>{@link com.tibco.xpd.resources.projectconfig.impl.CustomPropertyImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.tibco.xpd.resources.projectconfig.impl.CustomPropertyImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomPropertyImpl extends EObjectImpl implements CustomProperty {
    ...
    protected EClass eStaticClass() {
        return ProjectConfigPackage.Literals.CUSTOM_PROPERTY;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProjectConfigPackage.CUSTOM_PROPERTY__NAME, oldName,
                    name));
    }
    ...
    public void setValue(String newValue) {
        ...
        value = newValue;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ProjectConfigPackage.CUSTOM_PROPERTY__VALUE, oldValue,
                    value));
    }
