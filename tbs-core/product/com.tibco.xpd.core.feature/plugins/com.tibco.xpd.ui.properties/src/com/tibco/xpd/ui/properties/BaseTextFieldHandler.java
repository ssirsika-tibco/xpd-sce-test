 ...
 * @author wzurek
 */
public abstract class BaseTextFieldHandler implements Listener {
     ...
     */
    public BaseTextFieldHandler(Text text, CommandProvider commandProvider) {
        this.text = text;
     ...
     * @param text
     */
    protected void register(Text text) {
            ...
            if (cmd != null) {
                if (cmd.canExecute()) {
                    ...
                    if (commandStack instanceof TransactionalCommandStack) {
                        TransactionalCommandStack tcs =
                                (TransactionalCommandStack) commandStack;
                        try {
                            tcs.execute(cmd, Collections.emptyMap());
