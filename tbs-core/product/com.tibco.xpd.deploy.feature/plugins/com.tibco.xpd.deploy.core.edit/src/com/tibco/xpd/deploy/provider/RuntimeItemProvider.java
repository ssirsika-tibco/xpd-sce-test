...
/**
 * This is the item provider adapter for a {@link com.tibco.xpd.deploy.Runtime} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuntimeItemProvider extends ItemProviderAdapter implements
    ...
    protected void addRuntimeTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory)
                        .getRootAdapterFactory(), getResourceLocator(),
                getString("_UI_Runtime_runtimeType_feature"), getString(
                        "_UI_PropertyDescriptor_description",
                        "_UI_Runtime_runtimeType_feature", "_UI_Runtime_type"),
                DeployPackage.Literals.RUNTIME__RUNTIME_TYPE, true, false,
                true, null, null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(
        ...
        if (childrenFeatures == null) {
            ...
            childrenFeatures
                    .add(DeployPackage.Literals.RUNTIME__RUNTIME_CONFIG);
        }
    ...
    public String getText(Object object) {
        String label = ((com.tibco.xpd.deploy.Runtime) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_Runtime_type")
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(com.tibco.xpd.deploy.Runtime.class)) {
    ...
    protected void collectNewChildDescriptors(
        ...
        newChildDescriptors.add(createChildParameter(
                DeployPackage.Literals.RUNTIME__RUNTIME_CONFIG,
                DeployFactory.eINSTANCE.createRuntimeConfig()));
    }
