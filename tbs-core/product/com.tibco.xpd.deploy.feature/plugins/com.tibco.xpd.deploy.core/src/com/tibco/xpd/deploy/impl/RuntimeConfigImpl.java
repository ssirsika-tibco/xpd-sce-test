...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Runtime Config</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.xpd.deploy.impl.RuntimeConfigImpl#getConfigParameters <em>Config Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuntimeConfigImpl extends EObjectImpl implements RuntimeConfig {
    ...
    protected EClass eStaticClass() {
        return DeployPackage.Literals.RUNTIME_CONFIG;
    }
    ...
    public EList<ConfigParameter> getConfigParameters() {
        if (configParameters == null) {
            configParameters = new EObjectContainmentEList<ConfigParameter>(
                    ...
                    DeployPackage.RUNTIME_CONFIG__CONFIG_PARAMETERS);
        }
