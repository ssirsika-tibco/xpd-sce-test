...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Server Module</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.xpd.deploy.impl.ServerModuleImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.tibco.xpd.deploy.impl.ServerModuleImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.tibco.xpd.deploy.impl.ServerModuleImpl#getServerElementType <em>Server Element Type</em>}</li>
 *   <li>{@link com.tibco.xpd.deploy.impl.ServerModuleImpl#getServerElementState <em>Server Element State</em>}</li>
 *   <li>{@link com.tibco.xpd.deploy.impl.ServerModuleImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ServerModuleImpl extends EObjectImpl implements ServerModule {
    /**
    ...
    protected EClass eStaticClass() {
        return DeployPackage.Literals.SERVER_MODULE;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    DeployPackage.SERVER_MODULE__NAME, oldName, name));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    DeployPackage.SERVER_MODULE__DESCRIPTION, oldDescription,
                    description));
    }
            ...
            if (serverElementType != oldServerElementType) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            DeployPackage.SERVER_MODULE__SERVER_ELEMENT_TYPE,
    ...
    public ServerElementState getServerElementState() {
        if (serverElementState != null && serverElementState.eIsProxy()) {
            ...
            if (serverElementState != oldServerElementState) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            DeployPackage.SERVER_MODULE__SERVER_ELEMENT_STATE,
    ...
    public EList<ConfigParameter> getParameters() {
        if (parameters == null) {
            parameters = new EObjectContainmentEList<ConfigParameter>(
                    ...
                    DeployPackage.SERVER_MODULE__PARAMETERS);
        }
        return parameters;
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case DeployPackage.SERVER_MODULE__SERVER_ELEMENT_TYPE:
            if (resolve)
                return getServerElementType();
            return basicGetServerElementType();
        case DeployPackage.SERVER_MODULE__SERVER_ELEMENT_STATE:
            if (resolve)
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == ServerElement.class) {
            switch (derivedFeatureID) {
            case DeployPackage.SERVER_MODULE__SERVER_ELEMENT_TYPE:
                return DeployPackage.SERVER_ELEMENT__SERVER_ELEMENT_TYPE;
            case DeployPackage.SERVER_MODULE__SERVER_ELEMENT_STATE:
                return DeployPackage.SERVER_ELEMENT__SERVER_ELEMENT_STATE;
            case DeployPackage.SERVER_MODULE__PARAMETERS:
                return DeployPackage.SERVER_ELEMENT__PARAMETERS;
            default:
                return -1;
            }
        }
        if (baseClass == LeafElement.class) {
            switch (derivedFeatureID) {
            default:
                return -1;
            }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == ServerElement.class) {
            ...
            case DeployPackage.SERVER_ELEMENT__SERVER_ELEMENT_TYPE:
                return DeployPackage.SERVER_MODULE__SERVER_ELEMENT_TYPE;
            case DeployPackage.SERVER_ELEMENT__SERVER_ELEMENT_STATE:
                return DeployPackage.SERVER_MODULE__SERVER_ELEMENT_STATE;
            case DeployPackage.SERVER_ELEMENT__PARAMETERS:
                return DeployPackage.SERVER_MODULE__PARAMETERS;
            default:
                return -1;
            }
        }
