 ...
 * <p/>
 * NOTE: This class is a part of extension and should not be instantiated by the
 * user.
 * 
 * @author glewis
 * 
 * 
 * @deprecated Moved to {@link com.tibco.xpd.deploy.webdav.WebDavRepositoryPage}
 *             . Please use this class instead.
 */
@Deprecated
public class WebDavRepositoryPage extends BaseDeployWizardPage implements
        Listener, RepositoryConfigWizardPageExt {

    /** ISocketFactory supporting SSL protocol. */
    private static final ISocketFactory SOCKET_FACTORY = new ISocketFactory() {
        @Override
                        ...
                        try {
                            ...
                            httpClient
                                    .setAuthenticator(new SimpleBasicAuthenticator(
                                            username, password));
                            httpClient.setSocketFactory(SOCKET_FACTORY);
                            DAVClient davClient =
